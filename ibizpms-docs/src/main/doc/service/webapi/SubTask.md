...
| 9 | n_lasteditedby_eq | String | 允许 | 条件字段：lasteditedby<br>条件组合方式：`=` |
| 10 | n_status_eq | String | 允许 | 条件字段：status<br>条件组合方式：`=` |
| 11 | n_status_in | String | 允许 | 条件字段：status<br>条件组合方式：`in(...)` |
| 12 | n_status_noteq | String | 允许 | 条件字段：status<br>条件组合方式：`!=`或者`<>` |
| 13 | n_name_like | String | 允许 | 条件字段：name<br>条件组合方式：`%like%` |
| 14 | n_closeddate_ltandeq | Timestamp | 允许 | 条件字段：closeddate<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd HH:mm:ss |
| 15 | n_type_eq | String | 允许 | 条件字段：type<br>条件组合方式：`=` |
| 16 | n_assignedto_eq | String | 允许 | 条件字段：assignedto<br>条件组合方式：`=` |
| 17 | n_eststarted_gtandeq | Timestamp | 允许 | 条件字段：eststarted<br>条件组合方式：`>=`<br>时间格式：yyyy-MM-dd |
| 18 | n_eststarted_ltandeq | Timestamp | 允许 | 条件字段：eststarted<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd |
| 19 | n_openedby_eq | String | 允许 | 条件字段：openedby<br>条件组合方式：`=` |
| 20 | n_finisheddate_ltandeq | Timestamp | 允许 | 条件字段：finisheddate<br>条件组合方式：`<=`<br>时间格式：yyyy-MM-dd |
| 21 | n_modulename_eq | String | 允许 | 条件字段：modulename<br>条件组合方式：`=` |
| 22 | n_modulename_like | String | 允许 | 条件字段：modulename<br>条件组合方式：`%like%` |
| 23 | n_storyname_eq | String | 允许 | 条件字段：storyname<br>条件组合方式：`=` |
| 24 | n_storyname_like | String | 允许 | 条件字段：storyname<br>条件组合方式：`%like%` |
| 25 | n_projectname_eq | String | 允许 | 条件字段：projectname<br>条件组合方式：`=` |
| 26 | n_projectname_like | String | 允许 | 条件字段：projectname<br>条件组合方式：`%like%` |
| 27 | n_product_eq | Long | 允许 | 条件字段：product<br>条件组合方式：`=` |
| 28 | n_parentname_eq | String | 允许 | 条件字段：parentname<br>条件组合方式：`=` |
| 29 | n_parentname_like | String | 允许 | 条件字段：parentname<br>条件组合方式：`%like%` |
| 30 | n_project_eq | Long | 允许 | 条件字段：project<br>条件组合方式：`=` |
| 31 | n_story_eq | Long | 允许 | 条件字段：story<br>条件组合方式：`=` |
| 32 | n_parent_eq | Long | 允许 | 条件字段：parent<br>条件组合方式：`=` |
| 33 | n_frombug_eq | Long | 允许 | 条件字段：frombug<br>条件组合方式：`=` |
| 34 | n_module_eq | Long | 允许 | 条件字段：module<br>条件组合方式：`=` |
| 35 | n_path_like | String | 允许 | 条件字段：path<br>条件组合方式：`%like%` |
| 36 | n_status1_eq | String | 允许 | 条件字段：status1<br>条件组合方式：`=` |
| 37 | n_tasktype_eq | String | 允许 | 条件字段：tasktype<br>条件组合方式：`=` |
