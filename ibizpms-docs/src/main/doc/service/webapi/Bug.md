...
| 126 | filter | QueryFilter | 允许 | 条件表达式<br>参照`cn.ibizlab.pms.util.filter.QueryFilter` |
| 127 | page | int | 允许 | 当前页数<br>默认值0 |
| 128 | size | int | 允许 | 每页显示条数<br>默认值20 |
| 129 | sort | String | 允许 | 排序 |
