...
| 7 | linkcase | String | 允许 | 相关用例 |
| 8 | order | Integer | 允许 | 排序 |
| 9 | howrun | String | 允许 | howRun |
| 10 | version | Integer | 允许 | 用例版本 |
| 11 | scriptedby | String | 允许 | scriptedBy |
| 12 | openedby | String | 允许 | 由谁创建 |
| 13 | type | String | 允许 | 用例类型 |
| 14 | status | String | 允许 | 用例状态 |
| 15 | auto | String | 允许 | auto |
| 16 | frequency | String | 允许 | frequency |
| 17 | title | String | 不可 | 用例标题 |
| 18 | lasteditedby | String | 允许 | 最后修改者 |
| 19 | reviewedby | String | 允许 | 由谁评审 |
| 20 | deleted | String | 允许 | 已删除 |
| 21 | revieweddate | Timestamp | 允许 | 评审时间<br>时间格式：yyyy-MM-dd |
| 22 | pri | Integer | 允许 | 优先级 |
| 23 | stage | String | 允许 | 适用阶段 |
| 24 | scriptlocation | String | 允许 | scriptLocation |
| 25 | lastrundate | Timestamp | 允许 | 执行时间<br>时间格式：yyyy-MM-dd HH:mm:ss |
| 26 | keywords | String | 允许 | 关键词 |
| 27 | scriptstatus | String | 允许 | scriptStatus |
| 28 | frame | String | 允许 | 工具/框架 |
| 29 | substatus | String | 允许 | 子状态 |
| 30 | id | Long | 不可 | 用例编号 |
| 31 | precondition | String | 允许 | 前置条件 |
| 32 | lastrunner | String | 允许 | 执行人 |
| 33 | fromcaseversion | Integer | 允许 | 来源用例版本 |
| 34 | storyversion | Integer | 允许 | 需求版本 |
| 35 | fromcaseid | Long | 允许 | 来源用例 |
| 36 | branch | Long | 允许 | 平台/分支 |
| 37 | frombug | Long | 允许 | 来源Bug |
| 38 | story | Long | 允许 | 相关需求 |
| 39 | product | Long | 允许 | 所属产品 |
| 40 | lib | Long | 允许 | 所属库 |
| 41 | module | Long | 允许 | 所属模块 |
| 42 | modulename | String | 允许 | 模块名称 |
| 43 | storyname | String | 允许 | 需求名称 |
| 44 | productname | String | 允许 | 产品名称 |
| 45 | tobugcnt | Integer | 允许 | 转bug数 |
| 46 | resultcnt | Integer | 允许 | 测试结果数 |
| 47 | stepcnt | Integer | 允许 | 用例步骤数 |
| 48 | comment | String | 允许 | 备注 |
| 49 | resultfalicnt | Integer | 允许 | 测试失败数 |
| 50 | status1 | String | 允许 | 用例状态 |
| 51 | assignedto | String | 允许 | 指派给 |
| 52 | task | String | 允许 | 属性 |
...
| 9 | n_frame_eq | String | 允许 | 条件字段：frame<br>条件组合方式：`=` |
| 10 | n_lastrunner_eq | String | 允许 | 条件字段：lastrunner<br>条件组合方式：`=` |
| 11 | n_fromcaseid_eq | Long | 允许 | 条件字段：fromcaseid<br>条件组合方式：`=` |
| 12 | n_branch_eq | Long | 允许 | 条件字段：branch<br>条件组合方式：`=` |
| 13 | n_frombug_eq | Long | 允许 | 条件字段：frombug<br>条件组合方式：`=` |
| 14 | n_story_eq | Long | 允许 | 条件字段：story<br>条件组合方式：`=` |
| 15 | n_product_eq | Long | 允许 | 条件字段：product<br>条件组合方式：`=` |
| 16 | n_lib_eq | Long | 允许 | 条件字段：lib<br>条件组合方式：`=` |
...
| 20 | n_storyname_eq | String | 允许 | 条件字段：storyname<br>条件组合方式：`=` |
| 21 | n_storyname_like | String | 允许 | 条件字段：storyname<br>条件组合方式：`%like%` |
| 22 | n_productname_eq | String | 允许 | 条件字段：productname<br>条件组合方式：`=` |
| 23 | n_productname_like | String | 允许 | 条件字段：productname<br>条件组合方式：`%like%` |
| 24 | n_status1_eq | String | 允许 | 条件字段：status1<br>条件组合方式：`=` |
| 25 | n_assignedto_eq | String | 允许 | 条件字段：assignedto<br>条件组合方式：`=` |
| 26 | n_libname_eq | String | 允许 | 条件字段：libname<br>条件组合方式：`=` |
| 27 | n_libname_like | String | 允许 | 条件字段：libname<br>条件组合方式：`%like%` |
| 28 | n_lastrunresult1_eq | String | 允许 | 条件字段：lastrunresult1<br>条件组合方式：`=` |
