...
| 序号 | 属性名 | 属性类型 | 是否可以为空 | 说明 |
| -- | -- | -- | -- | -- |
| 56 | n_canceledby_eq | String | 允许 |  |
| 57 | n_color_eq | String | 允许 |  |
| 58 | n_id_noteq | Long | 允许 |  |
| 59 | n_finishedby_eq | String | 允许 |  |
| 60 | n_closedby_eq | String | 允许 |  |
| 61 | n_closedreason_eq | String | 允许 |  |
| 62 | n_assigneddate_gtandeq | Timestamp | 允许 | 时间格式：yyyy-MM-dd HH:mm:ss |
| 63 | n_pri_eq | Integer | 允许 |  |
| 64 | n_lasteditedby_eq | String | 允许 |  |
| 65 | n_status_eq | String | 允许 |  |
| 66 | n_status_in | String | 允许 |  |
| 67 | n_status_noteq | String | 允许 |  |
| 68 | n_name_like | String | 允许 |  |
| 69 | n_closeddate_ltandeq | Timestamp | 允许 | 时间格式：yyyy-MM-dd HH:mm:ss |
| 70 | n_type_eq | String | 允许 |  |
| 71 | n_assignedto_eq | String | 允许 |  |
| 72 | n_eststarted_gtandeq | Timestamp | 允许 | 时间格式：yyyy-MM-dd |
| 73 | n_eststarted_ltandeq | Timestamp | 允许 | 时间格式：yyyy-MM-dd |
| 74 | n_openedby_eq | String | 允许 |  |
| 75 | n_finisheddate_ltandeq | Timestamp | 允许 | 时间格式：yyyy-MM-dd |
| 76 | n_modulename_eq | String | 允许 |  |
| 77 | n_modulename_like | String | 允许 |  |
| 78 | n_storyname_eq | String | 允许 |  |
| 79 | n_storyname_like | String | 允许 |  |
| 80 | n_projectname_eq | String | 允许 |  |
| 81 | n_projectname_like | String | 允许 |  |
| 82 | n_product_eq | Long | 允许 |  |
| 83 | n_parentname_eq | String | 允许 |  |
| 84 | n_parentname_like | String | 允许 |  |
| 85 | n_project_eq | Long | 允许 |  |
| 86 | n_story_eq | Long | 允许 |  |
| 87 | n_parent_eq | Long | 允许 |  |
| 88 | n_frombug_eq | Long | 允许 |  |
| 89 | n_module_eq | Long | 允许 |  |
| 90 | n_path_like | String | 允许 |  |
| 91 | n_status1_eq | String | 允许 |  |
| 92 | n_tasktype_eq | String | 允许 |  |
