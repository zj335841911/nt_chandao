...
| 序号 | 参数名 | 参数类型 | 说明 |
| -- | -- | -- | -- |
| 1 | context | [ProductLifeSearchContext](#ProductLifeSearchContext) | 待补充 |

#### 返回值说明
返回类型：ResponseEntity<List<[ProductLifeDTO](#ProductLifeDTO)>>
...
#### 返回值说明
返回类型：ResponseEntity<Page<[ProductLifeDTO](#ProductLifeDTO)>>
