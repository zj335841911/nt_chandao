...
| 2 | projectteam_id | Long | 待补充 |
| 3 | projectteamdtos | List<[ProjectTeamDTO](#ProjectTeamDTO)> | 待补充 |
...
| -- | -- | -- | -- |
| 1 | project_id | Long | 待补充 |
| 2 | projectteamdto | [ProjectTeamDTO](#ProjectTeamDTO) | 待补充 |
...
| -- | -- | -- | -- |
| 1 | project_id | Long | 待补充 |
| 2 | context | [ProjectTeamSearchContext](#ProjectTeamSearchContext) | 待补充 |
