...
| 序号 | 参数名 | 参数类型 | 说明 |
| -- | -- | -- | -- |
| 1 | productdto | [ProductDTO](#ProductDTO) | 待补充 |

#### 返回值说明
返回类型：ResponseEntity<[ProductDTO](#ProductDTO)>
...
| 序号 | 参数名 | 参数类型 | 说明 |
| -- | -- | -- | -- |
| 1 | productdtos | List<[ProductDTO](#ProductDTO)> | 待补充 |
...
| 2 | productdtos | List<[ProductDTO](#ProductDTO)> | 待补充 |
...
| 序号 | 参数名 | 参数类型 | 说明 |
| -- | -- | -- | -- |
| 1 | context | [ProductSearchContext](#ProductSearchContext) | 待补充 |

#### 返回值说明
返回类型：ResponseEntity<List<[ProductDTO](#ProductDTO)>>
...
#### 返回值说明
返回类型：ResponseEntity<Page<[ProductDTO](#ProductDTO)>>
