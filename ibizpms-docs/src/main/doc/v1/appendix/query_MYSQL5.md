...
LEFT JOIN zt_product t41 ON t21.PRODUCT = t41.ID 
LEFT JOIN zt_task t51 ON t1.PARENT = t51.ID
WHERE FIND_IN_SET(t1.id,(select t1.todaytask from t_ibz_daily t1 where t1.IBZ_DAILYID =  ${srfdatacontext('srfparentkey')}
...
WHERE t1.DELETED = '0' 
FIND_IN_SET(t1.id,(select t1.tomorrowplanstask from t_ibz_daily t1 where t1.IBZ_DAILYID =  ${srfdatacontext('srfparentkey')} 
