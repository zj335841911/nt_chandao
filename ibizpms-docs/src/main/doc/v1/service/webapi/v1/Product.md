...
| 2 | n_name_eq | String | 允许 | 条件字段：name<br>条件组合方式：`=` |
...
| 8 | n_status_isnotnull | String | 允许 | 条件字段：status<br>条件组合方式：`is not NULL` |
| 9 | n_linename_eq | String | 允许 | 条件字段：linename<br>条件组合方式：`=` |
| 10 | n_linename_like | String | 允许 | 条件字段：linename<br>条件组合方式：`%like%` |
| 11 | n_line_eq | Long | 允许 | 条件字段：line<br>条件组合方式：`=` |
| 12 | n_productclass_eq | String | 允许 | 条件字段：productclass<br>条件组合方式：`=` |
