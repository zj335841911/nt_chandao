...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | ibilogin_id | Long | 实体主键ID |
| 2 | ibilogindto | [IbiLoginDTO](#IbiLoginDTO) | 实体实体传输对象 |

#### 返回说明
| 项目 | 说明 |
| ---- | ---- |
| 返回状态 | 200：请求成功。<br>401：用户未认证。<br>500：服务异常。 |
| 返回类型 | [IbiLoginDTO](#IbiLoginDTO)：实体实体传输对象 |

### ZT登录
#### 访问路径
/ibilogins/{ibilogin_id}/ztlogin
