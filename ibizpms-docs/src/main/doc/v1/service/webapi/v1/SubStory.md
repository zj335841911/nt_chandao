...
| 4 | n_pri_eq | Integer | 允许 | 条件字段：pri<br>条件组合方式：`=` |
| 5 | n_pri_gtandeq | Integer | 允许 | 条件字段：pri<br>条件组合方式：`>=` |
| 6 | n_pri_ltandeq | Integer | 允许 | 条件字段：pri<br>条件组合方式：`<=` |
...
| 10 | n_reviewedby_eq | String | 允许 | 条件字段：reviewedby<br>条件组合方式：`=` |
| 11 | n_stagedby_eq | String | 允许 | 条件字段：stagedby<br>条件组合方式：`=` |
| 12 | n_openedby_eq | String | 允许 | 条件字段：openedby<br>条件组合方式：`=` |
| 13 | n_id_eq | Long | 允许 | 条件字段：id<br>条件组合方式：`=` |
| 14 | n_id_noteq | Long | 允许 | 条件字段：id<br>条件组合方式：`!=`或者`<>` |
| 15 | n_source_eq | String | 允许 | 条件字段：source<br>条件组合方式：`=` |
| 16 | n_closedreason_eq | String | 允许 | 条件字段：closedreason<br>条件组合方式：`=` |
| 17 | n_color_eq | String | 允许 | 条件字段：color<br>条件组合方式：`=` |
| 18 | n_keywords_like | String | 允许 | 条件字段：keywords<br>条件组合方式：`%like%` |
| 19 | n_lasteditedby_eq | String | 允许 | 条件字段：lasteditedby<br>条件组合方式：`=` |
| 20 | n_stage_eq | String | 允许 | 条件字段：stage<br>条件组合方式：`=` |
| 21 | n_stage_noteq | String | 允许 | 条件字段：stage<br>条件组合方式：`!=`或者`<>` |
| 22 | n_closedby_eq | String | 允许 | 条件字段：closedby<br>条件组合方式：`=` |
| 23 | n_type_eq | String | 允许 | 条件字段：type<br>条件组合方式：`=` |
| 24 | n_path_like | String | 允许 | 条件字段：path<br>条件组合方式：`%like%` |
| 25 | n_parentname_eq | String | 允许 | 条件字段：parentname<br>条件组合方式：`=` |
| 26 | n_parentname_like | String | 允许 | 条件字段：parentname<br>条件组合方式：`%like%` |
| 27 | n_modulename_eq | String | 允许 | 条件字段：modulename<br>条件组合方式：`=` |
| 28 | n_modulename_like | String | 允许 | 条件字段：modulename<br>条件组合方式：`%like%` |
| 29 | n_prodoctname_eq | String | 允许 | 条件字段：prodoctname<br>条件组合方式：`=` |
| 30 | n_prodoctname_like | String | 允许 | 条件字段：prodoctname<br>条件组合方式：`%like%` |
| 31 | n_frombug_eq | Long | 允许 | 条件字段：frombug<br>条件组合方式：`=` |
| 32 | n_parent_eq | Long | 允许 | 条件字段：parent<br>条件组合方式：`=` |
| 33 | n_parent_gtandeq | Long | 允许 | 条件字段：parent<br>条件组合方式：`>=` |
| 34 | n_module_eq | Long | 允许 | 条件字段：module<br>条件组合方式：`=` |
| 35 | n_product_eq | Long | 允许 | 条件字段：product<br>条件组合方式：`=` |
| 36 | n_duplicatestory_eq | Long | 允许 | 条件字段：duplicatestory<br>条件组合方式：`=` |
| 37 | n_branch_eq | Long | 允许 | 条件字段：branch<br>条件组合方式：`=` |
| 38 | n_tobug_eq | Long | 允许 | 条件字段：tobug<br>条件组合方式：`=` |
| 39 | n_result_eq | String | 允许 | 条件字段：result<br>条件组合方式：`=` |
| 40 | n_branchname_eq | String | 允许 | 条件字段：branchname<br>条件组合方式：`=` |
| 41 | n_branchname_like | String | 允许 | 条件字段：branchname<br>条件组合方式：`%like%` |
| 42 | n_preversion_eq | Integer | 允许 | 条件字段：preversion<br>条件组合方式：`=` |
| 43 | n_storypoints_eq | String | 允许 | 条件字段：storypoints<br>条件组合方式：`=` |
| 44 | n_assessresult_eq | String | 允许 | 条件字段：assessresult<br>条件组合方式：`=` |
