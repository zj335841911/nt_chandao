...
| 4 | n_addedby_eq | String | 允许 | 条件字段：addedby<br>条件组合方式：`=` |
| 5 | n_lib_eq | Long | 允许 | 条件字段：lib<br>条件组合方式：`=` |
...
| 9 | n_projectname_eq | String | 允许 | 条件字段：projectname<br>条件组合方式：`=` |
| 10 | n_projectname_like | String | 允许 | 条件字段：projectname<br>条件组合方式：`%like%` |
| 11 | n_productname_eq | String | 允许 | 条件字段：productname<br>条件组合方式：`=` |
| 12 | n_productname_like | String | 允许 | 条件字段：productname<br>条件组合方式：`%like%` |
