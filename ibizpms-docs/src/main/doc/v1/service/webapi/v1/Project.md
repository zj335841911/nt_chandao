...
| 7 | n_rd_eq | String | 允许 | 条件字段：rd<br>条件组合方式：`=` |
| 8 | n_pri_eq | String | 允许 | 条件字段：pri<br>条件组合方式：`=` |
| 9 | n_statge_eq | String | 允许 | 条件字段：statge<br>条件组合方式：`=` |
| 10 | n_iscat_eq | String | 允许 | 条件字段：iscat<br>条件组合方式：`=` |
| 11 | n_type_eq | String | 允许 | 条件字段：type<br>条件组合方式：`=` |
| 12 | n_po_eq | String | 允许 | 条件字段：po<br>条件组合方式：`=` |
| 13 | n_status_eq | String | 允许 | 条件字段：status<br>条件组合方式：`=` |
| 14 | n_status_noteq | String | 允许 | 条件字段：status<br>条件组合方式：`!=`或者`<>` |
| 15 | n_qd_eq | String | 允许 | 条件字段：qd<br>条件组合方式：`=` |
| 16 | n_parentname_eq | String | 允许 | 条件字段：parentname<br>条件组合方式：`=` |
| 17 | n_parentname_like | String | 允许 | 条件字段：parentname<br>条件组合方式：`%like%` |
| 18 | n_parent_eq | Long | 允许 | 条件字段：parent<br>条件组合方式：`=` |
| 19 | n_period_eq | String | 允许 | 条件字段：period<br>条件组合方式：`=` |
| 20 | n_account_eq | String | 允许 | 条件字段：account<br>条件组合方式：`=` |
| 21 | n_dept_eq | String | 允许 | 条件字段：dept<br>条件组合方式：`=` |
| 22 | n_managemembers_eq | String | 允许 | 条件字段：managemembers<br>条件组合方式：`=` |
| 23 | n_supproreport_eq | String | 允许 | 条件字段：supproreport<br>条件组合方式：`=` |
