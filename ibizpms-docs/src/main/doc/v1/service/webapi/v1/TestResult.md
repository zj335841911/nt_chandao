...
### 根据建立测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults
...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | productmodule_id | Long | 需求模块主键ID |/r/n| 2 | story_id | Long | 需求主键ID |/r/n| 3 | case_id | Long | 测试用例主键ID |
| 4 | testresultdto | [TestResultDTO](#TestResultDTO) | 测试结果实体传输对象 |
...
### 根据批量建立测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/batch
...
### 根据更新测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/{testresult_id}
...
### 根据检查测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/checkkey
...
### 根据保存测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/save
...
### 根据批量保存测试结果
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/savebatch
...
### 根据获取CurTestRun
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/fetchcurtestrun
...
### 根据查询CurTestRun
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/searchcurtestrun
...
### 根据获取DEFAULT
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/fetchdefault
...
### 根据查询DEFAULT
#### 访问路径
/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/searchdefault
...
### 根据建立测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults
...
| 序号 | 参数名 | 参数类型 | 说明 |
| ---- | ---- | ---- | ---- |
| 1 | product_id | Long | 产品主键ID |/r/n| 2 | productmodule_id | Long | 需求模块主键ID |/r/n| 3 | story_id | Long | 需求主键ID |/r/n| 4 | case_id | Long | 测试用例主键ID |
| 5 | testresultdto | [TestResultDTO](#TestResultDTO) | 测试结果实体传输对象 |
...
### 根据批量建立测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/batch
...
| ---- | ---- | ---- | ---- |
| 1 | product_id | Long | 产品主键ID |/r/n| 2 | productmodule_id | Long | 需求模块主键ID |/r/n| 3 | story_id | Long | 需求主键ID |/r/n| 4 | case_id | Long | 测试用例主键ID |
| 5 | testresultdtos | List<[TestResultDTO](#TestResultDTO)> | 测试结果实体传输对象列表 |
...
### 根据更新测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/{testresult_id}
...
| ---- | ---- | ---- | ---- |
| 1 | product_id | Long | 产品主键ID |/r/n| 2 | productmodule_id | Long | 需求模块主键ID |/r/n| 3 | story_id | Long | 需求主键ID |/r/n| 4 | case_id | Long | 测试用例主键ID |
| 5 | testresult_id | Long | 测试结果主键ID |
| 6 | testresultdto | [TestResultDTO](#TestResultDTO) | 测试结果实体传输对象 |
...
### 根据检查测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/checkkey
...
### 根据保存测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/save
...
### 根据批量保存测试结果
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/savebatch
...
### 根据获取CurTestRun
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/fetchcurtestrun
...
| ---- | ---- | ---- | ---- |
| 1 | product_id | Long | 产品主键ID |/r/n| 2 | productmodule_id | Long | 需求模块主键ID |/r/n| 3 | story_id | Long | 需求主键ID |/r/n| 4 | case_id | Long | 测试用例主键ID |
| 5 | context | [TestResultSearchContext](#TestResultSearchContext) | 测试结果查询条件对象 |
...
### 根据查询CurTestRun
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/searchcurtestrun
...
### 根据获取DEFAULT
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/fetchdefault
...
### 根据查询DEFAULT
#### 访问路径
/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testresults/searchdefault
