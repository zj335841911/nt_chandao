...
| 4 | n_branch_eq | Long | 允许 | 条件字段：branch<br>条件组合方式：`=` |
...
| 8 | n_rebuild_eq | Integer | 允许 | 条件字段：rebuild<br>条件组合方式：`=` |
| 9 | n_releasetype_eq | String | 允许 | 条件字段：releasetype<br>条件组合方式：`=` |
| 10 | n_frontapplication_eq | String | 允许 | 条件字段：frontapplication<br>条件组合方式：`=` |
| 11 | n_backgroundid_eq | String | 允许 | 条件字段：backgroundid<br>条件组合方式：`=` |
| 12 | n_sqlid_eq | String | 允许 | 条件字段：sqlid<br>条件组合方式：`=` |
