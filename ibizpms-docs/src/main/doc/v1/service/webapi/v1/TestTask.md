...
| 4 | pri | Integer | 允许 | 优先级 |
| 5 | substatus | String | 允许 | 子状态 |
| 6 | report | String | 允许 | report |
| 7 | desc | String | 允许 | 描述 |
| 8 | id | Long | 不可 | 编号 |
| 9 | status | String | 允许 | 当前状态 |
| 10 | owner | String | 允许 | 负责人 |
| 11 | deleted | String | 允许 | 已删除 |
| 12 | auto | String | 允许 | auto |
| 13 | name | String | 不可 | 名称 |
| 14 | product | Long | 允许 | 所属产品 |
| 15 | build | Long | 允许 | 版本 |
| 16 | project | Long | 允许 | 所属项目 |
| 17 | productname | String | 允许 | 产品 |
...
| 7 | n_build_eq | Long | 允许 | 条件字段：build<br>条件组合方式：`=` |
...
| 13 | n_buildname_eq | String | 允许 | 条件字段：buildname<br>条件组合方式：`=` |
| 14 | n_buildname_like | String | 允许 | 条件字段：buildname<br>条件组合方式：`%like%` |
