...
| 44 | n_taskspecies_eq | String | 允许 | 条件字段：taskspecies<br>条件组合方式：`=` |
| 45 | n_config_type_eq | String | 允许 | 条件字段：config_type<br>条件组合方式：`=` |
| 46 | n_planname_eq | String | 允许 | 条件字段：planname<br>条件组合方式：`=` |
| 47 | n_planname_like | String | 允许 | 条件字段：planname<br>条件组合方式：`%like%` |
| 48 | n_cycle_eq | Integer | 允许 | 条件字段：cycle<br>条件组合方式：`=` |
