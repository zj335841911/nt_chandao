...
| DESIGNTAKCNT        | 设计类型任务  | INTEGER      |   -1   | &nbsp; |
| DISCUSSTAKCNT        | 讨论类型任务  | INTEGER      |   -1   | &nbsp; |
| STUDYTAKCNT        | 研究类型任务  | INTEGER      |   -1   | &nbsp; |
| UITAKCNT        | 界面类型任务  | INTEGER      |   -1   | &nbsp; |
| TESTTAKCNT        | 测试类型任务  | INTEGER      |   -1   | &nbsp; |
| SERVETAKCNT        | 服务类型任务  | INTEGER      |   -1   | &nbsp; |
| DEVELTAKCNT        | 开发类型任务  | INTEGER      |   -1   | &nbsp; |
| MISCTAKCNT        | 其他类型任务  | INTEGER      |   -1   | &nbsp; |
| AFFAIRTAKCNT        | 事务类型任务  | INTEGER      |   -1   | &nbsp; |
