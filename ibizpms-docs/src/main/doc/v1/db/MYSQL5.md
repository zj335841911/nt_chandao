...
`TASKMSGRECORDID`  VARCHAR(100)  NOT NULL PRIMARY KEY COMMENT '待办消息记录标识' 
,`CREATEMAN`  VARCHAR(60) COMMENT '建立人' 
,`TASKMSGRECORDNAME`  VARCHAR(200) COMMENT '待办消息记录名称' 
,`ENABLE`  INTEGER COMMENT '逻辑有效标志' 
,`UPDATEDATE`  DATETIME COMMENT '更新时间' 
,`UPDATEMAN`  VARCHAR(60) COMMENT '更新人' 
,`CREATEDATE`  DATETIME COMMENT '建立时间' 
,`TASKUSERID`  VARCHAR(100) COMMENT '待办人标识' 
,`APPTASKID`  VARCHAR(100) COMMENT '第三方应用待办标识' 
,`TASKTYPE`  VARCHAR(100) COMMENT '待办类型' 
,`MEMO`  VARCHAR(100) COMMENT '备注' 
,`TITLE`  VARCHAR(100) COMMENT '标题' 
,`REDIRECTURL`  VARCHAR(100) COMMENT '重定向地址' 
)COMMENT='待办消息记录';
```
