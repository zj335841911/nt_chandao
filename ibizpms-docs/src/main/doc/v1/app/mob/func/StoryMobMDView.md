...
需求移动端多数据视图(StoryMobMDView)

{% plantuml %}

digraph StoryMobMDView {
...
<TR>
<TD BORDER="0" COLSPAN="4" CELLPADDING="10">我的需求<BR/><BR/></TD>
</TR>
</TABLE>
>];
...
<TR>
<TD BORDER="0" COLSPAN="4" CELLPADDING="10">新建需求<BR/><BR/></TD>
</TR>
</TABLE>
>];
...
part -> MobCreate [style=dashed,label=<新建需求<BR/>(迁移/popup)>];
