...
| 32 | [原密码](#属性-原密码（ORIGINALPASSWORD）) | ORIGINALPASSWORD | 文本，可指定长度 | 否 | 是 | 是 |
| 33 | [新密码](#属性-新密码（NEWPASSWORD）) | NEWPASSWORD | 文本，可指定长度 | 否 | 是 | 是 |
| 34 | [重复密码](#属性-重复密码（REPEATPASSWORD）) | REPEATPASSWORD | 文本，可指定长度 | 否 | 是 | 是 |
