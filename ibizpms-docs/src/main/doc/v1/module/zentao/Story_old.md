...
|ProductPlanStories|产品计划需求([MYSQL5](../../appendix/query_MYSQL5.md#Story_ProductPlanStories))|否|&nbsp;|
...
|ProductPlanStories|产品计划需求|ProductPlanStories|否|&nbsp;|
...
|ID|P|需求名称|计划|创建|指派|预计|状态|阶段|所属模块名称|所属模块|是否收藏|是否可以细分|
| :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
| - | - | - | - | - | - | - | - | - | - | - | - | - |
