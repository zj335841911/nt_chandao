...
| 1 | [解决方案（RESOLUTION）](#属性-解决方案（RESOLUTION）) | `=` |
| 1 | [由谁关闭（CLOSEDBY）](#属性-由谁关闭（CLOSEDBY）) | `=` |
| 1 | [浏览器（BROWSER）](#属性-浏览器（BROWSER）) | `=` |
| 1 | [是否确认（CONFIRMED）](#属性-是否确认（CONFIRMED）) | `=` |
| 1 | [由谁创建（OPENEDBY）](#属性-由谁创建（OPENEDBY）) | `=` |
| 1 | [指派日期（ASSIGNEDDATE）](#属性-指派日期（ASSIGNEDDATE）) | `>=` |
| 1 | [截止日期（DEADLINE）](#属性-截止日期（DEADLINE）) | `>=` |
| 2 | [截止日期（DEADLINE）](#属性-截止日期（DEADLINE）) | `<` |
| 3 | [截止日期（DEADLINE）](#属性-截止日期（DEADLINE）) | `<=` |
| 1 | [标题颜色（COLOR）](#属性-标题颜色（COLOR）) | `=` |
| 1 | [解决日期（RESOLVEDDATE）](#属性-解决日期（RESOLVEDDATE）) | `<=` |
| 1 | [Bug类型（TYPE）](#属性-Bug类型（TYPE）) | `=` |
| 1 | [Bug状态（STATUS）](#属性-Bug状态（STATUS）) | `=` |
| 2 | [Bug状态（STATUS）](#属性-Bug状态（STATUS）) | `!=`或者`<>` |
| 1 | [Bug编号（ID）](#属性-Bug编号（ID）) | `=` |
| 1 | [解决者（RESOLVEDBY）](#属性-解决者（RESOLVEDBY）) | `=` |
| 1 | [解决版本（RESOLVEDBUILD）](#属性-解决版本（RESOLVEDBUILD）) | `=` |
| 1 | [优先级（PRI）](#属性-优先级（PRI）) | `=` |
| 1 | [操作系统（OS）](#属性-操作系统（OS）) | `=` |
| 1 | [最后修改者（LASTEDITEDBY）](#属性-最后修改者（LASTEDITEDBY）) | `=` |
| 1 | [Bug标题（TITLE）](#属性-Bug标题（TITLE）) | `%like%` |
...
| 1 | [转需求（TOSTORY）](#属性-转需求（TOSTORY）) | `=` |
| 1 | [应用（ENTRY）](#属性-应用（ENTRY）) | `=` |
| 1 | [所属产品（PRODUCT）](#属性-所属产品（PRODUCT）) | `=` |
| 1 | [转任务（TOTASK）](#属性-转任务（TOTASK）) | `=` |
| 1 | [所属计划（PLAN）](#属性-所属计划（PLAN）) | `=` |
| 1 | [所属模块（MODULE）](#属性-所属模块（MODULE）) | `=` |
| 1 | [平台/分支（BRANCH）](#属性-平台/分支（BRANCH）) | `=` |
| 1 | [重复ID（DUPLICATEBUG）](#属性-重复ID（DUPLICATEBUG）) | `=` |
| 1 | [代码（REPO）](#属性-代码（REPO）) | `=` |
| 1 | [相关需求（STORY）](#属性-相关需求（STORY）) | `=` |
| 1 | [相关用例（CASE）](#属性-相关用例（CASE）) | `=` |
| 1 | [所属项目（PROJECT）](#属性-所属项目（PROJECT）) | `=` |
| 1 | [相关任务（TASK）](#属性-相关任务（TASK）) | `=` |
| 1 | [测试单（TESTTASK）](#属性-测试单（TESTTASK）) | `=` |
| 1 | [相关任务（TASKNAME）](#属性-相关任务（TASKNAME）) | `=` |
| 2 | [相关任务（TASKNAME）](#属性-相关任务（TASKNAME）) | `%like%` |
| 1 | [模块名称（MODULENAME）](#属性-模块名称（MODULENAME）) | `=` |
| 2 | [模块名称（MODULENAME）](#属性-模块名称（MODULENAME）) | `%like%` |
| 1 | [平台/分支（BRANCHNAME）](#属性-平台/分支（BRANCHNAME）) | `=` |
| 2 | [平台/分支（BRANCHNAME）](#属性-平台/分支（BRANCHNAME）) | `%like%` |
| 1 | [版本项目（BUILDPROJECT）](#属性-版本项目（BUILDPROJECT）) | `=` |
| 1 | [过期天数（OVERDUEBUGS）](#属性-过期天数（OVERDUEBUGS）) | `<` |
