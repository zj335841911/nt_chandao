...
| 9 | [测试用例（ZT_CASE）](../zentao/Case) | （默认） |
| 10 | [文档库（ZT_DOCLIB）](../zentao/DocLib) | （默认） |
| 11 | [文档（ZT_DOC）](../zentao/Doc) | （默认） |
| 12 | [产品计划（ZT_PRODUCTPLAN）](../zentao/ProductPlan) | （默认） |
| 13 | [项目产品（ZT_PROJECTPRODUCT）](../zentao/ProjectProduct) | （默认） |
| 14 | [项目中需要做的需求（ZT_PROJECTSTORY）](../zentao/ProjectStory) | （默认） |
| 15 | [发布（ZT_RELEASE）](../zentao/Release) | （默认） |
| 16 | [需求（ZT_STORY）](../zentao/Story) | （默认） |
| 17 | [套件用例（ZT_SUITECASE）](../zentao/SuiteCase) | （默认） |
| 18 | [测试报告（ZT_TESTREPORT）](../zentao/TestReport) | （默认） |
| 19 | [测试套件（ZT_TESTSUITE）](../zentao/TestSuite) | （默认） |
| 20 | [测试版本（ZT_TESTTASK）](../zentao/TestTask) | （默认） |
### N:1
| 序号 | 关系实体 | 关系类型 |
| ---- | ---- | ---- |
