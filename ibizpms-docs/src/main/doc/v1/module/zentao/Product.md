...
| 18 | [产品线](#属性-产品线（LINENAME）) | LINENAME | PICKUPTEXT | 否 | 是 | 是 |
| 19 | [产品线](#属性-产品线（LINE）) | LINE | PICKUP | 否 | 是 | 是 |
| 20 | [未解决Bug数](#属性-未解决Bug数（ACTIVEBUGCNT）) | ACTIVEBUGCNT | INT | 否 | 是 | 是 |
| 21 | [计划总数](#属性-计划总数（PRODUCTPLANCNT）) | PRODUCTPLANCNT | INT | 否 | 是 | 是 |
| 22 | [发布总数](#属性-发布总数（RELEASECNT）) | RELEASECNT | INT | 否 | 是 | 是 |
| 23 | [激活需求数](#属性-激活需求数（ACTIVESTORYCNT）) | ACTIVESTORYCNT | INT | 否 | 是 | 是 |
| 24 | [未确认Bug数](#属性-未确认Bug数（UNCONFIRMBUGCNT）) | UNCONFIRMBUGCNT | INT | 否 | 是 | 是 |
| 25 | [未关闭Bug数](#属性-未关闭Bug数（NOTCLOSEDBUGCNT）) | NOTCLOSEDBUGCNT | INT | 否 | 是 | 是 |
| 26 | [备注](#属性-备注（COMMENT）) | COMMENT | HTMLTEXT | 否 | 是 | 是 |
| 27 | [相关Bug数](#属性-相关Bug数（RELATEDBUGCNT）) | RELATEDBUGCNT | INT | 否 | 是 | 是 |
| 28 | [已变更需求](#属性-已变更需求（CHANGEDSTORYCNT）) | CHANGEDSTORYCNT | INT | 否 | 是 | 是 |
| 29 | [草稿需求](#属性-草稿需求（DRAFTSTORYCNT）) | DRAFTSTORYCNT | INT | 否 | 是 | 是 |
| 30 | [已关闭需求](#属性-已关闭需求（CLOSEDSTORYCNT）) | CLOSEDSTORYCNT | INT | 否 | 是 | 是 |
| 31 | [关联项目数](#属性-关联项目数（RELATEDPROJECTS）) | RELATEDPROJECTS | INT | 否 | 是 | 是 |
| 32 | [文档数](#属性-文档数（DOCCNT）) | DOCCNT | INT | 否 | 是 | 是 |
| 33 | [BUILD数](#属性-BUILD数（BUILDCNT）) | BUILDCNT | INT | 否 | 是 | 是 |
| 34 | [用例数](#属性-用例数（CASECNT）) | CASECNT | INT | 否 | 是 | 是 |
| 35 | [属性](#属性-属性（SRFCOUNT）) | SRFCOUNT | INT | 否 | 是 | 是 |
| 36 | [移动端图片](#属性-移动端图片（MOBIMAGE）) | MOBIMAGE | TEXT | 否 | 是 | 是 |
| 37 | [排序](#属性-排序（ORDER1）) | ORDER1 | INT | 否 | 是 | 是 |
| 38 | [是否置顶](#属性-是否置顶（ISTOP）) | ISTOP | INT | 否 | 是 | 是 |
| 39 | [测试单数](#属性-测试单数（TESTTASKCNT）) | TESTTASKCNT | INT | 否 | 是 | 是 |
| 40 | [套件数](#属性-套件数（TESTSUITECNT）) | TESTSUITECNT | INT | 否 | 是 | 是 |
