...
| 4 | [测试模块（IBZ_TESTMODULE）](../ibiz/TestModule) | （默认） |
| 5 | [产品的分支和平台信息（ZT_BRANCH）](../zentao/Branch) | （默认） |
| 6 | [Bug（ZT_BUG）](../zentao/Bug) | （默认） |
| 7 | [版本（ZT_BUILD）](../zentao/Build) | （默认） |
| 8 | [测试用例（ZT_CASE）](../zentao/Case) | （默认） |
| 9 | [文档库（ZT_DOCLIB）](../zentao/DocLib) | （默认） |
| 10 | [文档（ZT_DOC）](../zentao/Doc) | （默认） |
| 11 | [产品计划（ZT_PRODUCTPLAN）](../zentao/ProductPlan) | （默认） |
| 12 | [项目产品（ZT_PROJECTPRODUCT）](../zentao/ProjectProduct) | （默认） |
| 13 | [项目中需要做的需求（ZT_PROJECTSTORY）](../zentao/ProjectStory) | （默认） |
| 14 | [发布（ZT_RELEASE）](../zentao/Release) | （默认） |
| 15 | [需求（ZT_STORY）](../zentao/Story) | （默认） |
| 16 | [套件用例（ZT_SUITECASE）](../zentao/SuiteCase) | （默认） |
| 17 | [测试报告（ZT_TESTREPORT）](../zentao/TestReport) | （默认） |
| 18 | [测试套件（ZT_TESTSUITE）](../zentao/TestSuite) | （默认） |
| 19 | [测试版本（ZT_TESTTASK）](../zentao/TestTask) | （默认） |
### N:1
| 序号 | 关系实体 | 关系类型 |
| ---- | ---- | ---- |
