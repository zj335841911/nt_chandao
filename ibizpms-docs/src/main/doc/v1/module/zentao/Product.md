...
| 3 | [编号（ID）](#属性-编号（ID）) | `=` |
| 4 | [编号（ID）](#属性-编号（ID）) | `in(...)` |
| 5 | [产品类型（TYPE）](#属性-产品类型（TYPE）) | `=` |
| 6 | [状态（STATUS）](#属性-状态（STATUS）) | `=` |
| 7 | [状态（STATUS）](#属性-状态（STATUS）) | `is not NULL` |
| 8 | [产品线（LINENAME）](#属性-产品线（LINENAME）) | `=` |
| 9 | [产品线（LINENAME）](#属性-产品线（LINENAME）) | `%like%` |
| 10 | [产品线（LINE）](#属性-产品线（LINE）) | `=` |
| 11 | [产品分类（PRODUCTCLASS）](#属性-产品分类（PRODUCTCLASS）) | `=` |
