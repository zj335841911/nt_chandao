...
| 2 | [类型（TYPE）](#属性-类型（TYPE）) | `!=`或者`<>` |
| 1 | [结束（END）](#属性-结束（END）) | `=` |
| 1 | [开始（BEGIN）](#属性-开始（BEGIN）) | `=` |
| 1 | [周期（CYCLE）](#属性-周期（CYCLE）) | `=` |
| 1 | [状态（STATUS）](#属性-状态（STATUS）) | `=` |
| 2 | [状态（STATUS）](#属性-状态（STATUS）) | `!=`或者`<>` |
| 1 | [待办名称（NAME）](#属性-待办名称（NAME）) | `%like%` |
| 1 | [日期（DATE）](#属性-日期（DATE）) | `=` |
| 2 | [日期（DATE）](#属性-日期（DATE）) | `>=` |
| 3 | [日期（DATE）](#属性-日期（DATE）) | `<=` |
| 4 | [日期（DATE）](#属性-日期（DATE）) | `!=`或者`<>` |
| 1 | [私人事务（PRIVATE）](#属性-私人事务（PRIVATE）) | `=` |
| 1 | [周期类型（CONFIG_TYPE）](#属性-周期类型（CONFIG_TYPE）) | `=` |
