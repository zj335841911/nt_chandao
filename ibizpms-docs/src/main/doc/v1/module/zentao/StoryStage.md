...
| 2 | [设置阶段者](#属性-设置阶段者（STAGEDBY）) | STAGEDBY | 外键值附加数据 | 否 | 是 | 是 |
| 3 | [所处阶段](#属性-所处阶段（STAGE）) | STAGE | 外键值附加数据 | 否 | 是 | 是 |
| 4 | [需求](#属性-需求（STORY）) | STORY | 外键值 | 否 | 是 | 是 |
| 5 | [平台/分支](#属性-平台/分支（BRANCH）) | BRANCH | 外键值 | 否 | 是 | 是 |
...
| 2 | [平台/分支（BRANCH）](#属性-平台/分支（BRANCH）) | `=` |
