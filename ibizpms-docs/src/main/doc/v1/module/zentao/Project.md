...
| 6 | [项目团队（IBZ_PROJECTTEAM）](../ibiz/ProjectTeam) | 嵌套操作 |
| 7 | [系统日志（ZT_ACTION）](../zentao/Action) | （默认） |
| 8 | [Bug（ZT_BUG）](../zentao/Bug) | （默认） |
| 9 | [版本（ZT_BUILD）](../zentao/Build) | （默认） |
| 10 | [burn（ZT_BURN）](../zentao/Burn) | （默认） |
| 11 | [文档库（ZT_DOCLIB）](../zentao/DocLib) | （默认） |
| 12 | [文档（ZT_DOC）](../zentao/Doc) | （默认） |
| 13 | [项目产品（ZT_PROJECTPRODUCT）](../zentao/ProjectProduct) | （默认） |
| 14 | [项目中需要做的需求（ZT_PROJECTSTORY）](../zentao/ProjectStory) | （默认） |
| 15 | [任务（ZT_TASK）](../zentao/Task) | （默认） |
| 16 | [测试报告（ZT_TESTREPORT）](../zentao/TestReport) | （默认） |
| 17 | [测试版本（ZT_TESTTASK）](../zentao/TestTask) | （默认） |
| 18 | [项目（ZT_PROJECT）](../zentao/Project) | （默认） |
### N:1
| 序号 | 关系实体 | 关系类型 |
| ---- | ---- | ---- |
