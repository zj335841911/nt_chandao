...
| 1 | [项目负责人（PM）](#属性-项目负责人（PM）) | `=` |
| 1 | [项目编号（ID）](#属性-项目编号（ID）) | `=` |
| 2 | [项目编号（ID）](#属性-项目编号（ID）) | `!=`或者`<>` |
| 1 | [项目名称（NAME）](#属性-项目名称（NAME）) | `%like%` |
| 1 | [发布负责人（RD）](#属性-发布负责人（RD）) | `=` |
| 1 | [优先级（PRI）](#属性-优先级（PRI）) | `=` |
| 1 | [statge（STATGE）](#属性-statge（STATGE）) | `=` |
| 1 | [isCat（ISCAT）](#属性-isCat（ISCAT）) | `=` |
| 1 | [项目类型（TYPE）](#属性-项目类型（TYPE）) | `=` |
| 1 | [产品负责人（PO）](#属性-产品负责人（PO）) | `=` |
| 1 | [项目状态（STATUS）](#属性-项目状态（STATUS）) | `=` |
| 2 | [项目状态（STATUS）](#属性-项目状态（STATUS）) | `!=`或者`<>` |
| 1 | [测试负责人（QD）](#属性-测试负责人（QD）) | `=` |
| 1 | [parent（PARENTNAME）](#属性-parent（PARENTNAME）) | `=` |
| 2 | [parent（PARENTNAME）](#属性-parent（PARENTNAME）) | `%like%` |
| 1 | [父项目（PARENT）](#属性-父项目（PARENT）) | `=` |
| 1 | [时间段（PERIOD）](#属性-时间段（PERIOD）) | `=` |
| 1 | [项目团队成员（ACCOUNT）](#属性-项目团队成员（ACCOUNT）) | `=` |
| 1 | [选择部门（DEPT）](#属性-选择部门（DEPT）) | `=` |
| 1 | [复制团队（MANAGEMEMBERS）](#属性-复制团队（MANAGEMEMBERS）) | `=` |
