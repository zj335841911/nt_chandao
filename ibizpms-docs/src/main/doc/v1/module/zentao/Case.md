...
| 1 | [结果（LASTRUNRESULT）](#属性-结果（LASTRUNRESULT）) | `=` |
| 1 | [由谁创建（OPENEDBY）](#属性-由谁创建（OPENEDBY）) | `=` |
| 1 | [用例类型（TYPE）](#属性-用例类型（TYPE）) | `=` |
| 1 | [用例状态（STATUS）](#属性-用例状态（STATUS）) | `=` |
| 1 | [frequency（FREQUENCY）](#属性-frequency（FREQUENCY）) | `=` |
| 1 | [用例标题（TITLE）](#属性-用例标题（TITLE）) | `%like%` |
| 1 | [优先级（PRI）](#属性-优先级（PRI）) | `=` |
| 1 | [工具/框架（FRAME）](#属性-工具/框架（FRAME）) | `=` |
| 1 | [执行人（LASTRUNNER）](#属性-执行人（LASTRUNNER）) | `=` |
| 1 | [来源用例（FROMCASEID）](#属性-来源用例（FROMCASEID）) | `=` |
| 1 | [平台/分支（BRANCH）](#属性-平台/分支（BRANCH）) | `=` |
| 1 | [来源Bug（FROMBUG）](#属性-来源Bug（FROMBUG）) | `=` |
| 1 | [相关需求（STORY）](#属性-相关需求（STORY）) | `=` |
| 1 | [所属产品（PRODUCT）](#属性-所属产品（PRODUCT）) | `=` |
| 1 | [所属库（LIB）](#属性-所属库（LIB）) | `=` |
| 1 | [所属模块（MODULE）](#属性-所属模块（MODULE）) | `=` |
| 1 | [模块名称（MODULENAME）](#属性-模块名称（MODULENAME）) | `=` |
| 2 | [模块名称（MODULENAME）](#属性-模块名称（MODULENAME）) | `%like%` |
| 1 | [需求名称（STORYNAME）](#属性-需求名称（STORYNAME）) | `=` |
| 2 | [需求名称（STORYNAME）](#属性-需求名称（STORYNAME）) | `%like%` |
| 1 | [产品名称（PRODUCTNAME）](#属性-产品名称（PRODUCTNAME）) | `=` |
| 2 | [产品名称（PRODUCTNAME）](#属性-产品名称（PRODUCTNAME）) | `%like%` |
| 1 | [用例状态（STATUS1）](#属性-用例状态（STATUS1）) | `=` |
| 1 | [指派给（ASSIGNEDTO）](#属性-指派给（ASSIGNEDTO）) | `=` |
| 1 | [用例库（LIBNAME）](#属性-用例库（LIBNAME）) | `=` |
| 2 | [用例库（LIBNAME）](#属性-用例库（LIBNAME）) | `%like%` |
| 1 | [测试用例结果（LASTRUNRESULT1）](#属性-测试用例结果（LASTRUNRESULT1）) | `=` |
