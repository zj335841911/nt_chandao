...
|NextWeekPlanCompleteTaskZS|下周计划完成任务(汇报)([MYSQL5](../../appendix/query_MYSQL5.md#Task_NextWeekPlanCompleteTaskZS))|否|&nbsp;|
...
|NextWeekPlanCompleteTaskZS|下周计划完成任务(汇报)|NextWeekPlanCompleteTaskZS|否|&nbsp;|
