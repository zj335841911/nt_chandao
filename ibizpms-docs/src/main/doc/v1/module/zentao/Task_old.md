...
|预计开始|默认规则|默认规则|
|截止日期|截至日期必须大于预计开始|截至日期必须大于预计开始|
|截止日期|默认规则|默认规则|
|已删除|默认规则|内容长度必须小于等于[1]|
|抄送给|默认规则|内容长度必须小于等于[65535]|
|总计消耗|总计消耗大于等于0|数值必须大于等于[0.0]|
|总计消耗|总计消耗大于0|总消耗大于0|
|总计消耗|默认规则|默认规则|
|最初预计|预计消耗必须为数字|预计消耗必须为数字|
|最初预计|默认规则|默认规则|
...
|ID|P|任务名称|任务状态|任务状态|指派给|完成者|预计|消耗|剩余|截止日期|是否收藏|任务类型|
| :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: | :------: |
| - | - | - | - | - | - | - | - | - | - | - | - | - |
