...
| 15 | [我计划参与的任务（移动端月报）](#数据查询-我计划参与的任务（移动端月报）（MyPlansTaskMobMonthly）) | MyPlansTaskMobMonthly | 否 |
| 16 | [我计划参与的任务（汇报）](#数据查询-我计划参与的任务（汇报）（MyTomorrowPlanTask）) | MyTomorrowPlanTask | 否 |
| 17 | [我计划参与的任务（汇报）](#数据查询-我计划参与的任务（汇报）（MyTomorrowPlanTaskMobDaily）) | MyTomorrowPlanTaskMobDaily | 否 |
| 18 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（NextWeekCompleteTaskZS）) | NextWeekCompleteTaskZS | 否 |
| 19 | [下周计划完成任务(汇报)](#数据查询-下周计划完成任务(汇报)（NextWeekPlanCompleteTask）) | NextWeekPlanCompleteTask | 否 |
| 20 | [项目任务](#数据查询-项目任务（ProjectTask）) | ProjectTask | 否 |
| 21 | [根任务](#数据查询-根任务（RootTask）) | RootTask | 否 |
| 22 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（ThisWeekCompleteTask）) | ThisWeekCompleteTask | 否 |
| 23 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（ThisWeekCompleteTaskZS）) | ThisWeekCompleteTaskZS | 否 |
| 24 | [todo任务列表查询](#数据查询-todo任务列表查询（TodoListTask）) | TodoListTask | 否 |
| 25 | [任务类型分组](#数据查询-任务类型分组（TypeGroup）) | TypeGroup | 否 |
| 26 | [默认（全部数据）](#数据查询-默认（全部数据）（View）) | View | 否 |
...
| 18 | [本周完成的任务(汇报)](#数据集合-本周完成的任务(汇报)（NextWeekCompleteTaskZS）) | NextWeekCompleteTaskZS | 否 |
| 19 | [下周计划完成任务(汇报)](#数据集合-下周计划完成任务(汇报)（NextWeekPlanCompleteTask）) | NextWeekPlanCompleteTask | 否 |
| 20 | [项目任务](#数据集合-项目任务（ProjectTask）) | ProjectTask | 否 |
| 21 | [根任务](#数据集合-根任务（RootTask）) | RootTask | 否 |
| 22 | [本周完成的任务(汇报)](#数据集合-本周完成的任务(汇报)（ThisWeekCompleteTask）) | ThisWeekCompleteTask | 否 |
| 23 | [本周完成的任务(汇报)](#数据集合-本周完成的任务(汇报)（ThisWeekCompleteTaskZS）) | ThisWeekCompleteTaskZS | 否 |
| 24 | [todo列表查询](#数据集合-todo列表查询（TodoListTask）) | TodoListTask | 否 |
| 25 | [任务类型分组](#数据集合-任务类型分组（TypeGroup）) | TypeGroup | 否 |
