...
| 24 | [移动端本周已完成任务(汇报)](#数据查询-移动端本周已完成任务(汇报)（ThisWeekCompleteTaskMobZS）) | ThisWeekCompleteTaskMobZS | 否 |
| 25 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（ThisWeekCompleteTaskZS）) | ThisWeekCompleteTaskZS | 否 |
| 26 | [todo任务列表查询](#数据查询-todo任务列表查询（TodoListTask）) | TodoListTask | 否 |
| 27 | [任务类型分组](#数据查询-任务类型分组（TypeGroup）) | TypeGroup | 否 |
| 28 | [默认（全部数据）](#数据查询-默认（全部数据）（View）) | View | 否 |
