...
| 1 | [编号（ID）](#属性-编号（ID）) | `!=`或者`<>` |
| 1 | [由谁完成（FINISHEDBY）](#属性-由谁完成（FINISHEDBY）) | `=` |
| 1 | [由谁关闭（CLOSEDBY）](#属性-由谁关闭（CLOSEDBY）) | `=` |
| 1 | [关闭原因（CLOSEDREASON）](#属性-关闭原因（CLOSEDREASON）) | `=` |
| 1 | [指派日期（ASSIGNEDDATE）](#属性-指派日期（ASSIGNEDDATE）) | `>=` |
| 1 | [优先级（PRI）](#属性-优先级（PRI）) | `=` |
| 1 | [最后修改（LASTEDITEDBY）](#属性-最后修改（LASTEDITEDBY）) | `=` |
| 1 | [任务状态（STATUS）](#属性-任务状态（STATUS）) | `=` |
| 2 | [任务状态（STATUS）](#属性-任务状态（STATUS）) | `in(...)` |
| 3 | [任务状态（STATUS）](#属性-任务状态（STATUS）) | `!=`或者`<>` |
| 1 | [任务名称（NAME）](#属性-任务名称（NAME）) | `%like%` |
| 1 | [关闭时间（CLOSEDDATE）](#属性-关闭时间（CLOSEDDATE）) | `<=` |
| 1 | [任务类型（TYPE）](#属性-任务类型（TYPE）) | `=` |
| 1 | [指派给（ASSIGNEDTO）](#属性-指派给（ASSIGNEDTO）) | `=` |
| 1 | [预计开始（ESTSTARTED）](#属性-预计开始（ESTSTARTED）) | `>=` |
| 2 | [预计开始（ESTSTARTED）](#属性-预计开始（ESTSTARTED）) | `<=` |
| 1 | [由谁创建（OPENEDBY）](#属性-由谁创建（OPENEDBY）) | `=` |
| 1 | [实际完成（FINISHEDDATE）](#属性-实际完成（FINISHEDDATE）) | `<=` |
| 1 | [所属模块（MODULENAME）](#属性-所属模块（MODULENAME）) | `=` |
| 2 | [所属模块（MODULENAME）](#属性-所属模块（MODULENAME）) | `%like%` |
| 1 | [相关需求（STORYNAME）](#属性-相关需求（STORYNAME）) | `=` |
| 2 | [相关需求（STORYNAME）](#属性-相关需求（STORYNAME）) | `%like%` |
| 1 | [所属项目（PROJECTNAME）](#属性-所属项目（PROJECTNAME）) | `=` |
| 2 | [所属项目（PROJECTNAME）](#属性-所属项目（PROJECTNAME）) | `%like%` |
| 1 | [产品（PRODUCT）](#属性-产品（PRODUCT）) | `=` |
| 1 | [父任务（PARENTNAME）](#属性-父任务（PARENTNAME）) | `=` |
| 2 | [父任务（PARENTNAME）](#属性-父任务（PARENTNAME）) | `%like%` |
| 1 | [所属项目（PROJECT）](#属性-所属项目（PROJECT）) | `=` |
| 1 | [相关需求（STORY）](#属性-相关需求（STORY）) | `=` |
| 1 | [父任务（PARENT）](#属性-父任务（PARENT）) | `=` |
| 2 | [父任务（PARENT）](#属性-父任务（PARENT）) | `>=` |
| 1 | [来源Bug（FROMBUG）](#属性-来源Bug（FROMBUG）) | `=` |
| 1 | [id（MODULE）](#属性-id（MODULE）) | `=` |
| 1 | [模块路径（PATH）](#属性-模块路径（PATH）) | `%like%` |
| 1 | [任务状态（STATUS1）](#属性-任务状态（STATUS1）) | `=` |
