...
| 13 | [我完成的任务（汇报）](#数据查询-我完成的任务（汇报）（MyCompleteTaskZS）) | MyCompleteTaskZS | 否 |
| 14 | [我的收藏](#数据查询-我的收藏（MyFavorites）) | MyFavorites | 否 |
| 15 | [我计划参与的任务（汇报）](#数据查询-我计划参与的任务（汇报）（MyTomorrowPlanTask）) | MyTomorrowPlanTask | 否 |
| 16 | [我计划参与的任务（汇报）](#数据查询-我计划参与的任务（汇报）（MyTomorrowPlanTaskMobDaily）) | MyTomorrowPlanTaskMobDaily | 否 |
| 17 | [下周计划完成任务(汇报)](#数据查询-下周计划完成任务(汇报)（NextWeekPlanCompleteTask）) | NextWeekPlanCompleteTask | 否 |
| 18 | [项目任务](#数据查询-项目任务（ProjectTask）) | ProjectTask | 否 |
| 19 | [根任务](#数据查询-根任务（RootTask）) | RootTask | 否 |
| 20 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（ThisWeekCompleteTask）) | ThisWeekCompleteTask | 否 |
| 21 | [本周完成的任务(汇报)](#数据查询-本周完成的任务(汇报)（ThisWeekCompleteTaskZS）) | ThisWeekCompleteTaskZS | 否 |
| 22 | [todo任务列表查询](#数据查询-todo任务列表查询（TodoListTask）) | TodoListTask | 否 |
| 23 | [任务类型分组](#数据查询-任务类型分组（TypeGroup）) | TypeGroup | 否 |
| 24 | [默认（全部数据）](#数据查询-默认（全部数据）（View）) | View | 否 |
...
| 15 | [我计划参与的任务（汇报）](#数据集合-我计划参与的任务（汇报）（MyTomorrowPlanTask）) | MyTomorrowPlanTask | 否 |
| 16 | [我计划参与的任务（汇报）](#数据集合-我计划参与的任务（汇报）（MyTomorrowPlanTaskMobDaily）) | MyTomorrowPlanTaskMobDaily | 否 |
| 17 | [下周计划完成任务(汇报)](#数据集合-下周计划完成任务(汇报)（NextWeekPlanCompleteTask）) | NextWeekPlanCompleteTask | 否 |
| 18 | [项目任务](#数据集合-项目任务（ProjectTask）) | ProjectTask | 否 |
| 19 | [根任务](#数据集合-根任务（RootTask）) | RootTask | 否 |
| 20 | [本周完成的任务(汇报)](#数据集合-本周完成的任务(汇报)（ThisWeekCompleteTask）) | ThisWeekCompleteTask | 否 |
| 21 | [本周完成的任务(汇报)](#数据集合-本周完成的任务(汇报)（ThisWeekCompleteTaskZS）) | ThisWeekCompleteTaskZS | 否 |
| 22 | [todo列表查询](#数据集合-todo列表查询（TodoListTask）) | TodoListTask | 否 |
| 23 | [任务类型分组](#数据集合-任务类型分组（TypeGroup）) | TypeGroup | 否 |
