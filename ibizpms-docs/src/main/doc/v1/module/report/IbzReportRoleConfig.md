...
# 实体-汇报角色配置(IBZ_REPORT_ROLE_CONFIG)
## 实体说明
汇报角色配置
...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [汇报角色配置名称](#属性-汇报角色配置名称（IBZ_REPORT_ROLE_CONFIGNAME）) | IBZ_REPORT_ROLE_CONFIGNAME | 文本，可指定长度 | 否 | 否 | 是 |
| 2 | [汇报角色配置标识](#属性-汇报角色配置标识（IBZ_REPORT_ROLE_CONFIGID）) | IBZ_REPORT_ROLE_CONFIGID | 全局唯一标识，文本类型，用户不可见 | 是 | 否 | 否 |
...
### 属性-汇报角色配置标识（IBZ_REPORT_ROLE_CONFIGID）
#### 属性说明
汇报角色配置标识
...
- 取值范围/公式
参照数据字典【[所有角色（AllRole）](../../codelist/AllRole)】
...
| 序号 | 属性 |
| ---- | ---- |
| 1 | [汇报角色配置名称（IBZ_REPORT_ROLE_CONFIGNAME）](#属性-汇报角色配置名称（IBZ_REPORT_ROLE_CONFIGNAME）) |
