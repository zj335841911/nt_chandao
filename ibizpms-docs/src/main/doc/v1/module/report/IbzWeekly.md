...
| ---- | ---- | ---- | ---- |
| 1 | [未提交](#业务状态-未提交（NSUBMIT）) | ISSUBMIT |  |  | 否 |
### 业务状态-未提交（NSUBMIT）
#### 状态说明
未提交
...
| 属性名 | 状态值 |
| ---- | ---- |
| [是否提交](#属性-是否提交（ISSUBMIT）)<br>（ISSUBMIT） | ISSUBMIT |
...
| 2 | 状态[未提交]拒绝[Update]操作 | DenyByNSUBMIT | 抛出异常 |
| 3 | 获取数据 | Get | 实体行为 |
| 4 | 开始 | Begin | 开始 |
...
| 3 | 状态[未提交]拒绝[Remove]操作 | DenyByNSUBMIT | 抛出异常 |
| 4 | 获取数据 | Get | 实体行为 |
