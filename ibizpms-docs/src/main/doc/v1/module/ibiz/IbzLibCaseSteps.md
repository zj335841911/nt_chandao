...
| 序号 | 关系实体 | 关系类型 |
| ---- | ---- | ---- |
| 1 | [用例库用例步骤（IBZ_LIBCASESTEPS）](../ibiz/IbzLibCaseSteps) | （默认） |
### N:1
| 序号 | 关系实体 | 关系类型 |
| ---- | ---- | ---- |
| 1 | [测试用例（IBZ_CASE）](../ibiz/IbzCase) | 嵌套操作 |
| 2 | [用例库用例步骤（IBZ_LIBCASESTEPS）](../ibiz/IbzLibCaseSteps) | （默认） |


## 实体属性
| 序号 | 属性 | 属性名 | 数据类型 | 主键 | 外键 | 允许为空 |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [版本](#属性-版本（VERSION）) | VERSION | 外键值附加数据 | 否 | 是 | 是 |
| 2 | [用例编号](#属性-用例编号（CASE）) | CASE | 外键值 | 否 | 是 | 是 |
| 3 | [预期](#属性-预期（EXPECT）) | EXPECT | 长文本，没有长度限制 | 否 | 是 | 是 |
| 4 | [附件](#属性-附件（FILES）) | FILES | 文本，可指定长度 | 否 | 是 | 是 |
| 5 | [编号](#属性-编号（ID）) | ID | 自增标识，整数类型，用户不可见 | 是 | 是 | 否 |
| 6 | [实际情况](#属性-实际情况（REALS）) | REALS | 文本，可指定长度 | 否 | 是 | 是 |
| 7 | [步骤](#属性-步骤（DESC）) | DESC | 长文本，没有长度限制 | 否 | 是 | 是 |
| 8 | [编号](#属性-编号（PARENT）) | PARENT | 外键值 | 否 | 是 | 是 |
| 9 | [类型](#属性-类型（TYPE）) | TYPE | 单项选择(文本值) | 否 | 是 | 是 |
...
| 序号 | 属性 | 组合方式 |
| ---- | ---- | ---- |
| 1 | [版本（VERSION）](#属性-版本（VERSION）) | `=` |
| 2 | [用例编号（CASE）](#属性-用例编号（CASE）) | `=` |
| 3 | [预期（EXPECT）](#属性-预期（EXPECT）) | `%like%` |
| 4 | [编号（PARENT）](#属性-编号（PARENT）) | `=` |
| 5 | [类型（TYPE）](#属性-类型（TYPE）) | `=` |
