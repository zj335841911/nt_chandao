...
| 30 | [已完成任务数](#属性-已完成任务数（FINISHTASKCNT1）) | FINISHTASKCNT1 | 整型 | 否 | 否 | 是 |
| 31 | [已暂停任务数](#属性-已暂停任务数（PAUSETASKCNT）) | PAUSETASKCNT | 整型 | 否 | 否 | 是 |
| 32 | [未开始任务数](#属性-未开始任务数（WAITTASKCNT）) | WAITTASKCNT | 整型 | 否 | 否 | 是 |
| 33 | [进行中任务数](#属性-进行中任务数（DOINGTASKCNT）) | DOINGTASKCNT | 整型 | 否 | 否 | 是 |
