...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [代理标识](#属性-代理标识（IBZ_AGENTID）) | IBZ_AGENTID | 自增标识，整数类型，用户不可见 | 是 | 否 | 否 |
| 2 | [建立人](#属性-建立人（CREATEMAN）) | CREATEMAN | 文本，可指定长度 | 否 | 否 | 否 |
| 3 | [建立时间](#属性-建立时间（CREATEDATE）) | CREATEDATE | 日期时间型 | 否 | 否 | 否 |
| 4 | [代理名称](#属性-代理名称（IBZ_AGENTNAME）) | IBZ_AGENTNAME | 文本，可指定长度 | 否 | 否 | 是 |
...
| 序号 | 属性 |
| ---- | ---- |
| 1 | [代理名称（IBZ_AGENTNAME）](#属性-代理名称（IBZ_AGENTNAME）) |

### 搜索条件
| 序号 | 属性 | 组合方式 |
| ---- | ---- | ---- |
| 1 | [代理名称（IBZ_AGENTNAME）](#属性-代理名称（IBZ_AGENTNAME）) | `%like%` |
| 2 | [创建人姓名（CREATEMANNAME）](#属性-创建人姓名（CREATEMANNAME）) | `=` |
