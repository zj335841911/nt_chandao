...
# 实体-产品月报(IBIZPRO_PRODUCTMONTHLY)
## 实体说明
产品月报
...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [产品月报标识](#属性-产品月报标识（IBIZPRO_PRODUCTMONTHLYID）) | IBIZPRO_PRODUCTMONTHLYID | 自增标识，整数类型，用户不可见 | 是 | 否 | 否 |
| 2 | [产品月报名称](#属性-产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）) | IBIZPRO_PRODUCTMONTHLYNAME | 文本，可指定长度 | 否 | 否 | 是 |
...
| 7 | [产品编号](#属性-产品编号（PRODUCT）) | PRODUCT | 外键值 | 否 | 是 | 是 |
...
### 属性-产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）
#### 属性说明
产品月报名称
...
| 7 | [手动生成产品月报](#实体行为-手动生成产品月报（ManualCreateMonthly）) | ManualCreateMonthly | 用户自定义 | 后台 |
| 8 | [Save](#实体行为-Save（Save）) | Save | 内置方法 | 后台及前台 |
| 9 | [汇总产品月报](#实体行为-汇总产品月报（StatsProductMonthly）) | StatsProductMonthly | 用户自定义 | 后台 |
...
#### 逻辑附加
无
### 实体行为-手动生成产品月报（ManualCreateMonthly）
#### 说明
手动生成产品月报
...
#### 逻辑附加
无
### 实体行为-汇总产品月报（StatsProductMonthly）
#### 说明
汇总产品月报
...
| 序号 | 属性 |
| ---- | ---- |
| 1 | [产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）](#属性-产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）) |

### 搜索条件
| 序号 | 属性 | 组合方式 |
| ---- | ---- | ---- |
| 1 | [产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）](#属性-产品月报名称（IBIZPRO_PRODUCTMONTHLYNAME）) | `%like%` |
| 2 | [产品编号（PRODUCT）](#属性-产品编号（PRODUCT）) | `=` |
| 3 | [产品名称（PRODUCTNAME）](#属性-产品名称（PRODUCTNAME）) | `=` |
| 4 | [产品名称（PRODUCTNAME）](#属性-产品名称（PRODUCTNAME）) | `%like%` |
| 5 | [产品负责人（PO）](#属性-产品负责人（PO）) | `=` |
