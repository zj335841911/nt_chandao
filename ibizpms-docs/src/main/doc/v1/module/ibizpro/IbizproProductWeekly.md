...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [总工时](#属性-总工时（TOTALESTIMATES）) | TOTALESTIMATES | 浮点 | 否 | 否 | 是 |
| 2 | [任务](#属性-任务（TASKS）) | TASKS | 文本，可指定长度 | 否 | 否 | 是 |
| 3 | [产品负责人](#属性-产品负责人（PO）) | PO | 文本，可指定长度 | 否 | 否 | 是 |
...
| 7 | [建立人](#属性-建立人（CREATEMAN）) | CREATEMAN | 文本，可指定长度 | 否 | 否 | 否 |
| 8 | [建立时间](#属性-建立时间（CREATEDATE）) | CREATEDATE | 日期时间型 | 否 | 否 | 否 |
...
| 8 | [统计产品周报](#实体行为-统计产品周报（SumProductWeekly）) | SUMPRODUCTWEEKLY | 用户自定义 | 后台及前台 |
...
| 序号 | 属性 |
| ---- | ---- |
| 1 | [产品周报名称（IBIZPRO_PRODUCTDAILYNAME）](#属性-产品周报名称（IBIZPRO_PRODUCTDAILYNAME）) |
