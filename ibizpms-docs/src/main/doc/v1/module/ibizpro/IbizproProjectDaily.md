...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1 | [项目日报标识](#属性-项目日报标识（IBIZPRO_PROJECTDAILYID）) | IBIZPRO_PROJECTDAILYID | 全局唯一标识，文本类型，用户不可见 | 是 | 否 | 否 |
| 2 | [项目日报名称](#属性-项目日报名称（IBIZPRO_PROJECTDAILYNAME）) | IBIZPRO_PROJECTDAILYNAME | 文本，可指定长度 | 否 | 否 | 是 |
...
| 12 | [项目负责人](#属性-项目负责人（PM）) | PM | 文本，可指定长度 | 否 | 是 | 是 |
| 13 | [开始日期](#属性-开始日期（BEGIN）) | BEGIN | 日期型 | 否 | 是 | 是 |
| 14 | [结束日期](#属性-结束日期（END）) | END | 日期型 | 否 | 是 | 是 |

### 属性-项目日报标识（IBIZPRO_PROJECTDAILYID）
#### 属性说明
项目日报标识
...
### 属性-项目日报名称（IBIZPRO_PROJECTDAILYNAME）
#### 属性说明
项目日报名称
...
| 8 | [汇总项目日报](#实体行为-汇总项目日报（SumProjectDaily）) | SumProjectDaily | 用户自定义 | 后台 |
...
| 序号 | 属性 |
| ---- | ---- |
| 1 | [项目日报名称（IBIZPRO_PROJECTDAILYNAME）](#属性-项目日报名称（IBIZPRO_PROJECTDAILYNAME）) |

### 搜索条件
| 序号 | 属性 | 组合方式 |
| ---- | ---- | ---- |
| 1 | [项目日报名称（IBIZPRO_PROJECTDAILYNAME）](#属性-项目日报名称（IBIZPRO_PROJECTDAILYNAME）) | `%like%` |
