...
| 51 | [默认服务接口](#属性-默认服务接口（PSSYSSERVICEAPINAME）) | PSSYSSERVICEAPINAME | PICKUPTEXT | 否 | 是 | 是 |
| 52 | [默认服务接口](#属性-默认服务接口（PSSYSSERVICEAPIID）) | PSSYSSERVICEAPIID | PICKUP | 否 | 是 | 是 |
| 53 | [用户分类](#属性-用户分类（USERCAT）) | USERCAT | SSCODELIST | 否 | 是 | 是 |
| 54 | [用户标记](#属性-用户标记（USERTAG）) | USERTAG | TEXT | 否 | 是 | 是 |
| 55 | [自定义参数](#属性-自定义参数（USERPARAMS）) | USERPARAMS | TEXT | 否 | 是 | 是 |
| 56 | [用户标记2](#属性-用户标记2（USERTAG2）) | USERTAG2 | TEXT | 否 | 是 | 是 |
| 57 | [用户标记4](#属性-用户标记4（USERTAG4）) | USERTAG4 | TEXT | 否 | 是 | 是 |
| 58 | [用户标记3](#属性-用户标记3（USERTAG3）) | USERTAG3 | TEXT | 否 | 是 | 是 |
| 59 | [是否启用](#属性-是否启用（VALIDFLAG）) | VALIDFLAG | YESNO | 否 | 是 | 是 |
| 60 | [系统](#属性-系统（PSSYSTEMID）) | PSSYSTEMID | TEXT | 否 | 是 | 是 |
| 61 | [系统](#属性-系统（PSSYSTEMNAME）) | PSSYSTEMNAME | TEXT | 否 | 是 | 是 |
