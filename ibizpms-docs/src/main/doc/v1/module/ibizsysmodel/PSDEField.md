...
| 1 | [业务标记（BIZTAG）](#属性-业务标记（BIZTAG）) | `=` |
| 1 | [数据库更新值模式（DBVALUEMODE）](#属性-数据库更新值模式（DBVALUEMODE）) | `=` |
| 1 | [数据库新建值模式（DBVALUEMODE2）](#属性-数据库新建值模式（DBVALUEMODE2）) | `=` |
| 1 | [属性类型（DEFTYPE）](#属性-属性类型（DEFTYPE）) | `=` |
| 1 | [重复值检查（DUPCHECKMODE）](#属性-重复值检查（DUPCHECKMODE）) | `=` |
| 1 | [默认值类型（DVT）](#属性-默认值类型（DVT）) | `=` |
| 1 | [动态模型类型（DYNAMODELFLAG）](#属性-动态模型类型（DYNAMODELFLAG）) | `=` |
| 1 | [扩展模式（EXTENDMODE）](#属性-扩展模式（EXTENDMODE）) | `=` |
| 1 | [模型锁模式（LOCKFLAG）](#属性-模型锁模式（LOCKFLAG）) | `=` |
| 1 | [空值排序（NULLVALORDER）](#属性-空值排序（NULLVALORDER）) | `=` |
| 1 | [主键属性（PKEY）](#属性-主键属性（PKEY）) | `=` |
| 1 | [系统预置属性（PREDEFINETYPE）](#属性-系统预置属性（PREDEFINETYPE）) | `=` |
| 1 | [主状态属性（STATEFIELD）](#属性-主状态属性（STATEFIELD）) | `=` |
| 1 | [字符转换（STRINGCASE）](#属性-字符转换（STRINGCASE）) | `=` |
| 1 | [联合键值（UNIONKEYVALUE）](#属性-联合键值（UNIONKEYVALUE）) | `=` |
| 1 | [更新旧值回填（UPDATEOVMODE）](#属性-更新旧值回填（UPDATEOVMODE）) | `=` |
| 1 | [用户分类（USERCAT）](#属性-用户分类（USERCAT）) | `=` |
| 1 | [视图列级别（VIEWCOLLEVEL）](#属性-视图列级别（VIEWCOLLEVEL）) | `=` |
| 1 | [范围属性2（NO2DUPCHKPSDEFNAME）](#属性-范围属性2（NO2DUPCHKPSDEFNAME）) | `=` |
| 2 | [范围属性2（NO2DUPCHKPSDEFNAME）](#属性-范围属性2（NO2DUPCHKPSDEFNAME）) | `%like%` |
| 1 | [范围属性2（NO2DUPCHKPSDEFID）](#属性-范围属性2（NO2DUPCHKPSDEFID）) | `=` |
| 1 | [范围属性3（NO3DUPCHKPSDEFNAME）](#属性-范围属性3（NO3DUPCHKPSDEFNAME）) | `=` |
| 2 | [范围属性3（NO3DUPCHKPSDEFNAME）](#属性-范围属性3（NO3DUPCHKPSDEFNAME）) | `%like%` |
| 1 | [范围属性3（NO3DUPCHKPSDEFID）](#属性-范围属性3（NO3DUPCHKPSDEFID）) | `=` |
| 1 | [值项属性（VALUEPSDEFNAME）](#属性-值项属性（VALUEPSDEFNAME）) | `=` |
| 2 | [值项属性（VALUEPSDEFNAME）](#属性-值项属性（VALUEPSDEFNAME）) | `%like%` |
| 1 | [值项属性（VALUEPSDEFID）](#属性-值项属性（VALUEPSDEFID）) | `=` |
| 1 | [关系属性（DERPSDEFNAME）](#属性-关系属性（DERPSDEFNAME）) | `=` |
| 2 | [关系属性（DERPSDEFNAME）](#属性-关系属性（DERPSDEFNAME）) | `%like%` |
| 1 | [范围属性（DUPCHKPSDEFID）](#属性-范围属性（DUPCHKPSDEFID）) | `=` |
| 1 | [关系属性（DERPSDEFID）](#属性-关系属性（DERPSDEFID）) | `=` |
| 1 | [范围属性（DUPCHKPSDEFNAME）](#属性-范围属性（DUPCHKPSDEFNAME）) | `=` |
| 2 | [范围属性（DUPCHKPSDEFNAME）](#属性-范围属性（DUPCHKPSDEFNAME）) | `%like%` |
| 1 | [实体（PSDENAME）](#属性-实体（PSDENAME）) | `=` |
| 2 | [实体（PSDENAME）](#属性-实体（PSDENAME）) | `%like%` |
| 1 | [实体（PSDEID）](#属性-实体（PSDEID）) | `=` |
