...
| 73 | [范围属性2](#属性-范围属性2（NO2DUPCHKPSDEFNAME）) | NO2DUPCHKPSDEFNAME | PICKUPTEXT | 否 | 是 | 是 |
| 74 | [范围属性2](#属性-范围属性2（NO2DUPCHKPSDEFID）) | NO2DUPCHKPSDEFID | PICKUP | 否 | 是 | 是 |
| 75 | [范围属性3](#属性-范围属性3（NO3DUPCHKPSDEFNAME）) | NO3DUPCHKPSDEFNAME | PICKUPTEXT | 否 | 是 | 是 |
| 76 | [范围属性3](#属性-范围属性3（NO3DUPCHKPSDEFID）) | NO3DUPCHKPSDEFID | PICKUP | 否 | 是 | 是 |
| 77 | [值项属性](#属性-值项属性（VALUEPSDEFNAME）) | VALUEPSDEFNAME | PICKUPTEXT | 否 | 是 | 是 |
| 78 | [值项属性](#属性-值项属性（VALUEPSDEFID）) | VALUEPSDEFID | PICKUP | 否 | 是 | 是 |
| 79 | [关系属性](#属性-关系属性（DERPSDEFNAME）) | DERPSDEFNAME | PICKUPTEXT | 否 | 是 | 是 |
| 80 | [范围属性](#属性-范围属性（DUPCHKPSDEFID）) | DUPCHKPSDEFID | PICKUP | 否 | 是 | 是 |
| 81 | [关系属性](#属性-关系属性（DERPSDEFID）) | DERPSDEFID | PICKUP | 否 | 是 | 是 |
| 82 | [范围属性](#属性-范围属性（DUPCHKPSDEFNAME）) | DUPCHKPSDEFNAME | PICKUPTEXT | 否 | 是 | 是 |
| 83 | [实体](#属性-实体（PSDENAME）) | PSDENAME | PICKUPTEXT | 否 | 是 | 否 |
| 84 | [实体](#属性-实体（PSDEID）) | PSDEID | PICKUP | 否 | 是 | 否 |
| 85 | [PSSUBSYSSADEID](#属性-PSSUBSYSSADEID（PSSUBSYSSADEID）) | PSSUBSYSSADEID | PICKUPDATA | 否 | 是 | 是 |
| 86 | [系统](#属性-系统（PSSYSTEMID）) | PSSYSTEMID | TEXT | 否 | 是 | 是 |
| 87 | [系统](#属性-系统（PSSYSTEMNAME）) | PSSYSTEMNAME | TEXT | 否 | 是 | 是 |
