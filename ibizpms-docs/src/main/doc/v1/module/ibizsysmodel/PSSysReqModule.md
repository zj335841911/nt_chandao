...
| 23 | [父需求模块](#属性-父需求模块（PPSSYSREQMODULEID）) | PPSSYSREQMODULEID | PICKUP | 否 | 是 | 是 |
| 24 | [父需求模块](#属性-父需求模块（PPSSYSREQMODULENAME）) | PPSSYSREQMODULENAME | PICKUPTEXT | 否 | 是 | 是 |
| 25 | [系统模块](#属性-系统模块（PSMODULEID）) | PSMODULEID | PICKUP | 否 | 是 | 是 |
| 26 | [系统模块](#属性-系统模块（PSMODULENAME）) | PSMODULENAME | PICKUPTEXT | 否 | 是 | 是 |
