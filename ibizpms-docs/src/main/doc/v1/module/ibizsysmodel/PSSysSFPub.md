...
| 33 | [父后台服务体系](#属性-父后台服务体系（PPSSYSSFPUBID）) | PPSSYSSFPUBID | PICKUP | 否 | 是 | 是 |
| 34 | [父后台服务体系](#属性-父后台服务体系（PPSSYSSFPUBNAME）) | PPSSYSSFPUBNAME | PICKUPTEXT | 否 | 是 | 是 |
| 35 | [系统](#属性-系统（PSSYSTEMID）) | PSSYSTEMID | TEXT | 否 | 是 | 是 |
| 36 | [系统](#属性-系统（PSSYSTEMNAME）) | PSSYSTEMNAME | TEXT | 否 | 是 | 是 |
