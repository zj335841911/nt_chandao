...
public class SubTaskResource {
	...
	public ResponseEntity<List<HashMap>> fetchSubTaskTypeGroupByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
	...
	public ResponseEntity<Page<HashMap>> searchSubTaskTypeGroupByProjectModuleTask(@PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(domains.getContent(), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Create-all')")
    @ApiOperation(value = "根据需求模块需求任务建立任务", tags = {"任务" },  notes = "根据需求模块需求任务建立任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks")
    public ResponseEntity<SubTaskDTO> createByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
		taskService.create(domain);
        SubTaskDTO dto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Create-all')")
    @ApiOperation(value = "根据需求模块需求任务批量建立任务", tags = {"任务" },  notes = "根据需求模块需求任务批量建立任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    public ResponseEntity<Boolean> createBatchByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
            domain.setParent(task_id);
        }
    ...
    @VersionCheck(entity = "task" , versionfield = "lastediteddate")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Update-all')")
    @ApiOperation(value = "根据需求模块需求任务更新任务", tags = {"任务" },  notes = "根据需求模块需求任务更新任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<SubTaskDTO> updateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain.setId(subtask_id);
		taskService.update(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Update-all')")
    @ApiOperation(value = "根据需求模块需求任务批量更新任务", tags = {"任务" },  notes = "根据需求模块需求任务批量更新任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    public ResponseEntity<Boolean> updateBatchByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
            domain.setParent(task_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Remove-all')")
    @ApiOperation(value = "根据需求模块需求任务删除任务", tags = {"任务" },  notes = "根据需求模块需求任务删除任务")
	@RequestMapping(method = RequestMethod.DELETE, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<Boolean> removeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id) {
		return ResponseEntity.status(HttpStatus.OK).body(taskService.remove(subtask_id));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Remove-all')")
    @ApiOperation(value = "根据需求模块需求任务批量删除任务", tags = {"任务" },  notes = "根据需求模块需求任务批量删除任务")
	@RequestMapping(method = RequestMethod.DELETE, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Get-all')")
    @ApiOperation(value = "根据需求模块需求任务获取任务", tags = {"任务" },  notes = "根据需求模块需求任务获取任务")
	@RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<SubTaskDTO> getByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id) {
        Task domain = taskService.get(subtask_id);
        SubTaskDTO dto = subtaskMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据需求模块需求任务获取任务草稿", tags = {"任务" },  notes = "根据需求模块需求任务获取任务草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getdraft")
    public ResponseEntity<SubTaskDTO> getDraftByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, SubTaskDTO dto) {
        Task domain = subtaskMapping.toDomain(dto);
        domain.setParent(task_id);
        return ResponseEntity.status(HttpStatus.OK).body(subtaskMapping.toDto(taskService.getDraft(domain)));
    }
	...
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/activate")
    public ResponseEntity<SubTaskDTO> activateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.activate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
	...
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/activatebatch")
    public ResponseEntity<Boolean> activateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.activateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-AssignTo-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/assignto")
    public ResponseEntity<SubTaskDTO> assignToByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.assignTo(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/assigntobatch")
    public ResponseEntity<Boolean> assignToByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.assignToBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Cancel-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/cancel")
    public ResponseEntity<SubTaskDTO> cancelByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.cancel(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/cancelbatch")
    public ResponseEntity<Boolean> cancelByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.cancelBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @ApiOperation(value = "根据需求模块需求任务检查任务", tags = {"任务" },  notes = "根据需求模块需求任务检查任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/checkkey")
    public ResponseEntity<Boolean> checkKeyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        return  ResponseEntity.status(HttpStatus.OK).body(taskService.checkKey(subtaskMapping.toDomain(subtaskdto)));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Close-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/close")
    public ResponseEntity<SubTaskDTO> closeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.close(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/closebatch")
    public ResponseEntity<Boolean> closeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.closeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-ConfirmStoryChange-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/confirmstorychange")
    public ResponseEntity<SubTaskDTO> confirmStoryChangeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.confirmStoryChange(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/confirmstorychangebatch")
    public ResponseEntity<Boolean> confirmStoryChangeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.confirmStoryChangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-DeleteEstimate-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/deleteestimate")
    public ResponseEntity<SubTaskDTO> deleteEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.deleteEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/deleteestimatebatch")
    public ResponseEntity<Boolean> deleteEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.deleteEstimateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    ...
    public ResponseEntity<SubTaskDTO> editEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.editEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/editestimatebatch")
    public ResponseEntity<Boolean> editEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.editEstimateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Finish-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/finish")
    public ResponseEntity<SubTaskDTO> finishByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.finish(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/finishbatch")
    public ResponseEntity<Boolean> finishByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.finishBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetNextTeamUser-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getnextteamuser")
    public ResponseEntity<SubTaskDTO> getNextTeamUserByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getNextTeamUser(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getnextteamuserbatch")
    public ResponseEntity<Boolean> getNextTeamUserByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getNextTeamUserBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetTeamUserLeftActivity-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getteamuserleftactivity")
    public ResponseEntity<SubTaskDTO> getTeamUserLeftActivityByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getTeamUserLeftActivity(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getteamuserleftactivitybatch")
    public ResponseEntity<Boolean> getTeamUserLeftActivityByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getTeamUserLeftActivityBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetTeamUserLeftStart-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getteamuserleftstart")
    public ResponseEntity<SubTaskDTO> getTeamUserLeftStartByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getTeamUserLeftStart(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getteamuserleftstartbatch")
    public ResponseEntity<Boolean> getTeamUserLeftStartByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getTeamUserLeftStartBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetUsernames-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getusernames")
    public ResponseEntity<SubTaskDTO> getUsernamesByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getUsernames(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-OtherUpdate-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/otherupdate")
    public ResponseEntity<SubTaskDTO> otherUpdateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.otherUpdate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/otherupdatebatch")
    public ResponseEntity<Boolean> otherUpdateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.otherUpdateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Pause-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/pause")
    public ResponseEntity<SubTaskDTO> pauseByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.pause(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/pausebatch")
    public ResponseEntity<Boolean> pauseByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.pauseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordEstimate-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/recordestimate")
    public ResponseEntity<SubTaskDTO> recordEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.recordEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/recordestimatebatch")
    public ResponseEntity<Boolean> recordEstimateByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.recordEstimateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Restart-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/restart")
    public ResponseEntity<SubTaskDTO> restartByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.restart(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/restartbatch")
    public ResponseEntity<Boolean> restartByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.restartBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Save-all')")
    @ApiOperation(value = "根据需求模块需求任务保存任务", tags = {"任务" },  notes = "根据需求模块需求任务保存任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/save")
    public ResponseEntity<Boolean> saveByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        return ResponseEntity.status(HttpStatus.OK).body(taskService.save(domain));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Save-all')")
    @ApiOperation(value = "根据需求模块需求任务批量保存任务", tags = {"任务" },  notes = "根据需求模块需求任务批量保存任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/savebatch")
    public ResponseEntity<Boolean> saveBatchByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
             domain.setParent(task_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-SendMessage-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/sendmessage")
    public ResponseEntity<SubTaskDTO> sendMessageByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.sendMessage(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/sendmessagebatch")
    public ResponseEntity<Boolean> sendMessageByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.sendMessageBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-SendMsgPreProcess-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/sendmsgpreprocess")
    public ResponseEntity<SubTaskDTO> sendMsgPreProcessByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.sendMsgPreProcess(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/sendmsgpreprocessbatch")
    public ResponseEntity<Boolean> sendMsgPreProcessByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.sendMsgPreProcessBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Start-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/start")
    public ResponseEntity<SubTaskDTO> startByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.start(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/startbatch")
    public ResponseEntity<Boolean> startByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.startBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskFavorites-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/taskfavorites")
    public ResponseEntity<SubTaskDTO> taskFavoritesByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskFavorites(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskForward-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/taskforward")
    public ResponseEntity<SubTaskDTO> taskForwardByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskForward(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/taskforwardbatch")
    public ResponseEntity<Boolean> taskForwardByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.taskForwardBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskNFavorites-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/tasknfavorites")
    public ResponseEntity<SubTaskDTO> taskNFavoritesByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskNFavorites(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-UpdateStoryVersion-all')")
    @ApiOperation(value = "根据需求模块需求任务任务", tags = {"任务" },  notes = "根据需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/updatestoryversion")
    public ResponseEntity<SubTaskDTO> updateStoryVersionByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.updateStoryVersion(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取指派给我任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取指派给我任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchassignedtomytask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskAssignedToMyTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询指派给我任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询指派给我任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchassignedtomytask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskAssignedToMyTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskPc-all')")
	@ApiOperation(value = "根据需求模块需求任务获取指派给我任务（PC）", tags = {"任务" } ,notes = "根据需求模块需求任务获取指派给我任务（PC）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchassignedtomytaskpc")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskAssignedToMyTaskPcByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskPc(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskPc-all')")
	@ApiOperation(value = "根据需求模块需求任务查询指派给我任务（PC）", tags = {"任务" } ,notes = "根据需求模块需求任务查询指派给我任务（PC）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchassignedtomytaskpc")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskAssignedToMyTaskPcByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskPc(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchBugTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取Bug相关任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取Bug相关任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchbugtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskBugTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchBugTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchBugTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询Bug相关任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询Bug相关任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchbugtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskBugTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchBugTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModule-all')")
	@ApiOperation(value = "根据需求模块需求任务获取通过模块查询", tags = {"任务" } ,notes = "根据需求模块需求任务获取通过模块查询")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchbymodule")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskByModuleByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchByModule(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModule-all')")
	@ApiOperation(value = "根据需求模块需求任务查询通过模块查询", tags = {"任务" } ,notes = "根据需求模块需求任务查询通过模块查询")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchbymodule")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskByModuleByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchByModule(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取子任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取子任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchchildtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskChildTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询子任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询子任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchchildtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskChildTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTaskTree-all')")
	@ApiOperation(value = "根据需求模块需求任务获取子任务（树）", tags = {"任务" } ,notes = "根据需求模块需求任务获取子任务（树）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchchildtasktree")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskChildTaskTreeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTaskTree(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTaskTree-all')")
	@ApiOperation(value = "根据需求模块需求任务查询子任务（树）", tags = {"任务" } ,notes = "根据需求模块需求任务查询子任务（树）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchchildtasktree")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskChildTaskTreeByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTaskTree(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchCurFinishTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取用户年度完成任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取用户年度完成任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchcurfinishtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskCurFinishTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchCurFinishTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchCurFinishTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询用户年度完成任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询用户年度完成任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchcurfinishtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskCurFinishTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchCurFinishTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefault-all')")
	@ApiOperation(value = "根据需求模块需求任务获取DEFAULT", tags = {"任务" } ,notes = "根据需求模块需求任务获取DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchdefault")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskDefaultByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefault(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefault-all')")
	@ApiOperation(value = "根据需求模块需求任务查询DEFAULT", tags = {"任务" } ,notes = "根据需求模块需求任务查询DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchdefault")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskDefaultByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefaultRow-all')")
	@ApiOperation(value = "根据需求模块需求任务获取DefaultRow", tags = {"任务" } ,notes = "根据需求模块需求任务获取DefaultRow")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchdefaultrow")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskDefaultRowByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefaultRow(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefaultRow-all')")
	@ApiOperation(value = "根据需求模块需求任务查询DefaultRow", tags = {"任务" } ,notes = "根据需求模块需求任务查询DefaultRow")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchdefaultrow")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskDefaultRowByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefaultRow(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchESBulk-all')")
	@ApiOperation(value = "根据需求模块需求任务获取ES批量的导入", tags = {"任务" } ,notes = "根据需求模块需求任务获取ES批量的导入")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchesbulk")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskESBulkByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchESBulk(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchESBulk-all')")
	@ApiOperation(value = "根据需求模块需求任务查询ES批量的导入", tags = {"任务" } ,notes = "根据需求模块需求任务查询ES批量的导入")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchesbulk")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskESBulkByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchESBulk(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAgentTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我代理的任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取我代理的任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyagenttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyAgentTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyAgentTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAgentTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我代理的任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询我代理的任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyagenttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyAgentTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyAgentTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我完成的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我完成的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobDaily-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我完成的任务（移动端日报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我完成的任务（移动端日报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmobdaily")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMobDailyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobDaily(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobDaily-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我完成的任务（移动端日报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我完成的任务（移动端日报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmobdaily")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMobDailyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobDaily(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobMonthly-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我完成的任务（移动端月报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我完成的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmobmonthly")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMobMonthlyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobMonthly(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobMonthly-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我完成的任务（移动端月报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我完成的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmobmonthly")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMobMonthlyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobMonthly(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMonthlyZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我完成的任务（月报展示）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我完成的任务（月报展示）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmonthlyzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMonthlyZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMonthlyZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMonthlyZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我完成的任务（月报展示）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我完成的任务（月报展示）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmonthlyzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMonthlyZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMonthlyZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我完成的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我完成的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyFavorites-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我的收藏", tags = {"任务" } ,notes = "根据需求模块需求任务获取我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyfavorites")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyFavoritesByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyFavorites(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyFavorites-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我的收藏", tags = {"任务" } ,notes = "根据需求模块需求任务查询我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyfavorites")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyFavoritesByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyFavorites(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyPlansTaskMobMonthly-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我计划参与的任务（移动端月报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我计划参与的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyplanstaskmobmonthly")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyPlansTaskMobMonthlyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyPlansTaskMobMonthly(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyPlansTaskMobMonthly-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我计划参与的任务（移动端月报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我计划参与的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyplanstaskmobmonthly")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyPlansTaskMobMonthlyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyPlansTaskMobMonthly(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmytomorrowplantask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyTomorrowPlanTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmytomorrowplantask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyTomorrowPlanTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTaskMobDaily-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmytomorrowplantaskmobdaily")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyTomorrowPlanTaskMobDailyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTaskMobDaily(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTaskMobDaily-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmytomorrowplantaskmobdaily")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyTomorrowPlanTaskMobDailyByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTaskMobDaily(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取移动端下周计划参与(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取移动端下周计划参与(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekcompletetaskmobzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekCompleteTaskMobZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskMobZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询移动端下周计划参与(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询移动端下周计划参与(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekcompletetaskmobzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekCompleteTaskMobZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskMobZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekcompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekcompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekPlanCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取下周计划完成任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取下周计划完成任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekplancompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekPlanCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekPlanCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekPlanCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询下周计划完成任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询下周计划完成任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekplancompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekPlanCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekPlanCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取项目任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取项目任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchprojecttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskProjectTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchProjectTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询项目任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询项目任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchprojecttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskProjectTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchRootTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取根任务", tags = {"任务" } ,notes = "根据需求模块需求任务获取根任务")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchroottask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskRootTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchRootTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchRootTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询根任务", tags = {"任务" } ,notes = "根据需求模块需求任务查询根任务")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchroottask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskRootTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchRootTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisMonthCompleteTaskChoice-all')")
	@ApiOperation(value = "根据需求模块需求任务获取我本月完成的任务（下拉列表框）", tags = {"任务" } ,notes = "根据需求模块需求任务获取我本月完成的任务（下拉列表框）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthismonthcompletetaskchoice")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisMonthCompleteTaskChoiceByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisMonthCompleteTaskChoice(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisMonthCompleteTaskChoice-all')")
	@ApiOperation(value = "根据需求模块需求任务查询我本月完成的任务（下拉列表框）", tags = {"任务" } ,notes = "根据需求模块需求任务查询我本月完成的任务（下拉列表框）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthismonthcompletetaskchoice")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisMonthCompleteTaskChoiceByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisMonthCompleteTaskChoice(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskChoice-all')")
	@ApiOperation(value = "根据需求模块需求任务获取本周已完成任务(下拉框选择)", tags = {"任务" } ,notes = "根据需求模块需求任务获取本周已完成任务(下拉框选择)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskchoice")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskChoiceByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskChoice(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskChoice-all')")
	@ApiOperation(value = "根据需求模块需求任务查询本周已完成任务(下拉框选择)", tags = {"任务" } ,notes = "根据需求模块需求任务查询本周已完成任务(下拉框选择)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskchoice")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskChoiceByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskChoice(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取移动端本周已完成任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取移动端本周已完成任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskmobzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskMobZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskMobZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询移动端本周已完成任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询移动端本周已完成任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskmobzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskMobZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskMobZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskZSByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchTodoListTask-all')")
	@ApiOperation(value = "根据需求模块需求任务获取todo列表查询", tags = {"任务" } ,notes = "根据需求模块需求任务获取todo列表查询")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchtodolisttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskTodoListTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchTodoListTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchTodoListTask-all')")
	@ApiOperation(value = "根据需求模块需求任务查询todo列表查询", tags = {"任务" } ,notes = "根据需求模块需求任务查询todo列表查询")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchtodolisttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskTodoListTaskByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchTodoListTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
	@ApiOperation(value = "根据需求模块需求任务获取任务类型分组", tags = {"任务" } ,notes = "根据需求模块需求任务获取任务类型分组")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchtypegroup")
	public ResponseEntity<List<HashMap>> fetchSubTaskTypeGroupByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
	...
	@ApiOperation(value = "根据需求模块需求任务查询任务类型分组", tags = {"任务" } ,notes = "根据需求模块需求任务查询任务类型分组")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchtypegroup")
	public ResponseEntity<Page<HashMap>> searchSubTaskTypeGroupByProductModuleStoryTask(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(domains.getContent(), context.getPageable(), domains.getTotalElements()));
	...
	public ResponseEntity<List<HashMap>> fetchSubTaskTypeGroupByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
	...
	public ResponseEntity<Page<HashMap>> searchSubTaskTypeGroupByProjectProjectModuleTask(@PathVariable("project_id") Long project_id, @PathVariable("projectmodule_id") Long projectmodule_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(domains.getContent(), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Create-all')")
    @ApiOperation(value = "根据产品需求模块需求任务建立任务", tags = {"任务" },  notes = "根据产品需求模块需求任务建立任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks")
    public ResponseEntity<SubTaskDTO> createByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
		taskService.create(domain);
        SubTaskDTO dto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Create-all')")
    @ApiOperation(value = "根据产品需求模块需求任务批量建立任务", tags = {"任务" },  notes = "根据产品需求模块需求任务批量建立任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    public ResponseEntity<Boolean> createBatchByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
            domain.setParent(task_id);
        }
    ...
    @VersionCheck(entity = "task" , versionfield = "lastediteddate")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Update-all')")
    @ApiOperation(value = "根据产品需求模块需求任务更新任务", tags = {"任务" },  notes = "根据产品需求模块需求任务更新任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<SubTaskDTO> updateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain.setId(subtask_id);
		taskService.update(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Update-all')")
    @ApiOperation(value = "根据产品需求模块需求任务批量更新任务", tags = {"任务" },  notes = "根据产品需求模块需求任务批量更新任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    public ResponseEntity<Boolean> updateBatchByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
            domain.setParent(task_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Remove-all')")
    @ApiOperation(value = "根据产品需求模块需求任务删除任务", tags = {"任务" },  notes = "根据产品需求模块需求任务删除任务")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<Boolean> removeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id) {
		return ResponseEntity.status(HttpStatus.OK).body(taskService.remove(subtask_id));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Remove-all')")
    @ApiOperation(value = "根据产品需求模块需求任务批量删除任务", tags = {"任务" },  notes = "根据产品需求模块需求任务批量删除任务")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/batch")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Get-all')")
    @ApiOperation(value = "根据产品需求模块需求任务获取任务", tags = {"任务" },  notes = "根据产品需求模块需求任务获取任务")
	@RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}")
    public ResponseEntity<SubTaskDTO> getByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id) {
        Task domain = taskService.get(subtask_id);
        SubTaskDTO dto = subtaskMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据产品需求模块需求任务获取任务草稿", tags = {"任务" },  notes = "根据产品需求模块需求任务获取任务草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getdraft")
    public ResponseEntity<SubTaskDTO> getDraftByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, SubTaskDTO dto) {
        Task domain = subtaskMapping.toDomain(dto);
        domain.setParent(task_id);
        return ResponseEntity.status(HttpStatus.OK).body(subtaskMapping.toDto(taskService.getDraft(domain)));
    }
	...
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/activate")
    public ResponseEntity<SubTaskDTO> activateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.activate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
	...
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/activatebatch")
    public ResponseEntity<Boolean> activateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.activateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-AssignTo-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/assignto")
    public ResponseEntity<SubTaskDTO> assignToByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.assignTo(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/assigntobatch")
    public ResponseEntity<Boolean> assignToByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.assignToBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Cancel-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/cancel")
    public ResponseEntity<SubTaskDTO> cancelByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.cancel(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/cancelbatch")
    public ResponseEntity<Boolean> cancelByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.cancelBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @ApiOperation(value = "根据产品需求模块需求任务检查任务", tags = {"任务" },  notes = "根据产品需求模块需求任务检查任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/checkkey")
    public ResponseEntity<Boolean> checkKeyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        return  ResponseEntity.status(HttpStatus.OK).body(taskService.checkKey(subtaskMapping.toDomain(subtaskdto)));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Close-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/close")
    public ResponseEntity<SubTaskDTO> closeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.close(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/closebatch")
    public ResponseEntity<Boolean> closeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.closeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-ConfirmStoryChange-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/confirmstorychange")
    public ResponseEntity<SubTaskDTO> confirmStoryChangeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.confirmStoryChange(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/confirmstorychangebatch")
    public ResponseEntity<Boolean> confirmStoryChangeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.confirmStoryChangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-DeleteEstimate-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/deleteestimate")
    public ResponseEntity<SubTaskDTO> deleteEstimateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.deleteEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/deleteestimatebatch")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-EditEstimate-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/editestimate")
    public ResponseEntity<SubTaskDTO> editEstimateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.editEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/editestimatebatch")
    public ResponseEntity<Boolean> editEstimateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.editEstimateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Finish-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/finish")
    public ResponseEntity<SubTaskDTO> finishByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.finish(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/finishbatch")
    public ResponseEntity<Boolean> finishByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.finishBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetNextTeamUser-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getnextteamuser")
    public ResponseEntity<SubTaskDTO> getNextTeamUserByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getNextTeamUser(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getnextteamuserbatch")
    public ResponseEntity<Boolean> getNextTeamUserByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getNextTeamUserBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetTeamUserLeftActivity-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getteamuserleftactivity")
    public ResponseEntity<SubTaskDTO> getTeamUserLeftActivityByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getTeamUserLeftActivity(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getteamuserleftactivitybatch")
    public ResponseEntity<Boolean> getTeamUserLeftActivityByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getTeamUserLeftActivityBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetTeamUserLeftStart-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getteamuserleftstart")
    public ResponseEntity<SubTaskDTO> getTeamUserLeftStartByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getTeamUserLeftStart(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/getteamuserleftstartbatch")
    public ResponseEntity<Boolean> getTeamUserLeftStartByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.getTeamUserLeftStartBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-GetUsernames-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/getusernames")
    public ResponseEntity<SubTaskDTO> getUsernamesByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.getUsernames(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-OtherUpdate-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/otherupdate")
    public ResponseEntity<SubTaskDTO> otherUpdateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.otherUpdate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/otherupdatebatch")
    public ResponseEntity<Boolean> otherUpdateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.otherUpdateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Pause-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/pause")
    public ResponseEntity<SubTaskDTO> pauseByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.pause(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/pausebatch")
    public ResponseEntity<Boolean> pauseByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.pauseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-RecordEstimate-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/recordestimate")
    public ResponseEntity<SubTaskDTO> recordEstimateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.recordEstimate(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/recordestimatebatch")
    public ResponseEntity<Boolean> recordEstimateByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.recordEstimateBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Restart-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/restart")
    public ResponseEntity<SubTaskDTO> restartByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.restart(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/restartbatch")
    public ResponseEntity<Boolean> restartByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.restartBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Save-all')")
    @ApiOperation(value = "根据产品需求模块需求任务保存任务", tags = {"任务" },  notes = "根据产品需求模块需求任务保存任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/save")
    public ResponseEntity<Boolean> saveByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        return ResponseEntity.status(HttpStatus.OK).body(taskService.save(domain));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Save-all')")
    @ApiOperation(value = "根据产品需求模块需求任务批量保存任务", tags = {"任务" },  notes = "根据产品需求模块需求任务批量保存任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/savebatch")
    public ResponseEntity<Boolean> saveBatchByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domainlist=subtaskMapping.toDomain(subtaskdtos);
        for(Task domain:domainlist){
             domain.setParent(task_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-SendMessage-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/sendmessage")
    public ResponseEntity<SubTaskDTO> sendMessageByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.sendMessage(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/sendmessagebatch")
    public ResponseEntity<Boolean> sendMessageByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.sendMessageBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-SendMsgPreProcess-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/sendmsgpreprocess")
    public ResponseEntity<SubTaskDTO> sendMsgPreProcessByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.sendMsgPreProcess(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/sendmsgpreprocessbatch")
    public ResponseEntity<Boolean> sendMsgPreProcessByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.sendMsgPreProcessBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-Start-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/start")
    public ResponseEntity<SubTaskDTO> startByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.start(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/startbatch")
    public ResponseEntity<Boolean> startByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.startBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskFavorites-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/taskfavorites")
    public ResponseEntity<SubTaskDTO> taskFavoritesByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskFavorites(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskForward-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/taskforward")
    public ResponseEntity<SubTaskDTO> taskForwardByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskForward(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求任务任务]", tags = {"任务" },  notes = "批量处理[根据产品需求模块需求任务任务]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/taskforwardbatch")
    public ResponseEntity<Boolean> taskForwardByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody List<SubTaskDTO> subtaskdtos) {
        List<Task> domains = subtaskMapping.toDomain(subtaskdtos);
        boolean result = taskService.taskForwardBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-TaskNFavorites-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/tasknfavorites")
    public ResponseEntity<SubTaskDTO> taskNFavoritesByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.taskNFavorites(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-UpdateStoryVersion-all')")
    @ApiOperation(value = "根据产品需求模块需求任务任务", tags = {"任务" },  notes = "根据产品需求模块需求任务任务")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/{subtask_id}/updatestoryversion")
    public ResponseEntity<SubTaskDTO> updateStoryVersionByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @PathVariable("subtask_id") Long subtask_id, @RequestBody SubTaskDTO subtaskdto) {
        Task domain = subtaskMapping.toDomain(subtaskdto);
        domain.setParent(task_id);
        domain = taskService.updateStoryVersion(domain) ;
        subtaskdto = subtaskMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取指派给我任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取指派给我任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchassignedtomytask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskAssignedToMyTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询指派给我任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询指派给我任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchassignedtomytask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskAssignedToMyTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskPc-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取指派给我任务（PC）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取指派给我任务（PC）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchassignedtomytaskpc")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskAssignedToMyTaskPcByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskPc(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchAssignedToMyTaskPc-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询指派给我任务（PC）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询指派给我任务（PC）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchassignedtomytaskpc")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskAssignedToMyTaskPcByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchAssignedToMyTaskPc(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchBugTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取Bug相关任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取Bug相关任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchbugtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskBugTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchBugTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchBugTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询Bug相关任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询Bug相关任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchbugtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskBugTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchBugTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModule-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取通过模块查询", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取通过模块查询")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchbymodule")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskByModuleByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchByModule(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchByModule-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询通过模块查询", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询通过模块查询")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchbymodule")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskByModuleByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchByModule(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取子任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取子任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchchildtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskChildTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询子任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询子任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchchildtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskChildTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTaskTree-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取子任务（树）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取子任务（树）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchchildtasktree")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskChildTaskTreeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTaskTree(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchChildTaskTree-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询子任务（树）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询子任务（树）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchchildtasktree")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskChildTaskTreeByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchChildTaskTree(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchCurFinishTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取用户年度完成任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取用户年度完成任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchcurfinishtask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskCurFinishTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchCurFinishTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchCurFinishTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询用户年度完成任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询用户年度完成任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchcurfinishtask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskCurFinishTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchCurFinishTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefault-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取DEFAULT", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchdefault")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskDefaultByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefault(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefault-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询DEFAULT", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchdefault")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskDefaultByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefaultRow-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取DefaultRow", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取DefaultRow")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchdefaultrow")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskDefaultRowByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefaultRow(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchDefaultRow-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询DefaultRow", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询DefaultRow")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchdefaultrow")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskDefaultRowByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchDefaultRow(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchESBulk-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取ES批量的导入", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取ES批量的导入")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchesbulk")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskESBulkByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchESBulk(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchESBulk-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询ES批量的导入", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询ES批量的导入")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchesbulk")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskESBulkByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchESBulk(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAgentTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我代理的任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我代理的任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyagenttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyAgentTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyAgentTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyAgentTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我代理的任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我代理的任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyagenttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyAgentTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyAgentTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我完成的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我完成的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobDaily-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我完成的任务（移动端日报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我完成的任务（移动端日报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmobdaily")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMobDailyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobDaily(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobDaily-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我完成的任务（移动端日报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我完成的任务（移动端日报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmobdaily")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMobDailyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobDaily(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobMonthly-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我完成的任务（移动端月报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我完成的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmobmonthly")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMobMonthlyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobMonthly(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMobMonthly-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我完成的任务（移动端月报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我完成的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmobmonthly")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMobMonthlyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMobMonthly(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMonthlyZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我完成的任务（月报展示）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我完成的任务（月报展示）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskmonthlyzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskMonthlyZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMonthlyZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskMonthlyZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我完成的任务（月报展示）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我完成的任务（月报展示）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskmonthlyzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskMonthlyZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskMonthlyZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我完成的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmycompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我完成的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我完成的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmycompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyFavorites-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我的收藏", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyfavorites")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyFavoritesByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyFavorites(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyFavorites-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我的收藏", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyfavorites")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyFavoritesByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyFavorites(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyPlansTaskMobMonthly-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我计划参与的任务（移动端月报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我计划参与的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmyplanstaskmobmonthly")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyPlansTaskMobMonthlyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyPlansTaskMobMonthly(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyPlansTaskMobMonthly-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我计划参与的任务（移动端月报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我计划参与的任务（移动端月报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmyplanstaskmobmonthly")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyPlansTaskMobMonthlyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyPlansTaskMobMonthly(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmytomorrowplantask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyTomorrowPlanTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmytomorrowplantask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyTomorrowPlanTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTaskMobDaily-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchmytomorrowplantaskmobdaily")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskMyTomorrowPlanTaskMobDailyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTaskMobDaily(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchMyTomorrowPlanTaskMobDaily-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我计划参与的任务（汇报）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我计划参与的任务（汇报）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchmytomorrowplantaskmobdaily")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskMyTomorrowPlanTaskMobDailyByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchMyTomorrowPlanTaskMobDaily(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取移动端下周计划参与(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取移动端下周计划参与(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekcompletetaskmobzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekCompleteTaskMobZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskMobZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询移动端下周计划参与(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询移动端下周计划参与(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekcompletetaskmobzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekCompleteTaskMobZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskMobZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekcompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekcompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekPlanCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取下周计划完成任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取下周计划完成任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchnextweekplancompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskNextWeekPlanCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekPlanCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchNextWeekPlanCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询下周计划完成任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询下周计划完成任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchnextweekplancompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskNextWeekPlanCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchNextWeekPlanCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取项目任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取项目任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchprojecttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskProjectTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,@RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchProjectTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchProjectTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询项目任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询项目任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchprojecttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskProjectTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchProjectTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchRootTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取根任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取根任务")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchroottask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskRootTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchRootTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchRootTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询根任务", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询根任务")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchroottask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskRootTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchRootTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisMonthCompleteTaskChoice-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取我本月完成的任务（下拉列表框）", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取我本月完成的任务（下拉列表框）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthismonthcompletetaskchoice")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisMonthCompleteTaskChoiceByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisMonthCompleteTaskChoice(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisMonthCompleteTaskChoice-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询我本月完成的任务（下拉列表框）", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询我本月完成的任务（下拉列表框）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthismonthcompletetaskchoice")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisMonthCompleteTaskChoiceByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisMonthCompleteTaskChoice(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskChoice-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取本周已完成任务(下拉框选择)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取本周已完成任务(下拉框选择)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskchoice")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskChoiceByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskChoice(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskChoice-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询本周已完成任务(下拉框选择)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询本周已完成任务(下拉框选择)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskchoice")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskChoiceByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskChoice(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取移动端本周已完成任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取移动端本周已完成任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskmobzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskMobZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskMobZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskMobZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询移动端本周已完成任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询移动端本周已完成任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskmobzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskMobZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskMobZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchthisweekcompletetaskzs")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskThisWeekCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskZS(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchThisWeekCompleteTaskZS-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询本周完成的任务(汇报)", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询本周完成的任务(汇报)")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchthisweekcompletetaskzs")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskThisWeekCompleteTaskZSByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchThisWeekCompleteTaskZS(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchTodoListTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务获取todo列表查询", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取todo列表查询")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchtodolisttask")
	public ResponseEntity<List<SubTaskDTO>> fetchSubTaskTodoListTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchTodoListTask(context) ;
        List<SubTaskDTO> list = subtaskMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Task-searchTodoListTask-all')")
	@ApiOperation(value = "根据产品需求模块需求任务查询todo列表查询", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询todo列表查询")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchtodolisttask")
	public ResponseEntity<Page<SubTaskDTO>> searchSubTaskTodoListTaskByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<Task> domains = taskService.searchTodoListTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(subtaskMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
	}
	@ApiOperation(value = "根据产品需求模块需求任务获取任务类型分组", tags = {"任务" } ,notes = "根据产品需求模块需求任务获取任务类型分组")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/fetchtypegroup")
	public ResponseEntity<List<HashMap>> fetchSubTaskTypeGroupByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id,TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
	...
	@ApiOperation(value = "根据产品需求模块需求任务查询任务类型分组", tags = {"任务" } ,notes = "根据产品需求模块需求任务查询任务类型分组")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/tasks/{task_id}/subtasks/searchtypegroup")
	public ResponseEntity<Page<HashMap>> searchSubTaskTypeGroupByProductProductModuleStoryTask(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("task_id") Long task_id, @RequestBody TaskSearchContext context) {
        context.setN_parent_eq(task_id);
        Page<HashMap> domains = taskService.searchTypeGroup(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(domains.getContent(), context.getPageable(), domains.getTotalElements()));
