...
public class CaseResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Create-all')")
    @ApiOperation(value = "根据需求模块需求建立测试用例", tags = {"测试用例" },  notes = "根据需求模块需求建立测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases")
    public ResponseEntity<CaseDTO> createByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
		caseService.create(domain);
        CaseDTO dto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Create-all')")
    @ApiOperation(value = "根据需求模块需求批量建立测试用例", tags = {"测试用例" },  notes = "根据需求模块需求批量建立测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    public ResponseEntity<Boolean> createBatchByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
            domain.setStory(story_id);
        }
    ...
    @VersionCheck(entity = "case" , versionfield = "lastediteddate")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Update-all')")
    @ApiOperation(value = "根据需求模块需求更新测试用例", tags = {"测试用例" },  notes = "根据需求模块需求更新测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<CaseDTO> updateByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain.setId(case_id);
		caseService.update(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Update-all')")
    @ApiOperation(value = "根据需求模块需求批量更新测试用例", tags = {"测试用例" },  notes = "根据需求模块需求批量更新测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    public ResponseEntity<Boolean> updateBatchByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
            domain.setStory(story_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Remove-all')")
    @ApiOperation(value = "根据需求模块需求删除测试用例", tags = {"测试用例" },  notes = "根据需求模块需求删除测试用例")
	@RequestMapping(method = RequestMethod.DELETE, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<Boolean> removeByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id) {
		return ResponseEntity.status(HttpStatus.OK).body(caseService.remove(case_id));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Remove-all')")
    @ApiOperation(value = "根据需求模块需求批量删除测试用例", tags = {"测试用例" },  notes = "根据需求模块需求批量删除测试用例")
	@RequestMapping(method = RequestMethod.DELETE, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Get-all')")
    @ApiOperation(value = "根据需求模块需求获取测试用例", tags = {"测试用例" },  notes = "根据需求模块需求获取测试用例")
	@RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<CaseDTO> getByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id) {
        Case domain = caseService.get(case_id);
        CaseDTO dto = caseMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据需求模块需求获取测试用例草稿", tags = {"测试用例" },  notes = "根据需求模块需求获取测试用例草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/getdraft")
    public ResponseEntity<CaseDTO> getDraftByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, CaseDTO dto) {
        Case domain = caseMapping.toDomain(dto);
        domain.setStory(story_id);
        return ResponseEntity.status(HttpStatus.OK).body(caseMapping.toDto(caseService.getDraft(domain)));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-CaseFavorite-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/casefavorite")
    public ResponseEntity<CaseDTO> caseFavoriteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.caseFavorite(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-CaseNFavorite-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/casenfavorite")
    public ResponseEntity<CaseDTO> caseNFavoriteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.caseNFavorite(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "根据需求模块需求检查测试用例", tags = {"测试用例" },  notes = "根据需求模块需求检查测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/checkkey")
    public ResponseEntity<Boolean> checkKeyByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        return  ResponseEntity.status(HttpStatus.OK).body(caseService.checkKey(caseMapping.toDomain(casedto)));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-ConfirmChange-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/confirmchange")
    public ResponseEntity<CaseDTO> confirmChangeByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.confirmChange(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/confirmchangebatch")
    public ResponseEntity<Boolean> confirmChangeByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.confirmChangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Confirmstorychange-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/confirmstorychange")
    public ResponseEntity<CaseDTO> confirmstorychangeByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.confirmstorychange(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/confirmstorychangebatch")
    public ResponseEntity<Boolean> confirmstorychangeByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.confirmstorychangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-GetByTestTask-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/getbytesttask")
    public ResponseEntity<CaseDTO> getByTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.getByTestTask(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.GET, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/getbytesttaskbatch")
    public ResponseEntity<Boolean> getByTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.getByTestTaskBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-GetTestTaskCntRun-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/gettesttaskcntrun")
    public ResponseEntity<CaseDTO> getTestTaskCntRunByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.getTestTaskCntRun(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.PUT, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/gettesttaskcntrunbatch")
    public ResponseEntity<Boolean> getTestTaskCntRunByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.getTestTaskCntRunBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-LinkCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/linkcase")
    public ResponseEntity<CaseDTO> linkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.linkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/linkcasebatch")
    public ResponseEntity<Boolean> linkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.linkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-MobLinkCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/moblinkcase")
    public ResponseEntity<CaseDTO> mobLinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.mobLinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/moblinkcasebatch")
    public ResponseEntity<Boolean> mobLinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.mobLinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-RunCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/runcase")
    public ResponseEntity<CaseDTO> runCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.runCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/runcasebatch")
    public ResponseEntity<Boolean> runCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.runCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-RunCases-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/runcases")
    public ResponseEntity<CaseDTO> runCasesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.runCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Save-all')")
    @ApiOperation(value = "根据需求模块需求保存测试用例", tags = {"测试用例" },  notes = "根据需求模块需求保存测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/save")
    public ResponseEntity<Boolean> saveByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        return ResponseEntity.status(HttpStatus.OK).body(caseService.save(domain));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Save-all')")
    @ApiOperation(value = "根据需求模块需求批量保存测试用例", tags = {"测试用例" },  notes = "根据需求模块需求批量保存测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/savebatch")
    public ResponseEntity<Boolean> saveBatchByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
             domain.setStory(story_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestRunCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testruncase")
    public ResponseEntity<CaseDTO> testRunCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testRunCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/testruncasebatch")
    public ResponseEntity<Boolean> testRunCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.testRunCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestRunCases-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testruncases")
    public ResponseEntity<CaseDTO> testRunCasesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testRunCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestsuitelinkCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testsuitelinkcase")
    public ResponseEntity<CaseDTO> testsuitelinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testsuitelinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/testsuitelinkcasebatch")
    public ResponseEntity<Boolean> testsuitelinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.testsuitelinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinkcase")
    public ResponseEntity<CaseDTO> unlinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/unlinkcasebatch")
    public ResponseEntity<Boolean> unlinkCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.unlinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkCases-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinkcases")
    public ResponseEntity<CaseDTO> unlinkCasesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkSuiteCase-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinksuitecase")
    public ResponseEntity<CaseDTO> unlinkSuiteCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkSuiteCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/unlinksuitecasebatch")
    public ResponseEntity<Boolean> unlinkSuiteCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.unlinkSuiteCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkSuiteCases-all')")
    @ApiOperation(value = "根据需求模块需求测试用例", tags = {"测试用例" },  notes = "根据需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinksuitecases")
    public ResponseEntity<CaseDTO> unlinkSuiteCasesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkSuiteCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchBatchNew-all')")
	@ApiOperation(value = "根据需求模块需求获取批量新建用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取批量新建用例")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchbatchnew")
	public ResponseEntity<List<CaseDTO>> fetchCaseBatchNewByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchBatchNew(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchBatchNew-all')")
	@ApiOperation(value = "根据需求模块需求查询批量新建用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询批量新建用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchbatchnew")
	public ResponseEntity<Page<CaseDTO>> searchCaseBatchNewByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchBatchNew(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurOpenedCase-all')")
	@ApiOperation(value = "根据需求模块需求获取累计创建的用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取累计创建的用例")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcuropenedcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurOpenedCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurOpenedCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurOpenedCase-all')")
	@ApiOperation(value = "根据需求模块需求查询累计创建的用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询累计创建的用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcuropenedcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurOpenedCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurOpenedCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurSuite-all')")
	@ApiOperation(value = "根据需求模块需求获取套件关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcursuite")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurSuiteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurSuite(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurSuite-all')")
	@ApiOperation(value = "根据需求模块需求查询套件关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcursuite")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurSuiteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurSuite(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurTestTask-all')")
	@ApiOperation(value = "根据需求模块需求获取测试单关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcurtesttask")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurTestTask(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurTestTask-all')")
	@ApiOperation(value = "根据需求模块需求查询测试单关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcurtesttask")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurTestTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchDefault-all')")
	@ApiOperation(value = "根据需求模块需求获取DEFAULT", tags = {"测试用例" } ,notes = "根据需求模块需求获取DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchdefault")
	public ResponseEntity<List<CaseDTO>> fetchCaseDefaultByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchDefault(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchDefault-all')")
	@ApiOperation(value = "根据需求模块需求查询DEFAULT", tags = {"测试用例" } ,notes = "根据需求模块需求查询DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchdefault")
	public ResponseEntity<Page<CaseDTO>> searchCaseDefaultByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchESBulk-all')")
	@ApiOperation(value = "根据需求模块需求获取ES批量的导入", tags = {"测试用例" } ,notes = "根据需求模块需求获取ES批量的导入")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchesbulk")
	public ResponseEntity<List<CaseDTO>> fetchCaseESBulkByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchESBulk(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchESBulk-all')")
	@ApiOperation(value = "根据需求模块需求查询ES批量的导入", tags = {"测试用例" } ,notes = "根据需求模块需求查询ES批量的导入")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchesbulk")
	public ResponseEntity<Page<CaseDTO>> searchCaseESBulkByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchESBulk(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联-按模块-条目", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联-按模块-条目")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联-按模块-条目", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联-按模块-条目")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求获取项目报告关联-按模块", tags = {"测试用例" } ,notes = "根据需求模块需求获取项目报告关联-按模块")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求查询项目报告关联-按模块", tags = {"测试用例" } ,notes = "根据需求模块需求查询项目报告关联-按模块")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchMyFavorites-all')")
	@ApiOperation(value = "根据需求模块需求获取我的收藏", tags = {"测试用例" } ,notes = "根据需求模块需求获取我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmyfavorites")
	public ResponseEntity<List<CaseDTO>> fetchCaseMyFavoritesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchMyFavorites(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchMyFavorites-all')")
	@ApiOperation(value = "根据需求模块需求查询我的收藏", tags = {"测试用例" } ,notes = "根据需求模块需求查询我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmyfavorites")
	public ResponseEntity<Page<CaseDTO>> searchCaseMyFavoritesByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchMyFavorites(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestSuite-all')")
	@ApiOperation(value = "根据需求模块需求获取套件关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtestsuite")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestSuiteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestSuite(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestSuite-all')")
	@ApiOperation(value = "根据需求模块需求查询套件关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtestsuite")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestSuiteByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestSuite(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTask-all')")
	@ApiOperation(value = "根据需求模块需求获取测试单关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtesttask")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTask(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTask-all')")
	@ApiOperation(value = "根据需求模块需求查询测试单关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtesttask")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestTaskByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTaskProject-all')")
	@ApiOperation(value = "根据需求模块需求获取测试单关联用例（项目关联）", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试单关联用例（项目关联）")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtesttaskproject")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestTaskProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTaskProject(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTaskProject-all')")
	@ApiOperation(value = "根据需求模块需求查询测试单关联用例（项目关联）", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试单关联用例（项目关联）")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtesttaskproject")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestTaskProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTaskProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联用例-条目", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联用例-条目")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联用例-条目", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联用例-条目")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求获取项目报告关联用例-关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取项目报告关联用例-关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求查询项目报告关联用例-关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询项目报告关联用例-关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联-执行人", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联-执行人")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联-执行人", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联-执行人")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联-执行人-条目", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联-执行人-条目")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联-执行人-条目", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联-执行人-条目")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求获取项目报告关联-执行人", tags = {"测试用例" } ,notes = "根据需求模块需求获取项目报告关联-执行人")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求查询项目报告关联-执行人", tags = {"测试用例" } ,notes = "根据需求模块需求查询项目报告关联-执行人")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCaseByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求获取测试报告关联--执行结果条目", tags = {"测试用例" } ,notes = "根据需求模块需求获取测试报告关联--执行结果条目")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCaseEntry-all')")
	@ApiOperation(value = "根据需求模块需求查询测试报告关联--执行结果条目", tags = {"测试用例" } ,notes = "根据需求模块需求查询测试报告关联--执行结果条目")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCaseEntryByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求获取项目报告关联-执行结果", tags = {"测试用例" } ,notes = "根据需求模块需求获取项目报告关联-执行结果")
    @RequestMapping(method= RequestMethod.GET , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase_Project-all')")
	@ApiOperation(value = "根据需求模块需求查询项目报告关联-执行结果", tags = {"测试用例" } ,notes = "根据需求模块需求查询项目报告关联-执行结果")
    @RequestMapping(method= RequestMethod.POST , value="/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCase_ProjectByProductModuleStory(@PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Create-all')")
    @ApiOperation(value = "根据产品需求模块需求建立测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求建立测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases")
    public ResponseEntity<CaseDTO> createByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
		caseService.create(domain);
        CaseDTO dto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Create-all')")
    @ApiOperation(value = "根据产品需求模块需求批量建立测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求批量建立测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    public ResponseEntity<Boolean> createBatchByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
            domain.setStory(story_id);
        }
    ...
    @VersionCheck(entity = "case" , versionfield = "lastediteddate")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Update-all')")
    @ApiOperation(value = "根据产品需求模块需求更新测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求更新测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<CaseDTO> updateByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain.setId(case_id);
		caseService.update(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Update-all')")
    @ApiOperation(value = "根据产品需求模块需求批量更新测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求批量更新测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    public ResponseEntity<Boolean> updateBatchByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
            domain.setStory(story_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Remove-all')")
    @ApiOperation(value = "根据产品需求模块需求删除测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求删除测试用例")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<Boolean> removeByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id) {
		return ResponseEntity.status(HttpStatus.OK).body(caseService.remove(case_id));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Remove-all')")
    @ApiOperation(value = "根据产品需求模块需求批量删除测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求批量删除测试用例")
	@RequestMapping(method = RequestMethod.DELETE, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/batch")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Get-all')")
    @ApiOperation(value = "根据产品需求模块需求获取测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求获取测试用例")
	@RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}")
    public ResponseEntity<CaseDTO> getByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id) {
        Case domain = caseService.get(case_id);
        CaseDTO dto = caseMapping.toDto(domain);
        return ResponseEntity.status(HttpStatus.OK).body(dto);
    }

    @ApiOperation(value = "根据产品需求模块需求获取测试用例草稿", tags = {"测试用例" },  notes = "根据产品需求模块需求获取测试用例草稿")
    @RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/getdraft")
    public ResponseEntity<CaseDTO> getDraftByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, CaseDTO dto) {
        Case domain = caseMapping.toDomain(dto);
        domain.setStory(story_id);
        return ResponseEntity.status(HttpStatus.OK).body(caseMapping.toDto(caseService.getDraft(domain)));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-CaseFavorite-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/casefavorite")
    public ResponseEntity<CaseDTO> caseFavoriteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.caseFavorite(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-CaseNFavorite-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/casenfavorite")
    public ResponseEntity<CaseDTO> caseNFavoriteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.caseNFavorite(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "根据产品需求模块需求检查测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求检查测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/checkkey")
    public ResponseEntity<Boolean> checkKeyByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        return  ResponseEntity.status(HttpStatus.OK).body(caseService.checkKey(caseMapping.toDomain(casedto)));
    }

    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-ConfirmChange-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/confirmchange")
    public ResponseEntity<CaseDTO> confirmChangeByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.confirmChange(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/confirmchangebatch")
    public ResponseEntity<Boolean> confirmChangeByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.confirmChangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Confirmstorychange-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/confirmstorychange")
    public ResponseEntity<CaseDTO> confirmstorychangeByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.confirmstorychange(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/confirmstorychangebatch")
    public ResponseEntity<Boolean> confirmstorychangeByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.confirmstorychangeBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-GetByTestTask-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/getbytesttask")
    public ResponseEntity<CaseDTO> getByTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.getByTestTask(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.GET, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/getbytesttaskbatch")
    public ResponseEntity<Boolean> getByTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.getByTestTaskBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-GetTestTaskCntRun-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/gettesttaskcntrun")
    public ResponseEntity<CaseDTO> getTestTaskCntRunByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.getTestTaskCntRun(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.PUT, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/gettesttaskcntrunbatch")
    public ResponseEntity<Boolean> getTestTaskCntRunByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.getTestTaskCntRunBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-LinkCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/linkcase")
    public ResponseEntity<CaseDTO> linkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.linkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/linkcasebatch")
    public ResponseEntity<Boolean> linkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.linkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-MobLinkCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/moblinkcase")
    public ResponseEntity<CaseDTO> mobLinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.mobLinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/moblinkcasebatch")
    public ResponseEntity<Boolean> mobLinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.mobLinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-RunCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/runcase")
    public ResponseEntity<CaseDTO> runCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.runCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/runcasebatch")
    public ResponseEntity<Boolean> runCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.runCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-RunCases-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/runcases")
    public ResponseEntity<CaseDTO> runCasesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.runCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Save-all')")
    @ApiOperation(value = "根据产品需求模块需求保存测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求保存测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/save")
    public ResponseEntity<Boolean> saveByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        return ResponseEntity.status(HttpStatus.OK).body(caseService.save(domain));
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-Save-all')")
    @ApiOperation(value = "根据产品需求模块需求批量保存测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求批量保存测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/savebatch")
    public ResponseEntity<Boolean> saveBatchByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domainlist=caseMapping.toDomain(casedtos);
        for(Case domain:domainlist){
             domain.setStory(story_id);
        }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestRunCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testruncase")
    public ResponseEntity<CaseDTO> testRunCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testRunCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/testruncasebatch")
    public ResponseEntity<Boolean> testRunCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.testRunCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestRunCases-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testruncases")
    public ResponseEntity<CaseDTO> testRunCasesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testRunCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-TestsuitelinkCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/testsuitelinkcase")
    public ResponseEntity<CaseDTO> testsuitelinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.testsuitelinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/testsuitelinkcasebatch")
    public ResponseEntity<Boolean> testsuitelinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.testsuitelinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinkcase")
    public ResponseEntity<CaseDTO> unlinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/unlinkcasebatch")
    public ResponseEntity<Boolean> unlinkCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.unlinkCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkCases-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinkcases")
    public ResponseEntity<CaseDTO> unlinkCasesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkSuiteCase-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinksuitecase")
    public ResponseEntity<CaseDTO> unlinkSuiteCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkSuiteCase(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @ApiOperation(value = "批量处理[根据产品需求模块需求测试用例]", tags = {"测试用例" },  notes = "批量处理[根据产品需求模块需求测试用例]")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/unlinksuitecasebatch")
    public ResponseEntity<Boolean> unlinkSuiteCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody List<CaseDTO> casedtos) {
        List<Case> domains = caseMapping.toDomain(casedtos);
        boolean result = caseService.unlinkSuiteCaseBatch(domains);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-UnlinkSuiteCases-all')")
    @ApiOperation(value = "根据产品需求模块需求测试用例", tags = {"测试用例" },  notes = "根据产品需求模块需求测试用例")
	@RequestMapping(method = RequestMethod.POST, value = "/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/{case_id}/unlinksuitecases")
    public ResponseEntity<CaseDTO> unlinkSuiteCasesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @PathVariable("case_id") Long case_id, @RequestBody CaseDTO casedto) {
        Case domain = caseMapping.toDomain(casedto);
        domain.setStory(story_id);
        domain = caseService.unlinkSuiteCases(domain) ;
        casedto = caseMapping.toDto(domain);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchBatchNew-all')")
	@ApiOperation(value = "根据产品需求模块需求获取批量新建用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取批量新建用例")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchbatchnew")
	public ResponseEntity<List<CaseDTO>> fetchCaseBatchNewByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchBatchNew(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchBatchNew-all')")
	@ApiOperation(value = "根据产品需求模块需求查询批量新建用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询批量新建用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchbatchnew")
	public ResponseEntity<Page<CaseDTO>> searchCaseBatchNewByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchBatchNew(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurOpenedCase-all')")
	@ApiOperation(value = "根据产品需求模块需求获取累计创建的用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取累计创建的用例")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcuropenedcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurOpenedCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurOpenedCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurOpenedCase-all')")
	@ApiOperation(value = "根据产品需求模块需求查询累计创建的用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询累计创建的用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcuropenedcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurOpenedCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurOpenedCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurSuite-all')")
	@ApiOperation(value = "根据产品需求模块需求获取套件关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcursuite")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurSuiteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurSuite(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurSuite-all')")
	@ApiOperation(value = "根据产品需求模块需求查询套件关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcursuite")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurSuiteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurSuite(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurTestTask-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试单关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchcurtesttask")
	public ResponseEntity<List<CaseDTO>> fetchCaseCurTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurTestTask(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchCurTestTask-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试单关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchcurtesttask")
	public ResponseEntity<Page<CaseDTO>> searchCaseCurTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchCurTestTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchDefault-all')")
	@ApiOperation(value = "根据产品需求模块需求获取DEFAULT", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchdefault")
	public ResponseEntity<List<CaseDTO>> fetchCaseDefaultByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchDefault(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchDefault-all')")
	@ApiOperation(value = "根据产品需求模块需求查询DEFAULT", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询DEFAULT")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchdefault")
	public ResponseEntity<Page<CaseDTO>> searchCaseDefaultByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchDefault(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchESBulk-all')")
	@ApiOperation(value = "根据产品需求模块需求获取ES批量的导入", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取ES批量的导入")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchesbulk")
	public ResponseEntity<List<CaseDTO>> fetchCaseESBulkByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchESBulk(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchESBulk-all')")
	@ApiOperation(value = "根据产品需求模块需求查询ES批量的导入", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询ES批量的导入")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchesbulk")
	public ResponseEntity<Page<CaseDTO>> searchCaseESBulkByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchESBulk(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联-按模块-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联-按模块-条目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联-按模块-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联-按模块-条目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求获取项目报告关联-按模块", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取项目报告关联-按模块")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmodulereportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseModuleRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchModuleRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求查询项目报告关联-按模块", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询项目报告关联-按模块")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmodulereportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseModuleRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchModuleRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchMyFavorites-all')")
	@ApiOperation(value = "根据产品需求模块需求获取我的收藏", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchmyfavorites")
	public ResponseEntity<List<CaseDTO>> fetchCaseMyFavoritesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchMyFavorites(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchMyFavorites-all')")
	@ApiOperation(value = "根据产品需求模块需求查询我的收藏", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询我的收藏")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchmyfavorites")
	public ResponseEntity<Page<CaseDTO>> searchCaseMyFavoritesByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchMyFavorites(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestSuite-all')")
	@ApiOperation(value = "根据产品需求模块需求获取套件关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtestsuite")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestSuiteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestSuite(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestSuite-all')")
	@ApiOperation(value = "根据产品需求模块需求查询套件关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询套件关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtestsuite")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestSuiteByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestSuite(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTask-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试单关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtesttask")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTask(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTask-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试单关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试单关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtesttask")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestTaskByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTask(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTaskProject-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试单关联用例（项目关联）", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试单关联用例（项目关联）")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchnotcurtesttaskproject")
	public ResponseEntity<List<CaseDTO>> fetchCaseNotCurTestTaskProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTaskProject(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchNotCurTestTaskProject-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试单关联用例（项目关联）", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试单关联用例（项目关联）")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchnotcurtesttaskproject")
	public ResponseEntity<Page<CaseDTO>> searchCaseNotCurTestTaskProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchNotCurTestTaskProject(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联用例-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联用例-条目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联用例-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联用例-条目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求获取项目报告关联用例-关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取项目报告关联用例-关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,@RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求查询项目报告关联用例-关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询项目报告关联用例-关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联-执行人", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联-执行人")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联-执行人", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联-执行人")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联-执行人-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联-执行人-条目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联-执行人-条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联-执行人-条目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求获取项目报告关联-执行人", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取项目报告关联-执行人")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunerreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunERRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunERRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求查询项目报告关联-执行人", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询项目报告关联-执行人")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunerreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunERRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunERRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联用例")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcase")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联用例", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联用例")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcase")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCaseByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求获取测试报告关联--执行结果条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取测试报告关联--执行结果条目")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcaseentry")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCaseEntry(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCaseEntry-all')")
	@ApiOperation(value = "根据产品需求模块需求查询测试报告关联--执行结果条目", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询测试报告关联--执行结果条目")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcaseentry")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCaseEntryByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCaseEntry(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求获取项目报告关联-执行结果", tags = {"测试用例" } ,notes = "根据产品需求模块需求获取项目报告关联-执行结果")
    @RequestMapping(method= RequestMethod.GET , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/fetchrunreportcase_project")
	public ResponseEntity<List<CaseDTO>> fetchCaseRunRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id,CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase_Project(context) ;
        List<CaseDTO> list = caseMapping.toDto(domains.getContent());
	    return ResponseEntity.status(HttpStatus.OK)
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','pms-Case-searchRunRePortCase_Project-all')")
	@ApiOperation(value = "根据产品需求模块需求查询项目报告关联-执行结果", tags = {"测试用例" } ,notes = "根据产品需求模块需求查询项目报告关联-执行结果")
    @RequestMapping(method= RequestMethod.POST , value="/products/{product_id}/productmodules/{productmodule_id}/stories/{story_id}/cases/searchrunreportcase_project")
	public ResponseEntity<Page<CaseDTO>> searchCaseRunRePortCase_ProjectByProductProductModuleStory(@PathVariable("product_id") Long product_id, @PathVariable("productmodule_id") Long productmodule_id, @PathVariable("story_id") Long story_id, @RequestBody CaseSearchContext context) {
        context.setN_story_eq(story_id);
        Page<Case> domains = caseService.searchRunRePortCase_Project(context) ;
	    return ResponseEntity.status(HttpStatus.OK)
                .body(new PageImpl(caseMapping.toDto(domains.getContent()), context.getPageable(), domains.getTotalElements()));
