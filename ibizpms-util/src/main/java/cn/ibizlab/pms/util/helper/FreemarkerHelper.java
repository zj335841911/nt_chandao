...
final public class FreemarkerHelper {
     ...
     * @return
     */
    final public static Configuration initConf(String dir) {
        if (StringHelper.isNullOrEmptyString(dir)) {
            return null;
        }
        ...
        try {
            ...
            conf.setTemplateLoader(new FileTemplateLoader(new File(dir)));
        } catch (IOException e) {
