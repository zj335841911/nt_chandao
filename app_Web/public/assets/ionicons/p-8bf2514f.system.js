System.register(['./p-28478b38.system.js'], function (r, e) {
    'use strict';
    var t, n, o, s, i, c;
    return {
        setters: [
        ...
        execute: function () {
            ...
            var w = r('p', function () {
                ...
                var r = Array.from(i.querySelectorAll('script')).find(function (r) {
                    return (
                        new RegExp('/' + c + '(\\.esm)?\\.js($|\\?|#)').test(r.src) ||
                        r.getAttribute('data-stencil-namespace') === c
                    );
                });
                var t = r['data-opts'] || {};
                ...
                {
                    t.resourcesUrl = new URL(
                        '.',
                        new URL(r.getAttribute('data-resources-url') || r.src, o.location.href)
                    ).href;
                    {
                        g(t.resourcesUrl, r);
                    }
                    ...
                    o[t] = function (s) {
                        ...
                        if (!a) {
                            ...
                            u.src = URL.createObjectURL(
                                new Blob(["import * as m from '" + c + "'; window." + t + '.m = m;'], {
