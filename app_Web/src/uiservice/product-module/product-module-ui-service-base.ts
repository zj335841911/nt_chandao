...
export default class ProductModuleUIServiceBase extends UIService {
     ...
     * @returns {Promise<any>}
     */
    public async ProductModule_RemoveModule(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '该模块及其子模块都会被删除，您确定删除吗？',
              onOk: () => {resolve(true);},
