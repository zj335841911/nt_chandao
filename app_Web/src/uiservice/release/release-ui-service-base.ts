...
export default class ReleaseUIServiceBase extends UIService {
     ...
     * @returns {Promise<any>}
     */
    public async Release_OneEdit(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                viewname: 'release-option-view', 
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.release.views.optionview.title'),
                placement: 'DRAWER_RIGHT',
            };
            openDrawer(view, data);
    }
