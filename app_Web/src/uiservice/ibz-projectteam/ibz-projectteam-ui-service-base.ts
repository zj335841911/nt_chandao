...
export default class IBZ_PROJECTTEAMUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set(':',{viewname:'maingridview_editrow',srfappde:'ibz_projectteams'});
     ...
     * @returns {Promise<any>}
     */
    public async IBZ_PROJECTTEAM_RemoveMember(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        Object.assign(context, { ibz_projectteam: '%ibz_projectteam%' });
        Object.assign(params, { id: '%ibz_projectteam%' });
        ...
        const backend = () => {
            const curService:IBZ_PROJECTTEAMService =  new IBZ_PROJECTTEAMService();
     ...
     * @returns {Promise<any>}
     */
    public async IBZ_PROJECTTEAM_ManagerMember(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            ...
            const view: any = {
                ...
                height: 0, 
                width: 0,  
                title: actionContext.$t('entities.ibz_projectteam.views.maingridview_editrow.title'),
