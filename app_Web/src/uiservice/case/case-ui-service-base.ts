...
export default class CaseUIServiceBase extends UIService {
    ...
    public initDeMainStateOPPrivsMap(){
        ...
        this.allDeMainStateOPPrivsMap.set('blocked__fail',Object.assign({'CASECOF':0,'CASERESULT':0,'CASERUN':0,'CASETOBUG':0,'CONFIRM':0,'CREATE':0,'DELETE':0,'EDIT':0,'READ':0,'RESULT':0,'RUN':0,'TOBUG':0,'UNLINK':0,'UPDATE':0},{'UNLINK':1,'TOBUG':1,'SRFUR__CASE_DELETE_BUT':1,'RESULT':1,'CASETOBUG':1,'CASERUN':1,'SRFUR__CASE_CASECOF_BUT':1,'SRFUR__CASE_CONFIRM_BUT':1,'RUN':1,'EDIT':1,'CASERESULT':1,}));
