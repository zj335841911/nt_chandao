...
export default class TestResultUIServiceBase extends UIService {
    ...
    public initViewMap(){
        ...
        this.allViewMap.set(':',{viewname:'testtaskmeditview9',srfappde:'testresults'});
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${appDataEntity.getMajorPSAppDEField(...  [in template "TEMPLCODE_en_US" at line 144, column 107]
----
