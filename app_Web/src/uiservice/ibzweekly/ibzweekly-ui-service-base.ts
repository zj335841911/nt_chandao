...
export default class IBZWEEKLYUIServiceBase extends UIService {
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_jugCreate(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let data: any = {};
        let parentContext:any = {};
        let parentViewParam:any = {};
        const _this: any = actionContext;
        ...
        const backend = () => {
            const curService:IBZWEEKLYService =  new IBZWEEKLYService();
            curService.JugThisWeekCreateWeekly(context,data, false).then((response: any) => {
                if (!response || response.status !== 200) {
                    actionContext.$Notice.error({ title: '错误', desc: response.message });
                    return;
                }
                ...
                if (this.IbzWeekly_create && this.IbzWeekly_create instanceof Function) {
                    this.IbzWeekly_create(_args,context, params, $event, xData,actionContext);
                }
                return response;
            }).catch((response: any) => {
                if (!response || !response.status || !response.data) {
     ...
     * @returns {Promise<any>}
     */
    public async IbzWeekly_submit(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
