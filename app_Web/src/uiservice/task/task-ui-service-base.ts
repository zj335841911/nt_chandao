...
export default class TaskUIServiceBase extends UIService {
    ...
    public async Task_TaskToBug(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        let parentViewParam:any = {};
        const _this: any = actionContext;
        Object.assign(context,{MAILTO:"%mailto%",ASSIGNEDTO:"%assignedto%",TASK:"%task%",STORYNAME:"%storyname%",MODULE:"%module%",CURPROJECT:"%project%",STORY:"%story%",PROJECT:"%project%",COLOR:"%color%",BRANCH:"0",TITLE:"%name%"});
        Object.assign(params,{mailto:"%mailto%",story:"%story%",assignedto:"%assignedto%",project:"%project%",title:"%name%",module:"%module%",curproject:"%project%",color:"%color%",task:"%task%",branch:"0",storyname:"%storyname%"});
        const _args: any[] = Util.deepCopy(args);
        const actionTarget: string | null = 'SINGLEKEY';
        Object.assign(context, { task: '%task%' });
        Object.assign(params, { id: '%task%' });
