...
export default class StoryUIServiceBase extends UIService {
     ...
     * @returns {Promise<any>}
     */
    public async Story_buildUnlinkMultiStories(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        let confirmResult:boolean = await new Promise((resolve: any, reject: any) => {
          actionContext.$Modal.confirm({
              title: '警告',
              content: '是否移除关联需求？',
        ...
        const backend = () => {
            const curService:StoryService =  new StoryService();
            curService.BuildBatchUnlinkStory(context,data, true).then((response: any) => {
                if (!response || response.status !== 200) {
                    actionContext.$Notice.error({ title: '错误', desc: response.message });
                    return;
                }
     ...
     * @returns {Promise<any>}
     */
    public async Story_Activite(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
    ...
    public async Story_buildUnlinkStory(args: any[],context:any = {}, params:any = {}, $event?: any, xData?: any,actionContext?: any,srfParentDeName?:string){
        ...
        let parentViewParam:any = {};
        const _this: any = actionContext;
        Object.assign(context,{BUILD:"%srfparentkey%",PRODUCT:"null"});
        Object.assign(params,{product:"null",build:"%srfparentkey%"});
        const _args: any[] = Util.deepCopy(args);
        const actionTarget: string | null = 'SINGLEKEY';
        Object.assign(context, { story: '%story%' });
        Object.assign(params, { id: '%story%' });
