 ...
 *
 * @export
 * @class IBZ_CASESTATSUIServiceBase
 */
export default class IBZ_CASESTATSUIServiceBase extends UIService {

    /**
     * 是否支持工作流
     * 
     * @memberof  IBZ_CASESTATSUIServiceBase
     */
     ...
     * @memberof  IBZ_CASESTATSUIServiceBase
     */
    public dataService:IBZ_CASESTATSService = new IBZ_CASESTATSService();
    ...
    /**
     * Creates an instance of  IBZ_CASESTATSUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZ_CASESTATSUIServiceBase
     */
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBZ_CASESTATSAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibz_casestats:srfkey});
