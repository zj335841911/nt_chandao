...
export default class DocLibUIServiceBase extends UIService {
     ...
     * @returns {Promise<any>}
     */
    public async DocLib_MyStarQuickAccess(args: any[], context:any = {} ,params: any={}, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        const parameters: any[] = [
            { pathName: 'docs', parameterName: 'doc' },
            { pathName: 'mystorygridview', parameterName: 'mystorygridview' },
        ];
        const openIndexViewTab = (data: any) => {
            const routePath = actionContext.$viewTool.buildUpRoutePath(actionContext.$route, context, deResParameters, parameters, _args, data);
            actionContext.$router.push(routePath);
