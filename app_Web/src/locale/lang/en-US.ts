...
import ibztaskteam_en_US from '@locale/lanres/ibztask-team/ibztask-team_en_US';
...
import suitecase_en_US from '@locale/lanres/suite-case/suite-case_en_US';
import burn_en_US from '@locale/lanres/burn/burn_en_US';
...
import usertpl_en_US from '@locale/lanres/user-tpl/user-tpl_en_US';
...
import ibzprojectmember_en_US from '@locale/lanres/ibz-project-member/ibz-project-member_en_US';
...
import ibztaskestimate_en_US from '@locale/lanres/ibztask-estimate/ibztask-estimate_en_US';
import productline_en_US from '@locale/lanres/product-line/product-line_en_US';
import testreport_en_US from '@locale/lanres/test-report/test-report_en_US';
import projectstats_en_US from '@locale/lanres/project-stats/project-stats_en_US';
import testrun_en_US from '@locale/lanres/test-run/test-run_en_US';
