...
import ibizpro_productweekly_zh_CN from '@locale/lanres/entities/ibizpro-productweekly/ibizpro-productweekly_zh_CN';
...
function getAppLocale(){
    const data: any = {
        ...
        entities: {
            ...
            ibizpro_productweekly: ibizpro_productweekly_zh_CN(),
