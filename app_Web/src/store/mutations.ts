 ...
 * @param param1
 */
export const updateCodeList = (
  state: any,
  { srfkey, items }: { srfkey: string; items: any[] }
) => {
  const index = state.codelists.findIndex((_codelist: any) =>
    Object.is(_codelist.srfkey, srfkey)
  );
  if (index === -1) {
 ...
 */
export const setViewSplit = (
  state: any,
  args: { viewSplit: number; viewUID: string }
) => {
 ...
 * @param localdata
 */
export const addCopyData = (
  state: any,
  args: { srfkey: string; copyData: any }
) => {
 ...
 * @param args
 */
export const addOrgData = (
  state: any,
  args: { srfkey: string; orgData: any }
) => {
 ...
 * @param args
 */
export const addDepData = (
  state: any,
  args: { srfkey: string; depData: any }
) => {
