...
export const getResourceData = (state: any) => (resourcetag: string) => {
  let itemIndex: any = state.resourceData.findIndex(
    (unirescode: any, objIndex: any, objs: any) => {
...
export const getMenuData = (state: any) => (menutag: string) => {
  let itemIndex: any = state.menuData.findIndex(
    (menucode: any, objIndex: any, objs: any) => {
...
export const getAuthMenu = (state: any) => (menu: any) => {
  if (state.enablePermissionValid) {
    ...
    let menuIndex: any;
    resourceIndex = state.resourceData.findIndex(
      (resourcetag: any, objIndex: any, objs: any) => {
        return Object.is(menu.resourcetag, resourcetag);
      }
    );
    menuIndex = state.menuData.findIndex(
      (menutag: any, objIndex: any, objs: any) => {
