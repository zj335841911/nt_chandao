...
export class StudioViewStyle2Base extends StudioViewBase {
   ...
   * @memberof StudioViewStyle2Base
   */
  protected getContainerClass(classNames?: {
    [str: string]: boolean;
  }): { [str: string]: boolean } {
    ...
    return [
      this.$slots.toolbar ? (
        <div class="view-top" key="view-top">
          {this.$slots.toolbar ? (
            <div class="view-toolbar">{this.$slots.toolbar}</div>
          ) : null}
      ...
      this.$slots.topMessage ? (
        <div class="view-top-messages">{this.$slots.topMessage}</div>
      ) : null,
      this.isShowHeader ? (
        <div
          class={{ "view-header": true, "hidden-top": !this.$slots.toolbar }}
          key="view-header"
        >
          {this.$slots.title ? (
          ...
          {this.$slots.dataPanel ? (
            <div class="data-panel">{this.$slots.dataPanel}</div>
          ) : null}
          {this.$slots.quickGroupSearch ? (
      ...
      this.$slots.quickGroupTab ? (
        <div class="quick-group-tab">{this.$slots.quickGroupTab}</div>
      ) : null,
      <div
        class={{
          "view-content": true,
          "show-search-form": this.$slots.searchForm
        }}
        key="view-content"
      >
      ...
      this.$slots.bottomMessage ? (
        <div class="view-bottom-messages">{this.$slots.bottomMessage}</div>
      ) : null,
      this.$slots.footer ? (
