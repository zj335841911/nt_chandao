    ...
    return (
      <div
        ...
        class={{
          ...
          "hidden-bottom":
            !this.$uiState.layoutState.contentBottomShow ||
            !this.$slots.content_bottom
        }}
      >
        <split
          mode="vertical"
          v-model={this.$uiState.layoutState.contentVerticalSplit}
          max={0.1}
        >
          ...
          {this.$slots.content_bottom ? (
            <div slot="bottom" class="app-content-bottom">
              <div
                class="app-content-bottom-close"
                on-click={() => this.changeBottom(false)}
              >
  ...
  public render(): VNode {
    ...
    if (this.$uiState.layoutState.styleMode === "STYLE2") {
      ...
      content = this.$slots.content_left ? (
        <split
          class={{
            "app-content-split": true,
            "hidden-left": !this.$uiState.layoutState.leftExpContentShow
          }}
