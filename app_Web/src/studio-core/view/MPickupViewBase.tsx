...
export class MPickupViewBase extends PickupViewBase {
  ...
  protected viewMounted(): void {
    if (this.viewparams.selectedData) {
      this.engine.onCtrlEvent(
        "pickupviewpanel",
        "selectionchange",
        this.viewparams.selectedData
      );
      this.onCLickRight();
    }
  }
  ...
  public selectionsClick(item: any): void {
    ...
    const removeSelect: boolean = this.viewSelections.some(
      (selection: any) => selection._select
    );
  ...
  public onCLickLeft(): void {
    ...
    _selectiions.forEach((item: any) => {
      ...
      const index = this.viewSelections.findIndex((selection: any) =>
  ...
  public onCLickRight(): void {
    Object.values(this.containerModel).forEach((model: any) => {
      ...
      this.viewSelections = this.removeDuplicates([
        ...newSelections,
        ...this.viewSelections
      ]);
    });
