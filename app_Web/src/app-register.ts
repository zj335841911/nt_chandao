...
export const AppComponents = {
  install(v: any, opt: any) {
    ...
    v.component("app-rich-text-editor", () =>
      import("./components/app-rich-text-editor/app-rich-text-editor.vue")
    );
    ...
    v.component("app-portal-design", () =>
      import("./components/app-portal-design/app-portal-design.vue")
    );
    ...
    v.component("app-data-upload", () =>
      import("./components/app-data-upload/app-data-upload.vue")
    );
    ...
    v.component("app-department-select", () =>
      import("./components/app-department-select/app-department-select.vue")
    );
    v.component("app-org-select", () =>
      import("./components/app-org-select/app-org-select.vue")
    );
