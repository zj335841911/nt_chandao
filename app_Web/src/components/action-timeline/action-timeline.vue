            ...
            <td>
              <div class="timeline">
                ...
                >
                  ...
                  <strong>
                    <template
                      v-for="(identitylink, len) in usertask.identitylinks"
                    >
                      <template v-if="identitylink.displayname">
                        {{ identitylink.displayname }}
                        <template
                          v-if="len != usertask.identitylinks.length - 1"
                        >
                          、
                        </template>
                      </template>
                ...
                <template v-else>
                  <ul class="action-timeline-wrapper">
                    ...
                    <template v-else>
                      <template
                        v-for="(comment, commentIndex) in usertask.comments"
                      >
