...
import TestCaseStatsService from './test-case-stats-grid-service';
 ...
 */
export class TestCaseStatsGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * @memberof TestCaseStatsGridBase
     */
    public appEntityService: IBZ_CASESTATSService = new IBZ_CASESTATSService({ $store: this.$store });
     ...
     * @memberof TestCaseStatsBase
     */
    protected localStorageTag: string = 'ibz_casestats_testcasestats_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'modulename',
            label: '模块名称',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.modulename',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'totalcase',
            label: '总用例数',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.totalcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'passcase',
            label: '通过',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.passcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'failcase',
            label: '失败',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.failcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'blockedcase',
            label: '阻塞',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.blockedcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalruncase',
            label: '总执行数',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.totalruncase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'passrate',
            label: '用例通过率',
            langtag: 'entities.ibz_casestats.testcasestats_grid.columns.passrate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['modulename','totalcase','passcase','failcase','blockedcase','totalruncase','passrate'];
        if(row && row.children) {
