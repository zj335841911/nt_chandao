...
import TestCaseStatsModel from './test-case-stats-grid-model';


/**
 * TestCaseStats 部件服务对象
 *
 * @export
 * @class TestCaseStatsService
 */
export default class TestCaseStatsService extends ControlService {

    /**
     * 测试用例统计服务对象
     *
     * @type {IBZ_CASESTATSService}
     * @memberof TestCaseStatsService
     */
    public appEntityService: IBZ_CASESTATSService = new IBZ_CASESTATSService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of TestCaseStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof TestCaseStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TestCaseStatsModel();
    }
