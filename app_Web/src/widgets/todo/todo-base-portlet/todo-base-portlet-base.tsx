 ...
 */
export class TodoBasePortletBase extends MainControlBase {
     ...
     * @memberof TodoBasePortletBase
     */
    public service: TodoBaseService = new TodoBaseService({ $store: this.$store });
