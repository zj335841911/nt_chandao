...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.todo.assigntoform_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false">
    
    <row>
        <i-col v-show="detailsModel.assignto.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 24, offset: 0 }">
    <app-form-item name='assignto' :itemRules="this.rules.assignto" class='' :caption="$t('entities.todo.assigntoform_form.details.assignto')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.assignto.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.assignto" :data="data" :itemParam="{}" :disabled="detailsModel.assignto.disabled"  tag='UserRealName' codelistType='DYNAMIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.date.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 16, offset: 0 }">
    <app-form-item name='date' :itemRules="this.rules.date" class='' :caption="$t('entities.todo.assigntoform_form.details.date')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.date.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.future.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='future' :itemRules="this.rules.future" class='' :caption="$t('entities.todo.assigntoform_form.details.future')" uiStyle="DEFAULT" :labelWidth="0" :isShowCaption="false" :error="detailsModel.future.error" :isEmptyCaption="false" labelPos="NONE">
    <app-checkbox-list v-model="data.future" :disabled="detailsModel.future.disabled"  tag='Date_disable' codelistType='STATIC'   mode="" name="future" style=""></app-checkbox-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.begin.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 10, offset: 0 }">
    <app-form-item name='begin' :itemRules="this.rules.begin" class='' :caption="$t('entities.todo.assigntoform_form.details.begin')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.begin.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.begin" :data="data" :itemParam="{}" :disabled="detailsModel.begin.disabled"  tag='BeginendDropList' codelistType='STATIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.end.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 6, offset: 0 }">
    <app-form-item name='end' :itemRules="this.rules.end" class='' :caption="$t('entities.todo.assigntoform_form.details.end')" uiStyle="DEFAULT" :labelWidth="10" :isShowCaption="true" :error="detailsModel.end.error" :isEmptyCaption="false" labelPos="LEFT">
     <dropdown-list v-model="data.end" :data="data" :itemParam="{}" :disabled="detailsModel.end.disabled"  tag='BeginendDropList' codelistType='STATIC' placeholder='请选择...' style=""></dropdown-list>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.lbldisabledate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='lbldisabledate' :itemRules="this.rules.lbldisabledate" class='' :caption="$t('entities.todo.assigntoform_form.details.lbldisabledate')" uiStyle="DEFAULT" :labelWidth="0" :isShowCaption="false" :error="detailsModel.lbldisabledate.error" :isEmptyCaption="false" labelPos="NONE">
    <app-checkbox-list v-model="data.lbldisabledate" :disabled="detailsModel.lbldisabledate.disabled"  tag='Beginend_disable' codelistType='STATIC'   mode="" name="lbldisabledate" style=""></app-checkbox-list>
</app-form-item>
...
export default class AssigntoFormBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof AssigntoForm
     */
     ...
     * @memberof AssigntoForm
     */
    protected service: AssigntoFormService = new AssigntoFormService({ $store: this.$store });
    ...
    protected rules: any = {
        ...
        begin: [
            { type: 'number', message: '起止时间 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '起止时间 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '起止时间 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '起止时间 值不能为空', trigger: 'blur' },
        ],
        end: [
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '指派给', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.todo.assigntoform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        future: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'future', visible: true, isShowCaption: false, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        end: new FormItemModel({ caption: '~', detailType: 'FORMITEM', name: 'end', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        lbldisabledate: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'lbldisabledate', visible: true, isShowCaption: false, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    /**
     * 监控表单属性 lbldisabledate 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof AssigntoForm
     */
    @Watch('data.lbldisabledate')
    onLbldisabledateChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'lbldisabledate', newVal: newVal, oldVal: oldVal });
    }
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof AssigntoForm
     */
    ...
    private load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'TodoAssignToView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    protected loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'TodoAssignToView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    protected autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'TodoAssignToView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    private remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'TodoAssignToView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'TodoAssignToView视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.todo || Object.is(arg.todo, '')) {
            return;
        }
...
<style lang='less'>
@import './assignto-form-form.less';
</style>