...
export class DashboardMainEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        name: new FormItemModel({ caption: '描述', detailType: 'FORMITEM', name: 'name', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
