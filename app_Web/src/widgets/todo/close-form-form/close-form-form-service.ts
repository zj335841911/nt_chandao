...
import CloseFormModel from './close-form-form-model';
 ...
 *
 * @export
 * @class CloseFormService
 */
export default class CloseFormService extends ControlService {

    /**
     * 待办事宜表服务对象
     *
     * @type {TodoService}
     * @memberof CloseFormService
     */
    ...
    /**
     * Creates an instance of CloseFormService.
     * 
     * @param {*} [opts={}]
     * @memberof CloseFormService
     */
