...
import ActiviteFROMModel from './activite-from-form-model';
...
export default class ActiviteFROMService extends ControlService {
    ...
    /**
     * Creates an instance of ActiviteFROMService.
     * 
     * @param {*} [opts={}]
     * @memberof ActiviteFROMService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ActiviteFROMModel();
    }
