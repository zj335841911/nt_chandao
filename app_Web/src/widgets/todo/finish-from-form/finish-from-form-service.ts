...
import FinishFromModel from './finish-from-form-model';
 ...
 *
 * @export
 * @class FinishFromService
 */
export default class FinishFromService extends ControlService {

    /**
     * 待办事宜表服务对象
     *
     * @type {TodoService}
     * @memberof FinishFromService
     */
    ...
    /**
     * Creates an instance of FinishFromService.
     * 
     * @param {*} [opts={}]
     * @memberof FinishFromService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new FinishFromModel();
    }
