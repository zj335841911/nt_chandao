...
import CalendarMainModel from './calendar-main-form-model';
 ...
 *
 * @export
 * @class CalendarMainService
 */
export default class CalendarMainService extends ControlService {

    /**
     * 待办服务对象
     *
     * @type {TodoService}
     * @memberof CalendarMainService
     */
    ...
    /**
     * Creates an instance of CalendarMainService.
     * 
     * @param {*} [opts={}]
     * @memberof CalendarMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CalendarMainModel();
    }
