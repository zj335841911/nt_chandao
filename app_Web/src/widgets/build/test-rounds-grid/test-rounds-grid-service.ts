...
import TestRoundsModel from './test-rounds-grid-model';
 ...
 *
 * @export
 * @class TestRoundsService
 */
export default class TestRoundsService extends ControlService {
    ...
    /**
     * Creates an instance of TestRoundsService.
     * 
     * @param {*} [opts={}]
     * @memberof TestRoundsService
     */
