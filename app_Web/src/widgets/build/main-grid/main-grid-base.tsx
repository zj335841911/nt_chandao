...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_ud66a79a_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u515beb6_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u88d879a_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u1402a26_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u399f905_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    public allExportColumns: any[] = [
        {
            name: 'id',
            label: 'ID',
            langtag: 'entities.build.main_grid.exportColumns.id',
            show: true,
        },
        {
            name: 'productname',
            label: '产品名称',
            langtag: 'entities.build.main_grid.exportColumns.productname',
            show: true,
        },
        {
            name: 'name',
            label: '名称编号',
            langtag: 'entities.build.main_grid.exportColumns.name',
            show: true,
        },
        {
            name: 'scmpath',
            label: '源代码地址',
            langtag: 'entities.build.main_grid.exportColumns.scmpath',
            show: true,
        },
        {
            name: 'filepath',
            label: '下载地址',
            langtag: 'entities.build.main_grid.exportColumns.filepath',
            show: true,
        },
        {
            name: 'date',
            label: '打包日期',
            langtag: 'entities.build.main_grid.exportColumns.date',
            show: true,
        },
        {
            name: 'builder',
            label: '构建者',
            langtag: 'entities.build.main_grid.exportColumns.builder',
            show: true,
        },
        {
            name: 'product',
            label: '产品',
            langtag: 'entities.build.main_grid.exportColumns.product',
            show: true,
        },
        {
            name: 'project',
            label: '所属项目',
            langtag: 'entities.build.main_grid.exportColumns.project',
            show: true,
        },
    ]
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('linkStories', tag)) {
            this.grid_uagridcolumn1_ud66a79a_click(row, tag, $event);
        }
        if(Object.is('submitToTesting', tag)) {
            this.grid_uagridcolumn1_u515beb6_click(row, tag, $event);
        }
        if(Object.is('viewBugs', tag)) {
            this.grid_uagridcolumn1_u88d879a_click(row, tag, $event);
        }
        if(Object.is('editBuild', tag)) {
            this.grid_uagridcolumn1_u1402a26_click(row, tag, $event);
        }
        if(Object.is('Delete', tag)) {
            this.grid_uagridcolumn1_u399f905_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','productname','name','scmpath','filepath','date','builder','uagridcolumn1'];
        if(row && row.children) {
