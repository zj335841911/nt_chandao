...
import TestBuildReleaseModel from './test-build-release-form-model';


/**
 * TestBuildRelease 部件服务对象
 *
 * @export
 * @class TestBuildReleaseService
 */
export default class TestBuildReleaseService extends ControlService {

    /**
     * 版本服务对象
     *
     * @type {BuildService}
     * @memberof TestBuildReleaseService
     */
    ...
    /**
     * Creates an instance of TestBuildReleaseService.
     * 
     * @param {*} [opts={}]
     * @memberof TestBuildReleaseService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TestBuildReleaseModel();
    }
