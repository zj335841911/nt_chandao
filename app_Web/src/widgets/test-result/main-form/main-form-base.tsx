...
export class MainEditFormBase extends EditFormControlBase {
 ...
 tag: 'ToBug',actiontarget: 'SINGLEKEY',noprivdisplaymode:2,dataaccaction:'SRFUR__CUTINTBEHAVIOR',visible: true,disabled: false} }),
        ...
        srfmajortext: new FormItemModel({ caption: '用例名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        date: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'date', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),

        lastrunner: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'lastrunner', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),

        caseresult: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'caseresult', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),

        formitem: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'formitem', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),

        title: new FormItemModel({ caption: '用例名称', detailType: 'FORMITEM', name: 'title', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        job: new FormItemModel({ caption: '构建任务', detailType: 'FORMITEM', name: 'job', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        case: new FormItemModel({ caption: '用例', detailType: 'FORMITEM', name: 'case', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
