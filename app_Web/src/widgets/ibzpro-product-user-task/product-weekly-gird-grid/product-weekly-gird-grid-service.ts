...
import ProductWeeklyGirdModel from './product-weekly-gird-grid-model';


/**
 * ProductWeeklyGird 部件服务对象
 *
 * @export
 * @class ProductWeeklyGirdService
 */
export default class ProductWeeklyGirdService extends ControlService {

    /**
     * 产品汇报用户任务服务对象
     *
     * @type {IbzproProductUserTaskService}
     * @memberof ProductWeeklyGirdService
     */
    ...
    /**
     * Creates an instance of ProductWeeklyGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductWeeklyGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductWeeklyGirdModel();
    }
