...
import ProductMonthlyGirdModel from './product-monthly-gird-grid-model';


/**
 * ProductMonthlyGird 部件服务对象
 *
 * @export
 * @class ProductMonthlyGirdService
 */
export default class ProductMonthlyGirdService extends ControlService {

    /**
     * 产品汇报用户任务服务对象
     *
     * @type {IbzproProductUserTaskService}
     * @memberof ProductMonthlyGirdService
     */
    public appEntityService: IbzproProductUserTaskService = new IbzproProductUserTaskService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ProductMonthlyGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductMonthlyGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductMonthlyGirdModel();
    }
