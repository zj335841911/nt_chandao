...
import ProductMonthlyGirdService from './product-monthly-gird-grid-service';
 ...
 * @extends {ProductMonthlyGirdGridBase}
 */
export class ProductMonthlyGirdGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductMonthlyGirdGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProductMonthlyGirdService}
     * @memberof ProductMonthlyGirdGridBase
     */
    public service: ProductMonthlyGirdService = new ProductMonthlyGirdService({ $store: this.$store });
     ...
     * @memberof ProductMonthlyGirdBase
     */  
     ...
     * @memberof ProductMonthlyGirdBase
     */
    protected localStorageTag: string = 'ibizpro_productusertask_productmonthlygird_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.account',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'taskname',
            label: '任务名称',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.taskname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'tasktype',
            label: '任务类型',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.tasktype',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'consumed',
            label: '当天消耗',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.consumed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'eststarted',
            label: '预计开始',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.eststarted',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deadline',
            label: '截止日期',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.deadline',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'progressrate',
            label: '进度',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.progressrate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'delaydays',
            label: '延期天数',
            langtag: 'entities.ibzproproductusertask.productmonthlygird_grid.columns.delaydays',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
