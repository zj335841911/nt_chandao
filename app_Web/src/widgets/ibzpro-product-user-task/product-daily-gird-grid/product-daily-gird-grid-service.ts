...
import ProductDailyGirdModel from './product-daily-gird-grid-model';


/**
 * ProductDailyGird 部件服务对象
 *
 * @export
 * @class ProductDailyGirdService
 */
export default class ProductDailyGirdService extends ControlService {

    /**
     * 产品汇报用户任务服务对象
     *
     * @type {IbzproProductUserTaskService}
     * @memberof ProductDailyGirdService
     */
    ...
    /**
     * Creates an instance of ProductDailyGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductDailyGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductDailyGirdModel();
    }
