...
export default class BurnDown2Base extends Vue implements ControlInterface {
     ...
     * @memberof BurnDown2
     */
    protected service: BurnDown2Service = new BurnDown2Service({ $store: this.$store });
