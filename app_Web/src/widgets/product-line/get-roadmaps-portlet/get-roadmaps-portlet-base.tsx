...
import ProductLineUIService from '@/uiservice/product-line/product-line-ui-service';
...
export class GetRoadmapsPortletBase extends MainControlBase {
     ...
     * @memberof GetRoadmapsPortletBase
     */
    public appEntityService: ProductLineService = new ProductLineService({ $store: this.$store });
     ...
     * @memberof GetRoadmapsPortletBase
     */
    protected appDeName: string = 'productline';
