...
import ProductInputTableModel from './product-input-table-grid-model';


/**
 * ProductInputTable 部件服务对象
 *
 * @export
 * @class ProductInputTableService
 */
export default class ProductInputTableService extends ControlService {

    /**
     * 产品统计服务对象
     *
     * @type {ProductStatsService}
     * @memberof ProductInputTableService
     */
    ...
    /**
     * Creates an instance of ProductInputTableService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductInputTableService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductInputTableModel();
    }
