...
import ProductCompleteTableModel from './product-complete-table-grid-model';


/**
 * ProductCompleteTable 部件服务对象
 *
 * @export
 * @class ProductCompleteTableService
 */
export default class ProductCompleteTableService extends ControlService {

    /**
     * 产品统计服务对象
     *
     * @type {ProductStatsService}
     * @memberof ProductCompleteTableService
     */
    ...
    /**
     * Creates an instance of ProductCompleteTableService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductCompleteTableService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductCompleteTableModel();
    }
