<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='productstats_testmain2' style="">
...
<div v-show="detailsModel.assigntomebugcnt.visible">
...
<div v-show="detailsModel.unconfirmbugcnt.visible">
...
<div v-show="detailsModel.notclosedbugcnt.visible">
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'productstats_testmain2',popTitle:'嵌入测试统计'});
    }
