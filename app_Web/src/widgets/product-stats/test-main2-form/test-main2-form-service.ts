...
import TestMain2Model from './test-main2-form-model';
 ...
 *
 * @export
 * @class TestMain2Service
 */
export default class TestMain2Service extends ControlService {

    /**
     * 产品统计服务对象
     *
     * @type {ProductStatsService}
     * @memberof TestMain2Service
     */
    ...
    /**
     * Creates an instance of TestMain2Service.
     * 
     * @param {*} [opts={}]
     * @memberof TestMain2Service
     */
