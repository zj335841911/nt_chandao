...
import OpenItemsModel from './open-items-grid-model';
 ...
 */
export default class OpenItemsService extends ControlService {

    /**
     * 产品统计服务对象
     *
     * @type {ProductStatsService}
     * @memberof OpenItemsService
     */
    ...
    /**
     * Creates an instance of OpenItemsService.
     * 
     * @param {*} [opts={}]
     * @memberof OpenItemsService
     */
