...
export class CustomSearchbarBase extends MainControlBase {
    ...
    public detailsModel: any = {
        'namelike': {
            label: '产品名称',
            localetag: 'entities.productstats.fields.name',
            name: 'namelike',
            prop: 'name',
            mode: 'LIKE',
            disabled: false
        ...
        'statuseq': {
            label: '状态',
            localetag: 'entities.productstats.fields.status',
            name: 'statuseq',
            prop: 'status',
            mode: 'EQ',
            disabled: false
        ...
        'typeeq': {
            label: '产品类型',
            localetag: 'entities.productstats.fields.type',
            name: 'typeeq',
            prop: 'type',
            mode: 'EQ',
            disabled: false
     ...
     * @memberof CustomBase
     */
    public appdeName: string = 'ProductStats';
     ...
     * @memberof CustomBase
     */
    public modelId: string = "searchbar_productstats_custom";
