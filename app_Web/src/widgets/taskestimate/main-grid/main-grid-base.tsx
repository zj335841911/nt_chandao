...
export class MainGridBase extends GridControlBase {
     ...
     */
    protected localStorageTag: string = 'zt_taskestimate_main_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            property: 'date',
            label: '日期',
            langtag: 'entities.taskestimate.main_grid.columns.date',
            show: true,
            util: 'PX',
            width: 100,
        },
        {
            ...
            property: 'consumed',
            label: '总计消耗',
            langtag: 'entities.taskestimate.main_grid.columns.consumed',
            show: true,
            util: 'PX',
            width: 100,
        },
        {
            ...
            property: 'left',
            label: '预计剩余',
            langtag: 'entities.taskestimate.main_grid.columns.left',
            show: true,
            util: 'PX',
            width: 100,
        },
        {
            ...
            property: 'work',
            label: '备注',
            langtag: 'entities.taskestimate.main_grid.columns.work',
            show: true,
            util: 'PX',
            width: 100,
        },
    ...
    public rules: any = {
        ...
        task: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任务 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '任务 值不能为空', trigger: 'blur' },
        ],
        left: [
