...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'zt_usertpl_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: '编号',
            langtag: 'entities.usertpl.main_grid.columns.id',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'title',
            label: '模板标题',
            langtag: 'entities.usertpl.main_grid.columns.title',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'type',
            label: '类型',
            langtag: 'entities.usertpl.main_grid.columns.type',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
