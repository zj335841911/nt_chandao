            ...
            title: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.usertpl.main_form.details.title')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.title.required,
            ...
            type: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.usertpl.main_form.details.type')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.type.required,
            ...
            content: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.usertpl.main_form.details.content')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.content.required,
            ...
            public: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.usertpl.main_form.details.public')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.public.required,
