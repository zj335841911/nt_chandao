...
export class MainDetailEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        desc: new FormItemModel({ caption: '描述', detailType: 'FORMITEM', name: 'desc', visible: true, isShowCaption: false, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
