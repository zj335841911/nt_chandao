    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ testtask: keys.join(';') }),Object.assign({ testtask: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
