<template>
    <div class='porlet main-dashboard-viewdashboard-container3' :style="{}">
...
export default class TestTaskMainDashboardViewdashboard_container3Base extends Vue implements ControlInterface {
     ...
     * @memberof MainDashboardViewdashboard_container3
     */
    protected service: MainDashboardViewdashboard_container3Service = new MainDashboardViewdashboard_container3Service({ $store: this.$store });
