...
export class MainEditFormBase extends EditFormControlBase {
    ...
    public rules():any{
        return {
        projecttname: [
            { required: this.detailsModel.projecttname.required, type: 'string', message: '项目 值不能为空', trigger: 'change' },
            { required: this.detailsModel.projecttname.required, type: 'string', message: '项目 值不能为空', trigger: 'blur' },
        ],
        buildname: [
            { required: this.detailsModel.buildname.required, type: 'string', message: '版本 值不能为空', trigger: 'change' },
            { required: this.detailsModel.buildname.required, type: 'string', message: '版本 值不能为空', trigger: 'blur' },
        ],
        begin: [
            { required: this.detailsModel.begin.required, type: 'string', message: '开始日期 值不能为空', trigger: 'change' },
            { required: this.detailsModel.begin.required, type: 'string', message: '开始日期 值不能为空', trigger: 'blur' },
        ],
        end: [
    ...
    public detailsModel: any = {
        ...
        projecttname: new FormItemModel({ caption: '项目', detailType: 'FORMITEM', name: 'projecttname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        buildname: new FormItemModel({ caption: '版本', detailType: 'FORMITEM', name: 'buildname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),
        ...
        begin: new FormItemModel({ caption: '开始日期', detailType: 'FORMITEM', name: 'begin', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        end: new FormItemModel({ caption: '结束日期', detailType: 'FORMITEM', name: 'end', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),
        ...
        status: new FormItemModel({ caption: '当前状态', detailType: 'FORMITEM', name: 'status', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
