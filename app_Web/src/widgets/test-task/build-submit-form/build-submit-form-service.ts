 ...
 *
 * @export
 * @class BuildSUBMITService
 */
export default class BuildSUBMITService extends ControlService {
    ...
    /**
     * Creates an instance of BuildSUBMITService.
     * 
     * @param {*} [opts={}]
     * @memberof BuildSUBMITService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BuildSUBMITModel();
    }
