...
export default class DashboardBase extends Vue implements ControlInterface {
     ...
     * @memberof Dashboard
     */
    protected service: DashboardService = new DashboardService({ $store: this.$store });
     ...
     * @memberof Dashboard
     */
    protected modelId:string = "dashboard_testtask_dashboard";
