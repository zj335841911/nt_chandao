            ...
            projecttname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testtask.mainedit_form.details.projecttname')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.projecttname.required,
            ...
            buildname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testtask.mainedit_form.details.buildname')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.buildname.required,
            ...
            begin: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testtask.mainedit_form.details.begin')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.begin.required,
            ...
            end: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testtask.mainedit_form.details.end')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.end.required,
            ...
            name: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testtask.mainedit_form.details.name')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.name.required,
