...
<i-col v-show="detailsModel.owner.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='owner'
:value="data.owner" tag='UserRealName' codelistType='DYNAMIC' renderMode="STR" valueSeparator="," textSeparator="," style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.pri.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='pri'
:value="data.pri" tag='Testtask__pri' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.status" tag='Testtask__status' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'基本信息'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'TestTaskEditView9_Info视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
