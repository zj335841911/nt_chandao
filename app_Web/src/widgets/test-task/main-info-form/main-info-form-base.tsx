...
export class MainInfoEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        projecttname: new FormItemModel({ caption: '所属项目', detailType: 'FORMITEM', name: 'projecttname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, disabled: false, enableCond: 3 }),
