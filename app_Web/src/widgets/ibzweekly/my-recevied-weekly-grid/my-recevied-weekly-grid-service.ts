...
import MyReceviedWeeklyModel from './my-recevied-weekly-grid-model';


/**
 * MyReceviedWeekly 部件服务对象
 *
 * @export
 * @class MyReceviedWeeklyService
 */
export default class MyReceviedWeeklyService extends ControlService {

    /**
     * 周报服务对象
     *
     * @type {IBZWEEKLYService}
     * @memberof MyReceviedWeeklyService
     */
    public appEntityService: IBZWEEKLYService = new IBZWEEKLYService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of MyReceviedWeeklyService.
     * 
     * @param {*} [opts={}]
     * @memberof MyReceviedWeeklyService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MyReceviedWeeklyModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.ibzweeklyid = Util.createUUID();
                }
