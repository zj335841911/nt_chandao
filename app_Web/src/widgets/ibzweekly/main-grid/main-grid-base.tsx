...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u31efdd1_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_ufd17a6f_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        // 界面行为
        const curUIService:IBZWEEKLYUIService  = new IBZWEEKLYUIService();
        curUIService.IbzWeekly_submitZZZ(datas,contextJO, paramJO,  $event, xData,this,"IBZWEEKLY");
    }
    ...
    public ActionModel: any = {
        edit: { name: 'edit',disabled: false, visible: true,noprivdisplaymode:1,dataaccaction: 'SRFUR__WEEKLY_SUBMIT_BUT', actiontarget: 'SINGLEKEY'},
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('edit', tag)) {
            this.grid_uagridcolumn1_u31efdd1_click(row, tag, $event);
        }
        if(Object.is('submitZZZ', tag)) {
            this.grid_uagridcolumn1_ufd17a6f_click(row, tag, $event);
        }
    }
