...
import ProjectWeeklyMainModel from './project-weekly-main-grid-model';


/**
 * ProjectWeeklyMain 部件服务对象
 *
 * @export
 * @class ProjectWeeklyMainService
 */
export default class ProjectWeeklyMainService extends ControlService {

    /**
     * 周报服务对象
     *
     * @type {IBZWEEKLYService}
     * @memberof ProjectWeeklyMainService
     */
    ...
    /**
     * Creates an instance of ProjectWeeklyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectWeeklyMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectWeeklyMainModel();
    }
