...
import ProjectWeeklyMainService from './project-weekly-main-grid-service';
 ...
 * @extends {ProjectWeeklyMainGridBase}
 */
export class ProjectWeeklyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProjectWeeklyMainGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProjectWeeklyMainService}
     * @memberof ProjectWeeklyMainGridBase
     */
    public service: ProjectWeeklyMainService = new ProjectWeeklyMainService({ $store: this.$store });
     ...
     * @memberof ProjectWeeklyMainBase
     */  
     ...
     * @memberof ProjectWeeklyMainBase
     */
    protected localStorageTag: string = 'ibz_weekly_projectweeklymain_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_weeklyname',
            label: '周报名称',
            langtag: 'entities.ibzweekly.projectweeklymain_grid.columns.ibz_weeklyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzweekly.projectweeklymain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzweekly.projectweeklymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzweekly.projectweeklymain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibz_weeklyname','account','date','reportto'];
        if(row && row.children) {
