...
import WeeklyMsgModel from './weekly-msg-form-model';
 ...
 *
 * @export
 * @class WeeklyMsgService
 */
export default class WeeklyMsgService extends ControlService {

    /**
     * 周报服务对象
     *
     * @type {IBZWEEKLYService}
     * @memberof WeeklyMsgService
     */
    ...
    /**
     * Creates an instance of WeeklyMsgService.
     * 
     * @param {*} [opts={}]
     * @memberof WeeklyMsgService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibzweeklyid = PrimaryKey;
        Data.ibzweekly = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibzweeklyid = PrimaryKey;
