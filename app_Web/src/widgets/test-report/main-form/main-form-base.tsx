...
export class MainEditFormBase extends EditFormControlBase {
    ...
    public rules():any{
        return {
        tasks: [
            { required: this.detailsModel.tasks.required, type: 'string', message: '测试单 值不能为空', trigger: 'change' },
            { required: this.detailsModel.tasks.required, type: 'string', message: '测试单 值不能为空', trigger: 'blur' },
        ],
        begin: [
            { required: this.detailsModel.begin.required, type: 'string', message: '起始时间 值不能为空', trigger: 'change' },
            { required: this.detailsModel.begin.required, type: 'string', message: '起始时间 值不能为空', trigger: 'blur' },
        ],
        end: [
            { required: this.detailsModel.end.required, type: 'string', message: '~ 值不能为空', trigger: 'change' },
            { required: this.detailsModel.end.required, type: 'string', message: '~ 值不能为空', trigger: 'blur' },
        ],
        owner: [
    ...
    public detailsModel: any = {
        ...
        tasks: new FormItemModel({ caption: '测试单', detailType: 'FORMITEM', name: 'tasks', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),
        ...
        begin: new FormItemModel({ caption: '起始时间', detailType: 'FORMITEM', name: 'begin', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        end: new FormItemModel({ caption: '~', detailType: 'FORMITEM', name: 'end', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),
        ...
        projectname: new FormItemModel({ caption: '所属项目', detailType: 'FORMITEM', name: 'projectname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 0 }),
