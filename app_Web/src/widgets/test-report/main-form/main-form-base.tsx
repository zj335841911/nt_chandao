            ...
            tasks: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testreport.main_form.details.tasks')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.tasks.required,
            ...
            begin: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testreport.main_form.details.begin')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.begin.required,
            ...
            end: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testreport.main_form.details.end')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.end.required,
            ...
            owner: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testreport.main_form.details.owner')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.owner.required,
            ...
            title: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.testreport.main_form.details.title')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.title.required,
