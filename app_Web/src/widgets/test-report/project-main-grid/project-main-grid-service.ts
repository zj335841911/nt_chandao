...
import ProjectMainModel from './project-main-grid-model';
 ...
 *
 * @export
 * @class ProjectMainService
 */
export default class ProjectMainService extends ControlService {

    /**
     * 测试报告服务对象
     *
     * @type {TestReportService}
     * @memberof ProjectMainService
     */
    ...
    /**
     * Creates an instance of ProjectMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectMainService
     */
