...
import Project_NewModel from './project-new-form-model';
 ...
 *
 * @export
 * @class Project_NewService
 */
export default class Project_NewService extends ControlService {

    /**
     * 测试报告服务对象
     *
     * @type {TestReportService}
     * @memberof Project_NewService
     */
    ...
    /**
     * Creates an instance of Project_NewService.
     * 
     * @param {*} [opts={}]
     * @memberof Project_NewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Project_NewModel();
    }
