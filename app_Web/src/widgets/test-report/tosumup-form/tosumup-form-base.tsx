...
export class TosumupEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        report: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'report', visible: false, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
