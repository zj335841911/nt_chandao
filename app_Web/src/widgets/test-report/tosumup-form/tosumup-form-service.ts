...
import TosumupModel from './tosumup-form-model';
 ...
 *
 * @export
 * @class TosumupService
 */
export default class TosumupService extends ControlService {

    /**
     * 测试报告服务对象
     *
     * @type {TestReportService}
     * @memberof TosumupService
     */
    ...
    /**
     * Creates an instance of TosumupService.
     * 
     * @param {*} [opts={}]
     * @memberof TosumupService
     */
