...
import TestRangeModel from './test-range-form-model';
 ...
 */
export default class TestRangeService extends ControlService {

    /**
     * 测试报告服务对象
     *
     * @type {TestReportService}
     * @memberof TestRangeService
     */
    ...
    /**
     * Creates an instance of TestRangeService.
     * 
     * @param {*} [opts={}]
     * @memberof TestRangeService
     */
