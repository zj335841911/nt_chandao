...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */  
    public majorInfoColName:string = "ibz_plantempletname";
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibz_plantemplet_main_grid';
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.ibzplantemplet.main_grid.columns.updatedate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibzplantempletid === data.srfkey;
                })
                if(targetData){
