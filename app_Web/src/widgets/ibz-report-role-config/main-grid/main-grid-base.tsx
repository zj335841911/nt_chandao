...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */  
    public majorInfoColName:string = "ibz_report_role_configname";
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibz_report_role_config_main_grid';
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'report_role',
            label: '角色',
            langtag: 'entities.ibzreportroleconfig.main_grid.columns.report_role',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'updateman',
            label: '更新人',
            langtag: 'entities.ibzreportroleconfig.main_grid.columns.updateman',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.ibzreportroleconfig.main_grid.columns.updatedate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '汇报角色配置标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '汇报角色配置标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibzreportroleconfigid === data.srfkey;
                })
                if(targetData){
