...
import MonthlyMainModel from './monthly-main-grid-model';
 ...
 */
export default class MonthlyMainService extends ControlService {

    /**
     * 项目汇报用户任务服务对象
     *
     * @type {IbzproProjectUserTaskService}
     * @memberof MonthlyMainService
     */
    public appEntityService: IbzproProjectUserTaskService = new IbzproProjectUserTaskService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of MonthlyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof MonthlyMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MonthlyMainModel();
    }
