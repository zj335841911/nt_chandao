...
import MonthlyMainService from './monthly-main-grid-service';
 ...
 * @extends {MonthlyMainGridBase}
 */
export class MonthlyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {MonthlyMainService}
     * @memberof MonthlyMainGridBase
     */
    public service: MonthlyMainService = new MonthlyMainService({ $store: this.$store });
    ...
    public allColumns: any[] = [
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.account',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'taskname',
            label: '任务名称',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.taskname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'tasktype',
            label: '任务类型',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.tasktype',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'eststarted',
            label: '预计开始',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.eststarted',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deadline',
            label: '截止日期',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.deadline',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'progressrate',
            label: '进度',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.progressrate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'delaydays',
            label: '延期天数',
            langtag: 'entities.ibzproprojectusertask.monthlymain_grid.columns.delaydays',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
