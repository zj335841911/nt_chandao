...
import ProductStoryHoursSumModel from './product-story-hours-sum-grid-model';


/**
 * ProductStoryHoursSum 部件服务对象
 *
 * @export
 * @class ProductStoryHoursSumService
 */
export default class ProductStoryHoursSumService extends ControlService {

    /**
     * 产品汇总表服务对象
     *
     * @type {ProductSumService}
     * @memberof ProductStoryHoursSumService
     */
    ...
    /**
     * Creates an instance of ProductStoryHoursSumService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductStoryHoursSumService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductStoryHoursSumModel();
    }
