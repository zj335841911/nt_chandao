...
import ProductBugTypeSumFormModel from './product-bug-type-sum-form-grid-model';


/**
 * ProductBugTypeSumForm 部件服务对象
 *
 * @export
 * @class ProductBugTypeSumFormService
 */
export default class ProductBugTypeSumFormService extends ControlService {

    /**
     * 产品汇总表服务对象
     *
     * @type {ProductSumService}
     * @memberof ProductBugTypeSumFormService
     */
    ...
    /**
     * Creates an instance of ProductBugTypeSumFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductBugTypeSumFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductBugTypeSumFormModel();
    }
