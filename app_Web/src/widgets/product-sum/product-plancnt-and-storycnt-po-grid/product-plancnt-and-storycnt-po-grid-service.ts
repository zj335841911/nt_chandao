...
import ProductPlancntAndStorycnt_POModel from './product-plancnt-and-storycnt-po-grid-model';


/**
 * ProductPlancntAndStorycnt_PO 部件服务对象
 *
 * @export
 * @class ProductPlancntAndStorycnt_POService
 */
export default class ProductPlancntAndStorycnt_POService extends ControlService {

    /**
     * 产品汇总表服务对象
     *
     * @type {ProductSumService}
     * @memberof ProductPlancntAndStorycnt_POService
     */
    ...
    /**
     * Creates an instance of ProductPlancntAndStorycnt_POService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductPlancntAndStorycnt_POService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductPlancntAndStorycnt_POModel();
    }
