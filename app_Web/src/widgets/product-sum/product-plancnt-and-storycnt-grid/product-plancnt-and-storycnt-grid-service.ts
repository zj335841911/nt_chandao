...
import ProductPlancntAndStorycntModel from './product-plancnt-and-storycnt-grid-model';


/**
 * ProductPlancntAndStorycnt 部件服务对象
 *
 * @export
 * @class ProductPlancntAndStorycntService
 */
export default class ProductPlancntAndStorycntService extends ControlService {

    /**
     * 产品汇总表服务对象
     *
     * @type {ProductSumService}
     * @memberof ProductPlancntAndStorycntService
     */
    ...
    /**
     * Creates an instance of ProductPlancntAndStorycntService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductPlancntAndStorycntService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductPlancntAndStorycntModel();
    }
