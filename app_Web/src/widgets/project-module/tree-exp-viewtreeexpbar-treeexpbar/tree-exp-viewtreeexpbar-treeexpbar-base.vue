...
export default class TreeExpViewtreeexpbarBase extends Vue implements ControlInterface {
     ...
     * @memberof TreeExpViewtreeexpbar
     */
    protected treeexpbar_toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1')) {
            this.treeexpbar_toolbar_deuiaction1_click($event, 'treeexpbar_toolbar', $event2);
        }
        if (Object.is($event.tag, 'deuiaction2')) {
            this.treeexpbar_toolbar_deuiaction2_click($event, 'treeexpbar_toolbar', $event2);
        }
    }
     ...
     * @memberof 
     */
    protected treeexpbar_toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected treeexpbar_toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
