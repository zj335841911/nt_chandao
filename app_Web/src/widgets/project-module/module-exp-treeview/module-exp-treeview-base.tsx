...
export class ModuleExpTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        MODULE2_deuiaction1: {name:'deuiaction1',nodeOwner:'MODULE2',type: 'DEUIACTION', tag: 'OpenQuickCfgView', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__UNIVERSALEDIT', visible: true, disabled: false},
        MODULE2_deuiaction2: {name:'deuiaction2',nodeOwner:'MODULE2',type: 'DEUIACTION', tag: 'RefreshAll', noprivdisplaymode:2, visible: true, disabled: false},
        ...
        ROOTMODULE_deuiaction1: {name:'deuiaction1',nodeOwner:'ROOTMODULE',type: 'DEUIACTION', tag: 'OpenQuickCfgView', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__UNIVERSALEDIT', visible: true, disabled: false},
        ...
        MODULE_deuiaction1: {name:'deuiaction1',nodeOwner:'MODULE',type: 'DEUIACTION', tag: 'OpenQuickCfgView', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__UNIVERSALEDIT', visible: true, disabled: false},
        ...
        ProjectModule_deuiaction1: {name:'deuiaction1',nodeOwner:'ProjectModule',type: 'DEUIACTION', tag: 'OpenQuickCfgView', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__UNIVERSALEDIT', visible: true, disabled: false},
        ProjectModule_deuiaction2: {name:'deuiaction2',nodeOwner:'ProjectModule',type: 'DEUIACTION', tag: 'RefreshAll', noprivdisplaymode:2, visible: true, disabled: false},
        Root_NoBranch_deuiaction1: {name:'deuiaction1',nodeOwner:'Root_NoBranch',type: 'DEUIACTION', tag: 'OpenQuickCfgView', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__UNIVERSALEDIT', visible: true, disabled: false},
