...
export default class ModuleExpBase extends Vue implements ControlInterface {
     ...
     * @memberof ModuleExp
     */
    protected module2_cm_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1')) {
            this.module2_cm_deuiaction1_click($event, 'module2_cm', $event2);
        }
        if (Object.is($event.tag, 'deuiaction2')) {
            this.module2_cm_deuiaction2_click($event, 'module2_cm', $event2);
        }
    }
    ...
    protected projectmodule_cm_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction2')) {
            this.projectmodule_cm_deuiaction2_click($event, 'projectmodule_cm', $event2);
        }
    }
     ...
     * @memberof 
     */
    protected projectmodule_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected module2_cm_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected module2_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof ModuleExp
     */
    protected renderContextMenuModule2() {
        return (
