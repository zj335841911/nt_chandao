...
export class MainEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '模块信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.projectmodule.main_form', extractMode: 'ITEM', details: [] } }),
        ...
        root: new FormItemModel({ caption: '所属项目', detailType: 'FORMITEM', name: 'root', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        rootname: new FormItemModel({ caption: '所属项目', detailType: 'FORMITEM', name: 'rootname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 0 }),
        ...
        order: new FormItemModel({ caption: '排序值', detailType: 'FORMITEM', name: 'order', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
