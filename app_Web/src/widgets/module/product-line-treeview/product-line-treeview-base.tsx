 ...
 * @extends {ProductLineTreeBase}
 */
export class ProductLineTreeBase extends MainControlBase {
     ...
     * @memberof ProductLineTreeBase
     */
    public service: ProductLineService = new ProductLineService({ $store: this.$store });
    ...
    public all_cm_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction2')) {
            this.all_cm_deuiaction2_click(null, 'all_cm', $event2);
        }
    }
     ...
     * @memberof 
     */
    public all_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
