...
import ProductLineService from './product-line-treeview-service';
...
export default class ProductLineBase extends Vue implements ControlInterface {
     ...
     * @memberof ProductLine
     */
    protected service: ProductLineService = new ProductLineService({ $store: this.$store });
    ...
    protected all_cm_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction2')) {
            this.all_cm_deuiaction2_click($event, 'all_cm', $event2);
        }
    }
    ...
    protected all_cm_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:ModuleUIService  = new ModuleUIService();
        curUIService.Module_SeLine(datas,contextJO, paramJO,  $event, xData,this,"Module");
    }
     ...
     * @memberof 
     */
    protected all_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
...
<style lang='less'>
@import './product-line-treeview.less';
</style>