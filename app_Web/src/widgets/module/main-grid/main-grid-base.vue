    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ module: keys.join(';') }),Object.assign({ module: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
