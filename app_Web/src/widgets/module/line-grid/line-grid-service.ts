...
import LineModel from './line-grid-model';
 ...
 * @class LineService
 */
export default class LineService extends ControlService {
    ...
    /**
     * Creates an instance of LineService.
     * 
     * @param {*} [opts={}]
     * @memberof LineService
     */
    ...
    public mergeDefaults(response:any = {}){ 
        if(response.data){                    
            Object.assign(response.data,{'type':'line'});
        }
    }
