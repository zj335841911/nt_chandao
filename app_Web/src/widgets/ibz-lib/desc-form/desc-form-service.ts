...
import DescModel from './desc-form-model';
 ...
 * @class DescService
 */
export default class DescService extends ControlService {

    /**
     * 用例库服务对象
     *
     * @type {IbzLibService}
     * @memberof DescService
     */
    ...
    /**
     * Creates an instance of DescService.
     * 
     * @param {*} [opts={}]
     * @memberof DescService
     */
