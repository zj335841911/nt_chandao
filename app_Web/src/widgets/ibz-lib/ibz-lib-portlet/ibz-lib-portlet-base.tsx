...
import IbzLibService from './ibz-lib-portlet-service';
 ...
 * @extends {IbzLibPortletBase}
 */
export class IbzLibPortletBase extends MainControlBase {
     ...
     * @memberof IbzLibPortletBase
     */
    public service: IbzLibService = new IbzLibService({ $store: this.$store });
