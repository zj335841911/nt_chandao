...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_uadedd49_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_ue16a62b_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibz_lib_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: '编号',
            langtag: 'entities.ibzlib.main_grid.columns.id',
            show: true,
            unit: 'PX',
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Editlib', tag)) {
            this.grid_uagridcolumn1_uadedd49_click(row, tag, $event);
        }
        if(Object.is('Delete', tag)) {
            this.grid_uagridcolumn1_ue16a62b_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','name','uagridcolumn1'];
        if(row && row.children) {
