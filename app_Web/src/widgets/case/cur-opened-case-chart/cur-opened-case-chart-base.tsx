...
import CurOpenedCaseService from './cur-opened-case-chart-service';
 ...
 * @extends {CurOpenedCaseChartBase}
 */
export class CurOpenedCaseChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CurOpenedCaseChartBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {CurOpenedCaseService}
     * @memberof CurOpenedCaseChartBase
     */
    public service: CurOpenedCaseService = new CurOpenedCaseService({ $store: this.$store });
    ...
    */
    ...
    categorField:'pri',
    categorCodeList:{type:'STATIC',tag:'Testcase__pri',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"pri",codelist:{type:"STATIC",tag:"Testcase__pri",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:""},
    ...
    public chartUserParams:any ={
        legend:{show:false},
        color:["#00FF99","#00CCFF","#aa00ff","#884bff",'#00ffa9','#85B3FF','#A1FFFF']
    };
