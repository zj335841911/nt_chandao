...
import CaseModuleProjectService from './case-module-project-chart-service';
 ...
 */
export class CaseModuleProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CaseModuleProjectChartBase
     */
