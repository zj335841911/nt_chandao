...
import ToBugTestTaskModel from './to-bug-test-task-form-model';


/**
 * ToBugTestTask 部件服务对象
 *
 * @export
 * @class ToBugTestTaskService
 */
export default class ToBugTestTaskService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof ToBugTestTaskService
     */
    ...
    /**
     * Creates an instance of ToBugTestTaskService.
     * 
     * @param {*} [opts={}]
     * @memberof ToBugTestTaskService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ToBugTestTaskModel();
    }
