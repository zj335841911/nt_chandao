...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-form-item name='id' :itemRules="this.rules.id" class='panelitem-borad' :caption="$t('entities.case.maininfo_form.details.id')" uiStyle="DEFAULT" :labelWidth="1" :isShowCaption="true" :error="detailsModel.id.error" :isEmptyCaption="true" labelPos="LEFT">
    <app-span   name='id'
...
<i-col v-show="detailsModel.title.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    <app-form-item name='title' :itemRules="this.rules.title" class='' :caption="$t('entities.case.maininfo_form.details.title')" uiStyle="DEFAULT" :labelWidth="1" :isShowCaption="true" :error="detailsModel.title.error" :isEmptyCaption="true" labelPos="LEFT">
    <app-span   name='title'
...
<i-col v-show="detailsModel.version.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 2, offset: 0 }">
    <app-form-item name='version' :itemRules="this.rules.version" class='' :caption="$t('entities.case.maininfo_form.details.version')" uiStyle="DEFAULT" :labelWidth="1" :isShowCaption="true" :error="detailsModel.version.error" :isEmptyCaption="true" labelPos="LEFT">
     <dropdown-list v-model="data.version" :data="data" :itemParam="{}" :disabled="detailsModel.version.disabled"  tag='CurCaseVersion' codelistType='DYNAMIC' placeholder='请选择...' style="width:70px;"></dropdown-list>
</app-form-item>
...
, 
        version: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'version', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'主信息查看'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'CaseMainInfoEditView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
