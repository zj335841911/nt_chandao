...
import CaseLASTRUNNERProjectService from './case-lastrunnerproject-chart-service';
 ...
 * @extends {CaseLASTRUNNERProjectChartBase}
 */
export class CaseLASTRUNNERProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CaseLASTRUNNERProjectChartBase
     */
