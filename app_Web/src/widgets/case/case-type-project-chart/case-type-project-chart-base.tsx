...
import CaseTypeProjectService from './case-type-project-chart-service';
 ...
 */
export class CaseTypeProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CaseTypeProjectChartBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {CaseTypeProjectService}
     * @memberof CaseTypeProjectChartBase
     */
    public service: CaseTypeProjectService = new CaseTypeProjectService({ $store: this.$store });
