...
import TestTaskRMainModel from './test-task-rmain-form-model';


/**
 * TestTaskRMain 部件服务对象
 *
 * @export
 * @class TestTaskRMainService
 */
export default class TestTaskRMainService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof TestTaskRMainService
     */
    ...
    /**
     * Creates an instance of TestTaskRMainService.
     * 
     * @param {*} [opts={}]
     * @memberof TestTaskRMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TestTaskRMainModel();
    }
