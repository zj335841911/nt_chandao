...
import RePortMainGridModel from './re-port-main-grid-grid-model';


/**
 * RePortMainGrid 部件服务对象
 *
 * @export
 * @class RePortMainGridService
 */
export default class RePortMainGridService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof RePortMainGridService
     */
    ...
    /**
     * Creates an instance of RePortMainGridService.
     * 
     * @param {*} [opts={}]
     * @memberof RePortMainGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RePortMainGridModel();
    }
