...
import CaseResultEntryModel from './case-result-entry-grid-model';


/**
 * CaseResultEntry 部件服务对象
 *
 * @export
 * @class CaseResultEntryService
 */
export default class CaseResultEntryService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof CaseResultEntryService
     */
    ...
    /**
     * Creates an instance of CaseResultEntryService.
     * 
     * @param {*} [opts={}]
     * @memberof CaseResultEntryService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CaseResultEntryModel();
    }
