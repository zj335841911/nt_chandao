...
import StoryaffectCaseModel from './storyaffect-case-grid-model';


/**
 * StoryaffectCase 部件服务对象
 *
 * @export
 * @class StoryaffectCaseService
 */
export default class StoryaffectCaseService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof StoryaffectCaseService
     */
    ...
    /**
     * Creates an instance of StoryaffectCaseService.
     * 
     * @param {*} [opts={}]
     * @memberof StoryaffectCaseService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StoryaffectCaseModel();
    }
