...
import FeatureGridModel from './feature-grid-grid-model';
 ...
 *
 * @export
 * @class FeatureGridService
 */
export default class FeatureGridService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof FeatureGridService
     */
    ...
    /**
     * Creates an instance of FeatureGridService.
     * 
     * @param {*} [opts={}]
     * @memberof FeatureGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new FeatureGridModel();
    }
