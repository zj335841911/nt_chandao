...
import CaseLASTRUNNERService from './case-lastrunner-chart-service';
 ...
 */
export class CaseLASTRUNNERChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CaseLASTRUNNERChartBase
     */
