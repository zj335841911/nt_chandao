...
import MainTestTaskModel from './main-test-task-form-model';
 ...
 *
 * @export
 * @class MainTestTaskService
 */
export default class MainTestTaskService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof MainTestTaskService
     */
    ...
    /**
     * Creates an instance of MainTestTaskService.
     * 
     * @param {*} [opts={}]
     * @memberof MainTestTaskService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MainTestTaskModel();
    }
