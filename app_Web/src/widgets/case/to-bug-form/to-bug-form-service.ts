...
import ToBugModel from './to-bug-form-model';
 ...
 * @class ToBugService
 */
export default class ToBugService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof ToBugService
     */
    ...
    /**
     * Creates an instance of ToBugService.
     * 
     * @param {*} [opts={}]
     * @memberof ToBugService
     */
