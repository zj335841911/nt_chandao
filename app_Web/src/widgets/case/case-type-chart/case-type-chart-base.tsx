...
import CaseTypeService from './case-type-chart-service';
 ...
 * @extends {CaseTypeChartBase}
 */
export class CaseTypeChartBase extends MainControlBase {
