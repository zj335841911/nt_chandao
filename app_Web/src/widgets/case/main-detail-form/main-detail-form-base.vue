...
<i-col v-show="detailsModel.type.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='type'
:value="data.type" tag='Testcase__type' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.stage.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='stage'
:value="data.stage" tag='Testcase__stage' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.pri.visible" :style="{'width':'300px !important'}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='pri'
:value="data.pri" tag='Testcase__pri' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.status" tag='Testcase__status' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.lastrundate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='lastrundate'
:value="data.lastrundate"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.lastrunresult.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='lastrunresult'
:value="data.lastrunresult" tag='Testcase__result' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.linkcase.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='linkcase'
:value="data.linkcase"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.lasteditedby"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
