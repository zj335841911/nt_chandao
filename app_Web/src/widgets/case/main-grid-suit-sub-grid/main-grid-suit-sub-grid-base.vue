...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.case.maingrid_suitsub_grid.columns.title')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                ...
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.case.maingrid_suitsub_grid.columns.uagridcolumn1')" :width="160" :align="'center'">
                    <template slot-scope="scope">
                        <span>
                            ...
                            <a @click="uiAction(scope.row, 'OpenTestRunResultView', $event)">{{$t('entities.case.maingrid_suitsub_grid.uiactions.opentestrunresultview')}}</a>
                            <divider type='vertical'></divider>
                            <a @click="uiAction(scope.row, 'Execute', $event)">{{$t('entities.case.maingrid_suitsub_grid.uiactions.execute')}}</a>
                        </span>
                    </template>
                </el-table-column>
            </template>
...
export default class MainGrid_SuitSubBase extends Vue implements ControlInterface {
     ...
     * @memberof MainGrid_SuitSub
     */
    protected service: MainGrid_SuitSubService = new MainGrid_SuitSubService({ $store: this.$store });
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_uc27cc64_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_u8fd0327_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
