...
import CaseresultProjectService from './caseresult-project-chart-service';
 ...
 */
export class CaseresultProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CaseresultProjectChartBase
     */
