...
import MainNewModel from './main-new-form-model';
 ...
 *
 * @export
 * @class MainNewService
 */
export default class MainNewService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof MainNewService
     */
    ...
    /**
     * Creates an instance of MainNewService.
     * 
     * @param {*} [opts={}]
     * @memberof MainNewService
     */
