...
import FeatureDashboardService from './feature-dashboard-dashboard-service';
...
export default class FeatureDashboardBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof FeatureDashboard
     */
     ...
     * 建构部件服务对象
     *
     * @type {FeatureDashboardService}
     * @memberof FeatureDashboard
     */
    public service: FeatureDashboardService = new FeatureDashboardService({ $store: this.$store });
     ...
     * @memberof FeatureDashboard
     */
    public modelId:string = "dashboard_case_featuredashboard";
...
<style lang='less'>
@import './feature-dashboard-dashboard.less';
</style>