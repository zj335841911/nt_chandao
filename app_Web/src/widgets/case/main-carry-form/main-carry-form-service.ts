...
import MainCarryModel from './main-carry-form-model';
 ...
 *
 * @export
 * @class MainCarryService
 */
export default class MainCarryService extends ControlService {

    /**
     * 测试用例服务对象
     *
     * @type {CaseService}
     * @memberof MainCarryService
     */
    ...
    /**
     * Creates an instance of MainCarryService.
     * 
     * @param {*} [opts={}]
     * @memberof MainCarryService
     */
