...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibizpro_projectdaily_main_grid';
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'pm',
            label: '项目负责人',
            langtag: 'entities.ibizproprojectdaily.main_grid.columns.pm',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibizproprojectdaily.main_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'begin',
            label: '开始日期',
            langtag: 'entities.ibizproprojectdaily.main_grid.columns.begin',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'end',
            label: '结束日期',
            langtag: 'entities.ibizproprojectdaily.main_grid.columns.end',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalestimates',
            label: '总工时',
            langtag: 'entities.ibizproprojectdaily.main_grid.columns.totalestimates',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目日报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目日报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibizpro_projectdailyname','projectname','pm','date','begin','end','totalestimates'];
        if(row && row.children) {
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibizproprojectdailyid === data.srfkey;
                })
                if(targetData){
