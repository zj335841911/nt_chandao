 ...
 */
export class DEFAULTListBase extends MainControlBase {
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ history: keys.join(';') }),Object.assign({ history: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
