...
export default class DEFAULTBase extends Vue implements ControlInterface {
     ...
     * @memberof DEFAULT
     */
    protected appEntityService: HistoryService = new HistoryService({ $store: this.$store });
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(this.removeAction,Object.assign(context,{ history: keys.join(';') }),Object.assign({ id: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
