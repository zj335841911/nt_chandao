...
/**
 * ChangePassword 部件服务对象
 *
 * @export
 * @class ChangePasswordService
 */
export default class ChangePasswordService extends ControlService {
     ...
     */
    public appEntityService: SysUserService = new SysUserService({ $store: this.getStore() });
