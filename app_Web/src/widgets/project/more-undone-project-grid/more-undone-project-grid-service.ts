...
import MoreUndoneProjectModel from './more-undone-project-grid-model';


/**
 * MoreUndoneProject 部件服务对象
 *
 * @export
 * @class MoreUndoneProjectService
 */
export default class MoreUndoneProjectService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof MoreUndoneProjectService
     */
    ...
    /**
     * Creates an instance of MoreUndoneProjectService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreUndoneProjectService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreUndoneProjectModel();
    }
