...
import NewPlanModel from './new-plan-form-model';
 ...
 *
 * @export
 * @class NewPlanService
 */
export default class NewPlanService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof NewPlanService
     */
    ...
    /**
     * Creates an instance of NewPlanService.
     * 
     * @param {*} [opts={}]
     * @memberof NewPlanService
     */
