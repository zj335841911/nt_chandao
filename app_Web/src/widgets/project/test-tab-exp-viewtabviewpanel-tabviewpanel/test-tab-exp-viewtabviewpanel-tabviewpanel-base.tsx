 ...
 */
export class TestTabExpViewtabviewpanelTabviewpanelBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof TestTabExpViewtabviewpanelTabviewpanelBase
     */
     ...
     * @memberof TestTabExpViewtabviewpanelBase
     */  
