...
import MainConcatModel from './main-concat-grid-model';
 ...
 *
 * @export
 * @class MainConcatService
 */
export default class MainConcatService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof MainConcatService
     */
    ...
    /**
     * Creates an instance of MainConcatService.
     * 
     * @param {*} [opts={}]
     * @memberof MainConcatService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MainConcatModel();
    }
