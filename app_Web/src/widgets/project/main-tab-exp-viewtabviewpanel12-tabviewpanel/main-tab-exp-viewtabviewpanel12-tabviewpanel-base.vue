...
export default class MainTabExpViewtabviewpanel12Base extends Vue implements ControlInterface {
     ...
     * @memberof MainTabExpViewtabviewpanel12
     */
    protected service: MainTabExpViewtabviewpanel12Service = new MainTabExpViewtabviewpanel12Service({ $store: this.$store });
...
<style lang='less'>
@import './main-tab-exp-viewtabviewpanel12-tabviewpanel.less';
</style>