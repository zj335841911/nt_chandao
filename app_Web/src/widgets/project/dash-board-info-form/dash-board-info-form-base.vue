...
<div v-show="detailsModel.group1.visible">
    ...
    <row>
        <div v-show="detailsModel.id.visible">
...
<div v-show="detailsModel.days.visible">
...
<div v-show="detailsModel.grouppanel4.visible">
    ...
    <row>
        <div v-show="detailsModel.formitem3.visible">
...
<div v-show="detailsModel.formitem4.visible">
...
<div v-show="detailsModel.formitem5.visible">
...
export default class DashBoardInfoBase extends Vue implements ControlInterface {
