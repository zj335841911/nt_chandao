...
import DashBoardInfoModel from './dash-board-info-form-model';


/**
 * DashBoardInfo 部件服务对象
 *
 * @export
 * @class DashBoardInfoService
 */
export default class DashBoardInfoService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof DashBoardInfoService
     */
    ...
    /**
     * Creates an instance of DashBoardInfoService.
     * 
     * @param {*} [opts={}]
     * @memberof DashBoardInfoService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DashBoardInfoModel();
    }
