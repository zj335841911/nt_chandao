<template>
    <split id="tasktreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
        <div slot='left'>
...
export default class TaskTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof TaskTreeExpViewtreeexpbar
     */
     ...
     * @memberof TaskTreeExpViewtreeexpbar
     */
    protected service: TaskTreeExpViewtreeexpbarService = new TaskTreeExpViewtreeexpbarService({ $store: this.$store });
...
<style lang='less'>
@import './task-tree-exp-viewtreeexpbar-treeexpbar.less';
</style>
