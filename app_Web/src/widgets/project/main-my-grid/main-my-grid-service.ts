...
import MainMyModel from './main-my-grid-model';
 ...
 * @class MainMyService
 */
export default class MainMyService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof MainMyService
     */
    ...
    /**
     * Creates an instance of MainMyService.
     * 
     * @param {*} [opts={}]
     * @memberof MainMyService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.project = Util.createUUID();
                }
