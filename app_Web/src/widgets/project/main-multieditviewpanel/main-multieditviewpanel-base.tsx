...
export class MainMultieditviewpanelBase extends MainControlBase {
     ...
     * @memberof MainBase
     */
    public viewname: string = 'project-story-medit-view9';
    ...
    public load(data: any): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'ProjectStoryMEditView9' + (this.$t('app.multiEditView.notConfig.fetchAction') as string) });
            return;
        }
        let arg: any = {};
    ...
    public handleAdd(){
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'ProjectStoryMEditView9' + (this.$t('app.multiEditView.notConfig.loaddraftAction') as string) });
            return;
        }
