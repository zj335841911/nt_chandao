...
import ProjectMGModel from './project-mg-form-model';
 ...
 *
 * @export
 * @class ProjectMGService
 */
export default class ProjectMGService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof ProjectMGService
     */
    ...
    /**
     * Creates an instance of ProjectMGService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectMGService
     */
