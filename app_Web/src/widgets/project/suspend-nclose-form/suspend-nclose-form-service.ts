...
import SuspendNCloseModel from './suspend-nclose-form-model';


/**
 * SuspendNClose 部件服务对象
 *
 * @export
 * @class SuspendNCloseService
 */
export default class SuspendNCloseService extends ControlService {

    /**
     * 项目服务对象
     *
     * @type {ProjectService}
     * @memberof SuspendNCloseService
     */
    ...
    /**
     * Creates an instance of SuspendNCloseService.
     * 
     * @param {*} [opts={}]
     * @memberof SuspendNCloseService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SuspendNCloseModel();
    }
