...
export class InvolvedProject_devChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof InvolvedProject_devChartBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {InvolvedProject_devService}
     * @memberof InvolvedProject_devChartBase
     */
    public service: InvolvedProject_devService = new InvolvedProject_devService({ $store: this.$store });
