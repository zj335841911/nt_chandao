...
import TreeDocLibService from './tree-doc-lib-treeview-service';
 ...
 * @extends {TreeDocLibTreeBase}
 */
export class TreeDocLibTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof TreeDocLibTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TreeDocLibService}
     * @memberof TreeDocLibTreeBase
     */
    public service: TreeDocLibService = new TreeDocLibService({ $store: this.$store });
