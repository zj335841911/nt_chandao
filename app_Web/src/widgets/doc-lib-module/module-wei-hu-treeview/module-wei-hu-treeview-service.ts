...
import ModuleWeiHuModel from './module-wei-hu-treeview-model';
 ...
 *
 * @export
 * @class ModuleWeiHuService
 */
export default class ModuleWeiHuService extends ControlService {
     ...
     */
    public appEntityService: DocLibModuleService = new DocLibModuleService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ModuleWeiHuService.
     * 
     * @param {*} [opts={}]
     * @memberof ModuleWeiHuService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ModuleWeiHuModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclibmodule.moduleweihu_treeview.nodes.root') });
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充所有分类
            let AllmoduleRsNavContext:any = {};
            let AllmoduleRsNavParams:any = {};
            let AllmoduleRsParams:any = {};
			await this.fillAllmoduleNodes(context, filter, list ,AllmoduleRsNavContext,AllmoduleRsNavParams,AllmoduleRsParams);
		} else {
			// 填充所有分类
            let AllmoduleRsNavContext:any = {};
            let AllmoduleRsNavParams:any = {};
     ...
     */
    @Errorlog
    public fillAllmoduleNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclibmodule.moduleweihu_treeview.nodes.allmodule') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
            let strNodeId: string = 'AllModule';
