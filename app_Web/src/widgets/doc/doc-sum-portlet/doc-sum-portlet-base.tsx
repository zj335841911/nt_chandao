...
import DocSumService from './doc-sum-portlet-service';
 ...
 * @extends {DocSumPortletBase}
 */
export class DocSumPortletBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof DocSumPortletBase
     */
     ...
     * @memberof DocSumPortletBase
     */
    public service: DocSumService = new DocSumService({ $store: this.$store });
    ...
    public refresh(args?: any) {
      this.viewState.next({ tag: 'DocDocSumEditView9', action: 'refresh', data: args });
    }
