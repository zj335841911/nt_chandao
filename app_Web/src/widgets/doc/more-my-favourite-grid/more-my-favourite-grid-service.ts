...
import MoreMyFavouriteModel from './more-my-favourite-grid-model';


/**
 * MoreMyFavourite 部件服务对象
 *
 * @export
 * @class MoreMyFavouriteService
 */
export default class MoreMyFavouriteService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MoreMyFavouriteService
     */
    ...
    /**
     * Creates an instance of MoreMyFavouriteService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreMyFavouriteService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreMyFavouriteModel();
    }
