...
export class MainbodyEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        id: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'id', visible: true, isShowCaption: false, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 0 }),
