...
import MoreMyDocTreeModel from './more-my-doc-tree-treeview-model';
import CodeListService from '@service/app/codelist-service';
import i18n from '@/locale';


/**
 * MoreMyDocTree 部件服务对象
 *
 * @export
 * @class MoreMyDocTreeService
 */
export default class MoreMyDocTreeService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MoreMyDocTreeService
     */
    ...
    /**
     * Creates an instance of MoreMyDocTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreMyDocTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreMyDocTreeModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doc.moremydoctree_treeview.nodes.root') });
