...
import MoreRecentUpdateTreeModel from './more-recent-update-tree-treeview-model';
import CodeListService from '@service/app/codelist-service';
import i18n from '@/locale';


/**
 * MoreRecentUpdateTree 部件服务对象
 *
 * @export
 * @class MoreRecentUpdateTreeService
 */
export default class MoreRecentUpdateTreeService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MoreRecentUpdateTreeService
     */
    ...
    /**
     * Creates an instance of MoreRecentUpdateTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreRecentUpdateTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreRecentUpdateTreeModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doc.morerecentupdatetree_treeview.nodes.root') });
