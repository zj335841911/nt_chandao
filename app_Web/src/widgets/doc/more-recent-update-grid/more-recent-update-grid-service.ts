...
import MoreRecentUpdateModel from './more-recent-update-grid-model';


/**
 * MoreRecentUpdate 部件服务对象
 *
 * @export
 * @class MoreRecentUpdateService
 */
export default class MoreRecentUpdateService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MoreRecentUpdateService
     */
    ...
    /**
     * Creates an instance of MoreRecentUpdateService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreRecentUpdateService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreRecentUpdateModel();
    }
