    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: '文档编号',
            langtag: 'entities.doc.myfavourite_grid.columns.id',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'addeddate',
            label: '添加时间',
            langtag: 'entities.doc.myfavourite_grid.columns.addeddate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'editedby',
            label: '由谁更新',
            langtag: 'entities.doc.myfavourite_grid.columns.editedby',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.doc.myfavourite_grid.columns.uagridcolumn1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
