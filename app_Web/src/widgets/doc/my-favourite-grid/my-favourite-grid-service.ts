...
import MyFavouriteModel from './my-favourite-grid-model';
 ...
 */
export default class MyFavouriteService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MyFavouriteService
     */
    ...
    /**
     * Creates an instance of MyFavouriteService.
     * 
     * @param {*} [opts={}]
     * @memberof MyFavouriteService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MyFavouriteModel();
    }
