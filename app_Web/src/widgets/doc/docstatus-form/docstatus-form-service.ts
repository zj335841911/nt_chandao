...
import DOCSTATUSModel from './docstatus-form-model';
 ...
 */
export default class DOCSTATUSService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof DOCSTATUSService
     */
    ...
    /**
     * Creates an instance of DOCSTATUSService.
     * 
     * @param {*} [opts={}]
     * @memberof DOCSTATUSService
     */
