...
import RecentUpdateModel from './recent-update-grid-model';
 ...
 */
export default class RecentUpdateService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof RecentUpdateService
     */
    ...
    /**
     * Creates an instance of RecentUpdateService.
     * 
     * @param {*} [opts={}]
     * @memberof RecentUpdateService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new RecentUpdateModel();
    }
