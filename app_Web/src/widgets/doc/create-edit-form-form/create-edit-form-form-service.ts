...
import CreateEditFormModel from './create-edit-form-form-model';
import DocLibService from '@/service/doc-lib/doc-lib-service';
import ModuleService from '@/service/module/module-service';


/**
 * CreateEditForm 部件服务对象
 *
 * @export
 * @class CreateEditFormService
 */
export default class CreateEditFormService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof CreateEditFormService
     */
    ...
    /**
     * Creates an instance of CreateEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof CreateEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CreateEditFormModel();
    }
