...
import KeywordsService from './keywords-form-service';
 ...
 * @extends {KeywordsEditFormBase}
 */
export class KeywordsEditFormBase extends EditFormControlBase {
     ...
     * @memberof KeywordsEditFormBase
     */
    public service: KeywordsService = new KeywordsService({ $store: this.$store });
    ...
    public detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '关键字', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.doc.keywords_form', extractMode: 'ITEM', details: [] } }),
        ...
        keywords: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'keywords', visible: true, isShowCaption: false, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
