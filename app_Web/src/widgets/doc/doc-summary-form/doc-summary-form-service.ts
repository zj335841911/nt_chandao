...
import DocSummaryModel from './doc-summary-form-model';
 ...
 */
export default class DocSummaryService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof DocSummaryService
     */
    ...
    /**
     * Creates an instance of DocSummaryService.
     * 
     * @param {*} [opts={}]
     * @memberof DocSummaryService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DocSummaryModel();
    }
