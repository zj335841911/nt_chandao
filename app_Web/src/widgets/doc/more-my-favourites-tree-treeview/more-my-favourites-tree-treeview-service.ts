...
import MoreMyFavouritesTreeModel from './more-my-favourites-tree-treeview-model';
...
/**
 * MoreMyFavouritesTree 部件服务对象
 *
 * @export
 * @class MoreMyFavouritesTreeService
 */
export default class MoreMyFavouritesTreeService extends ControlService {
     ...
     */
    public appEntityService: DocService = new DocService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of MoreMyFavouritesTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof MoreMyFavouritesTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MoreMyFavouritesTreeModel();
    }
     ...
     * @memberof MoreMyFavouritesTreeService
     */
    public doclibService: DocLibService = new DocLibService({ $store: this.getStore() });
     ...
     * @memberof MoreMyFavouritesTreeService
     */
	public TREENODE_ROOTDIR: string = 'RootDir';
     ...
     * @memberof MoreMyFavouritesTreeService
     */
	public TREENODE_CHILDDIR: string = 'ChildDir';
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_ROOTDIR)) {
            await this.fillRootdirNodeChilds(context,filter, list);
            return Promise.resolve({ status: 200, data: list });
        }
        ...
        if (Object.is(strNodeType, this.TREENODE_CHILDDIR)) {
            await this.fillChilddirNodeChilds(context,filter, list);
            return Promise.resolve({ status: 200, data: list });
        }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doc.moremyfavouritestree_treeview.nodes.root') });
     ...
     */
    @Errorlog
    public fillDocNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            ...
            let records: any[] = [];
            try {
                this.searchDoc(context, searchFilter, filter).then((records:any) =>{
    ...
    public searchDoc(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            ...
            let list: any[] = [];
            if (_appEntityService['FetchMyFavouritesOnlyDoc'] && _appEntityService['FetchMyFavouritesOnlyDoc'] instanceof Function) {
                const response: Promise<any> = _appEntityService['FetchMyFavouritesOnlyDoc'](context, searchFilter, false);
                response.then((response: any) => {
                    if (!response.status || response.status !== 200) {
                        resolve([]);
                        console.log(JSON.stringify(context));
                        console.error('查询FetchMyFavouritesOnlyDoc数据集异常!');
                    }
     ...
     */
    @Errorlog
    public fillRootdirNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let searchFilter: any = {};
            ...
            let records: any[] = [];
            try {
                this.searchRootdir(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        records.forEach((entity: any) => {
                        let treeNode: any = {};
                        // 整理context
     ...
     */
    @Errorlog
    public searchRootdir(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            if(filter.viewparams){
                Object.assign(searchFilter,filter.viewparams);
            }
     ...
     */
    @Errorlog
    public async fillRootdirNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充文档库子目录
            let ChilddirRsNavContext:any = {};
            let ChilddirRsNavParams:any = {};
            let ChilddirRsParams:any = {};
			await this.fillChilddirNodes(context, filter, list ,ChilddirRsNavContext,ChilddirRsNavParams,ChilddirRsParams);
			// 填充分类下文档
    ...
    public searchDoclib(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            ...
            const _appEntityService: any = this.doclibService;
            let list: any[] = [];
            if (_appEntityService['FetchMyFavourites'] && _appEntityService['FetchMyFavourites'] instanceof Function) {
                const response: Promise<any> = _appEntityService['FetchMyFavourites'](context, searchFilter, false);
                response.then((response: any) => {
                    if (!response.status || response.status !== 200) {
                        resolve([]);
                        console.log(JSON.stringify(context));
                        console.error('查询FetchMyFavourites数据集异常!');
                    }
                    const data: any = response.data;
                    if (Object.keys(data).length > 0) {
                        list = JSON.parse(JSON.stringify(data));
    ...
    public async fillDoclibNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充文档库根目录
            let RootdirRsNavContext:any = {};
            let RootdirRsNavParams:any = {};
            let RootdirRsParams:any = {};
			await this.fillRootdirNodes(context, filter, list ,RootdirRsNavContext,RootdirRsNavParams,RootdirRsParams);
			// 填充文档库下文档
     ...
     */
    @Errorlog
    public fillChilddirNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let searchFilter: any = {};
            ...
            let records: any[] = [];
            try {
                this.searchChilddir(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        records.forEach((entity: any) => {
                        let treeNode: any = {};
                        // 整理context
     ...
     */
    @Errorlog
    public searchChilddir(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            if(filter.viewparams){
                Object.assign(searchFilter,filter.viewparams);
            }
     ...
     */
    @Errorlog
    public async fillChilddirNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充文档库子目录
            let ChilddirRsNavContext:any = {};
            let ChilddirRsNavParams:any = {};
