...
import MyDocModel from './my-doc-grid-model';
 ...
 * @class MyDocService
 */
export default class MyDocService extends ControlService {

    /**
     * 文档服务对象
     *
     * @type {DocService}
     * @memberof MyDocService
     */
    ...
    /**
     * Creates an instance of MyDocService.
     * 
     * @param {*} [opts={}]
     * @memberof MyDocService
     */
