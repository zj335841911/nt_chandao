...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */  
    public majorInfoColName:string = "ibizpro_pluginname";
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibizpro_plugin_main_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            label: '插件名称',
            langtag: 'entities.ibizproplugin.main_grid.columns.ibizpro_pluginname',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'type',
            label: '类型',
            langtag: 'entities.ibizproplugin.main_grid.columns.type',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'version',
            label: '版本',
            langtag: 'entities.ibizproplugin.main_grid.columns.version',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'downloadurl',
            label: '最新版本下载地址',
            langtag: 'entities.ibizproplugin.main_grid.columns.downloadurl',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'downloadcount',
            label: '总下载量',
            langtag: 'entities.ibizproplugin.main_grid.columns.downloadcount',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'commentcount',
            label: '总评论数',
            langtag: 'entities.ibizproplugin.main_grid.columns.commentcount',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'score',
            label: '总评分',
            langtag: 'entities.ibizproplugin.main_grid.columns.score',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'updatedate',
            label: '更新时间',
            langtag: 'entities.ibizproplugin.main_grid.columns.updatedate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'updateman',
            label: '更新人',
            langtag: 'entities.ibizproplugin.main_grid.columns.updateman',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '系统插件标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '系统插件标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibizpro_pluginname','type','version','downloadurl','downloadcount','commentcount','score','updatedate','updateman'];
        if(row && row.children) {
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibizpropluginid === data.srfkey;
                })
                if(targetData){
