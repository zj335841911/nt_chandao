...
import MainRModel from './main-r-grid-model';
 ...
 * @class MainRService
 */
export default class MainRService extends ControlService {

    /**
     * 用例步骤服务对象
     *
     * @type {CaseStepService}
     * @memberof MainRService
     */
    ...
    /**
     * Creates an instance of MainRService.
     * 
     * @param {*} [opts={}]
     * @memberof MainRService
     */
