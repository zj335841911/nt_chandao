...
export class MyReceivedGridBase extends GridControlBase {
    ...
    public grid_ibz_monthlyname_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.IbzMonthly_HaveRead(datas,contextJO, paramJO,  $event, xData,this,"IbzMonthly");
    }
     ...
     * @memberof MyReceivedBase
     */
    protected localStorageTag: string = 'ibz_monthly_myreceived_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_monthlyid',
            label: '编号',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.ibz_monthlyid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            ...
            label: '月报名称',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.ibz_monthlyname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportstatus',
            label: '状态',
            langtag: 'entities.ibzmonthly.myreceived_grid.columns.reportstatus',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibz_monthlyid','ibz_monthlyname','account','date','reportto','reportstatus'];
        if(row && row.children) {
