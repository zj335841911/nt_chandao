...
import MyReceivedModel from './my-received-grid-model';
 ...
 */
export default class MyReceivedService extends ControlService {
    ...
    /**
     * Creates an instance of MyReceivedService.
     * 
     * @param {*} [opts={}]
     * @memberof MyReceivedService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MyReceivedModel();
    }
