...
import NewModel from './new-form-model';
 ...
 * @class NewService
 */
export default class NewService extends ControlService {
    ...
    /**
     * Creates an instance of NewService.
     * 
     * @param {*} [opts={}]
     * @memberof NewService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibzmonthlyid = PrimaryKey;
        Data.ibzmonthly = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibzmonthlyid = PrimaryKey;
