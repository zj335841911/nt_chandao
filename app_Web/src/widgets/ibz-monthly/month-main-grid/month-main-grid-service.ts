...
import MonthMainModel from './month-main-grid-model';
 ...
 *
 * @export
 * @class MonthMainService
 */
export default class MonthMainService extends ControlService {

    /**
     * 月报服务对象
     *
     * @type {IbzMonthlyService}
     * @memberof MonthMainService
     */
    ...
    /**
     * Creates an instance of MonthMainService.
     * 
     * @param {*} [opts={}]
     * @memberof MonthMainService
     */
