...
import MonthMainService from './month-main-grid-service';
 ...
 * @extends {MonthMainGridBase}
 */
export class MonthMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {MonthMainService}
     * @memberof MonthMainGridBase
     */
    public service: MonthMainService = new MonthMainService({ $store: this.$store });
     ...
     * @memberof MonthMainBase
     */
    protected localStorageTag: string = 'ibz_monthly_monthmain_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            label: '月报名称',
            langtag: 'entities.ibzmonthly.monthmain_grid.columns.ibz_monthlyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzmonthly.monthmain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzmonthly.monthmain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzmonthly.monthmain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibz_monthlyname','account','date','reportto'];
        if(row && row.children) {
