...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u323f136_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u57939dc_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibz_monthly_main_grid';
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '月报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '月报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
    ...
    public allExportColumns: any[] = [
        {
            name: 'ibz_monthlyid',
            label: '月报标识',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.ibz_monthlyid',
            show: true,
        },
        {
            name: 'ibz_monthlyname',
            label: '月报名称',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.ibz_monthlyname',
            show: true,
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.account',
            show: true,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.date',
            show: true,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.reportto',
            show: true,
        },
        {
            name: 'issubmit',
            label: '是否提交',
            langtag: 'entities.ibzmonthly.main_grid.exportColumns.issubmit',
            show: true,
        },
    ]
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Edit', tag)) {
            this.grid_uagridcolumn1_u323f136_click(row, tag, $event);
        }
        if(Object.is('Submit', tag)) {
            this.grid_uagridcolumn1_u57939dc_click(row, tag, $event);
        }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibzmonthlyid === data.srfkey;
                })
                if(targetData){
