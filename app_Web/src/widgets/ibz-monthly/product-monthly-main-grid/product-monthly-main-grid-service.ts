...
import ProductMonthlyMainModel from './product-monthly-main-grid-model';


/**
 * ProductMonthlyMain 部件服务对象
 *
 * @export
 * @class ProductMonthlyMainService
 */
export default class ProductMonthlyMainService extends ControlService {

    /**
     * 月报服务对象
     *
     * @type {IbzMonthlyService}
     * @memberof ProductMonthlyMainService
     */
    public appEntityService: IbzMonthlyService = new IbzMonthlyService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of ProductMonthlyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductMonthlyMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductMonthlyMainModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.ibzmonthlyid = Util.createUUID();
                }
