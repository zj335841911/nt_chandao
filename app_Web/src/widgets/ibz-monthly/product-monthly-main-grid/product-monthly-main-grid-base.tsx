...
import ProductMonthlyMainService from './product-monthly-main-grid-service';
 ...
 * @extends {ProductMonthlyMainGridBase}
 */
export class ProductMonthlyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductMonthlyMainGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProductMonthlyMainService}
     * @memberof ProductMonthlyMainGridBase
     */
    public service: ProductMonthlyMainService = new ProductMonthlyMainService({ $store: this.$store });
     ...
     * @memberof ProductMonthlyMainBase
     */  
     ...
     * @memberof ProductMonthlyMainBase
     */
    protected localStorageTag: string = 'ibz_monthly_productmonthlymain_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            label: '月报名称',
            langtag: 'entities.ibzmonthly.productmonthlymain_grid.columns.ibz_monthlyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzmonthly.productmonthlymain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzmonthly.productmonthlymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzmonthly.productmonthlymain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
