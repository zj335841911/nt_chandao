...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainGridBase
     */
    public appEntityService: IbizproProductWeeklyService = new IbizproProductWeeklyService({ $store: this.$store });
     ...
     * @memberof MainGridBase
     */
    protected appDeLogicName: string = '产品周报';
     ...
     * @memberof MainBase
     */  
    public majorInfoColName:string = "ibizpro_productdailyname";
    ...
    public allColumns: any[] = [
        {
            ...
            label: '产品周报名称',
            langtag: 'entities.ibizproproductweekly.main_grid.columns.ibizpro_productdailyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'productname',
            label: '产品名称',
            langtag: 'entities.ibizproproductweekly.main_grid.columns.productname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'po',
            label: '产品负责人',
            langtag: 'entities.ibizproproductweekly.main_grid.columns.po',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'totalestimates',
            label: '总工时',
            langtag: 'entities.ibizproproductweekly.main_grid.columns.totalestimates',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '产品周报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '产品周报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibizpro_productweeklyid === data.srfkey;
                })
                if(targetData){
