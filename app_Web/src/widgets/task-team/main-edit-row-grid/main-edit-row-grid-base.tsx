...
export class MainEditRowGridBase extends GridControllerBase {
     ...
     */
    protected localStorageTag: string = 'taskteam_maineditrow_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.taskteam.maineditrow_grid.columns.account',
            show: true,
            util: 'PX',
        ...
        },
        {
            name: 'estimate',
            label: '预计',
            langtag: 'entities.taskteam.maineditrow_grid.columns.estimate',
            show: true,
            util: 'PX',
            isEnableRowEdit: true,
        },
