...
import BUGRESOLUTIONCNTModel from './bugresolutioncnt-grid-model';


/**
 * BUGRESOLUTIONCNT 部件服务对象
 *
 * @export
 * @class BUGRESOLUTIONCNTService
 */
export default class BUGRESOLUTIONCNTService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof BUGRESOLUTIONCNTService
     */
    ...
    /**
     * Creates an instance of BUGRESOLUTIONCNTService.
     * 
     * @param {*} [opts={}]
     * @memberof BUGRESOLUTIONCNTService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BUGRESOLUTIONCNTModel();
    }
