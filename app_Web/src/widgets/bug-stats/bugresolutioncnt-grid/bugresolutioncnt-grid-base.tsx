...
import BUGRESOLUTIONCNTService from './bugresolutioncnt-grid-service';
 ...
 * @extends {BUGRESOLUTIONCNTGridBase}
 */
export class BUGRESOLUTIONCNTGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof BUGRESOLUTIONCNTGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {BUGRESOLUTIONCNTService}
     * @memberof BUGRESOLUTIONCNTGridBase
     */
    public service: BUGRESOLUTIONCNTService = new BUGRESOLUTIONCNTService({ $store: this.$store });
     ...
     * @memberof BUGRESOLUTIONCNTBase
     */
    protected localStorageTag: string = 'ibz_bugstats_bugresolutioncnt_grid';
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'bugduplicate',
            label: '重复Bug',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugduplicate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugbydesign',
            label: '设计如此',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugbydesign',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugfixed',
            label: '已解决',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugfixed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugpostponed',
            label: '延期处理',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugpostponed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugnotrepro',
            label: '无法重现',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugnotrepro',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugtostory',
            label: '转为需求',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugtostory',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugwillnotfix',
            label: '不予解决',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugwillnotfix',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugexternal',
            label: '外部原因',
            langtag: 'entities.bugstats.bugresolutioncnt_grid.columns.bugexternal',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['projectname','bugduplicate','bugbydesign','bugfixed','bugpostponed','bugnotrepro','bugtostory','bugwillnotfix','bugexternal','bugcnt'];
        if(row && row.children) {
