...
export class MainGridBase extends GridControlBase {
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['openedby','bugwjj','bugbydesign','bugduplicate','bugexternal','bugfixed','bugnotrepro','bugpostponed','bugwillnotfix','bugtostory','bugefficient','bugtotal'];
        if(row && row.children) {
