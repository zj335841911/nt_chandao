...
import BugResolvedGirdModel from './bug-resolved-gird-searchform-model';


/**
 * BugResolvedGird 部件服务对象
 *
 * @export
 * @class BugResolvedGirdService
 */
export default class BugResolvedGirdService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof BugResolvedGirdService
     */
    ...
    /**
     * Creates an instance of BugResolvedGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof BugResolvedGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BugResolvedGirdModel();
    }
