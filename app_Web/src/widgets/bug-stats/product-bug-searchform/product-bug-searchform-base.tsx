...
import ProductBugService from './product-bug-searchform-service';
 ...
 * @extends {ProductBugSearchFormBase}
 */
export class ProductBugSearchFormBase extends SearchFormControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductBugSearchFormBase
     */
     ...
     * @memberof ProductBugSearchFormBase
     */
    public service: ProductBugService = new ProductBugService({ $store: this.$store });
    ...
    public detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.bugstats.productbug_searchform', extractMode: 'ITEM', details: [] } })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.bugstats.productbug_searchform', extractMode: 'ITEM', details: [] } })
, 
