...
import BugResolvedByService from './bug-resolved-by-grid-service';
 ...
 * @extends {BugResolvedByGridBase}
 */
export class BugResolvedByGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof BugResolvedByGridBase
     */
     ...
     * @memberof BugResolvedByBase
     */
    protected localStorageTag: string = 'ibz_bugstats_bugresolvedby_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'resolvedby',
            label: '姓名',
            langtag: 'entities.bugstats.bugresolvedby_grid.columns.resolvedby',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'productname',
            label: '产品',
            langtag: 'entities.bugstats.bugresolvedby_grid.columns.productname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugcnt',
            label: 'Bug',
            langtag: 'entities.bugstats.bugresolvedby_grid.columns.bugcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugtotal',
            label: '总计',
            langtag: 'entities.bugstats.bugresolvedby_grid.columns.bugtotal',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['resolvedby','productname','bugcnt','bugtotal'];
        if(row && row.children) {
