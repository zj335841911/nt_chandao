...
import ProjectBugStatusCountModel from './project-bug-status-count-grid-model';


/**
 * ProjectBugStatusCount 部件服务对象
 *
 * @export
 * @class ProjectBugStatusCountService
 */
export default class ProjectBugStatusCountService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof ProjectBugStatusCountService
     */
    ...
    /**
     * Creates an instance of ProjectBugStatusCountService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectBugStatusCountService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectBugStatusCountModel();
    }
