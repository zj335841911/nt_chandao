...
import ProjectBugStatusCountService from './project-bug-status-count-grid-service';
 ...
 * @extends {ProjectBugStatusCountGridBase}
 */
export class ProjectBugStatusCountGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ProjectBugStatusCountService}
     * @memberof ProjectBugStatusCountGridBase
     */
    public service: ProjectBugStatusCountService = new ProjectBugStatusCountService({ $store: this.$store });
     ...
     * @memberof ProjectBugStatusCountBase
     */
    protected localStorageTag: string = 'ibz_bugstats_projectbugstatuscount_grid';
