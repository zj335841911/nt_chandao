...
import BugassignedToModel from './bugassigned-to-grid-model';


/**
 * BugassignedTo 部件服务对象
 *
 * @export
 * @class BugassignedToService
 */
export default class BugassignedToService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof BugassignedToService
     */
    ...
    /**
     * Creates an instance of BugassignedToService.
     * 
     * @param {*} [opts={}]
     * @memberof BugassignedToService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BugassignedToModel();
    }
