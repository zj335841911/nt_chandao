...
import ProductBugResolutionStatsService from './product-bug-resolution-stats-grid-service';
 ...
 */
export class ProductBugResolutionStatsGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ProductBugResolutionStatsService}
     * @memberof ProductBugResolutionStatsGridBase
     */
    public service: ProductBugResolutionStatsService = new ProductBugResolutionStatsService({ $store: this.$store });
     ...
     * @memberof ProductBugResolutionStatsBase
     */  
     ...
     * @memberof ProductBugResolutionStatsBase
     */
    protected localStorageTag: string = 'ibz_bugstats_productbugresolutionstats_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'productname',
            label: '产品名称',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.productname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'bugwjj',
            label: '未解决',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugwjj',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugbydesign',
            label: '设计如此',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugbydesign',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugduplicate',
            label: '重复Bug',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugduplicate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugexternal',
            label: '外部原因',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugexternal',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugfixed',
            label: '已解决',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugfixed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugnotrepro',
            label: '无法重现',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugnotrepro',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugpostponed',
            label: '延期处理',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugpostponed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugwillnotfix',
            label: '不予解决',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugwillnotfix',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugtostory',
            label: '转为需求',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugtostory',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugefficient',
            label: '有效率',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugefficient',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugtotal',
            label: '总计',
            langtag: 'entities.bugstats.productbugresolutionstats_grid.columns.bugtotal',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['productname','bugwjj','bugbydesign','bugduplicate','bugexternal','bugfixed','bugnotrepro','bugpostponed','bugwillnotfix','bugtostory','bugefficient','bugtotal'];
        if(row && row.children) {
