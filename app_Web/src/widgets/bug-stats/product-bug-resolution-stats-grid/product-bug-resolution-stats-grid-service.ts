...
import ProductBugResolutionStatsModel from './product-bug-resolution-stats-grid-model';


/**
 * ProductBugResolutionStats 部件服务对象
 *
 * @export
 * @class ProductBugResolutionStatsService
 */
export default class ProductBugResolutionStatsService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof ProductBugResolutionStatsService
     */
    ...
    /**
     * Creates an instance of ProductBugResolutionStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductBugResolutionStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductBugResolutionStatsModel();
    }
