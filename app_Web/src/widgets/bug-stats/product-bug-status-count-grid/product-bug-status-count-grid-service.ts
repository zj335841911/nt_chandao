...
import ProductBugStatusCountModel from './product-bug-status-count-grid-model';


/**
 * ProductBugStatusCount 部件服务对象
 *
 * @export
 * @class ProductBugStatusCountService
 */
export default class ProductBugStatusCountService extends ControlService {

    /**
     * Bug统计服务对象
     *
     * @type {BugStatsService}
     * @memberof ProductBugStatusCountService
     */
    ...
    /**
     * Creates an instance of ProductBugStatusCountService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductBugStatusCountService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductBugStatusCountModel();
    }
