...
import ProductBugStatusCountService from './product-bug-status-count-grid-service';
 ...
 */
export class ProductBugStatusCountGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ProductBugStatusCountService}
     * @memberof ProductBugStatusCountGridBase
     */
    public service: ProductBugStatusCountService = new ProductBugStatusCountService({ $store: this.$store });
     ...
     * @memberof ProductBugStatusCountBase
     */  
     ...
     * @memberof ProductBugStatusCountBase
     */
    protected localStorageTag: string = 'ibz_bugstats_productbugstatuscount_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'productname',
            label: '产品名称',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.productname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'bugresolved',
            label: '已解决',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.bugresolved',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugclosed',
            label: '已关闭',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.bugclosed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugactive',
            label: '已激活',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.bugactive',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugefficient',
            label: '有效率',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.bugefficient',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugtotal',
            label: '总计',
            langtag: 'entities.bugstats.productbugstatuscount_grid.columns.bugtotal',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['productname','bugresolved','bugclosed','bugactive','bugefficient','bugtotal'];
        if(row && row.children) {
