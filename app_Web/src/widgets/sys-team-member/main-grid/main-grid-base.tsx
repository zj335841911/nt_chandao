...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'sys_teammember_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'teammemberid',
            label: '组成员标识',
            langtag: 'entities.systeammember.main_grid.columns.teammemberid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'personname',
            label: '姓名',
            langtag: 'entities.systeammember.main_grid.columns.personname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'userid',
            label: '用户标识',
            langtag: 'entities.systeammember.main_grid.columns.userid',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'teamname',
            label: '组名称',
            langtag: 'entities.systeammember.main_grid.columns.teamname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'teamid',
            label: '组标识',
            langtag: 'entities.systeammember.main_grid.columns.teamid',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
