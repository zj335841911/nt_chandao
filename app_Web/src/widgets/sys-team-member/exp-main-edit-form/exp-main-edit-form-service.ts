 ...
 *
 * @export
 * @class ExpMainEditService
 */
export default class ExpMainEditService extends ControlService {
    ...
    /**
     * Creates an instance of ExpMainEditService.
     * 
     * @param {*} [opts={}]
     * @memberof ExpMainEditService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ExpMainEditModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.teammemberid = PrimaryKey;
        Data.systeammember = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.teammemberid = PrimaryKey;
