...
import Main_EditModel from './main-edit-grid-model';
...
export default class Main_EditService extends ControlService {
     ...
     */
    public appEntityService: IbzPlanTempletDetailService = new IbzPlanTempletDetailService({ $store: this.getStore() });
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.ibzplantempletdetailid = Util.createUUID();
                }
