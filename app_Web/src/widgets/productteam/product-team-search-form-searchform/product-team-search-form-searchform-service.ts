...
import ProductTeamSearchFormModel from './product-team-search-form-searchform-model';


/**
 * ProductTeamSearchForm 部件服务对象
 *
 * @export
 * @class ProductTeamSearchFormService
 */
export default class ProductTeamSearchFormService extends ControlService {

    /**
     * 产品团队服务对象
     *
     * @type {PRODUCTTEAMService}
     * @memberof ProductTeamSearchFormService
     */
    ...
    /**
     * Creates an instance of ProductTeamSearchFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductTeamSearchFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductTeamSearchFormModel();
    }
