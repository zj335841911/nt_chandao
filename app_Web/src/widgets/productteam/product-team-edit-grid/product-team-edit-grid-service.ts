...
import ProductTeamEditModel from './product-team-edit-grid-model';


/**
 * ProductTeamEdit 部件服务对象
 *
 * @export
 * @class ProductTeamEditService
 */
export default class ProductTeamEditService extends ControlService {

    /**
     * 产品团队服务对象
     *
     * @type {PRODUCTTEAMService}
     * @memberof ProductTeamEditService
     */
    ...
    /**
     * Creates an instance of ProductTeamEditService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductTeamEditService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductTeamEditModel();
    }
