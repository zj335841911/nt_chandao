...
export class TestCaseStatsGridBase extends GridControlBase {
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'totalcase',
            label: '总用例数',
            langtag: 'entities.casestats.testcasestats_grid.columns.totalcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'passcase',
            label: '通过',
            langtag: 'entities.casestats.testcasestats_grid.columns.passcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'failcase',
            label: '失败',
            langtag: 'entities.casestats.testcasestats_grid.columns.failcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'blockedcase',
            label: '阻塞',
            langtag: 'entities.casestats.testcasestats_grid.columns.blockedcase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalruncase',
            label: '总执行数',
            langtag: 'entities.casestats.testcasestats_grid.columns.totalruncase',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'passrate',
            label: '用例通过率',
            langtag: 'entities.casestats.testcasestats_grid.columns.passrate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
