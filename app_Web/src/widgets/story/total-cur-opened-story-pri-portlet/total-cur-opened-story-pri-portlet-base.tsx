...
export class TotalCurOpenedStoryPriPortletBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof TotalCurOpenedStoryPriPortletBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TotalCurOpenedStoryPriService}
     * @memberof TotalCurOpenedStoryPriPortletBase
     */
    public service: TotalCurOpenedStoryPriService = new TotalCurOpenedStoryPriService({ $store: this.$store });
     ...
     *
     * @type {number}
     * @memberof TotalCurOpenedStoryPri
     */
