...
export class Main_BuildSubGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u92f0290_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    public allExportColumns: any[] = [
        ...
        },
        {
            name: 'color',
            label: '标题颜色',
            langtag: 'entities.story.main_buildsub_grid.exportColumns.color',
            show: true,
        },
    ]
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('buildUnlinkStory', tag)) {
            this.grid_uagridcolumn1_u92f0290_click(row, tag, $event);
        }
    }
