...
import MyFavoriteMainModel from './my-favorite-main-grid-model';


/**
 * MyFavoriteMain 部件服务对象
 *
 * @export
 * @class MyFavoriteMainService
 */
export default class MyFavoriteMainService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof MyFavoriteMainService
     */
    ...
    /**
     * Creates an instance of MyFavoriteMainService.
     * 
     * @param {*} [opts={}]
     * @memberof MyFavoriteMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MyFavoriteMainModel();
    }
