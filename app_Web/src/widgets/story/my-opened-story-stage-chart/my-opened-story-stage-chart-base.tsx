...
import MyOpenedStory_StageService from './my-opened-story-stage-chart-service';
 ...
 * @extends {MyOpenedStory_StageChartBase}
 */
export class MyOpenedStory_StageChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof MyOpenedStory_StageChartBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyOpenedStory_StageService}
     * @memberof MyOpenedStory_StageChartBase
     */
    public service: MyOpenedStory_StageService = new MyOpenedStory_StageService({ $store: this.$store });
     ...
     *
     * @type {StoryUIService}
     * @memberof MyOpenedStory_StageBase
     */  
    ...
    */
    ...
    categorField:'stage',
    categorCodeList:{type:'STATIC',tag:'Story__stage',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"stage",codelist:{type:"STATIC",tag:"Story__stage",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:""},
