...
export default class MPickupView3pickupviewpanelBase extends Vue implements ControlInterface {
     ...
     * @memberof MPickupView3pickupviewpanel
     */
    protected service: MPickupView3pickupviewpanelService = new MPickupView3pickupviewpanelService({ $store: this.$store });
...
<style lang='less'>
@import './mpickup-view3pickupviewpanel-pickupviewpanel.less';
</style>