<template>
    <div class='porlet main-viewdashboard-container2' :style="{}">
...
export default class StoryMainViewdashboard_container2Base extends Vue implements ControlInterface {
     ...
     * @memberof MainViewdashboard_container2
     */
    protected service: MainViewdashboard_container2Service = new MainViewdashboard_container2Service({ $store: this.$store });
