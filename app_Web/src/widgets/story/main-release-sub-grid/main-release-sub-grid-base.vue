...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('id')">
                <el-table-column show-overflow-tooltip :prop="'id'" :label="$t('entities.story.main_releasesub_grid.columns.id')" :width="70" :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('pri')">
                <el-table-column show-overflow-tooltip :prop="'pri'" :label="$t('entities.story.main_releasesub_grid.columns.pri')" :width="70" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.story.main_releasesub_grid.columns.title')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('modulename')">
                <el-table-column show-overflow-tooltip :prop="'modulename'" :label="$t('entities.story.main_releasesub_grid.columns.modulename')" :width="150" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
...
export default class Main_ReleaseSubBase extends Vue implements ControlInterface {
     ...
     * @memberof Main_ReleaseSub
     */
    protected service: Main_ReleaseSubService = new Main_ReleaseSubService({ $store: this.$store });
...
<style lang='less'>
@import './main-release-sub-grid.less';
</style>