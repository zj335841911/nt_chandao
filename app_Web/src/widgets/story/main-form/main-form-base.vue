...
<i-col v-show="detailsModel.plan.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='plan'
:value="data.plan" tag='CurProductPlan' codelistType='DYNAMIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.source" tag='Story__source' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.sourcenote"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.status" tag='Story__status' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.stage.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='stage'
:value="data.stage" tag='Story__stage' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
<i-col v-show="detailsModel.pri.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='pri'
:value="data.pri" tag='Story__pri' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.assigneddate"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.reviewedby"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.revieweddate"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.closedreason" tag='Story__closed_reason' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
