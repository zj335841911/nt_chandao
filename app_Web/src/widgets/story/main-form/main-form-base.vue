...
<i-col v-show="detailsModel.branch.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='branch' :itemRules="this.rules.branch" class='' :caption="$t('entities.story.main_form.details.branch')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.branch.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='branch'
:value="data.branch" tag='ProductBranch' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.modulename1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='modulename1' :itemRules="this.rules.modulename1" class='' :caption="$t('entities.story.main_form.details.modulename1')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.modulename1.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='modulename1'
:value="data.modulename1" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.source.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='source'
:value="data.source" tag='Story__source' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.sourcenote.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='sourcenote'
:value="data.sourcenote" style=""></app-span>
</app-form-item>
...
:value="data.status" tag='Story__status' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.stage.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='stage'
:value="data.stage" tag='Story__stage' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.pri.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='pri'
:value="data.pri" tag='Story__pri' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.estimate" style=""></app-span>
</app-form-item>
...
:value="data.openeddate" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.assigneddate.visible" :style="{}"  :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    ...
    <app-span   name='assigneddate'
:value="data.assigneddate" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.reviewedby.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
...
:value="data.reviewedby" tag='UserRealName' codelistType='DYNAMIC' renderMode="STR" valueSeparator="," textSeparator="," style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.revieweddate.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='revieweddate'
:value="data.revieweddate" style=""></app-span>
</app-form-item>
...
:value="data.closeddate" style=""></app-span>
</app-form-item>
...
:value="data.closedreason" tag='Story__closed_reason' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.lastediteddate" style=""></app-span>
</app-form-item>
...
, 
        branch: new FormItemModel({ caption: '平台/分支', detailType: 'FORMITEM', name: 'branch', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
        modulename1: new FormItemModel({ caption: '所属模块', detailType: 'FORMITEM', name: 'modulename1', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'StoryMainView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
