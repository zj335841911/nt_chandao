...
import StorySpecCalendarModel from './story-spec-calendar-form-model';


/**
 * StorySpecCalendar 部件服务对象
 *
 * @export
 * @class StorySpecCalendarService
 */
export default class StorySpecCalendarService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof StorySpecCalendarService
     */
    ...
    /**
     * Creates an instance of StorySpecCalendarService.
     * 
     * @param {*} [opts={}]
     * @memberof StorySpecCalendarService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StorySpecCalendarModel();
    }
