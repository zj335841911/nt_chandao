...
export default class MainPanelBase extends Vue implements ControlInterface {
     ...
     * @memberof MainPanel
     */
    protected service: MainPanelService = new MainPanelService({ $store: this.$store });
     ...
     * @memberof MainPanel
     */
    protected modelId:string = "dashboard_story_mainpanel";
