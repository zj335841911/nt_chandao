...
/**
 * Main_EditMode 部件服务对象
 *
 * @export
 * @class Main_EditModeService
 */
export default class Main_EditModeService extends ControlService {
    ...
    /**
     * Creates an instance of Main_EditModeService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_EditModeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_EditModeModel();
    }
