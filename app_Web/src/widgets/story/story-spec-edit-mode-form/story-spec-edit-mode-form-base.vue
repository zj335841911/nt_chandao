...
export default class StorySpec_EditModeBase extends Vue implements ControlInterface {
     ...
     * @memberof StorySpec_EditMode
     */
    protected service: StorySpec_EditModeService = new StorySpec_EditModeService({ $store: this.$store });
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'需求变更表单'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'StoryEditView_StoryChange视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
