...
export class PlanNewEditFormBase extends EditFormControlBase {
            ...
            prodoctname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.plannew_form.details.prodoctname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.prodoctname.required,
            ...
            title: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.plannew_form.details.title')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.title.required,
    ...
    caption: '联系人', detailType: 'FORMITEM', name: 'mailtoconact', visible: true, isShowCaption: true, form: this, showMoreMode: 0,
    required:false,
    disabled: false,
    enableCond: 3,
}),
    ...
    caption: '', detailType: 'FORMITEM', name: 'mailto', visible: true, isShowCaption: true, form: this, showMoreMode: 0,
    required:false,
    disabled: false,
    enableCond: 3,
}),
