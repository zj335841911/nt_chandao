...
import PlanNewModel from './plan-new-form-model';
 ...
 *
 * @export
 * @class PlanNewService
 */
export default class PlanNewService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof PlanNewService
     */
    ...
    /**
     * Creates an instance of PlanNewService.
     * 
     * @param {*} [opts={}]
     * @memberof PlanNewService
     */
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'ProductService') && Object.is(interfaceName, 'FetchStoryCurProject')) {
            return this.doItems(this.productService.FetchStoryCurProject(JSON.parse(JSON.stringify(context)),data, isloading), 'id', 'product');
        }
