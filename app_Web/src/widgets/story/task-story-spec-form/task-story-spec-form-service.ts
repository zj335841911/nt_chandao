...
import TaskStorySpecModel from './task-story-spec-form-model';


/**
 * TaskStorySpec 部件服务对象
 *
 * @export
 * @class TaskStorySpecService
 */
export default class TaskStorySpecService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof TaskStorySpecService
     */
    ...
    /**
     * Creates an instance of TaskStorySpecService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskStorySpecService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TaskStorySpecModel();
    }
