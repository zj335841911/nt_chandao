...
import ProjectPlanModel from './project-plan-form-model';
 ...
 */
export default class ProjectPlanService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof ProjectPlanService
     */
    ...
    /**
     * Creates an instance of ProjectPlanService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectPlanService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectPlanModel();
    }
