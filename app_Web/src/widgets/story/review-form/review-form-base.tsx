            ...
            result: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.review_form.details.result')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.result.required,
            ...
            preversion: [
                {
                    ...
                    type: 'number',
                    message: `${this.$t('entities.story.review_form.details.preversion')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.preversion.required,
            ...
            closedreason: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.review_form.details.closedreason')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.closedreason.required,
            ...
            assignedto: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.review_form.details.assignedto')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.assignedto.required,
            ...
            reviewedby: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.story.review_form.details.reviewedby')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.reviewedby.required,
