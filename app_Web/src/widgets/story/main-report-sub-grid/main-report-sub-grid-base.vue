...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.story.main_reportsub_grid.columns.title')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
...
export default class Main_ReportSubBase extends Vue implements ControlInterface {
     ...
     * @memberof Main_ReportSub
     */
    protected service: Main_ReportSubService = new Main_ReportSubService({ $store: this.$store });
