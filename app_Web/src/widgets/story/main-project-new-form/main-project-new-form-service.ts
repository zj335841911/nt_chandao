...
/**
 * MainProjectNew 部件服务对象
 *
 * @export
 * @class MainProjectNewService
 */
export default class MainProjectNewService extends ControlService {
    ...
    /**
     * Creates an instance of MainProjectNewService.
     * 
     * @param {*} [opts={}]
     * @memberof MainProjectNewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MainProjectNewModel();
    }
