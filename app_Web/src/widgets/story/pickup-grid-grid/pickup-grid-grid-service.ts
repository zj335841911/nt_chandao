...
import PickupGridModel from './pickup-grid-grid-model';
 ...
 *
 * @export
 * @class PickupGridService
 */
export default class PickupGridService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof PickupGridService
     */
    ...
    /**
     * Creates an instance of PickupGridService.
     * 
     * @param {*} [opts={}]
     * @memberof PickupGridService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new PickupGridModel();
    }
