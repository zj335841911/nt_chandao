    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('pri')">
                <el-table-column show-overflow-tooltip :prop="'pri'" :label="$t('entities.story.treemain_grid.columns.pri')" :width="70"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.story.treemain_grid.columns.title')" :min-width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                ...
                <el-table-column :column-key="'uagridcolumn1'" fixed="right" :label="$t('entities.story.treemain_grid.columns.uagridcolumn1')" :width="260"  :align="'center'">
                    ...
                    <template slot-scope="scope">
                        <div style="text-align: center;">
                          <a v-show="scope.row.ChangeStoryDetail.visabled" :disabled="scope.row.ChangeStoryDetail.disabled" @click="uiAction(scope.row, 'ChangeStoryDetail', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_changestorydetail')">
                            <i class='fa fa-exchange'></i>
                            
                          </a>
                          <divider v-show="scope.row.ReviewStory.visabled" type='vertical'></divider>
                          <a v-show="scope.row.ReviewStory.visabled" :disabled="scope.row.ReviewStory.disabled" @click="uiAction(scope.row, 'ReviewStory', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_reviewstory')">
                            <i class='fa fa-search'></i>
                            
                          </a>
                          <divider v-show="scope.row.CloseStory.visabled" type='vertical'></divider>
                          <a v-show="scope.row.CloseStory.visabled" :disabled="scope.row.CloseStory.disabled" @click="uiAction(scope.row, 'CloseStory', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_closestory')">
                            <i class='fa fa-power-off'></i>
                            
                          </a>
                          <divider v-show="scope.row.OpenBaseInfoEditView.visabled" type='vertical'></divider>
                          <a v-show="scope.row.OpenBaseInfoEditView.visabled" :disabled="scope.row.OpenBaseInfoEditView.disabled" @click="uiAction(scope.row, 'OpenBaseInfoEditView', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_openbaseinfoeditview')">
                            <i class='fa fa-edit'></i>
                            
                          </a>
                          <divider v-show="scope.row.OpenCaseCreateView.visabled" type='vertical'></divider>
                          <a v-show="scope.row.OpenCaseCreateView.visabled" :disabled="scope.row.OpenCaseCreateView.disabled" @click="uiAction(scope.row, 'OpenCaseCreateView', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_opencasecreateview')">
                            <i class='fa fa-lightbulb-o'></i>
                            
                          </a>
                          <divider v-show="scope.row.SubStory.visabled" type='vertical'></divider>
                          <a v-show="scope.row.SubStory.visabled" :disabled="scope.row.SubStory.disabled" @click="uiAction(scope.row, 'SubStory', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_substory')">
                            <i class='iconfont studio-icon-subnets'></i>
                            
                          </a>
                          <divider v-show="scope.row.StoryFavorites.visabled" type='vertical'></divider>
                          <a v-show="scope.row.StoryFavorites.visabled" :disabled="scope.row.StoryFavorites.disabled" @click="uiAction(scope.row, 'StoryFavorites', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_storyfavorites')">
                            <i class='fa fa-star-o'></i>
                            
                          </a>
                          <divider v-show="scope.row.StoryNFavorites.visabled" type='vertical'></divider>
                          <a v-show="scope.row.StoryNFavorites.visabled" :disabled="scope.row.StoryNFavorites.disabled" @click="uiAction(scope.row, 'StoryNFavorites', $event)" :title="$t('entities.story.treemain_grid.uiactions.story_storynfavorites')">
...
import { TreeMainGridBase } from './tree-main-grid-base';
...
export default class TreeMainGrid extends TreeMainGridBase { }
</script>
