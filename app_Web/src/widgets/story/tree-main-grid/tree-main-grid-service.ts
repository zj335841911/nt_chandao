...
import TreeMainModel from './tree-main-grid-model';
 ...
 *
 * @export
 * @class TreeMainService
 */
export default class TreeMainService extends ControlService {
    ...
    /**
     * Creates an instance of TreeMainService.
     * 
     * @param {*} [opts={}]
     * @memberof TreeMainService
     */
