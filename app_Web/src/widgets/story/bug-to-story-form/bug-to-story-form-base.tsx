...
export class BugToStoryEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        frombug: new FormItemModel({ caption: '来源Bug', detailType: 'FORMITEM', name: 'frombug', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
