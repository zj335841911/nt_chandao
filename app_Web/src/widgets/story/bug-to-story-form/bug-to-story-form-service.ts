...
import BugToStoryModel from './bug-to-story-form-model';
 ...
 *
 * @export
 * @class BugToStoryService
 */
export default class BugToStoryService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {StoryService}
     * @memberof BugToStoryService
     */
    ...
    /**
     * Creates an instance of BugToStoryService.
     * 
     * @param {*} [opts={}]
     * @memberof BugToStoryService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BugToStoryModel();
    }
