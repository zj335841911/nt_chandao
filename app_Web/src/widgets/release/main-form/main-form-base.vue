...
:value="data.status" tag='Release__status' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.date.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='date'
:value="data.date" style=""></app-span>
</app-form-item>
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'ReleaseEditView视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
