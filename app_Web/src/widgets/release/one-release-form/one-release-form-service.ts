...
import OneReleaseModel from './one-release-form-model';
 ...
 *
 * @export
 * @class OneReleaseService
 */
export default class OneReleaseService extends ControlService {

    /**
     * 发布服务对象
     *
     * @type {ReleaseService}
     * @memberof OneReleaseService
     */
    ...
    /**
     * Creates an instance of OneReleaseService.
     * 
     * @param {*} [opts={}]
     * @memberof OneReleaseService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new OneReleaseModel();
    }
