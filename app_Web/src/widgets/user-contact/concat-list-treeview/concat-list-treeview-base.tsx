...
import ConcatListService from './concat-list-treeview-service';
 ...
 * @extends {ConcatListTreeBase}
 */
export class ConcatListTreeBase extends MainControlBase {
     ...
     * 建构部件服务对象
     *
     * @type {ConcatListService}
     * @memberof ConcatListTreeBase
     */
    public service: ConcatListService = new ConcatListService({ $store: this.$store });
