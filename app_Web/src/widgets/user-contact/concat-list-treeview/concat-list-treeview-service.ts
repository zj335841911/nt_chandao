...
import ConcatListModel from './concat-list-treeview-model';
 ...
 *
 * @export
 * @class ConcatListService
 */
export default class ConcatListService extends ControlService {

    /**
     * 用户联系方式服务对象
     *
     * @type {UserContactService}
     * @memberof ConcatListService
     */
    ...
    /**
     * Creates an instance of ConcatListService.
     * 
     * @param {*} [opts={}]
     * @memberof ConcatListService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ConcatListModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.usercontact.concatlist_treeview.nodes.root') });
    ...
    public fillConcatlistNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            ...
            let records: any[] = [];
            try {
                this.searchConcatlist(context, searchFilter, filter).then((records:any) =>{
     ...
     */
    @Errorlog
    public searchConcatlist(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
