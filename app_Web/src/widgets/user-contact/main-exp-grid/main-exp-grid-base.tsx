...
export class MainExpGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public gridexpbar_grid_uagridcolumn1_u3d30a9a_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.usercontact.mainexp_grid.columns.uagridcolumn1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Remove', tag)) {
            this.gridexpbar_grid_uagridcolumn1_u3d30a9a_click(row, tag, $event);
        }
    }
