...
import MainExpModel from './main-exp-grid-model';
 ...
 *
 * @export
 * @class MainExpService
 */
export default class MainExpService extends ControlService {

    /**
     * 用户联系方式服务对象
     *
     * @type {UserContactService}
     * @memberof MainExpService
     */
    ...
    /**
     * Creates an instance of MainExpService.
     * 
     * @param {*} [opts={}]
     * @memberof MainExpService
     */
