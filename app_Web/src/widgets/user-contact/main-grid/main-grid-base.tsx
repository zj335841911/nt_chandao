...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u5eaeddc_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'zt_usercontact_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: '编号',
            langtag: 'entities.usercontact.main_grid.columns.id',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'listname',
            label: '标题',
            langtag: 'entities.usercontact.main_grid.columns.listname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Remove', tag)) {
            this.grid_uagridcolumn1_u5eaeddc_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','listname','uagridcolumn1'];
        if(row && row.children) {
