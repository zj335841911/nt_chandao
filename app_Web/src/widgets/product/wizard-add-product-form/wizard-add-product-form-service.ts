...
import WizardAddProductModel from './wizard-add-product-form-model';
import ModuleService from '@/service/module/module-service';


/**
 * WizardAddProduct 部件服务对象
 *
 * @export
 * @class WizardAddProductService
 */
export default class WizardAddProductService extends ControlService {

    /**
     * 产品服务对象
     *
     * @type {ProductService}
     * @memberof WizardAddProductService
     */
    ...
    /**
     * Creates an instance of WizardAddProductService.
     * 
     * @param {*} [opts={}]
     * @memberof WizardAddProductService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new WizardAddProductModel();
    }
