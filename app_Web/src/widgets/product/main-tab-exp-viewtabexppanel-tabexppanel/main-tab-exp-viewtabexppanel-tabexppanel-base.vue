...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="4" name='tabviewpanel9' tab='tabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '路线图'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="5" name='tabviewpanel5' tab='tabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '项目'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="6" name='tabviewpanel8' tab='tabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '平台'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="7" name='tabviewpanel7' tab='tabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '动态'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="8" name='tabviewpanel6' tab='tabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '模块'),
                    h('Badge', {
