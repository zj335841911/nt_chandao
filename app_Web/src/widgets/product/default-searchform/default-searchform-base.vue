...
export default class DefaultBase extends CtrlBase {
    ...
    public rules: any = {
        n_acl_eq: [
            { type: 'string', message: '访问控制(等于(=)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '访问控制(等于(=)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '访问控制(等于(=)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '访问控制(等于(=)) 值不能为空', trigger: 'blur' },
        ],
        n_line_eq: [
            { type: 'number', message: '产品线(等于(=)) 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '产品线(等于(=)) 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '产品线(等于(=)) 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '产品线(等于(=)) 值不能为空', trigger: 'blur' },
        ],
        n_linename_like: [
            { type: 'string', message: '产品线(文本包含(%)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '产品线(文本包含(%)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '产品线(文本包含(%)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '产品线(文本包含(%)) 值不能为空', trigger: 'blur' },
        ],
        n_linename_eq: [
            { type: 'string', message: '产品线(等于(=)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '产品线(等于(=)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '产品线(等于(=)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '产品线(等于(=)) 值不能为空', trigger: 'blur' },
        ],
        n_name_like: [
            { type: 'string', message: '产品名称(文本包含(%)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '产品名称(文本包含(%)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '产品名称(文本包含(%)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '产品名称(文本包含(%)) 值不能为空', trigger: 'blur' },
        ],
    }
...
, 
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'ProductPickupGridView视图搜索表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {},mode?:string): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'ProductPickupGridView视图搜索表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        Object.assign(arg,{viewparams:this.viewparams});
