<template>
    <split id="storytreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
        <div slot='left'>
...
export default class StoryTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof StoryTreeExpViewtreeexpbar
     */
     ...
     * @memberof StoryTreeExpViewtreeexpbar
     */
    protected service: StoryTreeExpViewtreeexpbarService = new StoryTreeExpViewtreeexpbarService({ $store: this.$store });
...
<style lang='less'>
@import './story-tree-exp-viewtreeexpbar-treeexpbar.less';
</style>
