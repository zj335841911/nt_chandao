...
export default class TestTabExpViewtabviewpanel7Base extends Vue implements ControlInterface {
     ...
     * @memberof TestTabExpViewtabviewpanel7
     */
    protected service: TestTabExpViewtabviewpanel7Service = new TestTabExpViewtabviewpanel7Service({ $store: this.$store });
...
<style lang='less'>
@import './test-tab-exp-viewtabviewpanel7-tabviewpanel.less';
</style>