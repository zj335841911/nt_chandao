...
import BugSidebarService from './bug-sidebar-list-service';
...
export default class BugSidebarBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {BugSidebarService}
     * @memberof BugSidebar
     */
    public service: BugSidebarService = new BugSidebarService({ $store: this.$store });
