...
export default class TestTabExpViewtabviewpanel2Base extends Vue implements ControlInterface {
     ...
     * @memberof TestTabExpViewtabviewpanel2
     */
    protected service: TestTabExpViewtabviewpanel2Service = new TestTabExpViewtabviewpanel2Service({ $store: this.$store });
...
<style lang='less'>
@import './test-tab-exp-viewtabviewpanel2-tabviewpanel.less';
</style>