...
import WizardProductService from './wizard-product-form-service';
import ProductUIService from '@/uiservice/product/product-ui-service';
import { FormButtonModel, FormPageModel, FormItemModel, FormDRUIPartModel, FormPartModel, FormGroupPanelModel, FormIFrameModel, FormRowItemModel, FormTabPageModel, FormTabPanelModel, FormUserControlModel } from '@/model/form-detail';


/**
 * wizardpanel_form_Product部件基类
 *
 * @export
 * @class EditFormControlBase
 * @extends {WizardProductEditFormBase}
 */
export class WizardProductEditFormBase extends EditFormControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof WizardProductEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {WizardProductService}
     * @memberof WizardProductEditFormBase
     */
    public service: WizardProductService = new WizardProductService({ $store: this.$store });
