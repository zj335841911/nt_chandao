...
import WizardProductModel from './wizard-product-form-model';


/**
 * WizardProduct 部件服务对象
 *
 * @export
 * @class WizardProductService
 */
export default class WizardProductService extends ControlService {

    /**
     * 产品服务对象
     *
     * @type {ProductService}
     * @memberof WizardProductService
     */
    ...
    /**
     * Creates an instance of WizardProductService.
     * 
     * @param {*} [opts={}]
     * @memberof WizardProductService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new WizardProductModel();
    }
