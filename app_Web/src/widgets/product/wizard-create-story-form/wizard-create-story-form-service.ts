...
import WizardCreateStoryModel from './wizard-create-story-form-model';


/**
 * WizardCreateStory 部件服务对象
 *
 * @export
 * @class WizardCreateStoryService
 */
export default class WizardCreateStoryService extends ControlService {

    /**
     * 产品服务对象
     *
     * @type {ProductService}
     * @memberof WizardCreateStoryService
     */
    ...
    /**
     * Creates an instance of WizardCreateStoryService.
     * 
     * @param {*} [opts={}]
     * @memberof WizardCreateStoryService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new WizardCreateStoryModel();
    }
