...
import WizardAddStoryModel from './wizard-add-story-form-model';


/**
 * WizardAddStory 部件服务对象
 *
 * @export
 * @class WizardAddStoryService
 */
export default class WizardAddStoryService extends ControlService {

    /**
     * 产品服务对象
     *
     * @type {ProductService}
     * @memberof WizardAddStoryService
     */
    ...
    /**
     * Creates an instance of WizardAddStoryService.
     * 
     * @param {*} [opts={}]
     * @memberof WizardAddStoryService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new WizardAddStoryModel();
    }
