...
import MyMainModel from './my-main-grid-model';
 ...
 * @class MyMainService
 */
export default class MyMainService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof MyMainService
     */
    ...
    /**
     * Creates an instance of MyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof MyMainService
     */
