...
import MyMainService from './my-main-grid-service';
 ...
 * @extends {MyMainGridBase}
 */
export class MyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * @memberof MyMainGridBase
     */
    public service: MyMainService = new MyMainService({ $store: this.$store });
     ...
     * @memberof MyMainGridBase
     */
    public columnKeyName: string = "ibz_dailyid";
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_dailyid',
            label: '编号',
            langtag: 'entities.ibzdaily.mymain_grid.columns.ibz_dailyid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'ibz_dailyname',
            label: '日报名称',
            langtag: 'entities.ibzdaily.mymain_grid.columns.ibz_dailyname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzdaily.mymain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzdaily.mymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzdaily.mymain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
