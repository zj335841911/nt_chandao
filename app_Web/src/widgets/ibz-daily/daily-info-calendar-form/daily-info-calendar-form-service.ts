...
import DailyInfoCalendarModel from './daily-info-calendar-form-model';


/**
 * DailyInfoCalendar 部件服务对象
 *
 * @export
 * @class DailyInfoCalendarService
 */
export default class DailyInfoCalendarService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof DailyInfoCalendarService
     */
    ...
    /**
     * Creates an instance of DailyInfoCalendarService.
     * 
     * @param {*} [opts={}]
     * @memberof DailyInfoCalendarService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DailyInfoCalendarModel();
    }
