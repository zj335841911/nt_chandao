...
import CreateDailyEditFormModel from './create-daily-edit-form-form-model';


/**
 * CreateDailyEditForm 部件服务对象
 *
 * @export
 * @class CreateDailyEditFormService
 */
export default class CreateDailyEditFormService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof CreateDailyEditFormService
     */
    public appEntityService: IbzDailyService = new IbzDailyService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of CreateDailyEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof CreateDailyEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CreateDailyEditFormModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibzdailyid = PrimaryKey;
        Data.ibzdaily = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibzdailyid = PrimaryKey;
