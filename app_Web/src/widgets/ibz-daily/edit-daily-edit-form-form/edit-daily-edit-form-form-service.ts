...
import EditDailyEditFormModel from './edit-daily-edit-form-form-model';


/**
 * EditDailyEditForm 部件服务对象
 *
 * @export
 * @class EditDailyEditFormService
 */
export default class EditDailyEditFormService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof EditDailyEditFormService
     */
    ...
    /**
     * Creates an instance of EditDailyEditFormService.
     * 
     * @param {*} [opts={}]
     * @memberof EditDailyEditFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new EditDailyEditFormModel();
    }
