...
import EditDailyEditFormService from './edit-daily-edit-form-form-service';
 ...
 * @extends {EditDailyEditFormEditFormBase}
 */
export class EditDailyEditFormEditFormBase extends EditFormControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof EditDailyEditFormEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {EditDailyEditFormService}
     * @memberof EditDailyEditFormEditFormBase
     */
    public service: EditDailyEditFormService = new EditDailyEditFormService({ $store: this.$store });
     ...
     * @memberof EditDailyEditFormBase
     */  
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '日报基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.ibzdaily.editdailyeditform_form', extractMode: 'ITEM', details: [] } }),
