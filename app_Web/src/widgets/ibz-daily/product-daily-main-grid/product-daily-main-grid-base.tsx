...
import ProductDailyMainService from './product-daily-main-grid-service';
 ...
 * @extends {ProductDailyMainGridBase}
 */
export class ProductDailyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductDailyMainGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProductDailyMainService}
     * @memberof ProductDailyMainGridBase
     */
    public service: ProductDailyMainService = new ProductDailyMainService({ $store: this.$store });
     ...
     * @memberof ProductDailyMainBase
     */
    protected localStorageTag: string = 'ibz_daily_productdailymain_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_dailyname',
            label: '日报名称',
            langtag: 'entities.ibzdaily.productdailymain_grid.columns.ibz_dailyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzdaily.productdailymain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzdaily.productdailymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzdaily.productdailymain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
