...
import ProductDailyMainModel from './product-daily-main-grid-model';


/**
 * ProductDailyMain 部件服务对象
 *
 * @export
 * @class ProductDailyMainService
 */
export default class ProductDailyMainService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof ProductDailyMainService
     */
    ...
    /**
     * Creates an instance of ProductDailyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductDailyMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductDailyMainModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.ibzdailyid = Util.createUUID();
                }
