...
import ProjectDailyMainModel from './project-daily-main-grid-model';


/**
 * ProjectDailyMain 部件服务对象
 *
 * @export
 * @class ProjectDailyMainService
 */
export default class ProjectDailyMainService extends ControlService {

    /**
     * 日报服务对象
     *
     * @type {IbzDailyService}
     * @memberof ProjectDailyMainService
     */
    ...
    /**
     * Creates an instance of ProjectDailyMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectDailyMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectDailyMainModel();
    }
