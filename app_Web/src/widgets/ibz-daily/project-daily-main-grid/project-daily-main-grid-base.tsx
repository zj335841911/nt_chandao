...
import ProjectDailyMainService from './project-daily-main-grid-service';
 ...
 * @extends {ProjectDailyMainGridBase}
 */
export class ProjectDailyMainGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ProjectDailyMainService}
     * @memberof ProjectDailyMainGridBase
     */
    public service: ProjectDailyMainService = new ProjectDailyMainService({ $store: this.$store });
     ...
     * @memberof ProjectDailyMainBase
     */  
    public majorInfoColName:string = "ibz_dailyname";
     ...
     * @memberof ProjectDailyMainBase
     */
    protected localStorageTag: string = 'ibz_daily_projectdailymain_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_dailyname',
            label: '日报名称',
            langtag: 'entities.ibzdaily.projectdailymain_grid.columns.ibz_dailyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'account',
            label: '用户',
            langtag: 'entities.ibzdaily.projectdailymain_grid.columns.account',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibzdaily.projectdailymain_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'reportto',
            label: '汇报给',
            langtag: 'entities.ibzdaily.projectdailymain_grid.columns.reportto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '日报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '日报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibzdailyid === data.srfkey;
                })
                if(targetData){
