...
import StoryToBugModel from './story-to-bug-form-model';
 ...
 *
 * @export
 * @class StoryToBugService
 */
export default class StoryToBugService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof StoryToBugService
     */
    ...
    /**
     * Creates an instance of StoryToBugService.
     * 
     * @param {*} [opts={}]
     * @memberof StoryToBugService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StoryToBugModel();
    }
