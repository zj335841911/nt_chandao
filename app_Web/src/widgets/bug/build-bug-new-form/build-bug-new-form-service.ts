...
import BuildBugNewModel from './build-bug-new-form-model';
 ...
 *
 * @export
 * @class BuildBugNewService
 */
export default class BuildBugNewService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof BuildBugNewService
     */
    ...
    /**
     * Creates an instance of BuildBugNewService.
     * 
     * @param {*} [opts={}]
     * @memberof BuildBugNewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BuildBugNewModel();
    }
