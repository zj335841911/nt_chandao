...
import Main_BuildSub3Model from './main-build-sub3-grid-model';


/**
 * Main_BuildSub3 部件服务对象
 *
 * @export
 * @class Main_BuildSub3Service
 */
export default class Main_BuildSub3Service extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof Main_BuildSub3Service
     */
    ...
    /**
     * Creates an instance of Main_BuildSub3Service.
     * 
     * @param {*} [opts={}]
     * @memberof Main_BuildSub3Service
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_BuildSub3Model();
    }
