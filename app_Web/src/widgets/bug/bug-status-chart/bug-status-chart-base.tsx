...
export class BugSTATUSChartBase extends MainControlBase {
     ...
     * 建构部件服务对象
     *
     * @type {BugSTATUSService}
     * @memberof BugSTATUSChartBase
     */
    public service: BugSTATUSService = new BugSTATUSService({ $store: this.$store });
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet11_chartBase
     */
