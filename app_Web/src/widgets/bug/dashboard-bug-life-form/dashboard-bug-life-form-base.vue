...
:value="data.openedbuild" tag='CurProductBuild' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
:value="data.resolvedbuild" tag='CurProductBuild' codelistType='DYNAMIC' style=""></app-span>
</app-form-item>
...
, 
        openedbuild: new FormItemModel({ caption: '影响版本', detailType: 'FORMITEM', name: 'openedbuild', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'看板Bug的一生'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'BugBugLifeEditView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
