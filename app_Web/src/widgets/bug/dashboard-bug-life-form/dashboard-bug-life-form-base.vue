...
:value="data.openedbuild"   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.resolvedby" tag='UserRealName' codelistType='DYNAMIC' renderMode="STR" valueSeparator="," textSeparator=","   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
...
:value="data.resolution" tag='Bug__resolution' codelistType='STATIC'   :data="data"
  :context="context"
  :viewparams="viewparams"
  :itemParam="{}" 
style=""></app-span>
