 ...
 * @extends {MPickupView2pickupviewpanelPickupviewpanelBase}
 */
export class MPickupView2pickupviewpanelPickupviewpanelBase extends MainControlBase {
     ...
     * @memberof MPickupView2pickupviewpanelPickupviewpanelBase
     */
    public service: MPickupView2pickupviewpanelService = new MPickupView2pickupviewpanelService({ $store: this.$store });
     ...
     */
    public view: any = {
        viewname: 'bug-pickup-grid-view-build-link-resolved-bugs',
        data: {},
    }
