<template>
    <div class='porlet assigned-to-me-bug' :style="{'height': isAdaptiveSize ? '100%' : '300px',}">
...
export default class BugAssignedToMeBugBase extends Vue implements ControlInterface {
     ...
     * @memberof AssignedToMeBug
     */
    protected service: AssignedToMeBugService = new AssignedToMeBugService({ $store: this.$store });
