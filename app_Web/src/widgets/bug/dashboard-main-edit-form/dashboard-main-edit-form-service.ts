...
/**
 * DashboardMainEdit 部件服务对象
 *
 * @export
 * @class DashboardMainEditService
 */
export default class DashboardMainEditService extends ControlService {
    ...
    /**
     * Creates an instance of DashboardMainEditService.
     * 
     * @param {*} [opts={}]
     * @memberof DashboardMainEditService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DashboardMainEditModel();
    }
