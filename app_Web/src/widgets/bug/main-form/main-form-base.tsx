            ...
            productname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.bug.main_form.details.productname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.productname.required,
            ...
            openedbuild: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.bug.main_form.details.openedbuild')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.openedbuild.required,
            ...
            title: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.bug.main_form.details.title')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.title.required,
