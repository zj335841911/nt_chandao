...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('id')">
                <el-table-column show-overflow-tooltip :prop="'id'" :label="$t('entities.bug.main_grid.columns.id')" :width="70" :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('pri')">
                <el-table-column show-overflow-tooltip :prop="'pri'" :label="$t('entities.bug.main_grid.columns.pri')" :width="70" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('confirmed')">
                <el-table-column show-overflow-tooltip :prop="'confirmed'" :label="$t('entities.bug.main_grid.columns.confirmed')" :width="80" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.bug.main_grid.columns.title')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <app-column-link deKeyField='bug' :context="JSON.parse(JSON.stringify(context))" :viewparams="JSON.parse(JSON.stringify(viewparams))" :data="row" :linkview="{viewname: 'bug-main-dashboard-view', height: 0,width: 0,title: $t('entities.bug.views.maindashboardview.title'),placement: 'DRAWER_TOP', isRedirectView: false,deResParameters: [
            ...
            <template v-if="getColumnState('status')">
                <el-table-column show-overflow-tooltip :prop="'status'" :label="$t('entities.bug.main_grid.columns.status')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('openedby')">
                <el-table-column show-overflow-tooltip :prop="'openedby'" :label="$t('entities.bug.main_grid.columns.openedby')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('openeddate')">
                <el-table-column show-overflow-tooltip :prop="'openeddate'" :label="$t('entities.bug.main_grid.columns.openeddate')" :width="160" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('assignedto')">
                <el-table-column show-overflow-tooltip :prop="'assignedto'" :label="$t('entities.bug.main_grid.columns.assignedto')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.bug.main_grid.columns.uagridcolumn1')" :width="160" :align="'center'">
                    <template slot-scope="scope">
                        <span>
                            
                            <a @click="uiAction(scope.row, 'ConfirmBug', $event)">{{$t('entities.bug.main_grid.uiactions.confirmbug')}}</a>
                            <divider type='vertical'></divider>
                            <a @click="uiAction(scope.row, 'ResolveBug', $event)">{{$t('entities.bug.main_grid.uiactions.resolvebug')}}</a>
                            <divider type='vertical'></divider>
                            <a @click="uiAction(scope.row, 'CloseBug', $event)">{{$t('entities.bug.main_grid.uiactions.closebug')}}</a>
                            <divider type='vertical'></divider>
                            <a @click="uiAction(scope.row, 'MainEdit', $event)">{{$t('entities.bug.main_grid.uiactions.mainedit')}}</a>
                        </span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('lastediteddate')">
                <el-table-column show-overflow-tooltip :prop="'lastediteddate'" :label="$t('entities.bug.main_grid.columns.lastediteddate')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <app-format-data format="YYYY-MM-DD HH:mm:ss" :data="row.lastediteddate"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('activateddate')">
                <el-table-column show-overflow-tooltip :prop="'activateddate'" :label="$t('entities.bug.main_grid.columns.activateddate')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <app-format-data format="YYYY-MM-DD HH:mm:ss" :data="row.activateddate"></app-format-data>
                    </template>
                </el-table-column>
            </template>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_ua4634db_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_u0efb050_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_uc6d84c5_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_u953838c_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof Main
     */
    protected minorSortPSDEF: string = 'id';
    ...
    */
    ...
    protected load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'BugMainMyGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    protected async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'BugMainMyGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(this.removeAction,Object.assign(context,{ bug: keys.join(';') }),Object.assign({ id: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
        ...
        _this.items.forEach((item:any)=>{
            if(!item.rowDataState){
                ...
                if(!this.createAction){
                    this.$Notice.error({ title: '错误', desc: 'BugMainMyGridView视图表格createAction参数未配置' });
                    return;
                }
                ...
                if(!this.updateAction){
                    this.$Notice.error({ title: '错误', desc: 'BugMainMyGridView视图表格updateAction参数未配置' });
                    return;
                }
                Object.assign(item,{viewparams:this.viewparams});
                if(item.bug){
