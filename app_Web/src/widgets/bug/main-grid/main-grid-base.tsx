    ...
    public allExportColumns: any[] = [
        {
            name: 'id',
            label: 'ID',
            langtag: 'entities.bug.main_grid.exportColumns.id',
            show: true,
        },
        {
            name: 'pri',
            label: 'P',
            langtag: 'entities.bug.main_grid.exportColumns.pri',
            show: true,
        },
        {
            name: 'confirmed',
            label: '确认',
            langtag: 'entities.bug.main_grid.exportColumns.confirmed',
            show: true,
        },
        {
            name: 'title',
            label: 'Bug标题',
            langtag: 'entities.bug.main_grid.exportColumns.title',
            show: true,
        },
        {
            name: 'status',
            label: 'Bug状态',
            langtag: 'entities.bug.main_grid.exportColumns.status',
            show: true,
        },
        {
            name: 'openedby',
            label: '由谁创建',
            langtag: 'entities.bug.main_grid.exportColumns.openedby',
            show: true,
        },
        {
            name: 'openeddate',
            label: '创建日期',
            langtag: 'entities.bug.main_grid.exportColumns.openeddate',
            show: true,
        },
        {
            name: 'assignedto',
            label: '指派给',
            langtag: 'entities.bug.main_grid.exportColumns.assignedto',
            show: true,
        },
        {
            name: 'resolution',
            label: '方案',
            langtag: 'entities.bug.main_grid.exportColumns.resolution',
            show: true,
        },
        {
            name: 'lastediteddate',
            label: '修改日期',
            langtag: 'entities.bug.main_grid.exportColumns.lastediteddate',
            show: true,
        },
        {
            name: 'activateddate',
            label: '激活日期',
            langtag: 'entities.bug.main_grid.exportColumns.activateddate',
            show: true,
        },
        {
            name: 'isfavorites',
            label: '是否收藏',
            langtag: 'entities.bug.main_grid.exportColumns.isfavorites',
            show: true,
        },
        {
            name: 'productname',
        ...
        },
        {
            name: 'projectname',
            label: '项目',
            langtag: 'entities.bug.main_grid.exportColumns.projectname',
            show: true,
        },
    ]
