...
import PickupGirdModel from './pickup-gird-grid-model';
 ...
 *
 * @export
 * @class PickupGirdService
 */
export default class PickupGirdService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof PickupGirdService
     */
    ...
    /**
     * Creates an instance of PickupGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof PickupGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new PickupGirdModel();
    }
