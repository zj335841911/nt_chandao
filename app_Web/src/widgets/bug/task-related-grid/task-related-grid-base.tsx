...
import TaskRelatedService from './task-related-grid-service';
 ...
 * @extends {TaskRelatedGridBase}
 */
export class TaskRelatedGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof TaskRelatedGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TaskRelatedService}
     * @memberof TaskRelatedGridBase
     */
    public service: TaskRelatedService = new TaskRelatedService({ $store: this.$store });
     ...
     * @memberof TaskRelatedBase
     */
    protected localStorageTag: string = 'zt_bug_taskrelated_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: 'Bug编号',
            langtag: 'entities.bug.taskrelated_grid.columns.id',
            show: true,
            unit: 'PX',
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','title'];
        if(row && row.children) {
