...
import TaskRelatedModel from './task-related-grid-model';
 ...
 */
export default class TaskRelatedService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof TaskRelatedService
     */
    ...
    /**
     * Creates an instance of TaskRelatedService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskRelatedService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TaskRelatedModel();
    }
