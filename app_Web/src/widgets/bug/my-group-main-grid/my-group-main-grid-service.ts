...
import MyGroupMainModel from './my-group-main-grid-model';
 ...
 *
 * @export
 * @class MyGroupMainService
 */
export default class MyGroupMainService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof MyGroupMainService
     */
    ...
    /**
     * Creates an instance of MyGroupMainService.
     * 
     * @param {*} [opts={}]
     * @memberof MyGroupMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MyGroupMainModel();
    }
