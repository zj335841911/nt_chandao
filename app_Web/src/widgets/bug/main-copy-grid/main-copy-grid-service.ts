...
import Main_CopyModel from './main-copy-grid-model';
 ...
 *
 * @export
 * @class Main_CopyService
 */
export default class Main_CopyService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof Main_CopyService
     */
    ...
    /**
     * Creates an instance of Main_CopyService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_CopyService
     */
