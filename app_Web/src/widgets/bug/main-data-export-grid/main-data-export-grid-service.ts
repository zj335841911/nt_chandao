...
import Main_DataExportModel from './main-data-export-grid-model';


/**
 * Main_DataExport 部件服务对象
 *
 * @export
 * @class Main_DataExportService
 */
export default class Main_DataExportService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof Main_DataExportService
     */
    ...
    /**
     * Creates an instance of Main_DataExportService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_DataExportService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_DataExportModel();
    }
