...
import BugResolvedBy_ProjectService from './bug-resolved-by-project-chart-service';
...
/**
 * dashboard_sysportlet15_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugResolvedBy_ProjectChartBase}
 */
export class BugResolvedBy_ProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof BugResolvedBy_ProjectChartBase
     */
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet15_chartBase
     */
    ...
    public  seriesModel:any = {
        bugresolvedby_project:new ChartPieSeries({
    name:'bugresolvedby_project',
    
    
    categorField:'resolvedby',
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"resolvedby",codelist:null,isGroupField:true,groupMode:""},
    ...
    public chartUserParams:any ={
        color:["#F50057","#FF1744","#8666B8","#BD7B46",'#FF9100','#FF3D00','#F57F17','#00E5FF','#00B0FF','#2979FF','#3D5AFE','#651FFF','#D500F9']
    };
