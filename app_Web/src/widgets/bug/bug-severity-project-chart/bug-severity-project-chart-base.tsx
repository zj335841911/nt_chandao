...
import BugSeverity_ProjectService from './bug-severity-project-chart-service';
...
/**
 * dashboard_BugSeverity_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugSeverity_ProjectChartBase}
 */
export class BugSeverity_ProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof BugSeverity_ProjectChartBase
     */
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_BugSeverity_chartBase
     */
    ...
    public  seriesModel:any = {
        bugseverity_project:new ChartPieSeries({
    name:'bugseverity_project',
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"severity",codelist:null,isGroupField:true,groupMode:""},
