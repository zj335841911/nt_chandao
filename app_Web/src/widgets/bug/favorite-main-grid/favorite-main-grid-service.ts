...
import FavoriteMainModel from './favorite-main-grid-model';
 ...
 */
export default class FavoriteMainService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof FavoriteMainService
     */
    ...
    /**
     * Creates an instance of FavoriteMainService.
     * 
     * @param {*} [opts={}]
     * @memberof FavoriteMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new FavoriteMainModel();
    }
