...
export class Main_BuildSub2GridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u7c0c879_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    public allExportColumns: any[] = [
        {
            name: 'id',
            label: 'ID',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.id',
            show: true,
        },
        {
            name: 'pri',
            label: 'P',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.pri',
            show: true,
        },
        {
            name: 'confirmed',
            label: '确认',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.confirmed',
            show: true,
        },
        {
            name: 'title',
            label: 'Bug标题',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.title',
            show: true,
        },
        {
            name: 'status',
            label: 'Bug状态',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.status',
            show: true,
        },
        {
            name: 'openedby',
            label: '由谁创建',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.openedby',
            show: true,
        },
        {
            name: 'openeddate',
            label: '创建日期',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.openeddate',
            show: true,
        },
        {
            name: 'assignedto',
            label: '指派给',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.assignedto',
            show: true,
        },
        {
            name: 'resolution',
            label: '方案',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.resolution',
            show: true,
        },
        {
            name: 'lastediteddate',
            label: '修改日期',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.lastediteddate',
            show: true,
        },
        {
            name: 'activateddate',
            label: '激活日期',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.activateddate',
            show: true,
        },
        {
            name: 'isfavorites',
            label: '是否收藏',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.isfavorites',
            show: true,
        },
        {
            name: 'productname',
            label: '产品',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.productname',
            show: true,
        },
        {
            name: 'projectname',
            label: '项目',
            langtag: 'entities.bug.main_buildsub2_grid.exportColumns.projectname',
            show: true,
        },
    ]
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('unlinkBug_build', tag)) {
            this.grid_uagridcolumn1_u7c0c879_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','pri','title','status','openedby','openeddate','resolvedby','uagridcolumn1','isfavorites'];
        if(row && row.children) {
