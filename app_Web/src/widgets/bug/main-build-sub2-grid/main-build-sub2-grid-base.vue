...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('id')">
                <el-table-column show-overflow-tooltip :prop="'id'" :label="$t('entities.bug.main_buildsub2_grid.columns.id')" :width="70" :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('pri')">
                <el-table-column show-overflow-tooltip :prop="'pri'" :label="$t('entities.bug.main_buildsub2_grid.columns.pri')" :width="70" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.bug.main_buildsub2_grid.columns.title')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('status')">
                <el-table-column show-overflow-tooltip :prop="'status'" :label="$t('entities.bug.main_buildsub2_grid.columns.status')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('openedby')">
                <el-table-column show-overflow-tooltip :prop="'openedby'" :label="$t('entities.bug.main_buildsub2_grid.columns.openedby')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('openeddate')">
                <el-table-column show-overflow-tooltip :prop="'openeddate'" :label="$t('entities.bug.main_buildsub2_grid.columns.openeddate')" :width="120" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
            ...
            <template v-if="getColumnState('resolvedby')">
                <el-table-column show-overflow-tooltip :prop="'resolvedby'" :label="$t('entities.bug.main_buildsub2_grid.columns.resolvedby')" :width="100" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
                        <template >
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.bug.main_buildsub2_grid.columns.uagridcolumn1')" :width="100" :align="'right'">
                    <template slot-scope="scope">
                        <span>
                            
                            <a @click="uiAction(scope.row, 'unlinkBug_build', $event)">{{$t('entities.bug.main_buildsub2_grid.uiactions.unlinkbug_build')}}</a>
                        </span>
                    </template>
                </el-table-column>
            </template>
...
export default class Main_BuildSub2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Main_BuildSub2
     */
     ...
     * @memberof Main_BuildSub2
     */
    protected service: Main_BuildSub2Service = new Main_BuildSub2Service({ $store: this.$store });
     ...
     * @memberof 
     */
    protected grid_uagridcolumn1_u82990f2_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    */
    ...
    protected setColState() {
		const _data: any = localStorage.getItem('zt_bug_main_buildsub2_grid');
		if (_data) {
    ...
    protected onColChange() {
        localStorage.setItem('zt_bug_main_buildsub2_grid', JSON.stringify(this.allColumns));
    }
...
<style lang='less'>
@import './main-build-sub2-grid.less';
</style>