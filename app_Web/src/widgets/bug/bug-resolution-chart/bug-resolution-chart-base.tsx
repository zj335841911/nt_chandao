...
import BugRESOLUTIONService from './bug-resolution-chart-service';
...
/**
 * dashboard_sysportlet12_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugRESOLUTIONChartBase}
 */
export class BugRESOLUTIONChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof BugRESOLUTIONChartBase
     */
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet12_chartBase
     */
    ...
    public chartUserParams:any ={
        color:["#00E5FF","#00B0FF","#2979FF","#3D5AFE",'#651FFF','#D500F9','#F50057','#FF1744','#BD7B46']
    };
