    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('title')">
                <el-table-column show-overflow-tooltip :prop="'title'" :label="$t('entities.bug.main_buildsub_grid.columns.title')" :min-width="1"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('openeddate')">
                <el-table-column show-overflow-tooltip :prop="'openeddate'" :label="$t('entities.bug.main_buildsub_grid.columns.openeddate')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.bug.main_buildsub_grid.columns.openeddate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
