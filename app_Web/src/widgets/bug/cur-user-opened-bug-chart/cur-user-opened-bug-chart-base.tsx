...
import CurUserOpenedBugService from './cur-user-opened-bug-chart-service';
 ...
 */
export class CurUserOpenedBugChartBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof CurUserOpenedBugChartBase
     */
    ...
    */
    ...
    categorField:'pri',
    categorCodeList:{type:'STATIC',tag:'Bug__pri',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"pri",codelist:{type:"STATIC",tag:"Bug__pri",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:""},
