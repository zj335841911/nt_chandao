...
import BugOpenedBy_ProjectService from './bug-opened-by-project-chart-service';
 ...
 */
export class BugOpenedBy_ProjectChartBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof BugOpenedBy_ProjectChartBase
     */
