...
import BugOpenedByService from './bug-opened-by-chart-service';
...
/**
 * dashboard_sysportlet13_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugOpenedByChartBase}
 */
export class BugOpenedByChartBase extends MainControlBase {
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet13_chartBase
     */
    ...
    public chartUserParams:any ={
        color:["#00A9FC","#FF5D5D","#FDC137","#3D5AFE",'#651FFF','#D500F9','#F50057','#FF1744','#BD7B46']
    };
