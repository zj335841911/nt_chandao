...
export class Main_PlanSubGridBase extends GridControlBase {
    ...
    public allExportColumns: any[] = [
        ...
        },
        {
            name: 'productname',
            label: '产品',
            langtag: 'entities.bug.main_plansub_grid.exportColumns.productname',
            show: true,
        },
        {
            name: 'projectname',
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','pri','title','status','openedby','openeddate','assignedto','uagridcolumn1','isfavorites'];
        if(row && row.children) {
