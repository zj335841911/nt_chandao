...
import Main_ReleaseSubRModel from './main-release-sub-r-grid-model';


/**
 * Main_ReleaseSubR 部件服务对象
 *
 * @export
 * @class Main_ReleaseSubRService
 */
export default class Main_ReleaseSubRService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof Main_ReleaseSubRService
     */
    ...
    /**
     * Creates an instance of Main_ReleaseSubRService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_ReleaseSubRService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_ReleaseSubRModel();
    }
