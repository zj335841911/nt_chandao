...
import BugModuleService from './bug-module-chart-service';
...
/**
 * dashboard_sysportlet14_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugModuleChartBase}
 */
export class BugModuleChartBase extends MainControlBase {
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet14_chartBase
     */
    ...
    public chartUserParams:any ={
        color:["#00DA88","#7EC5FF","#8666B8","#BD7B46",'#FF9100','#FF3D00','#F57F17','#00E5FF','#00B0FF','#2979FF','#3D5AFE','#651FFF','#D500F9']
    };
