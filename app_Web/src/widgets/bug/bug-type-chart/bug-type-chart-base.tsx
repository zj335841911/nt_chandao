...
import BugTypeService from './bug-type-chart-service';
...
/**
 * dashboard_sysportlet10_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugTypeChartBase}
 */
export class BugTypeChartBase extends MainControlBase {
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_sysportlet10_chartBase
     */
