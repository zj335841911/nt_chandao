...
/**
 * DashboardMain 部件服务对象
 *
 * @export
 * @class DashboardMainService
 */
export default class DashboardMainService extends ControlService {
    ...
    /**
     * Creates an instance of DashboardMainService.
     * 
     * @param {*} [opts={}]
     * @memberof DashboardMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DashboardMainModel();
    }
