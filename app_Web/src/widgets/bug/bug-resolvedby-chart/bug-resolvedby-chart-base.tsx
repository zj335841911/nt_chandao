...
import BugRESOLVEDBYService from './bug-resolvedby-chart-service';
 ...
 */
export class BugRESOLVEDBYChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof BugRESOLVEDBYChartBase
     */
