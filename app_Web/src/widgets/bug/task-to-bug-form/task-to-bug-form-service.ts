...
import TaskToBugModel from './task-to-bug-form-model';
 ...
 *
 * @export
 * @class TaskToBugService
 */
export default class TaskToBugService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof TaskToBugService
     */
    ...
    /**
     * Creates an instance of TaskToBugService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskToBugService
     */
