...
import BugStatus_ProjectService from './bug-status-project-chart-service';
...
/**
 * dashboard_BugStatusProject_chart部件基类
 *
 * @export
 * @class MainControlBase
 * @extends {BugStatus_ProjectChartBase}
 */
export class BugStatus_ProjectChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof BugStatus_ProjectChartBase
     */
    ...
    */
     ...
     * @public
     * @type {boolean}
     * @memberof Dashboard_BugStatusProject_chartBase
     */
    ...
    public  seriesModel:any = {
        bugstatus:new ChartPieSeries({
    name:'bugstatus',
    
    
    categorField:'status',
    categorCodeList:{type:'STATIC',tag:'Bug__status',emptycode:'empty',emptytext:'未定义'},
    ...
    seriesMap:{},
    dataSetFields:[
    {name:"status",codelist:{type:"STATIC",tag:"Bug__status",emptycode:'empty',emptytext:'未定义'},isGroupField:true,groupMode:"CODELIST"},
    ...
    public chartUserParams:any ={
        color:["#FF9100","#FF3D00","#F57F17","#FF5D5D",'#FDC137','#00DA88','#7ECFF','#8666B8','#BD7B46']
    };
