...
import CurUserResolveBugService from './cur-user-resolve-bug-chart-service';
 ...
 */
export class CurUserResolveBugChartBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CurUserResolveBugChartBase
     */
