...
import StoryAffectBugModel from './story-affect-bug-grid-model';


/**
 * StoryAffectBug 部件服务对象
 *
 * @export
 * @class StoryAffectBugService
 */
export default class StoryAffectBugService extends ControlService {

    /**
     * Bug服务对象
     *
     * @type {BugService}
     * @memberof StoryAffectBugService
     */
    ...
    /**
     * Creates an instance of StoryAffectBugService.
     * 
     * @param {*} [opts={}]
     * @memberof StoryAffectBugService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StoryAffectBugModel();
    }
