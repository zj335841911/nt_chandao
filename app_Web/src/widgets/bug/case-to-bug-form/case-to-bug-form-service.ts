 ...
 *
 * @export
 * @class CaseToBugService
 */
export default class CaseToBugService extends ControlService {
    ...
    /**
     * Creates an instance of CaseToBugService.
     * 
     * @param {*} [opts={}]
     * @memberof CaseToBugService
     */
