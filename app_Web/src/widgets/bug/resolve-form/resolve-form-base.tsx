...
export class ResolveEditFormBase extends EditFormControlBase {
    ...
    public rules():any{
        return {
        resolution: [
            { required: this.detailsModel.resolution.required, type: 'string', message: '解决方案 值不能为空', trigger: 'change' },
            { required: this.detailsModel.resolution.required, type: 'string', message: '解决方案 值不能为空', trigger: 'blur' },
        ],
        resolvedbuild: [
            { required: this.detailsModel.resolvedbuild.required, type: 'string', message: '解决版本 值不能为空', trigger: 'change' },
            { required: this.detailsModel.resolvedbuild.required, type: 'string', message: '解决版本 值不能为空', trigger: 'blur' },
        ],
        buildproject: [
            { required: this.detailsModel.buildproject.required, type: 'string', message: '解决版本/所属项目 值不能为空', trigger: 'change' },
            { required: this.detailsModel.buildproject.required, type: 'string', message: '解决版本/所属项目 值不能为空', trigger: 'blur' },
        ],
        buildname: [
            { required: this.detailsModel.buildname.required, type: 'string', message: ' 值不能为空', trigger: 'change' },
            { required: this.detailsModel.buildname.required, type: 'string', message: ' 值不能为空', trigger: 'blur' },
        ],
        }
    }
    ...
    public detailsModel: any = {
        ...
        resolution: new FormItemModel({ caption: '解决方案', detailType: 'FORMITEM', name: 'resolution', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        resolvedbuild: new FormItemModel({ caption: '解决版本', detailType: 'FORMITEM', name: 'resolvedbuild', visible: false, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        buildproject: new FormItemModel({ caption: '解决版本/所属项目', detailType: 'FORMITEM', name: 'buildproject', visible: false, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        buildname: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'buildname', visible: false, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        createbuild: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'createbuild', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),

        resolveddate: new FormItemModel({ caption: '解决日期', detailType: 'FORMITEM', name: 'resolveddate', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
