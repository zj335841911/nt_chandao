...
import DocLibLModel from './doc-lib-l-grid-model';
 ...
 *
 * @export
 * @class DocLibLService
 */
export default class DocLibLService extends ControlService {

    /**
     * 附件服务对象
     *
     * @type {FileService}
     * @memberof DocLibLService
     */
    ...
    /**
     * Creates an instance of DocLibLService.
     * 
     * @param {*} [opts={}]
     * @memberof DocLibLService
     */
