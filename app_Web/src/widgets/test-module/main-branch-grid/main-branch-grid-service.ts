...
import MainBranchModel from './main-branch-grid-model';
 ...
 *
 * @export
 * @class MainBranchService
 */
export default class MainBranchService extends ControlService {

    /**
     * 测试模块服务对象
     *
     * @type {TestModuleService}
     * @memberof MainBranchService
     */
    ...
    /**
     * Creates an instance of MainBranchService.
     * 
     * @param {*} [opts={}]
     * @memberof MainBranchService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MainBranchModel();
    }
    ...
    public mergeDefaults(response:any = {}){ 
        if(response.data){                    
            ...
            Object.assign(response.data,{'branch':'srfparentkey'});
