...
export default class ModuleExpBase extends Vue implements ControlInterface {
     ...
     * @memberof ModuleExp
     */
    protected service: ModuleExpService = new ModuleExpService({ $store: this.$store });
    ...
    protected rootmodule_cm_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction2')) {
            this.rootmodule_cm_deuiaction2_click($event, 'rootmodule_cm', $event2);
        }
    }
    ...
    protected root_nobranch_cm_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'deuiaction2')) {
            this.root_nobranch_cm_deuiaction2_click($event, 'root_nobranch_cm', $event2);
        }
    }
     ...
     * @memberof ModuleExp
     */
    protected branch_cm_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1')) {
            this.branch_cm_deuiaction1_click($event, 'branch_cm', $event2);
        }
    }
    ...
    protected root_nobranch_cm_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.TestModule_OpenQuickCfgView(datas,contextJO, paramJO,  $event, xData,this,"TestModule");
    }
     ...
     * @memberof 
     */
    protected root_nobranch_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected module_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected branch_cm_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected rootmodule_cm_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof TestModuleTreeExpViewBase
     */
    protected RefreshAll(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
     ...
     * @memberof ModuleExp
     */
    protected renderContextMenuBranch() {
        return (
