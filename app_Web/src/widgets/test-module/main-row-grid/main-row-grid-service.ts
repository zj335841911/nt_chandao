...
import MainRowModel from './main-row-grid-model';
 ...
 *
 * @export
 * @class MainRowService
 */
export default class MainRowService extends ControlService {

    /**
     * 测试模块服务对象
     *
     * @type {TestModuleService}
     * @memberof MainRowService
     */
    ...
    /**
     * Creates an instance of MainRowService.
     * 
     * @param {*} [opts={}]
     * @memberof MainRowService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.testmodule = Util.createUUID();
                }
    ...
    public mergeDefaults(response:any = {}){ 
        if(response.data){                    
            ...
            Object.assign(response.data,{'type':'moduletype'});
        }
    }
