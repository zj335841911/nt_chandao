...
import MainLModel from './main-l-form-model';
 ...
 * @class MainLService
 */
export default class MainLService extends ControlService {

    /**
     * 更新日志服务对象
     *
     * @type {SysUpdateLogService}
     * @memberof MainLService
     */
    ...
    /**
     * Creates an instance of MainLService.
     * 
     * @param {*} [opts={}]
     * @memberof MainLService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.sysupdatelogid = PrimaryKey;
        Data.sysupdatelog = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.sysupdatelogid = PrimaryKey;
