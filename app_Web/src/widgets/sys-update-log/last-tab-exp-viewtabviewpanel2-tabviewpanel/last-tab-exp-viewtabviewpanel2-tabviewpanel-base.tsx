...
export class LastTabExpViewtabviewpanel2TabviewpanelBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof LastTabExpViewtabviewpanel2TabviewpanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {LastTabExpViewtabviewpanel2Service}
     * @memberof LastTabExpViewtabviewpanel2TabviewpanelBase
     */
    public service: LastTabExpViewtabviewpanel2Service = new LastTabExpViewtabviewpanel2Service({ $store: this.$store });
     ...
     *
     * @type {*}
     * @memberof LastTabExpViewtabviewpanel2
     */
    @Prop()
