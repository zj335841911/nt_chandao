...
import LookMainModel from './look-main-grid-model';
 ...
 *
 * @export
 * @class LookMainService
 */
export default class LookMainService extends ControlService {

    /**
     * 更新日志服务对象
     *
     * @type {SysUpdateLogService}
     * @memberof LookMainService
     */
    ...
    /**
     * Creates an instance of LookMainService.
     * 
     * @param {*} [opts={}]
     * @memberof LookMainService
     */
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.sysupdatelogid = Util.createUUID();
                }
