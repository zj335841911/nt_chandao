...
import InfoMainService from './info-main-form-service';
 ...
 */
export class InfoMainEditFormBase extends EditFormControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof InfoMainEditFormBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {InfoMainService}
     * @memberof InfoMainEditFormBase
     */
    public service: InfoMainService = new InfoMainService({ $store: this.$store });
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '系统更新功能基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.sysupdatefeatures.infomain_form', extractMode: 'ITEM', details: [] } }),

        formpage1: new FormPageModel({ caption: '基本信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this, showMoreMode: 0 }),

        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.sysupdatefeatures.infomain_form', extractMode: 'ITEM', details: [] } }),
