...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: SysUpdateFeaturesService = new SysUpdateFeaturesService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public sysupdatelogService: SysUpdateLogService = new SysUpdateLogService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'SysUpdateLogService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.sysupdatelogService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'sysupdatelogid', 'sysupdatelog');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.sysupdatefeaturesid = PrimaryKey;
        Data.sysupdatefeatures = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.sysupdatefeaturesid = PrimaryKey;
