            ...
            sys_update_logname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.sysupdatefeatures.main_form.details.sys_update_logname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.sys_update_logname.required,
            ...
            type: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.sysupdatefeatures.main_form.details.type')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.type.required,
            ...
            upfeatures: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.sysupdatefeatures.main_form.details.upfeatures')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.upfeatures.required,
            ...
            displayorder: [
                {
                    ...
                    type: 'number',
                    message: `${this.$t('entities.sysupdatefeatures.main_form.details.displayorder')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.displayorder.required,
