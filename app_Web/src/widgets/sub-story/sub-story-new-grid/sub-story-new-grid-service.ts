 ...
 *
 * @export
 * @class SubStoryNewService
 */
export default class SubStoryNewService extends ControlService {

    /**
     * 需求服务对象
     *
     * @type {SubStoryService}
     * @memberof SubStoryNewService
     */
    public appEntityService: SubStoryService = new SubStoryService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of SubStoryNewService.
     * 
     * @param {*} [opts={}]
     * @memberof SubStoryNewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new SubStoryNewModel();
    }
