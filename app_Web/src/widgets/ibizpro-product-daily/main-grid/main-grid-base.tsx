...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibizpro_productdaily_main_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            label: '产品日报名称',
            langtag: 'entities.ibizproproductdaily.main_grid.columns.ibizpro_productdailyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibizproproductdaily.main_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '产品日报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '产品日报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibizproproductdailyid === data.srfkey;
                })
                if(targetData){
