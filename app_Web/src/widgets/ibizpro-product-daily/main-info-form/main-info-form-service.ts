...
export default class MainInfoService extends ControlService {
     ...
     */
    public appEntityService: IbizproProductDailyService = new IbizproProductDailyService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of MainInfoService.
     * 
     * @param {*} [opts={}]
     * @memberof MainInfoService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibizproproductdailyid = PrimaryKey;
        Data.ibizproproductdaily = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibizproproductdailyid = PrimaryKey;
