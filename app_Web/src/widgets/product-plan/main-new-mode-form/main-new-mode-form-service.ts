...
import Main_NewModeModel from './main-new-mode-form-model';
 ...
 *
 * @export
 * @class Main_NewModeService
 */
export default class Main_NewModeService extends ControlService {

    /**
     * 产品计划服务对象
     *
     * @type {ProductPlanService}
     * @memberof Main_NewModeService
     */
    ...
    /**
     * Creates an instance of Main_NewModeService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_NewModeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_NewModeModel();
    }
