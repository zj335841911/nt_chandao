    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ productplan: keys.join(';') }),Object.assign({ productplan: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
