...
import ImportPlanTempletModel from './import-plan-templet-form-model';


/**
 * ImportPlanTemplet 部件服务对象
 *
 * @export
 * @class ImportPlanTempletService
 */
export default class ImportPlanTempletService extends ControlService {

    /**
     * 产品计划服务对象
     *
     * @type {ProductPlanService}
     * @memberof ImportPlanTempletService
     */
    ...
    /**
     * Creates an instance of ImportPlanTempletService.
     * 
     * @param {*} [opts={}]
     * @memberof ImportPlanTempletService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ImportPlanTempletModel();
    }
