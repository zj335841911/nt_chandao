 ...
 */
export class MainTabExptabviewpanel2TabviewpanelBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof MainTabExptabviewpanel2TabviewpanelBase
     */
     ...
     * @memberof MainTabExptabviewpanel2Base
     */  
