 ...
 * @export
 * @class CtrlBase
 * @extends {MainTabExptabviewpanel2Base}
 */
@Component({
    components: {
...
export default class MainTabExptabviewpanel2Base extends CtrlBase {

    /**
     * 建构部件服务对象
     *
     * @type {MainTabExptabviewpanel2Service}
     * @memberof MainTabExptabviewpanel2
     */
    public service: MainTabExptabviewpanel2Service = new MainTabExptabviewpanel2Service({ $store: this.$store });
...
<style lang='less'>
@import './main-tab-exptabviewpanel2-tabviewpanel.less';
</style>