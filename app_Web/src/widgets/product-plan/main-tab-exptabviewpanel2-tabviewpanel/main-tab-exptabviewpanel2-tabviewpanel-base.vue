...
export default class MainTabExptabviewpanel2Base extends Vue implements ControlInterface {
     ...
     * @memberof MainTabExptabviewpanel2
     */
    protected service: MainTabExptabviewpanel2Service = new MainTabExptabviewpanel2Service({ $store: this.$store });
