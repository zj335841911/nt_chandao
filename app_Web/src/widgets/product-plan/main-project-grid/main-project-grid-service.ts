...
import MainProjectModel from './main-project-grid-model';
 ...
 */
export default class MainProjectService extends ControlService {

    /**
     * 产品计划服务对象
     *
     * @type {ProductPlanService}
     * @memberof MainProjectService
     */
    ...
    /**
     * Creates an instance of MainProjectService.
     * 
     * @param {*} [opts={}]
     * @memberof MainProjectService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new MainProjectModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.productplan = Util.createUUID();
                }
