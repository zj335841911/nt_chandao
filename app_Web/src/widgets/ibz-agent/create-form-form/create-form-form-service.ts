...
import CreateFormModel from './create-form-form-model';
 ...
 */
export default class CreateFormService extends ControlService {

    /**
     * 代理服务对象
     *
     * @type {IbzAgentService}
     * @memberof CreateFormService
     */
    public appEntityService: IbzAgentService = new IbzAgentService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of CreateFormService.
     * 
     * @param {*} [opts={}]
     * @memberof CreateFormService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibzagentid = PrimaryKey;
        Data.ibzagent = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibzagentid = PrimaryKey;
