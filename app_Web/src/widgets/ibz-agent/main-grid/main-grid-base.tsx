...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_uef4000f_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        curUIService.IbzAgent_Edit(datas,contextJO, paramJO,  $event, xData,this,"IbzAgent");
    }
     ...
     * @memberof MainGridBase
     */
    public columnKeyName: string = "ibz_agentid";
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibz_agent_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'ibz_agentid',
            label: '代理标识',
            langtag: 'entities.ibzagent.main_grid.columns.ibz_agentid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'agentuser',
            label: '代理用户',
            langtag: 'entities.ibzagent.main_grid.columns.agentuser',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'agentbegin',
            label: '代理开始日期',
            langtag: 'entities.ibzagent.main_grid.columns.agentbegin',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'agentend',
            label: '代理结束日期',
            langtag: 'entities.ibzagent.main_grid.columns.agentend',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.ibzagent.main_grid.columns.uagridcolumn1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '代理标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '代理标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Edit', tag)) {
            this.grid_uagridcolumn1_uef4000f_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibz_agentid','agentuser','agentbegin','agentend','uagridcolumn1'];
        if(row && row.children) {
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.ibzagentid === data.srfkey;
                })
                if(targetData){
