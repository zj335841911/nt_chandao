...
export class MainEditGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u68709de_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u53c485b_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Edit', tag)) {
            this.grid_uagridcolumn1_u68709de_click(row, tag, $event);
        }
        if(Object.is('Remove', tag)) {
            this.grid_uagridcolumn1_u53c485b_click(row, tag, $event);
        }
    }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['id','dates','consumed','left','work','uagridcolumn1'];
        if(row && row.children) {
