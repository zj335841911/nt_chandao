...
import MainLookModel from './main-look-grid-model';
 ...
 *
 * @export
 * @class MainLookService
 */
export default class MainLookService extends ControlService {

    /**
     * 任务预计服务对象
     *
     * @type {TaskEstimateService}
     * @memberof MainLookService
     */
    ...
    /**
     * Creates an instance of MainLookService.
     * 
     * @param {*} [opts={}]
     * @memberof MainLookService
     */
