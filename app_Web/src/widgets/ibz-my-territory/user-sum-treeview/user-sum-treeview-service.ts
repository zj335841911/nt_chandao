...
import UserSumModel from './user-sum-treeview-model';
 ...
 *
 * @export
 * @class UserSumService
 */
export default class UserSumService extends ControlService {
    ...
    /**
     * Creates an instance of UserSumService.
     * 
     * @param {*} [opts={}]
     * @memberof UserSumService
     */
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzmyterritory.usersum_treeview.nodes.root') });
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充用户完成任务汇总表
            let UserfinashtasksumRsNavContext:any = {};
