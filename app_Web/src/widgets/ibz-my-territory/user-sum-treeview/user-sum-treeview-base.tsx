...
import UserSumService from './user-sum-treeview-service';
 ...
 * @extends {UserSumTreeBase}
 */
export class UserSumTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof UserSumTreeBase
     */
     ...
     * @memberof UserSumTreeBase
     */
    public service: UserSumService = new UserSumService({ $store: this.$store });
