...
import EmployEeloadModel from './employ-eeload-treeview-model';
 ...
 */
export default class EmployEeloadService extends ControlService {
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.model = new EmployEeloadModel();
    }
     ...
     * @memberof EmployEeloadService
     */
	public TREENODE_EMPLOYEELOAD: string = 'EmployEeload';
     ...
     */
    @Errorlog
    public fillCompanydynamicstatsNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzmyterritory.employeeload_treeview.nodes.companydynamicstats') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
            let strNodeId: string = 'CompanyDynamicStats';
     ...
     */
    @Errorlog
    public fillEmployeeloadNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzmyterritory.employeeload_treeview.nodes.employeeload') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
            let strNodeId: string = 'EmployEeload';
     ...
     */
    @Errorlog
    public async fillEmployeeloadNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
		} else {
		}
	}
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzmyterritory.employeeload_treeview.nodes.root') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
            ...
            let EmployeeloadRsNavParams:any = {};
            let EmployeeloadRsParams:any = {};
			await this.fillEmployeeloadNodes(context, filter, list ,EmployeeloadRsNavContext,EmployeeloadRsNavParams,EmployeeloadRsParams);
			// 填充公司动态汇总表
            let CompanydynamicstatsRsNavContext:any = {};
