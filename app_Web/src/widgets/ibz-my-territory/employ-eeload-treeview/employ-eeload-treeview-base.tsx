...
import EmployEeloadService from './employ-eeload-treeview-service';
 ...
 * @extends {EmployEeloadTreeBase}
 */
export class EmployEeloadTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof EmployEeloadTreeBase
     */
     ...
     * @memberof EmployEeloadTreeBase
     */
    public service: EmployEeloadService = new EmployEeloadService({ $store: this.$store });
