...
import ALLReportTabExpViewtabexppanelService from './allreport-tab-exp-viewtabexppanel-tabexppanel-service';
 ...
 * @extends {ALLReportTabExpViewtabexppanelTabexppanelBase}
 */
export class ALLReportTabExpViewtabexppanelTabexppanelBase extends TabExpPanelControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ALLReportTabExpViewtabexppanelTabexppanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ALLReportTabExpViewtabexppanelService}
     * @memberof ALLReportTabExpViewtabexppanelTabexppanelBase
     */
    public service: ALLReportTabExpViewtabexppanelService = new ALLReportTabExpViewtabexppanelService({ $store: this.$store });
