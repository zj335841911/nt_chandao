...
import UserFinishTaskSumService from './user-finish-task-sum-grid-service';
 ...
 * @extends {UserFinishTaskSumGridBase}
 */
export class UserFinishTaskSumGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof UserFinishTaskSumGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {UserFinishTaskSumService}
     * @memberof UserFinishTaskSumGridBase
     */
    public service: UserFinishTaskSumService = new UserFinishTaskSumService({ $store: this.$store });
     ...
     * @memberof UserFinishTaskSumBase
     */
    protected localStorageTag: string = 'ibz_myterritory_userfinishtasksum_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'projectname',
            label: '项目名称',
            langtag: 'entities.ibzmyterritory.userfinishtasksum_grid.columns.projectname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'finishedby',
            label: '完成者',
            langtag: 'entities.ibzmyterritory.userfinishtasksum_grid.columns.finishedby',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalestimate',
            label: '预计总工时',
            langtag: 'entities.ibzmyterritory.userfinishtasksum_grid.columns.totalestimate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalconsumed',
            label: '消耗总工时',
            langtag: 'entities.ibzmyterritory.userfinishtasksum_grid.columns.totalconsumed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalleft',
            label: '剩余总工时',
            langtag: 'entities.ibzmyterritory.userfinishtasksum_grid.columns.totalleft',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
