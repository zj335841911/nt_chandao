...
export class TabExpViewtabviewpanel8TabviewpanelBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof TabExpViewtabviewpanel8TabviewpanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TabExpViewtabviewpanel8Service}
     * @memberof TabExpViewtabviewpanel8TabviewpanelBase
     */
    public service: TabExpViewtabviewpanel8Service = new TabExpViewtabviewpanel8Service({ $store: this.$store });
     ...
     *
     * @type {*}
     * @memberof TabExpViewtabviewpanel8
     */
    @Prop()
