...
import ProductSumService from './product-sum-treeview-service';
 ...
 */
export class ProductSumTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductSumTreeBase
     */
     ...
     * @memberof ProductSumTreeBase
     */
    public service: ProductSumService = new ProductSumService({ $store: this.$store });
