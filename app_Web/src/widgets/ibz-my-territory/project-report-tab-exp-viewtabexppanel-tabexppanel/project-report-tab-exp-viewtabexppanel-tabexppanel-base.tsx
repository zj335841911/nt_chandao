...
import ProjectReportTabExpViewtabexppanelService from './project-report-tab-exp-viewtabexppanel-tabexppanel-service';
 ...
 */
export class ProjectReportTabExpViewtabexppanelTabexppanelBase extends TabExpPanelControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProjectReportTabExpViewtabexppanelTabexppanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProjectReportTabExpViewtabexppanelService}
     * @memberof ProjectReportTabExpViewtabexppanelTabexppanelBase
     */
    public service: ProjectReportTabExpViewtabexppanelService = new ProjectReportTabExpViewtabexppanelService({ $store: this.$store });
     ...
     * @memberof ProjectReportTabExpViewtabexppanelBase
     */  
