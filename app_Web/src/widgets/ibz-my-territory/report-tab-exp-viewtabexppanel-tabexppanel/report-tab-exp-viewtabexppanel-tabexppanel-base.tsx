...
import ReportTabExpViewtabexppanelService from './report-tab-exp-viewtabexppanel-tabexppanel-service';
 ...
 * @extends {ReportTabExpViewtabexppanelTabexppanelBase}
 */
export class ReportTabExpViewtabexppanelTabexppanelBase extends TabExpPanelControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ReportTabExpViewtabexppanelTabexppanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ReportTabExpViewtabexppanelService}
     * @memberof ReportTabExpViewtabexppanelTabexppanelBase
     */
    public service: ReportTabExpViewtabexppanelService = new ReportTabExpViewtabexppanelService({ $store: this.$store });
