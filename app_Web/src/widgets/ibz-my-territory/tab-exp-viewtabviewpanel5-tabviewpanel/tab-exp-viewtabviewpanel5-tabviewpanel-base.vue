...
export default class TabExpViewtabviewpanel5Base extends Vue implements ControlInterface {
     ...
     * @memberof TabExpViewtabviewpanel5
     */
    protected service: TabExpViewtabviewpanel5Service = new TabExpViewtabviewpanel5Service({ $store: this.$store });
...
<style lang='less'>
@import './tab-exp-viewtabviewpanel5-tabviewpanel.less';
</style>