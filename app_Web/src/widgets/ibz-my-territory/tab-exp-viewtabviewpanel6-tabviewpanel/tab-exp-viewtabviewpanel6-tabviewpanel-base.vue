...
export default class TabExpViewtabviewpanel6Base extends Vue implements ControlInterface {
     ...
     * @memberof TabExpViewtabviewpanel6
     */
    protected service: TabExpViewtabviewpanel6Service = new TabExpViewtabviewpanel6Service({ $store: this.$store });
...
<style lang='less'>
@import './tab-exp-viewtabviewpanel6-tabviewpanel.less';
</style>