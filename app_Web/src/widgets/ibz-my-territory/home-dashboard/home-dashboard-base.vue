...
export default class HomeBase extends Vue implements ControlInterface {
     ...
     * @memberof Home
     */
    protected service: HomeService = new HomeService({ $store: this.$store });
     ...
     * @memberof Home
     */
    protected modelId:string = "dashboard_ibzmyterritory_home";
