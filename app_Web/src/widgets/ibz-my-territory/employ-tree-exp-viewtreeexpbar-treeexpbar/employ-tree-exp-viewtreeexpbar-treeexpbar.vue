...
import view_treeexpbar_tree from '@widgets/ibz-my-territory/employ-eeload-treeview/employ-eeload-treeview.vue';
 ...
 *
 * @export
 * @class EmployTreeExpViewtreeexpbarTreeExpBar
