 ...
 *
 * @export
 * @class Main_EditRowService
 */
export default class Main_EditRowService extends ControlService {
     ...
     */
    public appEntityService: ProjectTeamService = new ProjectTeamService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of Main_EditRowService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_EditRowService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_EditRowModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.projectteam = Util.createUUID();
                }
    ...
    public mergeDefaults(response:any = {}){ 
        if(response.data){                    
            ...
            Object.assign(response.data,{'days':'45'});
