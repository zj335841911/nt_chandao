...
export class InfoEditEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        lasteditedby: new FormItemModel({ caption: '由谁修改', detailType: 'FORMITEM', name: 'lasteditedby', visible: true, isShowCaption: true, form: this, showMoreMode: 0, disabled: false, enableCond: 3 }),
