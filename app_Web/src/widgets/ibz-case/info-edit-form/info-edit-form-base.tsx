...
export class InfoEditEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        libname: new FormItemModel({ caption: '用例库', detailType: 'FORMITEM', name: 'libname', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        lasteditedby: new FormItemModel({ caption: '由谁修改', detailType: 'FORMITEM', name: 'lasteditedby', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
        ...
        lib: new FormItemModel({ caption: '编号', detailType: 'FORMITEM', name: 'lib', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
