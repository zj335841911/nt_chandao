...
import InfoEditModel from './info-edit-form-model';
...
export default class InfoEditService extends ControlService {
    ...
    /**
     * Creates an instance of InfoEditService.
     * 
     * @param {*} [opts={}]
     * @memberof InfoEditService
     */
     ...
     * @memberof InfoEditService
     */
    public ibzlibService: IbzLibService = new IbzLibService();
     ...
     * @memberof InfoEditService
     */
    public ibzlibmoduleService: IbzLibModuleService = new IbzLibModuleService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'IbzLibService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.ibzlibService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'id', 'ibzlib');
        }
        if (Object.is(serviceName, 'IbzLibModuleService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.ibzlibmoduleService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'id', 'ibzlibmodule');
        }
