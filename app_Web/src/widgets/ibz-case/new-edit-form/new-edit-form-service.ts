...
import NewEditModel from './new-edit-form-model';
...
export default class NewEditService extends ControlService {
     ...
     */
    public appEntityService: IbzCaseService = new IbzCaseService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of NewEditService.
     * 
     * @param {*} [opts={}]
     * @memberof NewEditService
     */
