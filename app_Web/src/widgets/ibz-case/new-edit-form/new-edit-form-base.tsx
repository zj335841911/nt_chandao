...
export class NewEditEditFormBase extends EditFormControlBase {
    ...
    public detailsModel: any = {
        ...
        lasteditedby: new FormItemModel({ caption: '由谁编辑', detailType: 'FORMITEM', name: 'lasteditedby', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
