<template>
    <div class='porlet cur-suit-case-grid-view' :style="{}">
...
export default class TestSuiteCurSuitCaseGridViewBase extends Vue implements ControlInterface {
     ...
     * @memberof CurSuitCaseGridView
     */
    protected service: CurSuitCaseGridViewService = new CurSuitCaseGridViewService({ $store: this.$store });
...
<style lang='less'>
@import './cur-suit-case-grid-view-portlet.less';
</style>