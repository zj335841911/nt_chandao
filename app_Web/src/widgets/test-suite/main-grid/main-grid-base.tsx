...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u6440a22_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"TestSuite");
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { testsuite: args[0].testsuite })
            }
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Edit', tag)) {
            this.grid_uagridcolumn1_u6440a22_click(row, tag, $event);
        }
