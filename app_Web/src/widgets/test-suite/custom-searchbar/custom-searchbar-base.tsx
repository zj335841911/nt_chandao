...
export class CustomSearchbarBase extends MainControlBase {
    ...
    public detailsModel: any = {
        'namelike': {
            label: '名称',
            localetag: 'entities.testsuite.fields.name',
            name: 'namelike',
            prop: 'name',
            mode: 'LIKE',
            disabled: false
        ...
        'producteq': {
            label: '所属产品',
            localetag: 'entities.testsuite.fields.product',
            name: 'producteq',
            prop: 'product',
            mode: 'EQ',
            disabled: false
        ...
        'typeeq': {
            label: '类型',
            localetag: 'entities.testsuite.fields.type',
            name: 'typeeq',
            prop: 'type',
            mode: 'EQ',
            disabled: false
     ...
     * @memberof CustomBase
     */
    public appdeName: string = 'TestSuite';
     ...
     * @memberof CustomBase
     */
    public modelId: string = "searchbar_testsuite_custom";
