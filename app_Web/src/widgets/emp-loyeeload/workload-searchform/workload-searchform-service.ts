...
import WorkloadModel from './workload-searchform-model';
 ...
 */
export default class WorkloadService extends ControlService {

    /**
     * 员工负载表服务对象
     *
     * @type {EmpLoyeeloadService}
     * @memberof WorkloadService
     */
    public appEntityService: EmpLoyeeloadService = new EmpLoyeeloadService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of WorkloadService.
     * 
     * @param {*} [opts={}]
     * @memberof WorkloadService
     */
