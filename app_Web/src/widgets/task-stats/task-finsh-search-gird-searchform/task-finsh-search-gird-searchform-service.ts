...
import TaskFinshSearchGirdModel from './task-finsh-search-gird-searchform-model';


/**
 * TaskFinshSearchGird 部件服务对象
 *
 * @export
 * @class TaskFinshSearchGirdService
 */
export default class TaskFinshSearchGirdService extends ControlService {

    /**
     * 任务统计服务对象
     *
     * @type {TaskStatsService}
     * @memberof TaskFinshSearchGirdService
     */
    public appEntityService: TaskStatsService = new TaskStatsService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of TaskFinshSearchGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskFinshSearchGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TaskFinshSearchGirdModel();
    }
