...
import UserFinishTaskModel from './user-finish-task-searchform-model';


/**
 * UserFinishTask 部件服务对象
 *
 * @export
 * @class UserFinishTaskService
 */
export default class UserFinishTaskService extends ControlService {

    /**
     * 任务统计服务对象
     *
     * @type {TaskStatsService}
     * @memberof UserFinishTaskService
     */
    ...
    /**
     * Creates an instance of UserFinishTaskService.
     * 
     * @param {*} [opts={}]
     * @memberof UserFinishTaskService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new UserFinishTaskModel();
    }
