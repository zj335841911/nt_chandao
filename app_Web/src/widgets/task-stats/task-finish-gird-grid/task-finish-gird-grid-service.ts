...
import TaskFinishGirdModel from './task-finish-gird-grid-model';


/**
 * TaskFinishGird 部件服务对象
 *
 * @export
 * @class TaskFinishGirdService
 */
export default class TaskFinishGirdService extends ControlService {

    /**
     * 任务统计服务对象
     *
     * @type {TaskStatsService}
     * @memberof TaskFinishGirdService
     */
    ...
    /**
     * Creates an instance of TaskFinishGirdService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskFinishGirdService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TaskFinishGirdModel();
    }
