...
import UserFinishTaskSumModel from './user-finish-task-sum-grid-model';


/**
 * UserFinishTaskSum 部件服务对象
 *
 * @export
 * @class UserFinishTaskSumService
 */
export default class UserFinishTaskSumService extends ControlService {

    /**
     * 任务统计服务对象
     *
     * @type {TaskStatsService}
     * @memberof UserFinishTaskSumService
     */
    ...
    /**
     * Creates an instance of UserFinishTaskSumService.
     * 
     * @param {*} [opts={}]
     * @memberof UserFinishTaskSumService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new UserFinishTaskSumModel();
    }
