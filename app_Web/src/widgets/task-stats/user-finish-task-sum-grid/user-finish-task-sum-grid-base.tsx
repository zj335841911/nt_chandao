...
export class UserFinishTaskSumGridBase extends GridControlBase {
     ...
     * @memberof UserFinishTaskSumBase
     */
    protected localStorageTag: string = 'ibz_taskstats_userfinishtasksum_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'projectname',
            label: '项目名称',
            langtag: 'entities.taskstats.userfinishtasksum_grid.columns.projectname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'finshedby',
            label: '完成者',
            langtag: 'entities.taskstats.userfinishtasksum_grid.columns.finshedby',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'totalconsumed',
            label: '消耗总工时',
            langtag: 'entities.taskstats.userfinishtasksum_grid.columns.totalconsumed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['projectname','finshedby','totalestimate','totalconsumed','totalleft'];
        if(row && row.children) {
