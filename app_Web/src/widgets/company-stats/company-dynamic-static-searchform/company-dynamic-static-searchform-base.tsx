...
, 
        n_date_gtandeq: new FormItemModel({ caption: '日志日期(大于等于(>=))', detailType: 'FORMITEM', name: 'n_date_gtandeq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        n_date_ltandeq: new FormItemModel({ caption: '日志日期(小于等于(<=))', detailType: 'FORMITEM', name: 'n_date_ltandeq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
