...
import CompanyDynamicStaticModel from './company-dynamic-static-searchform-model';


/**
 * CompanyDynamicStatic 部件服务对象
 *
 * @export
 * @class CompanyDynamicStaticService
 */
export default class CompanyDynamicStaticService extends ControlService {

    /**
     * 公司动态汇总服务对象
     *
     * @type {CompanyStatsService}
     * @memberof CompanyDynamicStaticService
     */
    public appEntityService: CompanyStatsService = new CompanyStatsService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of CompanyDynamicStaticService.
     * 
     * @param {*} [opts={}]
     * @memberof CompanyDynamicStaticService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CompanyDynamicStaticModel();
    }
