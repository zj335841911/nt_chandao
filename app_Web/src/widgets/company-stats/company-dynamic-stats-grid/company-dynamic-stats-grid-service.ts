...
import CompanyDynamicStatsModel from './company-dynamic-stats-grid-model';


/**
 * CompanyDynamicStats 部件服务对象
 *
 * @export
 * @class CompanyDynamicStatsService
 */
export default class CompanyDynamicStatsService extends ControlService {

    /**
     * 公司动态汇总服务对象
     *
     * @type {CompanyStatsService}
     * @memberof CompanyDynamicStatsService
     */
    ...
    /**
     * Creates an instance of CompanyDynamicStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof CompanyDynamicStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CompanyDynamicStatsModel();
    }
