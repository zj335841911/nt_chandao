...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.dept.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        parent: [
            { type: 'number', message: 'parent 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: 'parent 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: 'parent 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: 'parent 值不能为空', trigger: 'blur' },
        ],
    }
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.dept.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        name: new FormItemModel({ caption: '部门名称', detailType: 'FORMITEM', name: 'name', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        parentname: new FormItemModel({ caption: '上级部门', detailType: 'FORMITEM', name: 'parentname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        manager: new FormItemModel({ caption: '负责人', detailType: 'FORMITEM', name: 'manager', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        parent: new FormItemModel({ caption: 'parent', detailType: 'FORMITEM', name: 'parent', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
     ...
     */
    @Watch('data.manager')
    onManagerChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'manager', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.dept){
            Object.assign(this.context,{dept:data.dept})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.dept = copyData.srfkey;
        copyData.id = copyData.srfkey;
        Object.assign(this.context,{dept:copyData.dept})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'dept_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'DeptEditView视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'DeptEditView视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'DeptEditView视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'DeptEditView视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.dept || Object.is(arg.dept, '')) {
            return;
        }
