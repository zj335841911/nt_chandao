...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'sys_team_main_grid';
    ...
    public rules() {
        ...
        srfkey: [
            ...
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '组标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.teamid === data.srfkey;
                })
                if(targetData){
