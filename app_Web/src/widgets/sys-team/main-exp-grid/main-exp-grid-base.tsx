...
export class MainExpGridBase extends GridControlBase {
     ...
     * @memberof MainExpBase
     */
    protected localStorageTag: string = 'sys_team_mainexp_gridexpbar_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'teamid',
            label: '组标识',
            langtag: 'entities.systeam.mainexp_grid.columns.teamid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'teamname',
            label: '组名称',
            langtag: 'entities.systeam.mainexp_grid.columns.teamname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
