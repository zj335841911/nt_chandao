 ...
 *
 * @export
 * @class SubTaskNewService
 */
export default class SubTaskNewService extends ControlService {
     ...
     */
    public appEntityService: IBZ_SUBTASKService = new IBZ_SUBTASKService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of SubTaskNewService.
     * 
     * @param {*} [opts={}]
     * @memberof SubTaskNewService
     */
