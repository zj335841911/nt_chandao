      ...
      <i-col :md="{ span: 24, offset: 0 }">
        <card :bordered="false" dis-hover :padding="0">
          ...
          <view_db_testcontainer1 
              ...
              :context="context" 
              name="db_testcontainer1"  
              ref='db_testcontainer1' 
...
export default class TestPortalView_dbBase extends Vue implements ControlInterface {
     ...
     * @memberof TestPortalView_db
     */
    protected service: TestPortalView_dbService = new TestPortalView_dbService({ $store: this.$store });
     ...
     * @memberof TestPortalView_db
     */
    protected modelId:string = "dashboard_app_testportalview_db";
...
<style lang='less'>
@import './test-portal-view-db-dashboard.less';
</style>