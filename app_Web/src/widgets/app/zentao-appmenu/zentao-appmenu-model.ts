...
export default class ZentaoModel {
    ...
    private items: any[] = [
        	...
        	items: [
                ...
                ,
                		        {
                	id: '724B4797-5A73-4E45-B43E-DFB7CAEFD977',
                	name: 'menuitem24',
                	text: '员工年度统计',
                	type: 'MENUITEM',
                	counterid: '',
                	...
                	items: [
                        ...
                        ,
                        		        {
                        	id: '374FB4C2-55F1-40EA-BF1A-C890144C88EC',
                        	name: 'menuitem26',
                        	text: '测试',
                        	type: 'MENUITEM',
                        	counterid: '',
	...
	private funcs: any[] = [
        ...
        },
        {
            ...
            appfuncyype: 'APPVIEW',
            openmode: 'DRAWER_TOP',
            codename: 'useryearworkstatsqadashboardview',
            deResParameters: [],
            routepath: '/ibizpms/:ibizpms?/useryearworkstats/:useryearworkstats?/qadashboardview/:qadashboardview?',
            parameters: [
