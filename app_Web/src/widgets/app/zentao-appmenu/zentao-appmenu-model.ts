...
export default class ZentaoModel {
    ...
    private items: any[] = [
        ...
        ,
        	...
        	items: [
                		        {
                	id: '317B4BEF-CCCF-487A-B04B-2021B4BD8F3A',
                	name: 'menuitem14',
                	text: '菜单项',
                	type: 'MENUITEM',
                	counterid: '',
                ...
                ,
                		        {
                	id: 'E7255E77-4BC1-4119-B80E-44AF9187ED20',
                	name: 'menuitem15',
                	text: '菜单项',
                	type: 'MENUITEM',
                	counterid: '',
                ...
                ,
                		        {
                	id: 'D6E2FF39-7CD6-4871-9248-CC52AAE5244E',
                	name: 'menuitem16',
                	text: '菜单项',
                	type: 'MENUITEM',
                	counterid: '',
                ...
                ,
                		        {
                	id: '1215B872-6303-412D-B614-1528E825FB05',
                	name: 'menuitem17',
                	text: '菜单项',
                	type: 'MENUITEM',
                	counterid: '',
