...
export default class ProductPortalView_dbBase extends Vue implements ControlInterface {
     ...
     * @memberof ProductPortalView_db
     */
    protected service: ProductPortalView_dbService = new ProductPortalView_dbService({ $store: this.$store });
     ...
     * @memberof ProductPortalView_db
     */
    protected modelId:string = "dashboard_app_productportalview_db";
...
<style lang='less'>
@import './product-portal-view-db-dashboard.less';
</style>