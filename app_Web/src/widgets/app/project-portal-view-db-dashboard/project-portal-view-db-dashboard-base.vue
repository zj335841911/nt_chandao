...
export default class ProjectPortalView_dbBase extends Vue implements ControlInterface {
     ...
     * @memberof ProjectPortalView_db
     */
    protected service: ProjectPortalView_dbService = new ProjectPortalView_dbService({ $store: this.$store });
     ...
     * @memberof ProjectPortalView_db
     */
    protected modelId:string = "dashboard_app_projectportalview_db";
