 ...
 */
export class SubTaskNewGridBase extends MainControlBase {
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ subtask: _keys }),Object.assign({ subtask: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    ...
                    if(!this.updateAction){
                        ...
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.subtask){
                            Object.assign(this.context,{subtask:item.subtask});
                        }
