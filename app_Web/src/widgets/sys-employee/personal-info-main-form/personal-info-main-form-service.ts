...
import PersonalInfoMainModel from './personal-info-main-form-model';


/**
 * PersonalInfoMain 部件服务对象
 *
 * @export
 * @class PersonalInfoMainService
 */
export default class PersonalInfoMainService extends ControlService {

    /**
     * 人员服务对象
     *
     * @type {SysEmployeeService}
     * @memberof PersonalInfoMainService
     */
    ...
    /**
     * Creates an instance of PersonalInfoMainService.
     * 
     * @param {*} [opts={}]
     * @memberof PersonalInfoMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new PersonalInfoMainModel();
    }
