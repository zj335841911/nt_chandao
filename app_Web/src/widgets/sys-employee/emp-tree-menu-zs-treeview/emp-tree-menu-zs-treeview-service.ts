...
import EmpTreeMenuZSModel from './emp-tree-menu-zs-treeview-model';
...
/**
 * EmpTreeMenuZS 部件服务对象
 *
 * @export
 * @class EmpTreeMenuZSService
 */
export default class EmpTreeMenuZSService extends ControlService {

    /**
     * 人员服务对象
     *
     * @type {SysEmployeeService}
     * @memberof EmpTreeMenuZSService
     */
    ...
    /**
     * Creates an instance of EmpTreeMenuZSService.
     * 
     * @param {*} [opts={}]
     * @memberof EmpTreeMenuZSService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new EmpTreeMenuZSModel();
    }
    ...
    public fillProjectNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.project') });
    ...
    public fillPostNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.post') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.root') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public fillOrgempNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.orgemp') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
            ...
            try {
                this.searchDepart(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode, { leaf: false });
                        Object.assign(treeNode, { curData: entity });
                        Object.assign(treeNode, {navigateContext: {SRFPARENTKEY:"%sysdept%"} });
                        Object.assign(treeNode, {navigateParams: {srfparentkey:"%sysdept%"} });
                        Object.assign(treeNode, { nodeid: treeNode.srfkey });
                        Object.assign(treeNode, { nodeid2: filter.strRealNodeId });
    ...
    public fillConcatlistNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.concatlist') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
            ...
            try {
                this.searchSysteam(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode, { expanded: filter.isautoexpand });
                        Object.assign(treeNode, { leaf: false });
                        Object.assign(treeNode, { navfilter: "teamid" });
                        Object.assign(treeNode, { curData: entity });
                        Object.assign(treeNode, {navigateContext: {SRFPARENTKEY:"%systeam%"} });
                        Object.assign(treeNode, {navigateParams: {srfparentkey:"%systeam%"} });
                        Object.assign(treeNode, { nodeid: treeNode.srfkey });
                        Object.assign(treeNode, { nodeid2: filter.strRealNodeId });
    ...
    public fillTeamNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.sysemployee.emptreemenuzs_treeview.nodes.team') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
