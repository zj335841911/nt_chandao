...
import ExpMainDeptService from './exp-main-dept-grid-service';
 ...
 * @extends {ExpMainDeptGridBase}
 */
export class ExpMainDeptGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ExpMainDeptGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ExpMainDeptService}
     * @memberof ExpMainDeptGridBase
     */
    public service: ExpMainDeptService = new ExpMainDeptService({ $store: this.$store });
     ...
     * @memberof ExpMainDeptBase
     */
    protected localStorageTag: string = 'ibzemp_expmaindept_gridexpbar_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'userid',
            label: '用户标识',
            langtag: 'entities.sysemployee.expmaindept_grid.columns.userid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'personname',
            label: '姓名',
            langtag: 'entities.sysemployee.expmaindept_grid.columns.personname',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'nickname',
            label: '昵称别名',
            langtag: 'entities.sysemployee.expmaindept_grid.columns.nickname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
