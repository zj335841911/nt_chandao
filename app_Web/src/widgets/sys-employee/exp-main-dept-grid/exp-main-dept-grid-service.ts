...
import ExpMainDeptModel from './exp-main-dept-grid-model';
 ...
 *
 * @export
 * @class ExpMainDeptService
 */
export default class ExpMainDeptService extends ControlService {

    /**
     * 人员服务对象
     *
     * @type {SysEmployeeService}
     * @memberof ExpMainDeptService
     */
    ...
    /**
     * Creates an instance of ExpMainDeptService.
     * 
     * @param {*} [opts={}]
     * @memberof ExpMainDeptService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ExpMainDeptModel();
    }
