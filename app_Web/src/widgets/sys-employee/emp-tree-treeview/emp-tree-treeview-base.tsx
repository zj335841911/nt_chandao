...
import EmpTreeService from './emp-tree-treeview-service';
 ...
 * @extends {EmpTreeTreeBase}
 */
export class EmpTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof EmpTreeTreeBase
     */
     ...
     * @memberof EmpTreeTreeBase
     */
    public service: EmpTreeService = new EmpTreeService({ $store: this.$store });
