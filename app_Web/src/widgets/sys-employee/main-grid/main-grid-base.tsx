...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibzemp_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'userid',
            label: '用户标识',
            langtag: 'entities.sysemployee.main_grid.columns.userid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'sex',
            label: '性别',
            langtag: 'entities.sysemployee.main_grid.columns.sex',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'personname',
            label: '姓名',
            langtag: 'entities.sysemployee.main_grid.columns.personname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'nickname',
            label: '昵称别名',
            langtag: 'entities.sysemployee.main_grid.columns.nickname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'phone',
            label: '联系方式',
            langtag: 'entities.sysemployee.main_grid.columns.phone',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
