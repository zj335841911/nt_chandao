...
import ExpMainProjectMemberModel from './exp-main-project-member-grid-model';


/**
 * ExpMainProjectMember 部件服务对象
 *
 * @export
 * @class ExpMainProjectMemberService
 */
export default class ExpMainProjectMemberService extends ControlService {

    /**
     * 人员服务对象
     *
     * @type {SysEmployeeService}
     * @memberof ExpMainProjectMemberService
     */
    ...
    /**
     * Creates an instance of ExpMainProjectMemberService.
     * 
     * @param {*} [opts={}]
     * @memberof ExpMainProjectMemberService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ExpMainProjectMemberModel();
    }
