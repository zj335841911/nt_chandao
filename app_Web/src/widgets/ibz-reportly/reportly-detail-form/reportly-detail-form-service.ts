...
import ReportlyDetailModel from './reportly-detail-form-model';


/**
 * ReportlyDetail 部件服务对象
 *
 * @export
 * @class ReportlyDetailService
 */
export default class ReportlyDetailService extends ControlService {

    /**
     * 汇报服务对象
     *
     * @type {IbzReportlyService}
     * @memberof ReportlyDetailService
     */
    ...
    /**
     * Creates an instance of ReportlyDetailService.
     * 
     * @param {*} [opts={}]
     * @memberof ReportlyDetailService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ReportlyDetailModel();
    }
