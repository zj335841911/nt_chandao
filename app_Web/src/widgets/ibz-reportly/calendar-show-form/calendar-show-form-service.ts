...
import CalendarShowModel from './calendar-show-form-model';
 ...
 *
 * @export
 * @class CalendarShowService
 */
export default class CalendarShowService extends ControlService {

    /**
     * 汇报服务对象
     *
     * @type {IbzReportlyService}
     * @memberof CalendarShowService
     */
    public appEntityService: IbzReportlyService = new IbzReportlyService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of CalendarShowService.
     * 
     * @param {*} [opts={}]
     * @memberof CalendarShowService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CalendarShowModel();
    }
    ...
    public add(action: string, context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Object.assign(Data,{ibzreportlyid: data.ibz_reportlyid, srffrontuf: '1'});
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.ibzreportlyid = PrimaryKey;
        Data.ibzreportly = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
            ...
            result.then((response) => {
                this.setRemoteCopyData(response);
                response.data.ibzreportlyid = PrimaryKey;
