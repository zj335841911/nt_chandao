    ...
    public allColumns: any[] = [
        {
            name: 'id',
            label: '编号',
            langtag: 'entities.ibzcasestep.main_grid.columns.id',
            show: false,
            util: 'PX',
            render: (val: any) => {
        ...
        },
        {
            name: 'desc',
            label: '步骤',
            langtag: 'entities.ibzcasestep.main_grid.columns.desc',
            show: true,
            util: 'PX',
            render: (val: any) => {
        ...
        },
        {
            name: 'type',
            label: '类型',
            langtag: 'entities.ibzcasestep.main_grid.columns.type',
            show: false,
            util: 'PX',
        ...
        },
        {
            name: 'expect',
            label: '预期',
            langtag: 'entities.ibzcasestep.main_grid.columns.expect',
            show: true,
            util: 'PX',
            render: (val: any) => {
