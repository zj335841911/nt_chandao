 ...
 *
 * @export
 * @class Main_RowEditService
 */
export default class Main_RowEditService extends ControlService {
    ...
    /**
     * Creates an instance of Main_RowEditService.
     * 
     * @param {*} [opts={}]
     * @memberof Main_RowEditService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new Main_RowEditModel();
    }
