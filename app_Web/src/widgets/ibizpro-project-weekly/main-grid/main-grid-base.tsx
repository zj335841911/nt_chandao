...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */  
    public majorInfoColName:string = "ibzpro_projectweeklyname";
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'ibzpro_projectweekly_main_grid';
    ...
    public allColumns: any[] = [
        {
            ...
            label: '项目周报名称',
            langtag: 'entities.ibizproprojectweekly.main_grid.columns.ibzpro_projectweeklyname',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'projectname',
            label: '项目名称',
            langtag: 'entities.ibizproprojectweekly.main_grid.columns.projectname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'pm',
            label: '项目负责人',
            langtag: 'entities.ibizproprojectweekly.main_grid.columns.pm',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'date',
            label: '日期',
            langtag: 'entities.ibizproprojectweekly.main_grid.columns.date',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'totalestimates',
            label: '总工时',
            langtag: 'entities.ibizproprojectweekly.main_grid.columns.totalestimates',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules() {
        return {
        srfkey: [
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目周报标识 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '项目周报标识 值不能为空', trigger: 'blur' },
        ],
    }
    }
    ...
    public hasRowEdit: any = {
        'ibzpro_projectweeklyname':false,
        'projectname':false,
        'pm':false,
        'date':false,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['ibzpro_projectweeklyname','projectname','pm','date','totalestimates'];
        if(row && row.children) {
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.projectweeklyid === data.srfkey;
                })
                if(targetData){
