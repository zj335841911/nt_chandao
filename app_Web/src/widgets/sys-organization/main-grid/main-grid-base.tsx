...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'sys_org_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'orgid',
            label: '单位标识',
            langtag: 'entities.sysorganization.main_grid.columns.orgid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'shortname',
            label: '单位简称',
            langtag: 'entities.sysorganization.main_grid.columns.shortname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'domains',
            label: '区属',
            langtag: 'entities.sysorganization.main_grid.columns.domains',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'orgname',
            label: '名称',
            langtag: 'entities.sysorganization.main_grid.columns.orgname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'orglevel',
            label: '单位级别',
            langtag: 'entities.sysorganization.main_grid.columns.orglevel',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
