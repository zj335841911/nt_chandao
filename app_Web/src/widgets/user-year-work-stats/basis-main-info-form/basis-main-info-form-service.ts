...
import BasisMainInfoModel from './basis-main-info-form-model';


/**
 * BasisMainInfo 部件服务对象
 *
 * @export
 * @class BasisMainInfoService
 */
export default class BasisMainInfoService extends ControlService {

    /**
     * 用户年度工作内容统计服务对象
     *
     * @type {UserYearWorkStatsService}
     * @memberof BasisMainInfoService
     */
    ...
    /**
     * Creates an instance of BasisMainInfoService.
     * 
     * @param {*} [opts={}]
     * @memberof BasisMainInfoService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new BasisMainInfoModel();
    }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.id = PrimaryKey;
        Data.useryearworkstats = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
