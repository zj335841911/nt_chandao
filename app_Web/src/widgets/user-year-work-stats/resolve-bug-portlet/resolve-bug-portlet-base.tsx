...
import ResolveBugService from './resolve-bug-portlet-service';
 ...
 * @extends {ResolveBugPortletBase}
 */
export class ResolveBugPortletBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof ResolveBugPortletBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ResolveBugService}
     * @memberof ResolveBugPortletBase
     */
    public service: ResolveBugService = new ResolveBugService({ $store: this.$store });
