...
import MonthFinishTaskAndBugService from './month-finish-task-and-bug-portlet-service';
 ...
 * @extends {MonthFinishTaskAndBugPortletBase}
 */
export class MonthFinishTaskAndBugPortletBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof MonthFinishTaskAndBugPortletBase
     */
     ...
     *
     * @type {number}
     * @memberof MonthFinishTaskAndBug
     */
