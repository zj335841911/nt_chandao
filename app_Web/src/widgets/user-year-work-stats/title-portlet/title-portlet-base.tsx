...
import TitleService from './title-portlet-service';
 ...
 * @extends {TitlePortletBase}
 */
export class TitlePortletBase extends MainControlBase {
     ...
     * @memberof TitlePortletBase
     */
    public service: TitleService = new TitleService({ $store: this.$store });
