...
import TitleFormModel from './title-form-form-model';
 ...
 *
 * @export
 * @class TitleFormService
 */
export default class TitleFormService extends ControlService {

    /**
     * 用户年度工作内容统计服务对象
     *
     * @type {UserYearWorkStatsService}
     * @memberof TitleFormService
     */
    ...
    /**
     * Creates an instance of TitleFormService.
     * 
     * @param {*} [opts={}]
     * @memberof TitleFormService
     */
