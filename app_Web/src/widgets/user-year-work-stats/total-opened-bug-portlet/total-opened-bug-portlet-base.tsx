...
import TotalOpenedBugService from './total-opened-bug-portlet-service';
 ...
 * @extends {TotalOpenedBugPortletBase}
 */
export class TotalOpenedBugPortletBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof TotalOpenedBugPortletBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TotalOpenedBugService}
     * @memberof TotalOpenedBugPortletBase
     */
    public service: TotalOpenedBugService = new TotalOpenedBugService({ $store: this.$store });
