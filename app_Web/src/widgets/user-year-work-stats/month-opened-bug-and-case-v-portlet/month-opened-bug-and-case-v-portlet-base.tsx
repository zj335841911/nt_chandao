...
import MonthOpenedBugAndCaseVService from './month-opened-bug-and-case-v-portlet-service';
 ...
 * @extends {MonthOpenedBugAndCaseVPortletBase}
 */
export class MonthOpenedBugAndCaseVPortletBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof MonthOpenedBugAndCaseVPortletBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MonthOpenedBugAndCaseVService}
     * @memberof MonthOpenedBugAndCaseVPortletBase
     */
    public service: MonthOpenedBugAndCaseVService = new MonthOpenedBugAndCaseVService({ $store: this.$store });
     ...
     * @memberof MonthOpenedBugAndCaseVBase
     */  
     ...
     *
     * @type {number}
     * @memberof MonthOpenedBugAndCaseV
     */
