...
import POService from './po-dashboard-service';
 ...
 * @extends {PODashboardBase}
 */
export class PODashboardBase extends MainControlBase {
     ...
     * @memberof PODashboardBase
     */
    public service: POService = new POService({ $store: this.$store });
     ...
     * @memberof PO
     */
    public modelId:string = "dashboard_useryearworkstats_po";
