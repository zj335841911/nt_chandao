...
import MonthBugService from './month-bug-chart-service';
 ...
 * @extends {MonthBugChartBase}
 */
export class MonthBugChartBase extends MainControlBase {
     ...
     * 建构部件服务对象
     *
     * @type {MonthBugService}
     * @memberof MonthBugChartBase
     */
    public service: MonthBugService = new MonthBugService({ $store: this.$store });
