    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ branch: _keys }),Object.assign({ branch: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
