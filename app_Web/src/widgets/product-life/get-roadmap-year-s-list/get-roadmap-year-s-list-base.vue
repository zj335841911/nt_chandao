...
export default class GetRoadmapYearSBase extends Vue implements ControlInterface {
     ...
     * @memberof GetRoadmapYearS
     */
    protected service: GetRoadmapYearSService = new GetRoadmapYearSService({ $store: this.$store });
    ...
    */
    ...
    protected async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(this.removeAction,Object.assign(context,{ productlife: keys.join(';') }),Object.assign({ productlifeid: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
...
<style lang='less'>
@import './get-roadmap-year-s-list.less';
</style>