...
export class MainMultieditviewpanelBase extends MainControlBase {
     ...
     * @memberof MainBase
     */
    public viewname: string = 'test-run-edit-view9';
    ...
    public load(data: any): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'TestRunMEditView9' + (this.$t('app.multiEditView.notConfig.fetchAction') as string) });
            return;
        }
        let arg: any = {};
    ...
    public handleAdd(){
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'TestRunMEditView9' + (this.$t('app.multiEditView.notConfig.loaddraftAction') as string) });
            return;
        }
