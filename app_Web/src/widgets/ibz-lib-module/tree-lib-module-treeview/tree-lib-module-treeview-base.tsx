...
import TreeLibModuleService from './tree-lib-module-treeview-service';
 ...
 * @extends {TreeLibModuleTreeBase}
 */
export class TreeLibModuleTreeBase extends MainControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof TreeLibModuleTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TreeLibModuleService}
     * @memberof TreeLibModuleTreeBase
     */
    public service: TreeLibModuleService = new TreeLibModuleService({ $store: this.$store });
