...
/**
 * TreeLibModule 部件服务对象
 *
 * @export
 * @class TreeLibModuleService
 */
export default class TreeLibModuleService extends ControlService {

    /**
     * 用例库模块服务对象
     *
     * @type {IbzLibModuleService}
     * @memberof TreeLibModuleService
     */
    ...
    /**
     * Creates an instance of TreeLibModuleService.
     * 
     * @param {*} [opts={}]
     * @memberof TreeLibModuleService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TreeLibModuleModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzlibmodule.treelibmodule_treeview.nodes.root') });
    ...
    public fillAllNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.ibzlibmodule.treelibmodule_treeview.nodes.all') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
