<template>
  <div class='tabviewpanel'>
        ...
        <tab-pane :index="0" name='tabviewpanel4' tab='maintabexpviewtabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '公司'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="1" name='tabviewpanel3' tab='maintabexpviewtabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '权限'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="2" name='tabviewpanel' tab='maintabexpviewtabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '用户'),
                    h('Badge', {
...
@viewpanelDatasChange = "tabViewPanelDatasChange"
    ...
    @closeview="closeView($event)">
        ...
        <tab-pane :index="3" name='tabviewpanel2' tab='maintabexpviewtabexppanel' class=''  
            :label="(h) =>{
                return h('div', [
                    h('span', '部门'),
                    h('Badge', {
...
export default class MainTabExpViewtabexppanelBase extends Vue implements ControlInterface {
    ...
    public afterCreated(){
        ...
        if (this.context.company) {
            Object.assign(this.context, { srfparentdename: 'Company', srfparentkey: this.context.company });
        }
        if (this.viewState) {
