<template>
    <split id="deptusertreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
...
import DeptUserTreeExpViewtreeexpbarService from './dept-user-tree-exp-viewtreeexpbar-treeexpbar-service';
...
export default class DeptUserTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof DeptUserTreeExpViewtreeexpbar
     */
     ...
     * 建构部件服务对象
     *
     * @type {DeptUserTreeExpViewtreeexpbarService}
     * @memberof DeptUserTreeExpViewtreeexpbar
     */
    public service: DeptUserTreeExpViewtreeexpbarService = new DeptUserTreeExpViewtreeexpbarService({ $store: this.$store });
     ...
     *
     * @type {boolean}
     * @memberof DeptUserTreeExpViewtreeexpbarBase
     */
     ...
     * vue 声明周期
     *
     * @memberof @memberof DeptUserTreeExpViewtreeexpbarBase
     */
    public created() {
        this.afterCreated();
    }
    ...
    */
    public afterMounted(){ 
        if(this.$store.getters.getViewSplit(this.viewUID)){
            ...
            let containerWidth:number = (document.getElementById("deptusertreeexpviewtreeexpbar") as any).offsetWidth;
            if(this.ctrlWidth){
...
<style lang='less'>
@import './dept-user-tree-exp-viewtreeexpbar-treeexpbar.less';
</style>
