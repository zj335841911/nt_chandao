<template>
    <split id="depttreeexpviewtreeexpbar" class='app-tree-exp-bar' v-model="split" mode="horizontal" @on-move-end="onSplitChange">
...
import DeptTreeExpViewtreeexpbarService from './dept-tree-exp-viewtreeexpbar-treeexpbar-service';
...
export default class DeptTreeExpViewtreeexpbarBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof DeptTreeExpViewtreeexpbar
     */
     ...
     * 建构部件服务对象
     *
     * @type {DeptTreeExpViewtreeexpbarService}
     * @memberof DeptTreeExpViewtreeexpbar
     */
    public service: DeptTreeExpViewtreeexpbarService = new DeptTreeExpViewtreeexpbarService({ $store: this.$store });
     ...
     *
     * @type {boolean}
     * @memberof DeptTreeExpViewtreeexpbarBase
     */
    ...
    public getExpItemView(arg: any = {}): any {
        ...
        if (Object.is(expmode, 'SUBDEPT')) {
            return {  
                viewname: 'dept-main-grid-view', 
                parentdata: {"srfparentdefname":"n_parent_eq","srfparentdename":"ZT_DEPT","srfparentmode":"DER1N__ZT_DEPT__ZT_DEPT__PARENT"},
                deKeyField:'dept'
			};
        }
     ...
     * vue 声明周期
     *
     * @memberof @memberof DeptTreeExpViewtreeexpbarBase
     */
    public created() {
        this.afterCreated();
    }
    ...
    */
    public afterMounted(){ 
        if(this.$store.getters.getViewSplit(this.viewUID)){
            ...
            let containerWidth:number = (document.getElementById("depttreeexpviewtreeexpbar") as any).offsetWidth;
            if(this.ctrlWidth){
...
<style lang='less'>
@import './dept-tree-exp-viewtreeexpbar-treeexpbar.less';
</style>
