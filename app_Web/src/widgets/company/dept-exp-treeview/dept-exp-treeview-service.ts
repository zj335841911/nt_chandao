...
import DeptExpModel from './dept-exp-treeview-model';
 ...
 *
 * @export
 * @class DeptExpService
 */
export default class DeptExpService extends ControlService {

    /**
     * 公司服务对象
     *
     * @type {CompanyService}
     * @memberof DeptExpService
     */
    ...
    /**
     * Creates an instance of DeptExpService.
     * 
     * @param {*} [opts={}]
     * @memberof DeptExpService
     */
    ...
    public fillAlldeptNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.company.deptexp_treeview.nodes.alldept' });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.company.deptexp_treeview.nodes.root' });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
