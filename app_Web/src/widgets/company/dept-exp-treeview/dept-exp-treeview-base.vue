...
import DeptExpService from './dept-exp-treeview-service';
...
export default class DeptExpBase extends Vue implements ControlInterface {
     ...
     * @memberof DeptExp
     */
    public service: DeptExpService = new DeptExpService({ $store: this.$store });
