...
<i-col v-show="detailsModel.phone.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='phone'
:value="data.phone" style=""></app-span>
</app-form-item>
...
:value="data.address" style=""></app-span>
</app-form-item>
...
:value="data.zipcode" style=""></app-span>
</app-form-item>
...
:value="data.website" style=""></app-span>
</app-form-item>
...
:value="data.backyard" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.guest.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='guest'
:value="data.guest" tag='Company__guest' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public rules: any = {
        ...
        website: [
            { type: 'string', message: '官网 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '官网 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '官网 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '官网 值不能为空', trigger: 'blur' },
        ],
        backyard: [
            { type: 'string', message: '内网 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '内网 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '内网 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '内网 值不能为空', trigger: 'blur' },
        ],
        guest: [
            { type: 'string', message: '匿名登陆 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '匿名登陆 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '匿名登陆 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '匿名登陆 值不能为空', trigger: 'blur' },
        ],
        id: [
            { type: 'number', message: 'id 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: 'id 值必须为数值类型', trigger: 'blur' },
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: 'company基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.company.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        name: new FormItemModel({ caption: '公司名称', detailType: 'FORMITEM', name: 'name', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        phone: new FormItemModel({ caption: '联系电话', detailType: 'FORMITEM', name: 'phone', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        zipcode: new FormItemModel({ caption: '邮政编码', detailType: 'FORMITEM', name: 'zipcode', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        website: new FormItemModel({ caption: '官网', detailType: 'FORMITEM', name: 'website', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        backyard: new FormItemModel({ caption: '内网', detailType: 'FORMITEM', name: 'backyard', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        guest: new FormItemModel({ caption: '匿名登陆', detailType: 'FORMITEM', name: 'guest', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     */
    @Watch('data.zipcode')
    onZipcodeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'zipcode', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.website')
    onWebsiteChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'website', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.backyard')
    onBackyardChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'backyard', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.guest')
    onGuestChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'guest', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.company){
            Object.assign(this.context,{company:data.company})
        }
    ...
    public copy(srfkey: string): void {
        ...
        copyData.company = copyData.srfkey;
        copyData.id = copyData.srfkey;
        Object.assign(this.context,{company:copyData.company})
        this.data = copyData;
        this.$nextTick(() => {
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'company_main',popTitle:'主信息表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: '错误', desc: 'CompanyMainView9视图表单loadAction参数未配置' });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'CompanyMainView9视图表单loaddraftAction参数未配置' });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: '错误', desc: 'CompanyMainView9视图表单'+actionName+'参数未配置' });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: '错误', desc: 'CompanyMainView9视图表单removeAction参数未配置' });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.company || Object.is(arg.company, '')) {
            return;
        }
