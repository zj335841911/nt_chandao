...
import DeptUserExpService from './dept-user-exp-treeview-service';
...
export default class DeptUserExpBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof DeptUserExp
     */
     ...
     * 建构部件服务对象
     *
     * @type {DeptUserExpService}
     * @memberof DeptUserExp
     */
    public service: DeptUserExpService = new DeptUserExpService({ $store: this.$store });
...
<style lang='less'>
@import './dept-user-exp-treeview.less';
</style>