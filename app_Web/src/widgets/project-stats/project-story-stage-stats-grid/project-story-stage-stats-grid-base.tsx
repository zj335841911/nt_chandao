...
import ProjectStoryStageStatsService from './project-story-stage-stats-grid-service';
 ...
 * @extends {ProjectStoryStageStatsGridBase}
 */
export class ProjectStoryStageStatsGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProjectStoryStageStatsGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProjectStoryStageStatsService}
     * @memberof ProjectStoryStageStatsGridBase
     */
    public service: ProjectStoryStageStatsService = new ProjectStoryStageStatsService({ $store: this.$store });
     ...
     * @memberof ProjectStoryStageStatsBase
     */  
     ...
     * @memberof ProjectStoryStageStatsBase
     */
    protected localStorageTag: string = 'ibz_projectstats_projectstorystagestats_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'name',
            label: '项目名称',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.name',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            ...
            label: '空',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.emptystagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '未开始',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.waitstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '已计划',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.plannedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '已立项',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.projectedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '研发中',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.developingstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '研发完毕',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.developedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '测试中',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.testingstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '测试完毕',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.testedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '已验收',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.verifiedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '已发布',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.releasedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            label: '已关闭',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.closedstagestorycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'storycnt',
            label: '总计',
            langtag: 'entities.projectstats.projectstorystagestats_grid.columns.storycnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public hasRowEdit: any = {
        'name':false,
        'emptystagestorycnt':false,
        'waitstagestorycnt':false,
        'plannedstagestorycnt':false,
    ...
    public getSummaries(param:any){
        ...
        columns.forEach((column:any, index:number) => {
          ...
          if (!values.every((value:any) => isNaN(value))) {
                if(Object.is(column.property,'emptystagestorycnt')){
                ...
                if(Object.is(column.property,'plannedstagestorycnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['name','emptystagestorycnt','waitstagestorycnt','plannedstagestorycnt','projectedstagestorycnt','developingstagestorycnt','developedstagestorycnt','testingstagestorycnt','testedstagestorycnt','verifiedstagestorycnt','releasedstagestorycnt','closedstagestorycnt','storycnt'];
        if(row && row.children) {
