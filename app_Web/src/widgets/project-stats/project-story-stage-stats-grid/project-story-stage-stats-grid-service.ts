...
import ProjectStoryStageStatsModel from './project-story-stage-stats-grid-model';


/**
 * ProjectStoryStageStats 部件服务对象
 *
 * @export
 * @class ProjectStoryStageStatsService
 */
export default class ProjectStoryStageStatsService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectStoryStageStatsService
     */
    ...
    /**
     * Creates an instance of ProjectStoryStageStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectStoryStageStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectStoryStageStatsModel();
    }
