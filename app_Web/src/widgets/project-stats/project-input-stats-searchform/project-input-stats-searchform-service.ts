...
import ProjectInputStatsModel from './project-input-stats-searchform-model';


/**
 * ProjectInputStats 部件服务对象
 *
 * @export
 * @class ProjectInputStatsService
 */
export default class ProjectInputStatsService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectInputStatsService
     */
    ...
    /**
     * Creates an instance of ProjectInputStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectInputStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectInputStatsModel();
    }
