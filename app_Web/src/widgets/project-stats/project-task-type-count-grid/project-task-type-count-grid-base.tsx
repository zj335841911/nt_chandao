...
import ProjectTaskTypeCountService from './project-task-type-count-grid-service';
 ...
 * @extends {ProjectTaskTypeCountGridBase}
 */
export class ProjectTaskTypeCountGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * @memberof ProjectTaskTypeCountBase
     */
    protected localStorageTag: string = 'ibz_projectstats_projecttasktypecount_grid';
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'designtaskcnt',
            label: '设计',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.designtaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'develtaskcnt',
            label: '开发',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.develtaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'testtaskcnt',
            label: '测试',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.testtaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'studytaskcnt',
            label: '研究',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.studytaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'discusstaskcnt',
            label: '讨论',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.discusstaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'uitaskcnt',
            label: '界面',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.uitaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'affairtaskcnt',
            label: '事务',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.affairtaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'servetaskcnt',
            label: '服务',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.servetaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'misctaskcnt',
            label: '其他',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.misctaskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'taskcnt',
            label: '总计',
            langtag: 'entities.projectstats.projecttasktypecount_grid.columns.taskcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public getSummaries(param:any){
        ...
        columns.forEach((column:any, index:number) => {
          ...
          if (!values.every((value:any) => isNaN(value))) {
                if(Object.is(column.property,'designtaskcnt')){
                ...
                if(Object.is(column.property,'develtaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'testtaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'studytaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'discusstaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'uitaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'affairtaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'servetaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
                ...
                if(Object.is(column.property,'misctaskcnt')){
                    let tempData = values.reduce((prev:any, curr:any) => {
                        const value = Number(curr);
                        if (!isNaN(value)) {
                            return prev + curr;
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['name','designtaskcnt','develtaskcnt','testtaskcnt','studytaskcnt','discusstaskcnt','uitaskcnt','affairtaskcnt','servetaskcnt','misctaskcnt','taskcnt'];
        if(row && row.children) {
