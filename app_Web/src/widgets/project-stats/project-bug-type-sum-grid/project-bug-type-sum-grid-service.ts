...
import ProjectBugTypeSumModel from './project-bug-type-sum-grid-model';


/**
 * ProjectBugTypeSum 部件服务对象
 *
 * @export
 * @class ProjectBugTypeSumService
 */
export default class ProjectBugTypeSumService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectBugTypeSumService
     */
    ...
    /**
     * Creates an instance of ProjectBugTypeSumService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectBugTypeSumService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectBugTypeSumModel();
    }
