...
import ProjectBugTypeSumService from './project-bug-type-sum-grid-service';
 ...
 * @extends {ProjectBugTypeSumGridBase}
 */
export class ProjectBugTypeSumGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProjectBugTypeSumGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProjectBugTypeSumService}
     * @memberof ProjectBugTypeSumGridBase
     */
    public service: ProjectBugTypeSumService = new ProjectBugTypeSumService({ $store: this.$store });
     ...
     * @memberof ProjectBugTypeSumBase
     */  
     ...
     * @memberof ProjectBugTypeSumBase
     */
    protected localStorageTag: string = 'ibz_projectstats_projectbugtypesum_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'name',
            label: '项目名称',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.name',
            show: true,
            unit: 'STAR',
        ...
        },
        {
            name: 'codeerror',
            label: '代码错误',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.codeerror',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'config',
            label: '配置相关',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.config',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'designdefect',
            label: '设计缺陷',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.designdefect',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'install',
            label: '安装部署',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.install',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'performance',
            label: '性能问题',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.performance',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'security',
            label: '安全相关',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.security',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'standard',
            label: '标准规范',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.standard',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'automation',
            label: '测试脚本',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.automation',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'others',
            label: '其他',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.others',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bugcnt',
            label: 'Bug总数',
            langtag: 'entities.projectstats.projectbugtypesum_grid.columns.bugcnt',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['name','codeerror','config','designdefect','install','performance','security','standard','automation','others','bugcnt'];
        if(row && row.children) {
