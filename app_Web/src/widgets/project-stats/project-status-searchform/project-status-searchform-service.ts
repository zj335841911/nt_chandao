...
import ProjectStatusModel from './project-status-searchform-model';


/**
 * ProjectStatus 部件服务对象
 *
 * @export
 * @class ProjectStatusService
 */
export default class ProjectStatusService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectStatusService
     */
    ...
    /**
     * Creates an instance of ProjectStatusService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectStatusService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectStatusModel();
    }
