...
<i-col v-show="detailsModel.grouppanel4.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 8, offset: 0 }">
    ...
    <app-range-editor v-model="data.formitemex4" :activeData="data" :disabled="detailsModel.formitemex4.disabled" name="formitemex4" editorType="USERCONTROL" format="" :refFormItem="['custom7','custom8']" @formitemvaluechange="onFormItemValueChange" style="height:250px;"></app-range-editor>
</app-form-item>
...
:value="data.totalestimate" style=""></app-span>
</app-form-item>
...
:value="data.totalconsumed" style=""></app-span>
</app-form-item>
...
:value="data.totalleft" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 16, offset: 0 }">
    ...
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.grouppanel1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.projectstats.main_form.details.grouppanel1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="true">
    
    <row>
        <i-col v-show="detailsModel.rawitem1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <div class="" style="">
    <div style="margin-top: 6px;padding-left: 69px;"><Icon type="md-checkmark-circle" color="#49db44"/>&nbsp;昨日完成任务数&nbsp;<b>{{data.yesterdayctaskcnt ? data.yesterdayctaskcnt : 0}}</b></div>
</div>

</i-col>
<i-col v-show="detailsModel.taskcnt.visible" :style="{}"  :lg="{ span: 4, offset: 18 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='taskcnt' :itemRules="this.rules.taskcnt" class='' :caption="$t('entities.projectstats.main_form.details.taskcnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.taskcnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='taskcnt'
:value="data.taskcnt" style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.formitemex1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <app-form-item name='formitemex1' :itemRules="this.rules.formitemex1" class='' :caption="$t('entities.projectstats.main_form.details.formitemex1')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.formitemex1.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.undonetaskcnt.visible" :style="{}"  :lg="{ span: 4, offset: 0 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='undonetaskcnt' :itemRules="this.rules.undonetaskcnt" class='' :caption="$t('entities.projectstats.main_form.details.undonetaskcnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.undonetaskcnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='undonetaskcnt'
:value="data.undonetaskcnt" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.grouppanel2.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.projectstats.main_form.details.grouppanel2')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="true">
    
    <row>
        <i-col v-show="detailsModel.rawitem2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <div class="" style="">
    <div style="margin-top: 6px;padding-left: 69px;"><Icon type="md-checkmark-circle" color="#49db44"/>&nbsp;已发布需求数&nbsp;<b>{{data.releasedstorycnt ? data.releasedstorycnt : 0}}</b></div>
</div>

</i-col>
<i-col v-show="detailsModel.storycnt.visible" :style="{}"  :lg="{ span: 4, offset: 18 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='storycnt' :itemRules="this.rules.storycnt" class='' :caption="$t('entities.projectstats.main_form.details.storycnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.storycnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='storycnt'
:value="data.storycnt" style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.formitemex2.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <app-form-item name='formitemex2' :itemRules="this.rules.formitemex2" class='' :caption="$t('entities.projectstats.main_form.details.formitemex2')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.formitemex2.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.unclosedstorycnt.visible" :style="{}"  :lg="{ span: 4, offset: 0 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='unclosedstorycnt' :itemRules="this.rules.unclosedstorycnt" class='' :caption="$t('entities.projectstats.main_form.details.unclosedstorycnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.unclosedstorycnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='unclosedstorycnt'
:value="data.unclosedstorycnt" style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.grouppanel3.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' uiActionGroup="detailsModel.grouppanel3.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.projectstats.main_form.details.grouppanel3')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="true">
    
    <row>
        <i-col v-show="detailsModel.rawitem3.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <div class="" style="">
    <div style="margin-top: 6px;padding-left: 69px;"><Icon type="md-checkmark-circle" color="#49db44"/>&nbsp;昨日解决Bug数&nbsp;<b>{{data.yesterdayrbugcnt ? data.yesterdayrbugcnt : 0}}</b></div>
</div>

</i-col>
<i-col v-show="detailsModel.bugcnt.visible" :style="{}"  :lg="{ span: 4, offset: 18 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='bugcnt' :itemRules="this.rules.bugcnt" class='' :caption="$t('entities.projectstats.main_form.details.bugcnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.bugcnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='bugcnt'
:value="data.bugcnt" style=""></app-span>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.formitemex3.visible" :style="{}"  :lg="{ span: 24, offset: 0 }" :xl="{ span: 18, offset: 0 }">
    <app-form-item name='formitemex3' :itemRules="this.rules.formitemex3" class='' :caption="$t('entities.projectstats.main_form.details.formitemex3')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.formitemex3.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.activebugcnt.visible" :style="{}"  :lg="{ span: 4, offset: 0 }" :xl="{ span: 4, offset: 0 }">
    <app-form-item name='activebugcnt' :itemRules="this.rules.activebugcnt" class='' :caption="$t('entities.projectstats.main_form.details.activebugcnt')" uiStyle="DEFAULT" :labelWidth="70" :isShowCaption="true" :error="detailsModel.activebugcnt.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-span   name='activebugcnt'
:value="data.activebugcnt" style=""></app-span>
</app-form-item>
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    protected appEntityService: ProjectStatsService = new ProjectStatsService({ $store: this.$store });
    ...
    protected rules: any = {
        ...
        custom7: [
            { type: 'number', message: '总工时 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '总工时 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '总工时 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '总工时 值不能为空', trigger: 'blur' },
        ],
        custom8: [
        ...
        custom2: [
            { type: 'number', message: '已结束任务总数 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '已结束任务总数 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '已结束任务总数 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '已结束任务总数 值不能为空', trigger: 'blur' },
        ],
        formitemex1: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        custom4: [
            { type: 'number', message: '关闭需求总数 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '关闭需求总数 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '关闭需求总数 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '关闭需求总数 值不能为空', trigger: 'blur' },
        ],
        formitemex2: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        custom6: [
            { type: 'number', message: '已解决Bug总数 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '已解决Bug总数 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '已解决Bug总数 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '已解决Bug总数 值不能为空', trigger: 'blur' },
        ],
        formitemex3: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
...
, 
        custom7: new FormItemModel({ caption: '总工时', detailType: 'FORMITEM', name: 'custom7', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        yesterdayctaskcnt: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'yesterdayctaskcnt', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        releasedstorycnt: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'releasedstorycnt', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        yesterdayrbugcnt: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'yesterdayrbugcnt', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    /**
     * 监控表单属性 yesterdayctaskcnt 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.yesterdayctaskcnt')
    onYesterdayctaskcntChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'yesterdayctaskcnt', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 yesterdayrbugcnt 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.yesterdayrbugcnt')
    onYesterdayrbugcntChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'yesterdayrbugcnt', newVal: newVal, oldVal: oldVal });
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'ProjectStatsEditView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
