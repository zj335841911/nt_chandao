...
import AllProjectModel from './all-project-grid-model';
 ...
 */
export default class AllProjectService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof AllProjectService
     */
    ...
    /**
     * Creates an instance of AllProjectService.
     * 
     * @param {*} [opts={}]
     * @memberof AllProjectService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new AllProjectModel();
    }
