...
import ProjectTaskTypeCountModel from './project-task-type-count-searchform-model';


/**
 * ProjectTaskTypeCount 部件服务对象
 *
 * @export
 * @class ProjectTaskTypeCountService
 */
export default class ProjectTaskTypeCountService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectTaskTypeCountService
     */
    ...
    /**
     * Creates an instance of ProjectTaskTypeCountService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectTaskTypeCountService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectTaskTypeCountModel();
    }
