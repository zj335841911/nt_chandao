...
import ProjectStoryStatusStatsModel from './project-story-status-stats-grid-model';


/**
 * ProjectStoryStatusStats 部件服务对象
 *
 * @export
 * @class ProjectStoryStatusStatsService
 */
export default class ProjectStoryStatusStatsService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectStoryStatusStatsService
     */
    ...
    /**
     * Creates an instance of ProjectStoryStatusStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectStoryStatusStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectStoryStatusStatsModel();
    }
