...
import ProjectTaskStatusCountModel from './project-task-status-count-grid-model';


/**
 * ProjectTaskStatusCount 部件服务对象
 *
 * @export
 * @class ProjectTaskStatusCountService
 */
export default class ProjectTaskStatusCountService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectTaskStatusCountService
     */
    ...
    /**
     * Creates an instance of ProjectTaskStatusCountService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectTaskStatusCountService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectTaskStatusCountModel();
    }
