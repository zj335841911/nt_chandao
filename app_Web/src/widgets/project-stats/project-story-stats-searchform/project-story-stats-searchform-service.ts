...
import ProjectStoryStatsModel from './project-story-stats-searchform-model';


/**
 * ProjectStoryStats 部件服务对象
 *
 * @export
 * @class ProjectStoryStatsService
 */
export default class ProjectStoryStatsService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectStoryStatsService
     */
    ...
    /**
     * Creates an instance of ProjectStoryStatsService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectStoryStatsService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectStoryStatsModel();
    }
