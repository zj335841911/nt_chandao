...
import ProjectProgressModel from './project-progress-grid-model';


/**
 * ProjectProgress 部件服务对象
 *
 * @export
 * @class ProjectProgressService
 */
export default class ProjectProgressService extends ControlService {

    /**
     * 项目统计服务对象
     *
     * @type {ProjectStatsService}
     * @memberof ProjectProgressService
     */
    ...
    /**
     * Creates an instance of ProjectProgressService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectProgressService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectProgressModel();
    }
