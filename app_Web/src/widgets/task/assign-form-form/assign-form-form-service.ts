...
import AssignFormModel from './assign-form-form-model';
 ...
 */
export default class AssignFormService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof AssignFormService
     */
    ...
    /**
     * Creates an instance of AssignFormService.
     * 
     * @param {*} [opts={}]
     * @memberof AssignFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new AssignFormModel();
    }
