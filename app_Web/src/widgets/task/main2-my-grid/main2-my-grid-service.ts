...
import Main2MyModel from './main2-my-grid-model';
 ...
 *
 * @export
 * @class Main2MyService
 */
export default class Main2MyService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof Main2MyService
     */
    ...
    /**
     * Creates an instance of Main2MyService.
     * 
     * @param {*} [opts={}]
     * @memberof Main2MyService
     */
