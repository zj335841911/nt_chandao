...
export class TaskGroupGridBase extends GridControlBase {
     ...
     * @memberof TaskGroupBase
     */
    public groupAppFieldCodelistTag:string ="TaskStatusCK";
    ...
    public getSummaries(param:any){
        ...
        columns.forEach((column:any, index:number) => {
          ...
          if (!values.every((value:any) => isNaN(value))) {
                if(Object.is(column.property,'status1')){
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['status1','id','pri','name','assignedto','finishedby','estimate','consumed','left','deadline','uagridcolumn1'];
        if(row && row.children) {
