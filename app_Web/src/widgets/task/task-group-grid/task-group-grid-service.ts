...
import TaskGroupModel from './task-group-grid-model';
 ...
 */
export default class TaskGroupService extends ControlService {
    ...
    /**
     * Creates an instance of TaskGroupService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskGroupService
     */
