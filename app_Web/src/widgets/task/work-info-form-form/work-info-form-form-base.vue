...
<i-col v-show="detailsModel.left.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='left'
:value="data.left" style=""></app-span>
</app-form-item>
...
:value="data.eststarted" style=""></app-span>
</app-form-item>
...
:value="data.realstarted" style=""></app-span>
</app-form-item>
...
export default class WorkInfoFormBase extends Vue implements ControlInterface {
     ...
     * @memberof WorkInfoForm
     */
    protected service: WorkInfoFormService = new WorkInfoFormService({ $store: this.$store });
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'工时信息'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'TaskWorkInfoEditView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
