...
import WorkInfoFormModel from './work-info-form-form-model';
 ...
 *
 * @export
 * @class WorkInfoFormService
 */
export default class WorkInfoFormService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof WorkInfoFormService
     */
    ...
    /**
     * Creates an instance of WorkInfoFormService.
     * 
     * @param {*} [opts={}]
     * @memberof WorkInfoFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new WorkInfoFormModel();
    }
