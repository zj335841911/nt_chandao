...
import ReportMainZSService from './report-main-zs-grid-service';
 ...
 * @extends {ReportMainZSGridBase}
 */
export class ReportMainZSGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ReportMainZSService}
     * @memberof ReportMainZSGridBase
     */
    public service: ReportMainZSService = new ReportMainZSService({ $store: this.$store });
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'progressrate',
            label: '%',
            langtag: 'entities.task.reportmainzs_grid.columns.progressrate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deadline',
            label: '截止日期',
            langtag: 'entities.task.reportmainzs_grid.columns.deadline',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
