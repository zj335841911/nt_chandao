...
import ReportMainZSModel from './report-main-zs-grid-model';
 ...
 *
 * @export
 * @class ReportMainZSService
 */
export default class ReportMainZSService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof ReportMainZSService
     */
    ...
    /**
     * Creates an instance of ReportMainZSService.
     * 
     * @param {*} [opts={}]
     * @memberof ReportMainZSService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ReportMainZSModel();
    }
