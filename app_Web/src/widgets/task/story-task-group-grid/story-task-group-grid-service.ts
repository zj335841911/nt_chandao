...
import StoryTaskGroupModel from './story-task-group-grid-model';


/**
 * StoryTaskGroup 部件服务对象
 *
 * @export
 * @class StoryTaskGroupService
 */
export default class StoryTaskGroupService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof StoryTaskGroupService
     */
    ...
    /**
     * Creates an instance of StoryTaskGroupService.
     * 
     * @param {*} [opts={}]
     * @memberof StoryTaskGroupService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StoryTaskGroupModel();
    }
