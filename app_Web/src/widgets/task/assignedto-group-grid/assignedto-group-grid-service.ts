...
import AssignedtoGroupModel from './assignedto-group-grid-model';


/**
 * AssignedtoGroup 部件服务对象
 *
 * @export
 * @class AssignedtoGroupService
 */
export default class AssignedtoGroupService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof AssignedtoGroupService
     */
    ...
    /**
     * Creates an instance of AssignedtoGroupService.
     * 
     * @param {*} [opts={}]
     * @memberof AssignedtoGroupService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new AssignedtoGroupModel();
    }
