...
import PriTaskGroupModel from './pri-task-group-grid-model';
 ...
 *
 * @export
 * @class PriTaskGroupService
 */
export default class PriTaskGroupService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof PriTaskGroupService
     */
    ...
    /**
     * Creates an instance of PriTaskGroupService.
     * 
     * @param {*} [opts={}]
     * @memberof PriTaskGroupService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new PriTaskGroupModel();
    }
