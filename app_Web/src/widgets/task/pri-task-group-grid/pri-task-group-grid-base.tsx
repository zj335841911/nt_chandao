...
import PriTaskGroupService from './pri-task-group-grid-service';
 ...
 * @extends {PriTaskGroupGridBase}
 */
export class PriTaskGroupGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof PriTaskGroupGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {PriTaskGroupService}
     * @memberof PriTaskGroupGridBase
     */
    public service: PriTaskGroupService = new PriTaskGroupService({ $store: this.$store });
     ...
     * @memberof TaskPriTaskGroupGridViewBase
     */
     ...
     * @memberof PriTaskGroupBase
     */
    protected localStorageTag: string = 'zt_task_pritaskgroup_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'pri',
            label: 'P',
            langtag: 'entities.task.pritaskgroup_grid.columns.pri',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'id',
            label: 'ID',
            langtag: 'entities.task.pritaskgroup_grid.columns.id',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'name',
            label: '任务名称',
            langtag: 'entities.task.pritaskgroup_grid.columns.name',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'status1',
            label: '任务状态',
            langtag: 'entities.task.pritaskgroup_grid.columns.status1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'assignedto',
            label: '指派给',
            langtag: 'entities.task.pritaskgroup_grid.columns.assignedto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'finishedby',
            label: '完成者',
            langtag: 'entities.task.pritaskgroup_grid.columns.finishedby',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'estimate',
            label: '预计',
            langtag: 'entities.task.pritaskgroup_grid.columns.estimate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'consumed',
            label: '消耗',
            langtag: 'entities.task.pritaskgroup_grid.columns.consumed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'left',
            label: '剩余',
            langtag: 'entities.task.pritaskgroup_grid.columns.left',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deadline',
            label: '截止日期',
            langtag: 'entities.task.pritaskgroup_grid.columns.deadline',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.task.pritaskgroup_grid.columns.uagridcolumn1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
     ...
     * @memberof PriTaskGroupBase
     */
    public groupAppField:string ="pri";
     ...
     * @memberof PriTaskGroupBase
     */
    public groupAppFieldCodelistTag:string ="Task__pri";
     ...
     * @memberof PriTaskGroupBase
     */
    public codelistTag: string = "Task__pri";
    ...
    public getSummaries(param:any){
        ...
        columns.forEach((column:any, index:number) => {
          ...
          if (!values.every((value:any) => isNaN(value))) {
                if(Object.is(column.property,'pri')){
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['pri','id','name','status1','assignedto','finishedby','estimate','consumed','left','deadline','uagridcolumn1'];
        if(row && row.children) {
