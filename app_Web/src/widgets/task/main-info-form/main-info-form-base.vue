...
<i-col v-show="detailsModel.modulename1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='modulename1' :itemRules="this.rules.modulename1" class='' :caption="$t('entities.task.maininfo_form.details.modulename1')" uiStyle="DEFAULT" :labelWidth="100" :isShowCaption="true" :error="detailsModel.modulename1.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.type.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='type'
:value="data.type" tag='Task__type' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.status" tag='Task__status' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
<i-col v-show="detailsModel.pri.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-span   name='pri'
:value="data.pri" tag='Task__pri' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.finishedby" tag='UserRealName' codelistType='DYNAMIC' renderMode="STR" valueSeparator="," textSeparator="," style=""></app-span>
</app-form-item>
...
:value="data.finisheddate" style=""></app-span>
</app-form-item>
...
:value="data.canceledby" tag='UserRealName' codelistType='DYNAMIC' renderMode="STR" valueSeparator="," textSeparator="," style=""></app-span>
</app-form-item>
...
:value="data.canceleddate" style=""></app-span>
</app-form-item>
...
:value="data.closedreason" tag='Task__closed_reason' codelistType='STATIC' style=""></app-span>
</app-form-item>
...
:value="data.lastediteddate" style=""></app-span>
            ...
            <tab-pane v-show="detailsModel.formpage3.visible" name='formpage3' :index="2" tab='form' class=''  
                :label="(h) =>{
                    return h('span',{
                        class:'caption'
                    },[
                    $t('entities.task.maininfo_form.details.formpage3')
                    ])
                }">
...
<i-col v-show="detailsModel.druipart1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    viewname='task-team-grid-view9-look' 
...
, 
        formpage3: new FormPageModel({ caption: '团队', detailType: 'FORMPAGE', name: 'formpage3', visible: true, isShowCaption: true, form: this })
, 
...
, 
        mailto: new FormItemModel({ caption: '抄送给', detailType: 'FORMITEM', name: 'mailto', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'TaskMainInfoView9视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
