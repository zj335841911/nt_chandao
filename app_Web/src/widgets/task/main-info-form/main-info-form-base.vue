<template>
    ...
    <row >
    <tabs size="small" :animated="false" name='maininfo' :value="detailsModel.form.activiedPage" @on-click="detailsModel.form.clickPage($event)">
...
:value="data.storyname" style=""></app-span>
</app-form-item>
...
:value="data.finishedby" style=""></app-span>
</app-form-item>
...
:value="data.canceledby" style=""></app-span>
</app-form-item>
