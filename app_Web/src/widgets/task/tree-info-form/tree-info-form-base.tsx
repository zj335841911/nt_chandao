...
export class TreeInfoEditFormBase extends EditFormControlBase {
 ...
 tag: 'NewSubTaskDash',actiontarget: 'SINGLEKEY',noprivdisplaymode:2,dataaccaction:'SRFUR__TASK_SUBTASKS_BUT',visabled: true,disabled: false} }),
        ...
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.treeinfo_form', extractMode: 'ITEM', details: [] } }),
