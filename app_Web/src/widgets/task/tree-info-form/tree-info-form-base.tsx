...
export class TreeInfoEditFormBase extends EditFormControlBase {
     ...
     * 建构部件服务对象
     *
     * @type {TreeInfoService}
     * @memberof TreeInfoEditFormBase
     */
    public service: TreeInfoService = new TreeInfoService({ $store: this.$store });
    ...
    uiaction: {
        ...
        grouppanel3: new FormGroupPanelModel({ caption: '任务描述', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: true, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.treeinfo_form', extractMode: 'ITEM', details: [] } }),
        ...
        grouppanel2: new FormGroupPanelModel({ caption: '需求', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: false, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.treeinfo_form', extractMode: 'ITEM', details: [] } }),

        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this, showMoreMode: 0 }),

        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.treeinfo_form', extractMode: 'ITEM', details: [] } }),

        group1: new FormGroupPanelModel({ caption: '任务描述', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.treeinfo_form', extractMode: 'ITEM', details: [] } }),
	 ...
	 * 表单 指派 事件
	 *
	 * @memberof @memberof TreeInfoEditFormBase
	 */
