...
:value="data.consumed" style=""></app-span>
</app-form-item>
...
:value="data.totaltime" style=""></app-span>
</app-form-item>
...
export default class CompleteFormBase extends Vue implements ControlInterface {
     ...
     * @memberof CompleteForm
     */
    protected service: CompleteFormService = new CompleteFormService({ $store: this.$store });
...
, 
    ...
    protected print(){
        let _this:any = this;
        _this.$print({id:'form',popTitle:'完成表单'});
    }
    ...
    */
    ...
    protected async wfsubmit(data: any): Promise<any> {
        ...
        if(!this.WFSubmitAction){
            this.$Notice.error({ title: '错误', desc: 'TaskDoneTaskView视图表单WFSubmitAction参数未配置' });
            return;
        }
        const _this: any = this;
        const arg: any = data[0];
...
<style lang='less'>
@import './complete-form-form.less';
</style>