...
import CompleteFormModel from './complete-form-form-model';
 ...
 *
 * @export
 * @class CompleteFormService
 */
export default class CompleteFormService extends ControlService {
    ...
    /**
     * Creates an instance of CompleteFormService.
     * 
     * @param {*} [opts={}]
     * @memberof CompleteFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CompleteFormModel();
    }
