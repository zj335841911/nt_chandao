...
import StorySubTaskNewModel from './story-sub-task-new-grid-model';
import StoryService from '@/service/story/story-service';
import ProjectModuleService from '@/service/project-module/project-module-service';


/**
 * StorySubTaskNew 部件服务对象
 *
 * @export
 * @class StorySubTaskNewService
 */
export default class StorySubTaskNewService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof StorySubTaskNewService
     */
    ...
    /**
     * Creates an instance of StorySubTaskNewService.
     * 
     * @param {*} [opts={}]
     * @memberof StorySubTaskNewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new StorySubTaskNewModel();
    }
