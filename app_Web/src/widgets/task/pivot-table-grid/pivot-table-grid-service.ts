...
import PivotTableModel from './pivot-table-grid-model';
 ...
 */
export default class PivotTableService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof PivotTableService
     */
    ...
    /**
     * Creates an instance of PivotTableService.
     * 
     * @param {*} [opts={}]
     * @memberof PivotTableService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new PivotTableModel();
    }
        ...
        return new Promise((resolve: any, reject: any) => {
            ...
            result.then((response) => {
                ...
                if(response.data){
                    Object.assign(response.data,{srfuf:'0'});
                    //仿真主键数据
                    response.data.task = Util.createUUID();
                }
