...
<div class='grid' style="height:100%;">
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('name')">
                <el-table-column show-overflow-tooltip :prop="'name'" :label="$t('entities.task.pivottable_grid.columns.name')" :align="'left'" :sortable="'custom'">
                    <template v-slot="{row,column}">
...
export default class PivotTableBase extends Vue implements ControlInterface {
     ...
     * @memberof PivotTable
     */
    protected service: PivotTableService = new PivotTableService({ $store: this.$store });
