...
import CompleteReportMainZSModel from './complete-report-main-zs-grid-model';


/**
 * CompleteReportMainZS 部件服务对象
 *
 * @export
 * @class CompleteReportMainZSService
 */
export default class CompleteReportMainZSService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof CompleteReportMainZSService
     */
    ...
    /**
     * Creates an instance of CompleteReportMainZSService.
     * 
     * @param {*} [opts={}]
     * @memberof CompleteReportMainZSService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new CompleteReportMainZSModel();
    }
