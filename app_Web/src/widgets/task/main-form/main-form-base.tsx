            ...
            projectname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.task.main_form.details.projectname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.projectname.required,
            ...
            type: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.task.main_form.details.type')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.type.required,
            ...
            assignedto: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.task.main_form.details.assignedto')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.assignedto.required,
            ...
            name: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.task.main_form.details.name')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.name.required,
