...
import ClosePauseCancelFormModel from './close-pause-cancel-form-form-model';


/**
 * ClosePauseCancelForm 部件服务对象
 *
 * @export
 * @class ClosePauseCancelFormService
 */
export default class ClosePauseCancelFormService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof ClosePauseCancelFormService
     */
    ...
    /**
     * Creates an instance of ClosePauseCancelFormService.
     * 
     * @param {*} [opts={}]
     * @memberof ClosePauseCancelFormService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ClosePauseCancelFormModel();
    }
