...
export class ClosePauseCancelFormEditFormBase extends EditFormControlBase {
     ...
     *
     * @type {*}
     * @memberof ClosePauseCancelFormBase
     */
    public deRules:any = {
    };
    ...
    public detailsModel: any = {
        ...
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.closepausecancelform_form', extractMode: 'ITEM', details: [] } }),

        group1: new FormGroupPanelModel({ caption: '任务基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, showMoreMode: 0, uiActionGroup: { caption: '', langbase: 'entities.task.closepausecancelform_form', extractMode: 'ITEM', details: [] } }),
