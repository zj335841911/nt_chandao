...
import TaskTreeModel from './task-tree-treeview-model';
 ...
 */
export default class TaskTreeService extends ControlService {
    ...
    /**
     * Creates an instance of TaskTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskTreeService
     */
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_PTASK)) {
     ...
     */
    @Errorlog
    public fillPtaskNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            ...
            let records: any[] = [];
            try {
                this.searchPtask(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode, { nodeType: "DE",appEntityName:"task" });
                        list.push(treeNode);
                        resolve(list);
                        bFirst = false;
                    });
     ...
     */
    @Errorlog
    public searchPtask(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
     ...
     */
    @Errorlog
    public async fillPtaskNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充子任务
            let ChildtaskRsNavContext:any = {};
            let ChildtaskRsNavParams:any = {};
            let ChildtaskRsParams:any = {};
			await this.fillChildtaskNodes(context, filter, list ,ChildtaskRsNavContext,ChildtaskRsNavParams,ChildtaskRsParams);
		} else {
			// 填充子任务
            let ChildtaskRsNavContext:any = {};
            let ChildtaskRsNavParams:any = {};
     ...
     */
    @Errorlog
    public fillChildtaskNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        context = this.handleResNavContext(context,filter,rsNavContext);
        filter = this.handleResNavParams(context,filter,rsNavParams,rsParams);
        return new Promise((resolve:any,reject:any) =>{
            let searchFilter: any = {};
            if (Object.is(filter.strNodeType, this.TREENODE_PTASK)) {
            ...
            let records: any[] = [];
            try {
                this.searchChildtask(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        records.forEach((entity: any) => {
                        let treeNode: any = {};
                        // 整理context
                        ...
                        Object.assign(treeNode, { srfkey: strId });
                        Object.assign(treeNode, { text: strText, srfmajortext: strText });
                        let strNodeId: string = 'ChildTask';
                        strNodeId += this.TREENODE_SEPARATOR;
                        strNodeId += strId;
                        Object.assign(treeNode, { id: strNodeId });
                        Object.assign(treeNode, { expanded: true });
     ...
     */
    @Errorlog
    public searchChildtask(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            if(filter.viewparams){
                Object.assign(searchFilter,filter.viewparams);
            }
