...
import ReportMainModel from './report-main-grid-model';
 ...
 *
 * @export
 * @class ReportMainService
 */
export default class ReportMainService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof ReportMainService
     */
    ...
    /**
     * Creates an instance of ReportMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ReportMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ReportMainModel();
    }
