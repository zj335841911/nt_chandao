...
export class ForwardEditFormBase extends EditFormControlBase {
    ...
    public rules():any{
        return {
        assignedto: [
            { required: this.detailsModel.assignedto.required, type: 'string', message: '转交给 值不能为空', trigger: 'change' },
            { required: this.detailsModel.assignedto.required, type: 'string', message: '转交给 值不能为空', trigger: 'blur' },
        ],
        left: [
    ...
    public detailsModel: any = {
        ...
        assignedto: new FormItemModel({ caption: '转交给', detailType: 'FORMITEM', name: 'assignedto', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        left: new FormItemModel({ caption: '预计剩余', detailType: 'FORMITEM', name: 'left', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:true, disabled: false, enableCond: 3 }),

        multiple: new FormItemModel({ caption: '多人任务', detailType: 'FORMITEM', name: 'multiple', visible: true, isShowCaption: true, form: this, showMoreMode: 0, required:false, disabled: false, enableCond: 3 }),
