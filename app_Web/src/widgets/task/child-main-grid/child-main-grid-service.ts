...
import ChildMainModel from './child-main-grid-model';
 ...
 *
 * @export
 * @class ChildMainService
 */
export default class ChildMainService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof ChildMainService
     */
    ...
    /**
     * Creates an instance of ChildMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ChildMainService
     */
