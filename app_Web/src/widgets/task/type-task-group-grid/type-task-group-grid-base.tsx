...
import TypeTaskGroupService from './type-task-group-grid-service';
 ...
 * @extends {TypeTaskGroupGridBase}
 */
export class TypeTaskGroupGridBase extends GridControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof TypeTaskGroupGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TypeTaskGroupService}
     * @memberof TypeTaskGroupGridBase
     */
    public service: TypeTaskGroupService = new TypeTaskGroupService({ $store: this.$store });
     ...
     * @memberof TypeTaskGroupBase
     */
    protected localStorageTag: string = 'zt_task_typetaskgroup_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'type',
            label: '任务类型',
            langtag: 'entities.task.typetaskgroup_grid.columns.type',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'id',
            label: 'ID',
            langtag: 'entities.task.typetaskgroup_grid.columns.id',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'pri',
            label: 'P',
            langtag: 'entities.task.typetaskgroup_grid.columns.pri',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'name',
            label: '任务名称',
            langtag: 'entities.task.typetaskgroup_grid.columns.name',
            show: true,
            unit: 'STAR',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'status1',
            label: '任务状态',
            langtag: 'entities.task.typetaskgroup_grid.columns.status1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'assignedto',
            label: '指派给',
            langtag: 'entities.task.typetaskgroup_grid.columns.assignedto',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'finishedby',
            label: '完成者',
            langtag: 'entities.task.typetaskgroup_grid.columns.finishedby',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'estimate',
            label: '预计',
            langtag: 'entities.task.typetaskgroup_grid.columns.estimate',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'consumed',
            label: '消耗',
            langtag: 'entities.task.typetaskgroup_grid.columns.consumed',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'left',
            label: '剩余',
            langtag: 'entities.task.typetaskgroup_grid.columns.left',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deadline',
            label: '截止日期',
            langtag: 'entities.task.typetaskgroup_grid.columns.deadline',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'uagridcolumn1',
            label: '操作',
            langtag: 'entities.task.typetaskgroup_grid.columns.uagridcolumn1',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
     ...
     * @memberof TypeTaskGroupBase
     */
    public groupAppField:string ="type";
     ...
     * @memberof TypeTaskGroupBase
     */
    public groupAppFieldCodelistTag:string ="Task__type";
     ...
     * @memberof TypeTaskGroupBase
     */
    public codelistTag: string = "Task__type";
    ...
    public getSummaries(param:any){
        ...
        columns.forEach((column:any, index:number) => {
          ...
          if (!values.every((value:any) => isNaN(value))) {
                if(Object.is(column.property,'type')){
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['type','id','pri','name','status1','assignedto','finishedby','estimate','consumed','left','deadline','uagridcolumn1'];
        if(row && row.children) {
