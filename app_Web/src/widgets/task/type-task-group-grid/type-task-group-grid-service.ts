...
import TypeTaskGroupModel from './type-task-group-grid-model';


/**
 * TypeTaskGroup 部件服务对象
 *
 * @export
 * @class TypeTaskGroupService
 */
export default class TypeTaskGroupService extends ControlService {

    /**
     * 任务服务对象
     *
     * @type {TaskService}
     * @memberof TypeTaskGroupService
     */
    ...
    /**
     * Creates an instance of TypeTaskGroupService.
     * 
     * @param {*} [opts={}]
     * @memberof TypeTaskGroupService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new TypeTaskGroupModel();
    }
