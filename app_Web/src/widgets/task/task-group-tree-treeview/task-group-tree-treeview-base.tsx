...
import TaskGroupTreeService from './task-group-tree-treeview-service';
 ...
 * @extends {TaskGroupTreeTreeBase}
 */
export class TaskGroupTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof TaskGroupTreeTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {TaskGroupTreeService}
     * @memberof TaskGroupTreeTreeBase
     */
    public service: TaskGroupTreeService = new TaskGroupTreeService({ $store: this.$store });
