...
import FeatureCaseExpModel from './feature-case-exp-treeview-model';
import CodeListService from '@service/app/codelist-service';
import i18n from '@/locale';


/**
 * FeatureCaseExp 部件服务对象
 *
 * @export
 * @class FeatureCaseExpService
 */
export default class FeatureCaseExpService extends ControlService {

    /**
     * 需求模块服务对象
     *
     * @type {ProductModuleService}
     * @memberof FeatureCaseExpService
     */
    ...
    /**
     * Creates an instance of FeatureCaseExpService.
     * 
     * @param {*} [opts={}]
     * @memberof FeatureCaseExpService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new FeatureCaseExpModel();
    }
    ...
    public fillAllNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.productmodule.featurecaseexp_treeview.nodes.all' });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.productmodule.featurecaseexp_treeview.nodes.root' });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
