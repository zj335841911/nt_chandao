...
import FeatureCaseExpService from './feature-case-exp-treeview-service';
...
export default class FeatureCaseExpBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof FeatureCaseExp
     */
     ...
     * 建构部件服务对象
     *
     * @type {FeatureCaseExpService}
     * @memberof FeatureCaseExp
     */
    public service: FeatureCaseExpService = new FeatureCaseExpService({ $store: this.$store });
...
<style lang='less'>
@import './feature-case-exp-treeview.less';
</style>