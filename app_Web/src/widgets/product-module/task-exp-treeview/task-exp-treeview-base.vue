...
import TaskExpService from './task-exp-treeview-service';
...
export default class TaskExpBase extends Vue implements ControlInterface {
     ...
     * @memberof TaskExp
     */
    public service: TaskExpService = new TaskExpService({ $store: this.$store });
