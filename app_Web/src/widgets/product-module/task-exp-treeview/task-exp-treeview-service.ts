...
import TaskExpModel from './task-exp-treeview-model';
 ...
 *
 * @export
 * @class TaskExpService
 */
export default class TaskExpService extends ControlService {

    /**
     * 需求模块服务对象
     *
     * @type {ProductModuleService}
     * @memberof TaskExpService
     */
    ...
    /**
     * Creates an instance of TaskExpService.
     * 
     * @param {*} [opts={}]
     * @memberof TaskExpService
     */
    ...
    public fillAllNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.productmodule.taskexp_treeview.nodes.all' });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: 'entities.productmodule.taskexp_treeview.nodes.root' });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
