...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u0b691d7_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
        ...
        curUIService.ProductModule_RemoveModule(datas,contextJO, paramJO,  $event, xData,this,"ProductModule");
    }
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('RemoveModule', tag)) {
            this.grid_uagridcolumn1_u0b691d7_click(row, tag, $event);
        }
    }
