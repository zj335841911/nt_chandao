...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof 
     */
    public grid_uagridcolumn1_u8447967_click(params: any = {}, tag?: any, $event?: any) {
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        // _this 指向容器对象
    ...
    public allColumns: any[] = [
        ...
        },
        {
            name: 'order',
            label: '排序值',
            langtag: 'entities.productmodule.main_grid.columns.order',
            show: true,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
	...
	public uiAction(row: any, tag: any, $event: any): void {
        ...
        if(Object.is('Remove', tag)) {
            this.grid_uagridcolumn1_u8447967_click(row, tag, $event);
        }
    }
