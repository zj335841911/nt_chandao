    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ productmodule: keys.join(';') }),Object.assign({ productmodule: keys.join(';') },{viewparams:this.viewparams}), this.showBusyIndicator);
