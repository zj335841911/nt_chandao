        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
                ...
                <el-table-column show-overflow-tooltip :prop="'name'" :label="$t('entities.productmodule.main_grid.columns.name')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.productmodule.main_grid.columns.name')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('short')">
                <el-table-column show-overflow-tooltip :prop="'short'" :label="$t('entities.productmodule.main_grid.columns.short')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.productmodule.main_grid.columns.short')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit">
            ...
            <template v-if="getColumnState('uagridcolumn1')">
                <el-table-column :column-key="'uagridcolumn1'" :label="$t('entities.productmodule.main_grid.columns.uagridcolumn1')" :width="50"  :align="'center'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.productmodule.main_grid.columns.uagridcolumn1')}}
                      </span>
                    </template>
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ productmodule: _keys }),Object.assign({ productmodule: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
