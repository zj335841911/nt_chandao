...
export default class CaseExpBase extends Vue implements ControlInterface {
     ...
     * @memberof CaseExp
     */
    protected service: CaseExpService = new CaseExpService({ $store: this.$store });
