...
import CaseExpModel from './case-exp-treeview-model';
 ...
 *
 * @export
 * @class CaseExpService
 */
export default class CaseExpService extends ControlService {

    /**
     * 需求模块服务对象
     *
     * @type {ProductModuleService}
     * @memberof CaseExpService
     */
    ...
    /**
     * Creates an instance of CaseExpService.
     * 
     * @param {*} [opts={}]
     * @memberof CaseExpService
     */
