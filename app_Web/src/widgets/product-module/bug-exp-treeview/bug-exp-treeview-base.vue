...
export default class BugExpBase extends Vue implements ControlInterface {
     ...
     * @memberof BugExp
     */
    protected service: BugExpService = new BugExpService({ $store: this.$store });
