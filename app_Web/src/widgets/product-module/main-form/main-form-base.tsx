...
export class MainEditFormBase extends EditFormControlBase {
            ...
            name: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.productmodule.main_form.details.name')}  ${this.$t('app.commonWords.valueNotEmpty')}`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.name.required,
    ...
    caption: '平台', detailType: 'FORMITEM', name: 'branch', visible: true, isShowCaption: false, form: this, showMoreMode: 0,
    required:false,
    disabled: false,
    enableCond: 3,
}),
    ...
    caption: '产品', detailType: 'FORMITEM', name: 'root', visible: true, isShowCaption: true, form: this, showMoreMode: 0,
    required:false,
    disabled: false,
    enableCond: 3,
}),
