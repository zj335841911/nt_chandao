...
export class DocChildProductTreeViewTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        ModuleDoc_deuiaction5: {ctrlname: 'moduledoc_cm',name:'deuiaction5',nodeOwner:'ModuleDoc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'eye',caption: '',title:'entities.doclib.docchildproducttreeview_treeview.uiactions.doc_docinfo'},
    }
