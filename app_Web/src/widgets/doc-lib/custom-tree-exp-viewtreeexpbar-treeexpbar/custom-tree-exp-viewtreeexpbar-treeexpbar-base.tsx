...
import CustomTreeExpViewtreeexpbarService from './custom-tree-exp-viewtreeexpbar-treeexpbar-service';
 ...
 * @extends {CustomTreeExpViewtreeexpbarTreeExpBarBase}
 */
export class CustomTreeExpViewtreeexpbarTreeExpBarBase extends TreeExpBarControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof CustomTreeExpViewtreeexpbarTreeExpBarBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {CustomTreeExpViewtreeexpbarService}
     * @memberof CustomTreeExpViewtreeexpbarTreeExpBarBase
     */
    public service: CustomTreeExpViewtreeexpbarService = new CustomTreeExpViewtreeexpbarService({ $store: this.$store });
     ...
     * @memberof CustomTreeExpViewtreeexpbarBase
     */  
    ...
    public getExpItemView(arg: any = {}): any {
        ...
        if (Object.is(expmode, 'DOCROOT')) {
            return {  
                viewname: 'doc-doc-module-grid-view', 
                parentdata: {},
                deKeyField:'doc'
			};
        }
    ...
    */
    public ctrlMounted(){ 
        if(this.$store.getters.getViewSplit(this.viewUID)){
            ...
            let containerWidth:number = (document.getElementById("customtreeexpviewtreeexpbar") as any).offsetWidth;
            if(this.ctrlWidth){
