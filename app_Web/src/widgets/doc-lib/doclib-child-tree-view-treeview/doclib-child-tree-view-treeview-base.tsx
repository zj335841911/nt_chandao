...
export class DoclibChildTreeViewTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ChildDoclib_deuiaction1: {name:'deuiaction1',nodeOwner:'ChildDoclib',type: 'DEUIACTION', tag: 'Edit', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'DOC', visible: true, disabled: false},
        ChildDoclib_deuiaction2: {name:'deuiaction2',nodeOwner:'ChildDoclib',type: 'DEUIACTION', tag: 'Collect', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__DOC_FAVOUR_BUT', visible: true, disabled: false},
        ChildDoclib_deuiaction3: {name:'deuiaction3',nodeOwner:'ChildDoclib',type: 'DEUIACTION', tag: 'UnCollect', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'SRFUR__DOC_NFAVOUR_BUT', visible: true, disabled: false},
    ...
    public onAction(item: any,tag: string) {
        ...
        if (_this.childdoclib_cm_click && _this.childdoclib_cm_click instanceof Function) {
