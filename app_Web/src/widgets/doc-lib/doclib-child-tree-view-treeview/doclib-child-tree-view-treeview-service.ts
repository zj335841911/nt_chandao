...
import DoclibChildTreeViewModel from './doclib-child-tree-view-treeview-model';
...
/**
 * DoclibChildTreeView 部件服务对象
 *
 * @export
 * @class DoclibChildTreeViewService
 */
export default class DoclibChildTreeViewService extends ControlService {
    ...
    /**
     * Creates an instance of DoclibChildTreeViewService.
     * 
     * @param {*} [opts={}]
     * @memberof DoclibChildTreeViewService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DoclibChildTreeViewModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.doclibchildtreeview_treeview.nodes.root') });
