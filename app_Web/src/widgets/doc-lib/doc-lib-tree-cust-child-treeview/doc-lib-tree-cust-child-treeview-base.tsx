...
import DocLibTreeCustChildService from './doc-lib-tree-cust-child-treeview-service';
 ...
 */
export class DocLibTreeCustChildTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof DocLibTreeCustChildTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {DocLibTreeCustChildService}
     * @memberof DocLibTreeCustChildTreeBase
     */
    public service: DocLibTreeCustChildService = new DocLibTreeCustChildService({ $store: this.$store });
     ...
     */
     public actionModel: any = {
        ...
        Doc_deuiaction5: {ctrlname: 'doc_cm',name:'deuiaction5',nodeOwner:'Doc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'fa fa-eye',caption: '',title:'entities.doclib.doclibtreecustchild_treeview.uiactions.doc_docinfo'},
