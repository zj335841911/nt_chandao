...
import DocLibTreeCustChildModel from './doc-lib-tree-cust-child-treeview-model';
...
/**
 * DocLibTreeCustChild 部件服务对象
 *
 * @export
 * @class DocLibTreeCustChildService
 */
export default class DocLibTreeCustChildService extends ControlService {

    /**
     * 文档库服务对象
     *
     * @type {DocLibService}
     * @memberof DocLibTreeCustChildService
     */
    ...
    /**
     * Creates an instance of DocLibTreeCustChildService.
     * 
     * @param {*} [opts={}]
     * @memberof DocLibTreeCustChildService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DocLibTreeCustChildModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.doclibtreecustchild_treeview.nodes.root') });
