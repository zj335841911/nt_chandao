...
/**
 * DocLibTreeProduct 部件服务对象
 *
 * @export
 * @class DocLibTreeProductService
 */
export default class DocLibTreeProductService extends ControlService {
    ...
    /**
     * Creates an instance of DocLibTreeProductService.
     * 
     * @param {*} [opts={}]
     * @memberof DocLibTreeProductService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new DocLibTreeProductModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.doclibtreeproduct_treeview.nodes.root') });
    ...
    public searchModule(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
            ...
            const _appEntityService: any = this.doclibmoduleService;
            let list: any[] = [];
            if (_appEntityService['FetchRootModuleMuLuByRoot'] && _appEntityService['FetchRootModuleMuLuByRoot'] instanceof Function) {
                const response: Promise<any> = _appEntityService['FetchRootModuleMuLuByRoot'](context, searchFilter, false);
                response.then((response: any) => {
                    if (!response.status || response.status !== 200) {
                        resolve([]);
                        console.log(JSON.stringify(context));
                        console.error('查询FetchRootModuleMuLuByRoot数据集异常!');
                    }
                    const data: any = response.data;
                    if (Object.keys(data).length > 0) {
                        list = JSON.parse(JSON.stringify(data));
