...
export class DocLibTreeCustTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        Doc_deuiaction5: {ctrlname: 'doc_cm',name:'deuiaction5',nodeOwner:'Doc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'eye',caption: '',title:'entities.doclib.doclibtreecust_treeview.uiactions.doc_docinfo'},
        ...
        ModuleDoc_deuiaction5: {ctrlname: 'moduledoc_cm',name:'deuiaction5',nodeOwner:'ModuleDoc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'eye',caption: '',title:'entities.doclib.doclibtreecust_treeview.uiactions.doc_docinfo'},
    }
