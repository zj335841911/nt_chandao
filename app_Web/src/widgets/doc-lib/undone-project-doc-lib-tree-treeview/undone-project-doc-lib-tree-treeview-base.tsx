...
import UndoneProjectDocLibTreeService from './undone-project-doc-lib-tree-treeview-service';
 ...
 * @extends {UndoneProjectDocLibTreeTreeBase}
 */
export class UndoneProjectDocLibTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof UndoneProjectDocLibTreeTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {UndoneProjectDocLibTreeService}
     * @memberof UndoneProjectDocLibTreeTreeBase
     */
    public service: UndoneProjectDocLibTreeService = new UndoneProjectDocLibTreeService({ $store: this.$store });
     ...
     * @memberof UndoneProjectDocLibTreeBase
     */  
