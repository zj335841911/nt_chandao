...
export class RootDoclibProjectTreeVeiwTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        docLIbRoot_deuiaction4: {ctrlname: 'doclibroot_cm',name:'deuiaction4',nodeOwner:'docLIbRoot',type: 'DEUIACTION', tag: 'WeiHuFenLei', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, dataaccaction:'DOC', visible: true, disabled: false,imgclass: 'fa fa-lock',caption: ''},
