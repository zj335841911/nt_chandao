...
import ProductMainModel from './product-main-grid-model';
 ...
 */
export default class ProductMainService extends ControlService {

    /**
     * 文档库服务对象
     *
     * @type {DocLibService}
     * @memberof ProductMainService
     */
    ...
    /**
     * Creates an instance of ProductMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ProductMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProductMainModel();
    }
