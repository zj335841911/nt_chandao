...
import ExpProductMainModel from './exp-product-main-grid-model';


/**
 * ExpProductMain 部件服务对象
 *
 * @export
 * @class ExpProductMainService
 */
export default class ExpProductMainService extends ControlService {

    /**
     * 文档库服务对象
     *
     * @type {DocLibService}
     * @memberof ExpProductMainService
     */
    ...
    /**
     * Creates an instance of ExpProductMainService.
     * 
     * @param {*} [opts={}]
     * @memberof ExpProductMainService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ExpProductMainModel();
    }
