...
import ExpProductMainService from './exp-product-main-grid-service';
 ...
 * @extends {ExpProductMainGridBase}
 */
export class ExpProductMainGridBase extends GridControlBase {
     ...
     * @protected
     * @type {string}
     * @memberof ExpProductMainGridBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ExpProductMainService}
     * @memberof ExpProductMainGridBase
     */
    public service: ExpProductMainService = new ExpProductMainService({ $store: this.$store });
     ...
     * @memberof ExpProductMainBase
     */
    protected localStorageTag: string = 'zt_doclib_expproductmain_gridexpbar_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'name',
            label: '文档库名称',
            langtag: 'entities.doclib.expproductmain_grid.columns.name',
            show: true,
            unit: 'STAR',
