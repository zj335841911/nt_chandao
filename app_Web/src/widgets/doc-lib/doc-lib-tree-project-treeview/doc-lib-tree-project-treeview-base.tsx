...
export class DocLibTreeProjectTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        DocLibDoc_deuiaction5: {ctrlname: 'doclibdoc_cm',name:'deuiaction5',nodeOwner:'DocLibDoc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'eye',caption: '',title:'entities.doclib.doclibtreeproject_treeview.uiactions.doc_docinfo'},
        ...
        ModuleDoc_deuiaction5: {ctrlname: 'moduledoc_cm',name:'deuiaction5',nodeOwner:'ModuleDoc',type: 'DEUIACTION', tag: 'DocInfo', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false,imgclass: 'eye',caption: '',title:'entities.doclib.doclibtreeproject_treeview.uiactions.doc_docinfo'},
