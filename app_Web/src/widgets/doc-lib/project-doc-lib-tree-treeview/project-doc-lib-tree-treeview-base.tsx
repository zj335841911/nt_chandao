 ...
 * @extends {ProjectDocLibTreeTreeBase}
 */
export class ProjectDocLibTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {ProjectDocLibTreeService}
     * @memberof ProjectDocLibTreeTreeBase
     */
    public service: ProjectDocLibTreeService = new ProjectDocLibTreeService({ $store: this.$store });
