...
import LooProductDocLibTreeModel from './loo-product-doc-lib-tree-treeview-model';
...
/**
 * LooProductDocLibTree 部件服务对象
 *
 * @export
 * @class LooProductDocLibTreeService
 */
export default class LooProductDocLibTreeService extends ControlService {

    /**
     * 文档库服务对象
     *
     * @type {DocLibService}
     * @memberof LooProductDocLibTreeService
     */
    ...
    /**
     * Creates an instance of LooProductDocLibTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof LooProductDocLibTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new LooProductDocLibTreeModel();
    }
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.looproductdoclibtree_treeview.nodes.root') });
    ...
    public fillFilesNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.looproductdoclibtree_treeview.nodes.files') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public fillAllproductNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.looproductdoclibtree_treeview.nodes.allproduct') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
