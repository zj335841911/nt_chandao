...
export class LooProductDocLibTreeTreeBase extends MainControlBase {
     ...
     */
     public actionModel: any = {
        ...
        DoclibModule_deuiaction1: {name:'deuiaction1',nodeOwner:'DoclibModule',type: 'DEUIACTION', tag: 'edit', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false},
        DoclibModule_deuiaction2: {name:'deuiaction2',nodeOwner:'DoclibModule',type: 'DEUIACTION', tag: 'Favorite', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false},
        DoclibModule_deuiaction3: {name:'deuiaction3',nodeOwner:'DoclibModule',type: 'DEUIACTION', tag: 'NFavorite', actiontarget: 'SINGLEKEY', noprivdisplaymode:2, visible: true, disabled: false},
    }
