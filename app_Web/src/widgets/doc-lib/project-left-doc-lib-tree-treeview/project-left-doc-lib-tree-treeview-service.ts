...
import ProjectLeftDocLibTreeModel from './project-left-doc-lib-tree-treeview-model';
...
/**
 * ProjectLeftDocLibTree 部件服务对象
 *
 * @export
 * @class ProjectLeftDocLibTreeService
 */
export default class ProjectLeftDocLibTreeService extends ControlService {
    ...
    /**
     * Creates an instance of ProjectLeftDocLibTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof ProjectLeftDocLibTreeService
     */
    constructor(opts: any = {}) {
        super(opts);
        this.model = new ProjectLeftDocLibTreeModel();
    }
    ...
    public fillAllNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.projectleftdoclibtree_treeview.nodes.all') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
    ...
    public fillRootNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            let treeNode: any = {};
            Object.assign(treeNode, { text: i18n.t('entities.doclib.projectleftdoclibtree_treeview.nodes.root') });
            Object.assign(treeNode, { isUseLangRes: true });
            Object.assign(treeNode,{srfappctx:context});
            Object.assign(treeNode, { srfmajortext: treeNode.text });
