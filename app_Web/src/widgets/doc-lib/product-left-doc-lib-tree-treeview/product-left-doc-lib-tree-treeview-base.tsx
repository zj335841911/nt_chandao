...
import ProductLeftDocLibTreeService from './product-left-doc-lib-tree-treeview-service';
 ...
 * @extends {ProductLeftDocLibTreeTreeBase}
 */
export class ProductLeftDocLibTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     * @type {string}
     * @memberof ProductLeftDocLibTreeTreeBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProductLeftDocLibTreeService}
     * @memberof ProductLeftDocLibTreeTreeBase
     */
    public service: ProductLeftDocLibTreeService = new ProductLeftDocLibTreeService({ $store: this.$store });
