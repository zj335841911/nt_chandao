            ...
            projectname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.doclib.main_form.details.projectname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.projectname.required,
            ...
            productname: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.doclib.main_form.details.productname')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.productname.required,
            ...
            name: [
                {
                    ...
                    type: 'string',
                    message: `${this.$t('entities.doclib.main_form.details.name')}  值不能为空`,
                    trigger: 'change',
                },
                {
                    required: this.detailsModel.name.required,
