...
import CustomDocLibTreeService from './custom-doc-lib-tree-treeview-service';
 ...
 * @extends {CustomDocLibTreeTreeBase}
 */
export class CustomDocLibTreeTreeBase extends MainControlBase {
    /**
     * 获取部件类型
     *
     * @protected
     ...
     * 建构部件服务对象
     *
     * @type {CustomDocLibTreeService}
     * @memberof CustomDocLibTreeTreeBase
     */
    public service: CustomDocLibTreeService = new CustomDocLibTreeService({ $store: this.$store });
