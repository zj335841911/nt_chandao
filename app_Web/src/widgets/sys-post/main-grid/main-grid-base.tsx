...
export class MainGridBase extends GridControlBase {
     ...
     * @memberof MainBase
     */
    protected localStorageTag: string = 'sys_post_main_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'postid',
            label: '岗位标识',
            langtag: 'entities.syspost.main_grid.columns.postid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'postname',
            label: '岗位名称',
            langtag: 'entities.syspost.main_grid.columns.postname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'memo',
            label: '备注',
            langtag: 'entities.syspost.main_grid.columns.memo',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
