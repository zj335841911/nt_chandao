...
export class MainExpGridBase extends GridControlBase {
     ...
     * @memberof MainExpBase
     */  
    public majorInfoColName:string = "deptname";
     ...
     * @memberof MainExpGridBase
     */
    public columnKeyName: string = "deptid";
     ...
     * @memberof MainExpBase
     */
    protected localStorageTag: string = 'sys_dept_mainexp_gridexpbar_grid';
    ...
    public allColumns: any[] = [
        {
            name: 'deptid',
            label: '部门标识',
            langtag: 'entities.sysdepartment.mainexp_grid.columns.deptid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'deptname',
            label: '部门名称',
            langtag: 'entities.sysdepartment.mainexp_grid.columns.deptname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['deptid','deptname'];
        if(row && row.children) {
        ...
        if(Object.is(action,"UPDATE")){
            ...
            if(nativeData && (nativeData instanceof Array) && nativeData.length >0){
                let targetData:any = nativeData.find((item:any) =>{
                    return item.deptid === data.srfkey;
                })
                if(targetData){
