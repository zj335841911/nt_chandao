...
export class UIActionTool {
     ...
     */
    public static handleContextParam(
        actionTarget: any,
        args: any,
        parentContext: any,
        parentParams: any,
            ...
            Object.keys(_params).forEach((name: string) => {
                ...
                if (value && typeof value === 'string' && value.startsWith('%') && value.endsWith('%')) {
                    ...
                    if (arg && arg.hasOwnProperty(key) && Object.is(actionTarget, 'SINGLEKEY')) {
                        ...
                        value =
                            parentContext[key] !== null && parentContext[key] !== undefined ? parentContext[key] : null;
                    } else if (parentParams && parentParams.hasOwnProperty(key)) {
                        value =
                            parentParams[key] !== null && parentParams[key] !== undefined ? parentParams[key] : null;
                    } else {
                        hasProperty = false;
                    }
                }
                ...
                if (value && typeof value === 'string' && value.startsWith('%') && value.endsWith('%')) {
                    ...
                    args.forEach((arg: any) => {
                        if (arg && arg.hasOwnProperty(key)) {
                            ...
                            value =
                                parentContext[key] !== null && parentContext[key] !== undefined
                                    ? parentContext[key]
                                    : null;
                        } else if (parentParams && parentParams.hasOwnProperty(key)) {
                            value =
                                parentParams[key] !== null && parentParams[key] !== undefined
                                    ? parentParams[key]
                                    : null;
                        } else {
                            value = null;
