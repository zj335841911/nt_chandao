 ...
 *
 * @export
 * @class SysEmployeeTreeExpViewBase
 * @extends {TreeExpViewBase}
 */
export class SysEmployeeTreeExpViewBase extends TreeExpViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.sysemployee.views.treeexpview.caption',
        srfTitle: 'entities.sysemployee.views.treeexpview.title',
        srfSubTitle: 'entities.sysemployee.views.treeexpview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof SysEmployeeTreeExpViewBase
     */ 
    protected viewName: string = 'SysEmployeeTreeExpView';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof SysEmployeeTreeExpView
     */
     ...
     * @memberof SysEmployeeTreeExpView
     */
    public viewUID: string = 'ou-sys-employee-tree-exp-view';
