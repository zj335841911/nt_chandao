 ...
 *
 * @export
 * @class IBZProStoryModuleGridViewBase
 * @extends {GridViewBase}
 */
export class IBZProStoryModuleGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.ibzprostorymodule.views.gridview.caption',
        srfTitle: 'entities.ibzprostorymodule.views.gridview.title',
        srfSubTitle: 'entities.ibzprostorymodule.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        deuiaction3_syncfromibiz: { name: 'deuiaction3_syncfromibiz', caption: '同步', 'isShowCaption': true, 'isShowIcon': true, tooltip: '同步', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'syncFromIBIZ', target: 'NONE', class: '' } },
    ...
    public toolbar_click($event: any, $event2?: any): void {
        if (Object.is($event.tag, 'deuiaction3_syncfromibiz')) {
            this.toolbar_deuiaction3_syncfromibiz_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction3_syncfromibiz_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:IBZProStoryModuleUIService  = new IBZProStoryModuleUIService();
        curUIService.IBZProStoryModule_syncFromIBIZ(datas,contextJO, paramJO,  $event, xData,this,"IBZProStoryModule");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"IBZProStoryModule");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Refresh(datas, contextJO,paramJO,  $event, xData,this,"IBZProStoryModule");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"IBZProStoryModule");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.ibzprostorymodule;
        if(args.length >0){
