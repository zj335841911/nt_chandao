...
export class IbizproProductWeeklyEditViewBase extends EditViewBase {
     ...
     *
     * @type {*}
     * @memberof IbizproProductWeeklyEditView
     */
    public toolBarModels: any = {
        tbitem3: { name: 'tbitem3', caption: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem3.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem3.tip', iconcls: 'fa fa-save', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'Save', target: '', class: '' } },

        tbitem4: { name: 'tbitem4', caption: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem4.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem4.tip', iconcls: 'sx-tb-saveandnew', icon: '../sasrfex/images/default/icon_saveandnew.png', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveAndNew', target: '', class: '' } },

        tbitem5: { name: 'tbitem5', caption: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem5.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem5.tip', iconcls: 'sx-tb-saveandclose', icon: '../sasrfex/images/default/icon_saveandclose.png', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveAndExit', target: '', class: '' } },

        tbitem7: { name: 'tbitem7', caption: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem7.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibizproproductweekly.editviewtoolbar_toolbar.tbitem7.tip', iconcls: 'fa fa-remove', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALDELETE', uiaction: { tag: 'RemoveAndExit', target: 'SINGLEKEY', class: '' } },
     ...
     * @memberof IbizproProductWeeklyEditViewBase
     */
	protected viewtag: string = 'c2466369bc195c738c016c59f423713a';
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndStart(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"IbizproProductWeekly");
    }
