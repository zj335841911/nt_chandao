 ...
 *
 * @export
 * @class IbzproProjectUserTaskProjectWeeklyGridViewBase
 * @extends {GridViewBase}
 */
export class IbzproProjectUserTaskProjectWeeklyGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof IbzproProjectUserTaskProjectWeeklyGridViewBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.ibzproprojectusertask.views.projectweeklygridview.caption',
        srfTitle: 'entities.ibzproprojectusertask.views.projectweeklygridview.title',
        srfSubTitle: 'entities.ibzproprojectusertask.views.projectweeklygridview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof IbzproProjectUserTaskProjectWeeklyGridViewBase
     */
	protected viewtag: string = 'e288763f49b2c168996087e7b44084c4';
     ...
     * @memberof IbzproProjectUserTaskProjectWeeklyGridViewBase
     */ 
    protected viewName: string = 'IbzproProjectUserTaskProjectWeeklyGridView';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof IbzproProjectUserTaskProjectWeeklyGridView
     */
