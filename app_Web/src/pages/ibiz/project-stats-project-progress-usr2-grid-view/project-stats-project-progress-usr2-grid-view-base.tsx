 ...
 *
 * @export
 * @class ProjectStatsProjectProgressUsr2GridViewBase
 * @extends {GridViewBase}
 */
export class ProjectStatsProjectProgressUsr2GridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.projectstats.views.projectprogressusr2gridview.caption',
        srfTitle: 'entities.projectstats.views.projectprogressusr2gridview.title',
        srfSubTitle: 'entities.projectstats.views.projectprogressusr2gridview.subtitle',
        dataInfo: '',
    };
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.projectstats.projectprogressusr2gridviewtoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.projectstats.projectprogressusr2gridviewtoolbar_toolbar.deuiaction1.tip', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000, class: '' },
     ...
     * @memberof ProjectStatsProjectProgressUsr2GridViewBase
     */
	protected viewtag: string = '595377d5c94799083b6ba5d33f2dfcee';
     ...
     * @memberof ProjectStatsProjectProgressUsr2GridViewBase
     */ 
    protected viewName: string = 'ProjectStatsProjectProgressUsr2GridView';
