 ...
 *
 * @export
 * @class ProductSumStorySumGridViewBase
 * @extends {GridViewBase}
 */
export class ProductSumStorySumGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.productsum.views.storysumgridview.caption',
        srfTitle: 'entities.productsum.views.storysumgridview.title',
        srfSubTitle: 'entities.productsum.views.storysumgridview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof ProductSumStorySumGridViewBase
     */
	protected viewtag: string = 'ae280d70f2ed0232df0d011af22a5746';
     ...
     * @memberof ProductSumStorySumGridViewBase
     */ 
    protected viewName: string = 'ProductSumStorySumGridView';
