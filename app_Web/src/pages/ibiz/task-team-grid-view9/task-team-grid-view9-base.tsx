...
export class TaskTeamGridView9Base extends GridView9Base {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.taskteam.views.gridview9.caption',
        srfTitle: 'entities.taskteam.views.gridview9.title',
        srfSubTitle: 'entities.taskteam.views.gridview9.subtitle',
        dataInfo: ''
    }
