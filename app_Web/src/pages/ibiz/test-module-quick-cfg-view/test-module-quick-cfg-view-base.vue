<template>
<div class="view-container test-module-quick-cfg-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testmodulequickcfgview"></app-studioaction>
...
export default class TestModuleQuickCfgViewBase extends Vue {
...
<style lang='less'>
@import './test-module-quick-cfg-view.less';
</style>