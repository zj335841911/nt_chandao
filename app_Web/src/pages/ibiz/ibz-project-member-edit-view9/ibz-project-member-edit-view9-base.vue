<template>
<div class="view-container ibz-project-member-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="ibzprojectmembereditview9"></app-studioaction>
...
export default class IbzProjectMemberEditView9Base extends Vue {
...
<style lang='less'>
@import './ibz-project-member-edit-view9.less';
</style>