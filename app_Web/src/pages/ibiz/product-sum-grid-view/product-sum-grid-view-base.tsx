 ...
 *
 * @export
 * @class ProductSumGridViewBase
 * @extends {GridViewBase}
 */
export class ProductSumGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolBarModels: any = {
        deuiaction2: { name: 'deuiaction2', caption: 'entities.productsum.gridviewtoolbar_toolbar.deuiaction2.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.productsum.gridviewtoolbar_toolbar.deuiaction2.tip', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000, class: '' },
