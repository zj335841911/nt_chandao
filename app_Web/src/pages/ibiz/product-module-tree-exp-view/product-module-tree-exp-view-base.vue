<template>
<div class='view-container product-module-tree-exp-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productmoduletreeexpview"></app-studioaction>
...
export default class ProductModuleTreeExpViewBase extends Vue {
