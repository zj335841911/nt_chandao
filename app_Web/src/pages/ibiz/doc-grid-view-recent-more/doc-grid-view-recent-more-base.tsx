 ...
 *
 * @export
 * @class DocGridView_RecentMoreBase
 * @extends {GridViewBase}
 */
export class DocGridView_RecentMoreBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof DocGridView_RecentMoreBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.doc.views.gridview_recentmore.caption',
        srfTitle: 'entities.doc.views.gridview_recentmore.title',
        srfSubTitle: 'entities.doc.views.gridview_recentmore.subtitle',
        dataInfo: ''
    }
     ...
     * @memberof DocGridView_RecentMoreBase
     */ 
    protected viewName:string = "DocGridView_RecentMore";
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof DocGridView_RecentMore
     */
