<template>
    <div class='view-container task-team-grid-view9-edit'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskteamgridview9_edit"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.ibztaskteam.gridview9_edittoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.ibztaskteam.gridview9_edittoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class TaskTeamGridView9_EditBase extends Vue {
...
<style lang='less'>
@import './task-team-grid-view9-edit.less';
</style>