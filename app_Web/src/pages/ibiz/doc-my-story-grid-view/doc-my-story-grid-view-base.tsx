 ...
 *
 * @export
 * @class DocMyStoryGridViewBase
 * @extends {GridViewBase}
 */
export class DocMyStoryGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof DocMyStoryGridViewBase
     */
    ...
    protected customViewParams: any = {
        ...
        'n_collector_like': { isRawValue: false, value: 'srfloginname' },
     ...
     */
    protected model: any = {
        srfCaption: 'entities.doc.views.mystorygridview.caption',
        srfTitle: 'entities.doc.views.mystorygridview.title',
        srfSubTitle: 'entities.doc.views.mystorygridview.subtitle',
        dataInfo: ''
    }
     ...
     * @memberof DocMyStoryGridViewBase
     */
	protected viewtag: string = '73647c564ed468885ee3c18bccce5a90';
     ...
     * @memberof DocMyStoryGridViewBase
     */ 
    protected viewName:string = "DocMyStoryGridView";
