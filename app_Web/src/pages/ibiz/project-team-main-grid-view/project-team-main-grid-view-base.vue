<template>
    <div class='view-container project-team-main-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectteammaingridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3_managermember.visabled" :disabled="toolBarModels.deuiaction3_managermember.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3_managermember' }, $event)">
                                    <i class='fa fa-users'></i>
                                    <span class='caption'>{{$t('entities.projectteam.maingridviewtoolbar_toolbar.deuiaction3_managermember.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.projectteam.maingridviewtoolbar_toolbar.deuiaction3_managermember.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.projectteam.maingridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.projectteam.maingridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ProjectTeamMainGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction3_managermember: { name: 'deuiaction3_managermember', caption: '团队管理', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ManagerMember', target: 'NONE' } },
    ...
    protected toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction3_managermember')) {
            this.toolbar_deuiaction3_managermember_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_deuiaction3_managermember_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
...
<style lang='less'>
@import './project-team-main-grid-view.less';
</style>