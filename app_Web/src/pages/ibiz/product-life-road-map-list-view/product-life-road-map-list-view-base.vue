...
<template>
<div class='view-container product-life-road-map-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productliferoadmaplistview"></app-studioaction>
