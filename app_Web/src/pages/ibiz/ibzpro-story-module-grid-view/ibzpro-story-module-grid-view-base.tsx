...
export class IBZProStoryModuleGridViewBase extends GridViewBase {
     ...
     * @memberof IBZProStoryModuleGridViewBase
     */
    protected appDeKey: string = 'ibzpro_storymoduleid';
     ...
     * @memberof IBZProStoryModuleGridViewBase
     */
    protected appDeMajor: string = 'ibzpro_storymodulename';
    ...
    public engineInit(): void {
        this.engine.init({
            ...
            majorPSDEField: 'ibzprostorymodulename',
            isLoadDefault: true,
        });
    }
    ...
    public toolbar_click($event: any, $event2?: any): void {
        if (Object.is($event.tag, 'deuiaction3_push')) {
            this.toolbar_deuiaction3_push_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction3_push_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        curUIService.IBZProStoryModule_Push(datas,contextJO, paramJO,  $event, xData,this,"IBZProStoryModule");
    }
