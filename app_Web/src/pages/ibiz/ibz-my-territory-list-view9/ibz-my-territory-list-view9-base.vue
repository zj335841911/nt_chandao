...
<template>
<div class='view-container ibz-my-territory-list-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="ibzmyterritorylistview9"></app-studioaction>
...
export default class IbzMyTerritoryListView9Base extends Vue {
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof IbzMyTerritoryListView9
     */
...
<style lang='less'>
@import './ibz-my-territory-list-view9.less';
</style>