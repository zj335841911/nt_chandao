...
import view_dashboard from '@widgets/user-year-work-stats/dashboard-dashboard/dashboard-dashboard.vue';

/**
 * 用户年度工作内容统计数据看板视图视图
 *
 * @export
 * @class UserYearWorkStatsDashboardView
 * @extends {UserYearWorkStatsDashboardViewBase}
 */
@Component({
    components: {
        view_dashboard, 
