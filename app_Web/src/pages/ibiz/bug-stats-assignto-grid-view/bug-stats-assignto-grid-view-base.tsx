...
/**
 * Bug统计表格视图（Bug指派表）视图基类
 *
 * @export
 * @class BugStatsAssigntoGridViewBase
 * @extends {GridViewBase}
 */
export class BugStatsAssigntoGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof BugStatsAssigntoGridView
     */
