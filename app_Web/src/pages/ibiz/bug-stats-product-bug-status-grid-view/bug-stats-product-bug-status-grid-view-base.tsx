 ...
 *
 * @export
 * @class BugStatsProductBugStatusGridViewBase
 * @extends {GridViewBase}
 */
export class BugStatsProductBugStatusGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.bugstats.views.productbugstatusgridview.caption',
        srfTitle: 'entities.bugstats.views.productbugstatusgridview.title',
        srfSubTitle: 'entities.bugstats.views.productbugstatusgridview.subtitle',
        dataInfo: '',
    };
     ...
     *
     * @type {*}
     * @memberof BugStatsProductBugStatusGridView
     */
     ...
     * @memberof BugStatsProductBugStatusGridViewBase
     */ 
    protected viewName: string = 'BugStatsProductBugStatusGridView';
