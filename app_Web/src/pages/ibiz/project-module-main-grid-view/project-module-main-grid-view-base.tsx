 ...
 *
 * @export
 * @class ProjectModuleMainGridViewBase
 * @extends {GridViewBase}
 */
export class ProjectModuleMainGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof ProjectModuleMainGridViewBase
     */
	protected viewtag: string = '95320a98383e165118979cd27997f20e';
