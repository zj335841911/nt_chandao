<template>
    <div class='view-container project-module-main-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectmodulemaingridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction3.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ProjectModuleMainGridViewBase extends Vue {
     ...
     * @memberof ProjectModuleMainGridViewBase
     */
    protected SaveRow(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        // 界面行为容器对象 _this
        const _this: any = this;
