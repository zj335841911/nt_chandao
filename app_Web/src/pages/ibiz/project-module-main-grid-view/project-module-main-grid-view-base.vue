<template>
<studio-view viewName="projectmodulemaingridview" viewTitle="实体表格视图" class='degridview project-module-main-grid-view'>
    <template slot="toolbar">
                <div class='toolbar-container'>
            <i-button :title="$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-plus'></i>
                    <span class='caption'>{{$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction3.tip')" v-show="toolBarModels.deuiaction3.visabled" :disabled="toolBarModels.deuiaction3.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3' }, $event)">
                    <i class='fa fa-save'></i>
                    <span class='caption'>{{$t('entities.projectmodule.maingridviewtoolbar_toolbar.deuiaction3.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
...
export default class ProjectModuleMainGridViewBase extends Vue {
	 ...
	 * @memberof ProjectModuleMainGridViewBase
	 */
	public viewtag: string = '41dab4e36aef71df5c66acca4db7d045';
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"ProjectModule");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"ProjectModule");
    }
...
<style lang='less'>
@import './project-module-main-grid-view.less';
</style>