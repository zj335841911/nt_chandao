<template>
<div class="view-container product-module-quick-cfg-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productmodulequickcfgview"></app-studioaction>
...
export default class ProductModuleQuickCfgViewBase extends Vue {
