 ...
 *
 * @export
 * @class BugStatsBugResolvedByGridViewBase
 * @extends {GridViewBase}
 */
export class BugStatsBugResolvedByGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof BugStatsBugResolvedByGridViewBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.bugstats.views.bugresolvedbygridview.caption',
        srfTitle: 'entities.bugstats.views.bugresolvedbygridview.title',
        srfSubTitle: 'entities.bugstats.views.bugresolvedbygridview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof BugStatsBugResolvedByGridViewBase
     */
	protected viewtag: string = '42bcda6d6a7f1b04456c358f942ef63e';
     ...
     * @memberof BugStatsBugResolvedByGridViewBase
     */ 
    protected viewName: string = 'BugStatsBugResolvedByGridView';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof BugStatsBugResolvedByGridView
     */
