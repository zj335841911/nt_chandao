<template>
    <div class='view-container task-team-grid-view9-look'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskteamgridview9_look"></app-studioaction>
...
export default class TaskTeamGridView9_LookBase extends Vue {
...
<style lang='less'>
@import './task-team-grid-view9-look.less';
</style>