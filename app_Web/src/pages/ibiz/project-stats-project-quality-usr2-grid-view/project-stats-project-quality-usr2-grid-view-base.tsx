...
export class ProjectStatsProjectQualityUsr2GridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction7: { name: 'deuiaction7', caption: 'entities.projectstats.projectqualityusr2gridviewtoolbar_toolbar.deuiaction7.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.projectstats.projectqualityusr2gridviewtoolbar_toolbar.deuiaction7.tip', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000, class: '' },
