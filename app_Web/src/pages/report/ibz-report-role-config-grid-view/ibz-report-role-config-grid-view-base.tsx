...
export class IbzReportRoleConfigGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction1.tip', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'New', target: '', class: '' } },

        deuiaction4: { name: 'deuiaction4', caption: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction4.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction4.tip', iconcls: 'fa fa-remove', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALDELETE', uiaction: { tag: 'Remove', target: 'MULTIKEY', class: '' } },

        seperator1: {  name: 'seperator1', type: 'SEPERATOR', visible: true, dataaccaction: '', uiaction: { } },
        deuiaction2: { name: 'deuiaction2', caption: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction2.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction2.tip', iconcls: 'fa fa-refresh', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Refresh', target: '', class: '' } },

        seperator3: {  name: 'seperator3', type: 'SEPERATOR', visible: true, dataaccaction: '', uiaction: { } },
        deuiaction5: { name: 'deuiaction5', caption: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction5.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction5.tip', iconcls: 'fa fa-file-excel-o', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000, class: '' },

        seperator4: {  name: 'seperator4', type: 'SEPERATOR', visible: true, dataaccaction: '', uiaction: { } },
        deuiaction7: { name: 'deuiaction7', caption: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction7.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzreportroleconfig.gridviewtoolbar_toolbar.deuiaction7.tip', iconcls: 'fa fa-filter', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '', class: '' } },
    ...
    public toolbar_deuiaction7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"IbzReportRoleConfig");
    }
