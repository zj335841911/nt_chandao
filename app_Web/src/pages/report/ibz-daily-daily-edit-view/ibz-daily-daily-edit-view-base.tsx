...
export class IbzDailyDailyEditViewBase extends EditViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.ibzdaily.dailyeditviewtoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.ibzdaily.dailyeditviewtoolbar_toolbar.deuiaction1.tip', iconcls: 'sx-tb-saveandclose', icon: '../sasrfex/images/default/icon_saveandclose.png', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveAndExit', target: '', class: '' } },
     ...
     * @memberof IbzDailyDailyEditViewBase
     */
	protected viewtag: string = '83de2f22eaa4faf59cf7f38e7c448bf9';
