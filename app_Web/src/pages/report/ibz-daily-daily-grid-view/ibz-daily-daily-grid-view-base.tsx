...
export class IbzDailyDailyGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_createuserdaily: { name: 'deuiaction3_createuserdaily', caption: '生成日报', 'isShowCaption': true, 'isShowIcon': true, tooltip: '生成日报', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__ADMIN', uiaction: { tag: 'CreateUserDaily', target: 'NONE', class: '' } },
    ...
    public toolbar_click($event: any, $event2?: any): void {
        if (Object.is($event.tag, 'deuiaction3_createuserdaily')) {
            this.toolbar_deuiaction3_createuserdaily_click(null, '', $event2);
        }
     ...
     * @memberof 
     */
    public toolbar_deuiaction3_createuserdaily_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportModel(datas, contextJO,paramJO,  $event, xData,this,"IbzDaily");
    }
