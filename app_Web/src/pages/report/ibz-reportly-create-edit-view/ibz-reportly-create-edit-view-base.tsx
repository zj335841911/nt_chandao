 ...
 *
 * @export
 * @class IbzReportlyCreateEditViewBase
 * @extends {EditViewBase}
 */
export class IbzReportlyCreateEditViewBase extends EditViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof IbzReportlyCreateEditViewBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.ibzreportly.views.createeditview.caption',
        srfTitle: 'entities.ibzreportly.views.createeditview.title',
        srfSubTitle: 'entities.ibzreportly.views.createeditview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof IbzReportlyCreateEditViewBase
     */
	protected viewtag: string = 'ee2c37e457f0b7bc79b04f7e9457d62d';
     ...
     * @memberof IbzReportlyCreateEditViewBase
     */ 
    protected viewName: string = 'IbzReportlyCreateEditView';
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"IbzReportly");
    }
