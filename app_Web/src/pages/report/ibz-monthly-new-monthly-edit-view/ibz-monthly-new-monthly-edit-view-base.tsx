...
export class IbzMonthlyNewMonthlyEditViewBase extends EditViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_submit: { name: 'deuiaction3_submit', caption: '提交', 'isShowCaption': true, 'isShowIcon': true, tooltip: '提交', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:6,dataaccaction: 'SRFUR__MONTHLY_SUBMIT_BUT', uiaction: { tag: 'Submit', target: 'SINGLEKEY', class: '' } },
