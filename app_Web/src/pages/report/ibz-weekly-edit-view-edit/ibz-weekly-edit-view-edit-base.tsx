 ...
 *
 * @export
 * @class IbzWeeklyEditViewEditBase
 * @extends {EditViewBase}
 */
export class IbzWeeklyEditViewEditBase extends EditViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.ibzweekly.views.editviewedit.caption',
        srfTitle: 'entities.ibzweekly.views.editviewedit.title',
        srfSubTitle: 'entities.ibzweekly.views.editviewedit.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof IbzWeeklyEditViewEditBase
     */
	protected viewtag: string = '0551f0f5f821e55d9ba9e4e4ed97aae8';
     ...
     * @memberof IbzWeeklyEditViewEditBase
     */ 
    protected viewName: string = 'IbzWeeklyEditViewEdit';
