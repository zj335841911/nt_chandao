 ...
 *
 * @export
 * @class CaseCurTestTaskGridViewBase
 * @extends {GridViewBase}
 */
export class CaseCurTestTaskGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolBarModels: any = {
        deuiaction1_linkcasec: { name: 'deuiaction1_linkcasec', caption: '关联用例', 'isShowCaption': true, 'isShowIcon': true, tooltip: '关联用例', iconcls: 'fa fa-link', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'LinkCaseC', target: 'SINGLEKEY', class: '' } },
     ...
     * @memberof 
     */
    public toolbar_deuiaction1_linkcasec_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
    ...
    protected loadQuickGroupModel(): void {
        const quickGroupCodeList: any = { tag: 'CaseTestTaskQuickpachet', codelistType: 'STATIC' };
