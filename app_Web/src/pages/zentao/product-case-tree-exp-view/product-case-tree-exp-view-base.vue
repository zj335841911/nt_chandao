<template>
<div class='view-container product-case-tree-exp-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productcasetreeexpview"></app-studioaction>
...
export default class ProductCaseTreeExpViewBase extends Vue {
