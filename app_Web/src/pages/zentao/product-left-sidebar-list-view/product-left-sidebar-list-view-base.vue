...
<template>
<div class='view-container product-left-sidebar-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productleftsidebarlistview"></app-studioaction>
    ...
    <div class='pull-right'>
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.product.leftsidebarlistviewtoolbar_toolbar.deuiaction3_manager.tip')}}</div>
            </tooltip>
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.product.leftsidebarlistviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.product.leftsidebarlistviewtoolbar_toolbar.deuiaction2.tip')}}</div>
            </tooltip>
        </div>
    </div>
</row>
