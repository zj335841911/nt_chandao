 ...
 *
 * @export
 * @class ProjectTeamMainGridView_EditRowBase
 * @extends {GridViewBase}
 */
export class ProjectTeamMainGridView_EditRowBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolBarModels: any = {
        deuiaction2: { name: 'deuiaction2', caption: 'entities.projectteam.maingridview_editrowtoolbar_toolbar.deuiaction2.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.projectteam.maingridview_editrowtoolbar_toolbar.deuiaction2.tip', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'NewRow', target: '', class: '' } },

        deuiaction3: { name: 'deuiaction3', caption: 'entities.projectteam.maingridview_editrowtoolbar_toolbar.deuiaction3.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.projectteam.maingridview_editrowtoolbar_toolbar.deuiaction3.tip', iconcls: 'fa fa-save', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveRow', target: '', class: '' } },
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"ProjectTeam");
    }
