<template>
<div class="view-container test-task-edit-view-commit-test">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskeditview_committest"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.testtask.editview_committesttoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.testtask.editview_committesttoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class TestTaskEditView_commitTestBase extends Vue {
     ...
     *
     * @type {*}
     * @memberof TestTaskEditView_commitTest
     */
...
<style lang='less'>
@import './test-task-edit-view-commit-test.less';
</style>