...
export class TestSuiteEditViewBase extends EditViewBase {
    ...
    public FirstRecord(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        let allNavData:any = Object.is(this.navModel,"route")?navDataService.getPreNavDataById('test-suite-edit-view'):navDataService.getPreNavDataByTag(_this.viewtag);
