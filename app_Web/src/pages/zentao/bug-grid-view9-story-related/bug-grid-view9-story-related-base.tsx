...
export class BugGridView9_StoryRelatedBase extends GridView9Base {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.bug.views.gridview9_storyrelated.caption',
        srfTitle: 'entities.bug.views.gridview9_storyrelated.title',
        srfSubTitle: 'entities.bug.views.gridview9_storyrelated.subtitle',
        dataInfo: ''
    }
     ...
     * @memberof ViewBase
     */
	protected viewtag: string = 'c959d7fe98c33b7befcad24e2596633e';
