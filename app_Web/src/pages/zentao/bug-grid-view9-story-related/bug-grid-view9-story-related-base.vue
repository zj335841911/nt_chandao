<template>
    <div class='view-container bug-grid-view9-story-related'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="buggridview9_storyrelated"></app-studioaction>
...
export default class BugGridView9_StoryRelatedBase extends Vue {
...
<style lang='less'>
@import './bug-grid-view9-story-related.less';
</style>