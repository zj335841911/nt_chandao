<template>
    <div class='view-container test-task-grid-view9-un-tested'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskgridview9_untested"></app-studioaction>
