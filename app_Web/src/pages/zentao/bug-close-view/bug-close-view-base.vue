<template>
<div class="view-container bug-close-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugcloseview"></app-studioaction>
...
export default class BugCloseViewBase extends Vue {
