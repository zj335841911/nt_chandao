<template>
<div class="view-container task-done-task-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskdonetaskview"></app-studioaction>
...
export default class TaskDoneTaskViewBase extends Vue {
...
<style lang='less'>
@import './task-done-task-view.less';
</style>