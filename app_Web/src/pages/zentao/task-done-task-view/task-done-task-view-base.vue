<template>
<studio-view viewName="taskdonetaskview" viewTitle="完成任务" class='deoptview task-done-task-view'>
    <template slot='title'>
...
export default class TaskDoneTaskViewBase extends OptionViewBase {
