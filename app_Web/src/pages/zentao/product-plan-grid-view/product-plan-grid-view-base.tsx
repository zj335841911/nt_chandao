...
export class ProductPlanGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_create: { name: 'deuiaction3_create', caption: '创建计划', 'isShowCaption': true, 'isShowIcon': true, tooltip: '创建计划', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:1,dataaccaction: 'SRFUR__PROP_CREATE_BUT', uiaction: { tag: 'Create', target: 'NONE', class: '' } },
