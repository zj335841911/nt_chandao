...
<studio-view viewName="productplangridview" viewTitle="productplan表格视图" class='degridview product-plan-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.productplan.gridviewtoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
...
export default class ProductPlanGridViewBase extends Vue {
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete curViewParam.productplan;
        if(args.length >0){
