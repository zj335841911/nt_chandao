 ...
 */
export class DeptMainGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolbar_deuiaction3_create_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:DeptUIService  = new DeptUIService();
        curUIService.Dept_Create(datas,contextJO, paramJO,  $event, xData,this,"Dept");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"Dept");
    }
    ...
    public opendata(args: any[],fullargs?:any[],params?: any, $event?: any, xData?: any) {
        ...
        const view: any = {
            viewname: 'dept-info-edit-view', 
            height: 0, 
            width: 750,  
            title: this.$t('entities.dept.views.infoeditview.title'),
            placement: 'DRAWER_RIGHT',
        };
        openDrawer(view, data);
    }
