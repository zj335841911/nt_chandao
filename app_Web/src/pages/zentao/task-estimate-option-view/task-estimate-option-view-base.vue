<template>
<div class="view-container task-estimate-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskestimateoptionview"></app-studioaction>
...
export default class TaskEstimateOptionViewBase extends Vue {
...
<style lang='less'>
@import './task-estimate-option-view.less';
</style>