<template>
<div class='view-container depickupgridview module-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="modulepickupgridview"></app-studioaction>
...
export default class ModulePickupGridViewBase extends Vue {
	 ...
	 * @memberof ModulePickupGridViewBase
	 */
	public viewtag: string = 'bda78773fabbeee54079951afb35f954';
