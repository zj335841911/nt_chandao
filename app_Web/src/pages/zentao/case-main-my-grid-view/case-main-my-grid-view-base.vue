<template>
    <div class='view-container case-main-my-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casemainmygridview"></app-studioaction>
...
export default class CaseMainMyGridViewBase extends Vue {
...
<style lang='less'>
@import './case-main-my-grid-view.less';
</style>