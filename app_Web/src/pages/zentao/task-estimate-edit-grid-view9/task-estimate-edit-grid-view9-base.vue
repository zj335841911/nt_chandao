<template>
    <div class='view-container task-estimate-edit-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskestimateeditgridview9"></app-studioaction>
...
export default class TaskEstimateEditGridView9Base extends Vue {
...
<style lang='less'>
@import './task-estimate-edit-grid-view9.less';
</style>