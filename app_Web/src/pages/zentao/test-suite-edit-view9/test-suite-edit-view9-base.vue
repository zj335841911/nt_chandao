<template>
<studio-embed-view viewName="testsuiteeditview9" viewTitle="测试套件编辑视图" class='deeditview9 test-suite-edit-view9'>
    <view_form 
                :viewState="viewState"  
...
export default class TestSuiteEditView9Base extends EditView9Base {
