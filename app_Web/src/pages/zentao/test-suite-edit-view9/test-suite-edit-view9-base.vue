<template>
<div class="view-container test-suite-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testsuiteeditview9"></app-studioaction>
...
export default class TestSuiteEditView9Base extends Vue {
...
<style lang='less'>
@import './test-suite-edit-view9.less';
</style>