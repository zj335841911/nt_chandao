<template>
<div class="view-container product-dashboard-info-main-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productdashboardinfomainview9"></app-studioaction>
