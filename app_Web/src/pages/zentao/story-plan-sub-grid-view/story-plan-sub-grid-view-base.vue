...
<studio-view viewName="storyplansubgridview" viewTitle="story表格视图" class='degridview story-plan-sub-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.story.plansubgridviewtoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.story.plansubgridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
