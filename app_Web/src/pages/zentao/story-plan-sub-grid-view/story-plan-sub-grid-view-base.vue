<template>
    <div class='view-container story-plan-sub-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyplansubgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3_planrelationstory.visabled" :disabled="toolBarModels.deuiaction3_planrelationstory.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3_planrelationstory' }, $event)">
                                    <i class='fa fa-chain'></i>
                                    
                                </i-button>
                            <div slot='content'>{{$t('entities.story.plansubgridviewtoolbar_toolbar.deuiaction3_planrelationstory.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.plansubgridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.plansubgridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class StoryPlanSubGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction3_planrelationstory: { name: 'deuiaction3_planrelationstory', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'PlanRelationStory', target: 'NONE' } },
    ...
    protected toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction3_planrelationstory')) {
            this.toolbar_deuiaction3_planrelationstory_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_deuiaction3_planrelationstory_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
