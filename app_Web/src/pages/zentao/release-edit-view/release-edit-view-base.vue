<template>
<div class="view-container release-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="releaseeditview"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.release.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.release.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
