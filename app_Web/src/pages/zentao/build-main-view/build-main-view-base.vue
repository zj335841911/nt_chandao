<template>
<div class="view-container build-main-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="buildmainview"></app-studioaction>
...
export default class BuildMainViewBase extends Vue {
