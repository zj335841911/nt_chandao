<template>
    <div class='view-container bug-plan-sub-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugplansubgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3_planrelationbug.visabled" :disabled="toolBarModels.deuiaction3_planrelationbug.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3_planrelationbug' }, $event)">
                                    <i class='fa fa-chain'></i>
                                    <span class='caption'>{{$t('entities.bug.plansubgridviewtoolbar_toolbar.deuiaction3_planrelationbug.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.bug.plansubgridviewtoolbar_toolbar.deuiaction3_planrelationbug.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.bug.plansubgridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class BugPlanSubGridViewBase extends Vue {
    ...
    protected toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction3_planrelationbug')) {
            this.toolbar_deuiaction3_planrelationbug_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_deuiaction3_planrelationbug_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
