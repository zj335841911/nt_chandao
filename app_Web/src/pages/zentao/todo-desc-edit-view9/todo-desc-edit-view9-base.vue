<template>
<div class="view-container todo-desc-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="tododesceditview9"></app-studioaction>
...
export default class TodoDescEditView9Base extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.todo.views.desceditview9.caption',
        srfTitle: 'entities.todo.views.desceditview9.title',
        srfSubTitle: 'entities.todo.views.desceditview9.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './todo-desc-edit-view9.less';
</style>