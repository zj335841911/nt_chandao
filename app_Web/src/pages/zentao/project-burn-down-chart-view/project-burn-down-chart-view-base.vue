<template>
<studio-view viewName="projectburndownchartview" viewTitle="燃尽图" class='dechartview project-burn-down-chart-view'>
    <view_chart 
        :viewState="viewState"  
...
export default class ProjectBurnDownChartViewBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {ProjectService}
     * @memberof ProjectBurnDownChartViewBase
     */
	 ...
	 * @memberof ProjectBurnDownChartViewBase
	 */
	public viewtag: string = '3aa4c66089ff40194c7f4ecaf627acb5';
     ...
     */
    public model: any = {
        srfCaption: 'entities.project.views.burndownchartview.caption',
        srfTitle: 'entities.project.views.burndownchartview.title',
        srfSubTitle: 'entities.project.views.burndownchartview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {string}
     * @memberof ProjectBurnDownChartView
     */
    public query: string = '';
...
<style lang='less'>
@import './project-burn-down-chart-view.less';
</style>