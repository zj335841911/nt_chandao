...
export class TestSuiteGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_create: { name: 'deuiaction3_create', caption: '新建', 'isShowCaption': true, 'isShowIcon': true, tooltip: '新建', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:1,dataaccaction: 'SRFUR__TESTSU_CREATE_BUT', uiaction: { tag: 'Create', target: 'SINGLEKEY', class: '' } },
