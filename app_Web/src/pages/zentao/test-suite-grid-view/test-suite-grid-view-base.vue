<template>
    <div class='view-container test-suite-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testsuitegridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.testsuite.gridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.testsuite.gridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class TestSuiteGridViewBase extends Vue {
...
<style lang='less'>
@import './test-suite-grid-view.less';
</style>