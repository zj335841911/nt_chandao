<template>
<studio-view viewName="testsuitegridview" viewTitle="testsuite表格视图" class='degridview test-suite-grid-view'>
...
export default class TestSuiteGridViewBase extends Vue {
	 ...
	 * @memberof TestSuiteGridViewBase
	 */
	public viewtag: string = 'a3bd82ec712d2e3ad12e716655e960fc';
