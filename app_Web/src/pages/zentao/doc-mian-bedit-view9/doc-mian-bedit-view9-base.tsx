 ...
 *
 * @export
 * @class DocMianBEditView9Base
 * @extends {EditView9Base}
 */
export class DocMianBEditView9Base extends EditView9Base {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.doc.views.mianbeditview9.caption',
        srfTitle: 'entities.doc.views.mianbeditview9.title',
        srfSubTitle: 'entities.doc.views.mianbeditview9.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof DocMianBEditView9Base
     */ 
    protected viewName: string = 'DocMianBEditView9';
