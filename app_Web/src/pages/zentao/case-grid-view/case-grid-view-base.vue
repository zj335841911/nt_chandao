<template>
<studio-view viewName="casegridview" viewTitle="case表格视图" class='degridview case-grid-view'>
    <template slot='title'>
    ...
    <template slot="toolbar">
        <div class='toolbar-container'>
            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem3.tip')" v-show="toolBarModels.tbitem3.visabled" :disabled="toolBarModels.tbitem3.disabled" class='' @click="toolbar_click({ tag: 'tbitem3' }, $event)">
                    <i class='fa fa-file-text-o'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem3.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem4.tip')" v-show="toolBarModels.tbitem4.visabled" :disabled="toolBarModels.tbitem4.disabled" class='' @click="toolbar_click({ tag: 'tbitem4' }, $event)">
                    <i class='fa fa-edit'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem4.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem6.tip')" v-show="toolBarModels.tbitem6.visabled" :disabled="toolBarModels.tbitem6.disabled" class='' @click="toolbar_click({ tag: 'tbitem6' }, $event)">
                    <i class='fa fa-copy'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem6.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem8.tip')" v-show="toolBarModels.tbitem8.visabled" :disabled="toolBarModels.tbitem8.disabled" class='' @click="toolbar_click({ tag: 'tbitem8' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem8.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <app-export-excel :item="toolBarModels.tbitem13" :caption="$t('entities.case.gridviewtoolbar_toolbar.tbitem13.caption')" @exportexcel="toolbar_click({ tag: 'tbitem13' }, $event)"></app-export-excel>
            <span class='seperator'>|</span>    <dropdown v-show="toolBarModels.tbitem16.visabled" :transfer="true" trigger='hover'>
                <i-button class='' title="$t('entities.case.gridviewtoolbar_toolbar.tbitem16.tip')">
                    <i class=''></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem16.caption')}}</span>
                    <icon type="ios-arrow-down"></icon>
                </i-button>
                <dropdown-menu slot='list'>
                    <dropdown-item>
                            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem21.tip')" v-show="toolBarModels.tbitem21.visabled" :disabled="toolBarModels.tbitem21.disabled" class='' @click="toolbar_click({ tag: 'tbitem21' }, $event)">
                    <i class='fa fa-download'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem21.caption')}}</span>
                </i-button>
            
            
                    </dropdown-item>
                    <dropdown-item>
                            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem23.tip')" v-show="toolBarModels.tbitem23.visabled" :disabled="toolBarModels.tbitem23.disabled" class='' @click="toolbar_click({ tag: 'tbitem23' }, $event)">
                    <i class='fa fa-upload'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem23.caption')}}</span>
                </i-button>
            ...
            <span class='seperator'>|</span>    <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem19.tip')" v-show="toolBarModels.tbitem19.visabled" :disabled="toolBarModels.tbitem19.disabled" class='' @click="toolbar_click({ tag: 'tbitem19' }, $event)">
                    <i class='fa fa-filter'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem19.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.case.gridviewtoolbar_toolbar.tbitem18.tip')" v-show="toolBarModels.tbitem18.visabled" :disabled="toolBarModels.tbitem18.disabled" class='' @click="toolbar_click({ tag: 'tbitem18' }, $event)">
                    <i class='fa fa-question'></i>
                    <span class='caption'>{{$t('entities.case.gridviewtoolbar_toolbar.tbitem18.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_searchform 
...
export default class CaseGridViewBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {CaseService}
     * @memberof CaseGridViewBase
     */
	 ...
	 * @memberof CaseGridViewBase
	 */
	public viewtag: string = 'f63aae9bc8cfe29654439743b465a942';
     ...
     */
    public model: any = {
        srfCaption: 'entities.case.views.gridview.caption',
        srfTitle: 'entities.case.views.gridview.title',
        srfSubTitle: 'entities.case.views.gridview.subtitle',
        dataInfo: ''
    }
 ...
 tbitem23: { name: 'tbitem23', caption: '数据导入', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Import', target: '' } },
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"Case");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"Case");
    }
    ...
    public toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleRowEdit(datas, contextJO,paramJO,  $event, xData,this,"Case");
    }
    ...
    public toolbar_tbitem21_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportModel(datas, contextJO,paramJO,  $event, xData,this,"Case");
    }
    ...
    public toolbar_tbitem23_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"Case");
    }
