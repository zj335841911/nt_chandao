<template>
<div class="view-container module-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="moduleeditview"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.module.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.module.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ModuleEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.module.views.editview.caption',
        srfTitle: 'entities.module.views.editview.title',
        srfSubTitle: 'entities.module.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    protected toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"Module");
    }
