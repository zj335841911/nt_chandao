...
export class BugGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_create: { name: 'deuiaction3_create', caption: '新建bug', 'isShowCaption': true, 'isShowIcon': true, tooltip: '新建bug', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__BUG_CREATE_BUT', uiaction: { tag: 'Create', target: 'NONE', class: '' } },
