<template>
<div class="view-container story-project-mpickup-view3">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyprojectmpickupview3"></app-studioaction>
...
export default class StoryProjectMPickupView3Base extends Vue {
...
<style lang='less'>
@import './story-project-mpickup-view3.less';
</style>