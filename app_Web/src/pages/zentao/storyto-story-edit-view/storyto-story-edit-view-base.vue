<template>
<div class="view-container storyto-story-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storytostoryeditview"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.story.tostoryeditviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.story.tostoryeditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class StorytoStoryEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.story.views.tostoryeditview.caption',
        srfTitle: 'entities.story.views.tostoryeditview.title',
        srfSubTitle: 'entities.story.views.tostoryeditview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './storyto-story-edit-view.less';
</style>