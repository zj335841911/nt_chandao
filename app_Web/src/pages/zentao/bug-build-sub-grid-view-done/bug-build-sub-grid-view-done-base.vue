<template>
    <div class='view-container bug-build-sub-grid-view-done'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugbuildsubgridview_done"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class BugBuildSubGridView_DoneBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '关联bug', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'buildlinkbugs', target: 'NONE' } },
