<template>
<studio-view viewName="bugbuildsubgridview_done" viewTitle="bug表格视图" class='degridview bug-build-sub-grid-view-done'>
    <i-input slot="quickSearch" v-model="query" search @on-search="onSearch($event)"/>
    <template slot="toolbar">
                <div class='toolbar-container'>
            <i-button :title="$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='fa fa-plus'></i>
                    <span class='caption'>{{$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-refresh'></i>
                    <span class='caption'>{{$t('entities.bug.buildsubgridview_donetoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
...
export default class BugBuildSubGridView_DoneBase extends Vue {
	 ...
	 * @memberof BugBuildSubGridView_DoneBase
	 */
	public viewtag: string = 'f8ffad31189703973765c5a9c4fc8a5c';
...
<style lang='less'>
@import './bug-build-sub-grid-view-done.less';
</style>