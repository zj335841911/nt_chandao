 ...
 *
 * @export
 * @class TaskPriTaskGroupGridViewBase
 * @extends {GridViewBase}
 */
export class TaskPriTaskGroupGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.task.views.pritaskgroupgridview.caption',
        srfTitle: 'entities.task.views.pritaskgroupgridview.title',
        srfSubTitle: 'entities.task.views.pritaskgroupgridview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof TaskPriTaskGroupGridViewBase
     */
	protected viewtag: string = '359b82fac8790c68593b4127a54aa85e';
     ...
     * @memberof TaskPriTaskGroupGridViewBase
     */ 
    protected viewName: string = 'TaskPriTaskGroupGridView';
