<template>
    <div class='view-container story-main-grid-view-by-module'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storymaingridview_bymodule"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.maingridview_bymoduletoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.maingridview_bymoduletoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
