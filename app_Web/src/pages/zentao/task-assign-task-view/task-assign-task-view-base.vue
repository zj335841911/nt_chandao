<template>
<studio-view viewName="taskassigntaskview" viewTitle="指派任务" class='deoptview task-assign-task-view'>
    <template slot='title'>
...
export default class TaskAssignTaskViewBase extends Vue {
	 ...
	 * @memberof TaskAssignTaskViewBase
	 */
	public viewtag: string = '12661bdb476cd339554799b417c6ea48';
...
<style lang='less'>
@import './task-assign-task-view.less';
</style>