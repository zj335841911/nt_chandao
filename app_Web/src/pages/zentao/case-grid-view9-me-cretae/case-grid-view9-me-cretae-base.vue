<template>
    <div class='view-container case-grid-view9-me-cretae'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casegridview9_mecretae"></app-studioaction>
...
export default class CaseGridView9_MeCretaeBase extends Vue {
...
<style lang='less'>
@import './case-grid-view9-me-cretae.less';
</style>