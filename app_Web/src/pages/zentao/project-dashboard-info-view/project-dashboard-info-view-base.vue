<template>
<div class="view-container project-dashboard-info-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectdashboardinfoview"></app-studioaction>
...
export default class ProjectDashboardInfoViewBase extends Vue {
