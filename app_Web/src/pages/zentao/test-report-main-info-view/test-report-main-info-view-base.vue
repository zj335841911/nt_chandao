<template>
<div class="view-container test-report-main-info-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testreportmaininfoview"></app-studioaction>
...
export default class TestReportMainInfoViewBase extends Vue {
