 ...
 *
 * @export
 * @class BugBuildSubGridView_LINKDONEBase
 * @extends {GridViewBase}
 */
export class BugBuildSubGridView_LINKDONEBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.bug.views.buildsubgridview_linkdone.caption',
        srfTitle: 'entities.bug.views.buildsubgridview_linkdone.title',
        srfSubTitle: 'entities.bug.views.buildsubgridview_linkdone.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof BugBuildSubGridView_LINKDONE
     */
     ...
     * @memberof ViewBase
     */
	protected viewtag: string = '5678993d5f15b1b7d40664d120ca31a5';
