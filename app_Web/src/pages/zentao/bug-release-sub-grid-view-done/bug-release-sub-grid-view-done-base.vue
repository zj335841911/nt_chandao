<template>
    <div class='view-container bug-release-sub-grid-view-done'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugreleasesubgridview_done"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.bug.releasesubgridview_donetoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
