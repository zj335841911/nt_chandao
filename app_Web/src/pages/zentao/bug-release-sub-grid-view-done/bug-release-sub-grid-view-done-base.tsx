...
export class BugReleaseSubGridView_DoneBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '关联bug', 'isShowCaption': true, 'isShowIcon': true, tooltip: '关联bug', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__BUILD_LINK_BUT', uiaction: { tag: 'releaseLinkResolvedBug', target: 'NONE', class: '' } },
