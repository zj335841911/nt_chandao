<template>
<div class='view-container product-test-tab-exp-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="producttesttabexpview"></app-studioaction>
...
<style lang='less'>
@import './product-test-tab-exp-view.less';
</style>