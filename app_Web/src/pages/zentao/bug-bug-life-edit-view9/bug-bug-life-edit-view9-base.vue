<template>
<div class="view-container bug-bug-life-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugbuglifeeditview9"></app-studioaction>
...
export default class BugBugLifeEditView9Base extends Vue {
...
<style lang='less'>
@import './bug-bug-life-edit-view9.less';
</style>