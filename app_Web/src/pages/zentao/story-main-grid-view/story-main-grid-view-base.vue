<template>
    <div class='view-container story-main-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storymaingridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction4" :caption="$t('entities.story.maingridviewtoolbar_toolbar.deuiaction4.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction4' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3.visabled" :disabled="toolBarModels.deuiaction3.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction3.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.story.maingridviewtoolbar_toolbar.deuiaction3.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class StoryMainGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        ...
        deuiaction4: { name: 'deuiaction4', caption: '导出', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000  },

        seperator3: {  name: 'seperator3', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { } },
        deuiaction3: { name: 'deuiaction3', caption: '过滤', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '' } },
     ...
     * @memberof StoryMainGridViewBase
     */
    protected Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        if (args.length === 0) {
            return;
        }
        const _this: any = this;
