<template>
<studio-view viewName="bugtestreportsubgridview" viewTitle="bug表格视图" class='degridview bug-test-report-sub-grid-view'>
...
export default class BugTestReportSubGridViewBase extends GridViewBase {
