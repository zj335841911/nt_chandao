<template>
<div class="view-container bug-main-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugmaineditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.bug.maineditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
