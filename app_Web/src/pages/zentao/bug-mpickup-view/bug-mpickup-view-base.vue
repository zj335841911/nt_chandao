<template>
<div class="view-container bug-mpickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugmpickupview"></app-studioaction>
...
export default class BugMPickupViewBase extends Vue {
