<template>
<div class="view-container todo-assign-to-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="todoassigntoview"></app-studioaction>
...
export default class TodoAssignToViewBase extends Vue {
...
<style lang='less'>
@import './todo-assign-to-view.less';
</style>