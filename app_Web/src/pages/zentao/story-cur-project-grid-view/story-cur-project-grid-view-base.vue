...
<studio-view viewName="storycurprojectgridview" viewTitle="story表格视图" class='degridview story-cur-project-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.story.curprojectgridviewtoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='fa fa-file-text-o'></i>
                    <span class='caption'>{{$t('entities.story.curprojectgridviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.story.curprojectgridviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-edit'></i>
                    <span class='caption'>{{$t('entities.story.curprojectgridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
...
export default class StoryCurProjectGridViewBase extends Vue {
	 ...
	 * @memberof StoryCurProjectGridViewBase
	 */
	public viewtag: string = '7b1cc190cbffe1cd122d87a9d03b2d21';
...
<style lang='less'>
@import './story-cur-project-grid-view.less';
</style>