<template>
    <div class='view-container case-grid-view9-story-related'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casegridview9_storyrelated"></app-studioaction>
...
export default class CaseGridView9_StoryRelatedBase extends Vue {
...
<style lang='less'>
@import './case-grid-view9-story-related.less';
</style>