<template>
<studio-view viewName="testreporteditview_testrange" viewTitle="测试报告编辑视图" class='deeditview test-report-edit-view-test-range'>
    <view_form 
                :viewState="viewState"  
...
export default class TestReportEditView_TestRangeBase extends EditViewBase {
