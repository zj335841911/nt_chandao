<template>
<div class="view-container test-report-edit-view-test-range">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testreporteditview_testrange"></app-studioaction>
...
export default class TestReportEditView_TestRangeBase extends Vue {
...
<style lang='less'>
@import './test-report-edit-view-test-range.less';
</style>