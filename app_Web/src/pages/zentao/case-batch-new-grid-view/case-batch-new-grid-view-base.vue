<template>
    <div class='view-container case-batch-new-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casebatchnewgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.case.batchnewgridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.case.batchnewgridviewtoolbar_toolbar.deuiaction3.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
