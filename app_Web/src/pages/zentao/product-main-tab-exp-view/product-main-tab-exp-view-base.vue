...
<template>
<studio-view viewName="productmaintabexpview" viewTitle="产品" class='detabexpview product-main-tab-exp-view'>
    <view_tabexppanel 
        :viewState="viewState"  
...
export default class ProductMainTabExpViewBase extends Vue {
	 ...
	 * @memberof ProductMainTabExpViewBase
	 */
	public viewtag: string = '6c7b582273d0726bcf77214807cfe40c';
...
<style lang='less'>
@import './product-main-tab-exp-view.less';
</style>