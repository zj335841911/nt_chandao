...
export class IbzWeeklyEditViewBase extends EditViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_submit: { name: 'deuiaction3_submit', caption: '提交', 'isShowCaption': true, 'isShowIcon': true, tooltip: '提交', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__WEEKLY_NSUBMIT_BUT', uiaction: { tag: 'submit', target: 'SINGLEKEY', class: '' } },
