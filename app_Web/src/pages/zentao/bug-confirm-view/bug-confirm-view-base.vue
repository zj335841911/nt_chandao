<template>
<div class="view-container bug-confirm-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugconfirmview"></app-studioaction>
...
export default class BugConfirmViewBase extends Vue {
