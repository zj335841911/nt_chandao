<template>
<div class="view-container task-forward-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskforwardview"></app-studioaction>
...
export default class TaskForwardViewBase extends Vue {
