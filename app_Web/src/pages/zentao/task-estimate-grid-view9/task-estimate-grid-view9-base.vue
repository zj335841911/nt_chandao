<template>
    <div class='view-container task-estimate-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskestimategridview9"></app-studioaction>
...
export default class TaskEstimateGridView9Base extends Vue {
...
<style lang='less'>
@import './task-estimate-grid-view9.less';
</style>