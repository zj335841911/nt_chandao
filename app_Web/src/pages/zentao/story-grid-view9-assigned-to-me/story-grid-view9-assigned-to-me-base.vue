<template>
    <div class='view-container story-grid-view9-assigned-to-me'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storygridview9_assignedtome"></app-studioaction>
