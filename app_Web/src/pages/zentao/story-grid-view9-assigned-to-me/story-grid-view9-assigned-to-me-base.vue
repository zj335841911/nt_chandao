<template>
<studio-embed-view viewName="storygridview9_assignedtome" viewTitle="需求表格视图" class='degridview9 story-grid-view9-assigned-to-me'>
    <view_grid 
        :viewState="viewState"  
 ...
 *
 * @export
 * @class StoryGridView9_AssignedToMeBase
 * @extends {GridView9Base}
 */
@Component({})
@VueLifeCycleProcessing()
export default class StoryGridView9_AssignedToMeBase extends GridView9Base {
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof StoryGridView9_AssignedToMe
     */
...
<style lang='less'>
@import './story-grid-view9-assigned-to-me.less';
</style>