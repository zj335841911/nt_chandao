<template>
<studio-view viewName="taskpausetaskview" viewTitle="暂停任务" class='deoptview task-pause-task-view'>
    <template slot='title'>
...
export default class TaskPauseTaskViewBase extends Vue {
	 ...
	 * @memberof TaskPauseTaskViewBase
	 */
	public viewtag: string = 'b03bf2445d2e295fccbb6280b2601248';
...
<style lang='less'>
@import './task-pause-task-view.less';
</style>