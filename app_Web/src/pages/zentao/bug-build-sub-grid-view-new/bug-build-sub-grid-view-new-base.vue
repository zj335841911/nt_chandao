<template>
    <div class='view-container bug-build-sub-grid-view-new'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugbuildsubgridview_new"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.bug.buildsubgridview_newtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
