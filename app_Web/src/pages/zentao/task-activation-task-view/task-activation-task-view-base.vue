<template>
<div class="view-container task-activation-task-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskactivationtaskview"></app-studioaction>
...
export default class TaskActivationTaskViewBase extends Vue {
...
<style lang='less'>
@import './task-activation-task-view.less';
</style>