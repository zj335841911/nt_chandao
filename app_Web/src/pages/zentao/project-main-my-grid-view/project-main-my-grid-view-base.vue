<template>
    <div class='view-container project-main-my-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectmainmygridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.project.mainmygridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.project.mainmygridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ProjectMainMyGridViewBase extends Vue {
     ...
     *
     * @type {*}
     * @memberof ProjectMainMyGridView
     */
...
<style lang='less'>
@import './project-main-my-grid-view.less';
</style>