...
<template>
<div class="view-container bug-main-dashboard-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugmaindashboardview"></app-studioaction>
...
export default class BugMainDashboardViewBase extends Vue {
