<template>
    <div class='view-container bug-build-sub-grid-view-new-9212'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugbuildsubgridview_new_9212"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.bug.buildsubgridview_new_9212toolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.bug.buildsubgridview_new_9212toolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class BugBuildSubGridView_New_9212Base extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '提Bug', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'createBugByBuild', target: 'NONE' } },
...
<style lang='less'>
@import './bug-build-sub-grid-view-new-9212.less';
</style>