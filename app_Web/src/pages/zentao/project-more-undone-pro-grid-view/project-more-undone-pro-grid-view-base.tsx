 ...
 *
 * @export
 * @class ProjectMoreUndoneProGridViewBase
 * @extends {GridViewBase}
 */
export class ProjectMoreUndoneProGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     *
     * @type {*}
     * @memberof ProjectMoreUndoneProGridView
     */
     ...
     * @memberof ProjectMoreUndoneProGridViewBase
     */
	protected viewtag: string = 'd695dac99ccf0ddd077eb13916241bd0';
