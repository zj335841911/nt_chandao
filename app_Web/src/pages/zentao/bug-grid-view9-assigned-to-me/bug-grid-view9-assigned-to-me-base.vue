<template>
    <div class='view-container bug-grid-view9-assigned-to-me'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="buggridview9_assignedtome"></app-studioaction>
...
export default class BugGridView9_AssignedToMeBase extends Vue {
