<template>
<studio-embed-view viewName="storygridview9_substory" viewTitle="需求表格视图" class='degridview9 story-grid-view9-sub-story'>
    <template slot='title'>
...
export default class StoryGridView9_SubStoryBase extends Vue {
	 ...
	 * @memberof StoryGridView9_SubStoryBase
	 */
	public viewtag: string = '956ad42e59e60cd8b49e7035147e25cf';
...
<style lang='less'>
@import './story-grid-view9-sub-story.less';
</style>