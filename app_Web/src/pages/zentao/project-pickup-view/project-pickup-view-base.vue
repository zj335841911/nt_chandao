<template>
<div class="view-container depickupview project-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectpickupview"></app-studioaction>
...
export default class ProjectPickupViewBase extends Vue {
	 ...
	 * @memberof ProjectPickupViewBase
	 */
	public viewtag: string = '5a8a29268a7563b62fc0160233958830';
