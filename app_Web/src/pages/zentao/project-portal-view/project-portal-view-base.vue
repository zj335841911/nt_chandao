...
<template>
<studio-view viewName="projectportalview" viewTitle="项目主页" class='appportalview project-portal-view'>
    <template slot='title'>
...
export default class ProjectPortalViewBase extends Vue {
	 ...
	 * @memberof ProjectPortalViewBase
	 */
	public viewtag: string = 'CC49500F-030F-458F-82DF-F88F6973DF64';
...
<style lang='less'>
@import './project-portal-view.less';
</style>