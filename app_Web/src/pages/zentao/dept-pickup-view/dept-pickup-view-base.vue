<template>
<div class="view-container depickupview dept-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="deptpickupview"></app-studioaction>
...
export default class DeptPickupViewBase extends Vue {
	 ...
	 * @memberof DeptPickupViewBase
	 */
	public viewtag: string = '16b54862dad958907853dc7eb084a0c0';
