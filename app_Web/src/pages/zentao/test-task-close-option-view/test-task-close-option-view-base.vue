<template>
<div class="view-container test-task-close-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskcloseoptionview"></app-studioaction>
...
export default class TestTaskCloseOptionViewBase extends Vue {
...
<style lang='less'>
@import './test-task-close-option-view.less';
</style>