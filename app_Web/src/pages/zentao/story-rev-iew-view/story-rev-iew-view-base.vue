<template>
<div class="view-container story-rev-iew-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyreviewview"></app-studioaction>
...
export default class StoryRevIewViewBase extends Vue {
...
<style lang='less'>
@import './story-rev-iew-view.less';
</style>