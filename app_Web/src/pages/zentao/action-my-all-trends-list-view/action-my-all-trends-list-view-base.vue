...
<template>
<div class='view-container action-my-all-trends-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="actionmyalltrendslistview"></app-studioaction>
...
export default class ActionMyAllTrendsListViewBase extends Vue {
	 ...
	 * @memberof ActionMyAllTrendsListViewBase
	 */
	protected viewtag: string = '6d466e003e0479fb8b1a16e49b889dc1';
     ...
     */
    protected model: any = {
        srfCaption: 'entities.action.views.myalltrendslistview.caption',
        srfTitle: 'entities.action.views.myalltrendslistview.title',
        srfSubTitle: 'entities.action.views.myalltrendslistview.subtitle',
        dataInfo: ''
    }
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof ActionMyAllTrendsListView
     */
...
<style lang='less'>
@import './action-my-all-trends-list-view.less';
</style>