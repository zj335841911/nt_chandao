 ...
 *
 * @export
 * @class ActionMyAllTrendsListViewBase
 * @extends {ListViewBase}
 */
export class ActionMyAllTrendsListViewBase extends ListViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof ActionMyAllTrendsListViewBase
     */
	protected viewtag: string = 'b4e9c97f4ba0a08e4f916933fc97b522';
     ...
     * @memberof ActionMyAllTrendsListViewBase
     */ 
    protected viewName: string = 'ActionMyAllTrendsListView';
