<template>
<div class='view-container story-project-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyprojectpickupgridview"></app-studioaction>
...
export default class StoryProjectPickupGridViewBase extends Vue {
     ...
     *
     * @type {string}
     * @memberof StoryProjectPickupGridView
     */
...
<style lang='less'>
@import './story-project-pickup-grid-view.less';
</style>