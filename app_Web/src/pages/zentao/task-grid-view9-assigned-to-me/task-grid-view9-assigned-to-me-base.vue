<template>
<studio-embed-view viewName="taskgridview9_assignedtome" viewTitle="任务表格视图" class='degridview9 task-grid-view9-assigned-to-me'>
    <view_grid 
        :viewState="viewState"  
...
export default class TaskGridView9_AssignedToMeBase extends GridView9Base {
...
<style lang='less'>
@import './task-grid-view9-assigned-to-me.less';
</style>