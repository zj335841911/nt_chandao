<template>
    <div class='view-container task-grid-view9-assigned-to-me'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskgridview9_assignedtome"></app-studioaction>
