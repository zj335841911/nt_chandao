<template>
    <div class='view-container todo-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="todogridview9"></app-studioaction>
...
export default class TodoGridView9Base extends Vue {
