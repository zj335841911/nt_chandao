...
<template>
<div class="view-container test-suite-main-dashboard-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testsuitemaindashboardview"></app-studioaction>
...
export default class TestSuiteMainDashboardViewBase extends Vue {
