<template>
    <div class='view-container task-main-my-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskmainmygridview"></app-studioaction>
...
export default class TaskMainMyGridViewBase extends Vue {
	 ...
	 * @memberof TaskMainMyGridViewBase
	 */
	protected viewtag: string = '24a03de02dc02b92a3c228b944e78ed9';
     ...
     */
    protected model: any = {
        srfCaption: 'entities.task.views.mainmygridview.caption',
        srfTitle: 'entities.task.views.mainmygridview.title',
        srfSubTitle: 'entities.task.views.mainmygridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './task-main-my-grid-view.less';
</style>