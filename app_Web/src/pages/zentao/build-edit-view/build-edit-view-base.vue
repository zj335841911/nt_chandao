<template>
<div class="view-container build-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="buildeditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.build.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
