<template>
<div class="view-container todo-base-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="todobaseeditview9"></app-studioaction>
...
export default class TodoBaseEditView9Base extends Vue {
...
<style lang='less'>
@import './todo-base-edit-view9.less';
</style>