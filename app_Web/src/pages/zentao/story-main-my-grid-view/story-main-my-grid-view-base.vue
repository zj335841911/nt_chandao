<template>
    <div class='view-container story-main-my-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storymainmygridview"></app-studioaction>
...
export default class StoryMainMyGridViewBase extends Vue {
	 ...
	 * @memberof StoryMainMyGridViewBase
	 */
	protected viewtag: string = 'd86b9d1e9fad770e8fc97718cee8ed31';
...
<style lang='less'>
@import './story-main-my-grid-view.less';
</style>