<template>
<studio-view viewName="taskclosetaskview" viewTitle="关闭任务" class='deoptview task-close-task-view'>
    <template slot='title'>
...
export default class TaskCloseTaskViewBase extends Vue {
	 ...
	 * @memberof TaskCloseTaskViewBase
	 */
	public viewtag: string = '507c506d62dc910a814332e6ae242266';
...
<style lang='less'>
@import './task-close-task-view.less';
</style>