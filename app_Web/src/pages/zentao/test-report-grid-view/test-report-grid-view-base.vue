<template>
<studio-view viewName="testreportgridview" viewTitle="testreport表格视图" class='degridview test-report-grid-view'>
...
export default class TestReportGridViewBase extends Vue {
	 ...
	 * @memberof TestReportGridViewBase
	 */
	public viewtag: string = '48600bd551aa923b5fceabcb83f65239';
...
<style lang='less'>
@import './test-report-grid-view.less';
</style>