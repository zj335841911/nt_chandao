<template>
<div class="view-container case-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="caseoptionview"></app-studioaction>
...
export default class CaseOptionViewBase extends Vue {
