<template>
<div class="view-container bug-assing-to-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugassingtoview"></app-studioaction>
...
export default class BugAssingToViewBase extends Vue {
...
<style lang='less'>
@import './bug-assing-to-view.less';
</style>