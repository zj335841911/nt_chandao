...
<studio-view viewName="bugreleasesubgridview_undone" viewTitle="bug表格视图" class='degridview bug-release-sub-grid-view-undone'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='fa fa-plus'></i>
                    <span class='caption'>{{$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-refresh'></i>
                    <span class='caption'>{{$t('entities.bug.releasesubgridview_undonetoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
...
export default class BugReleaseSubGridView_UndoneBase extends Vue {
	 ...
	 * @memberof BugReleaseSubGridView_UndoneBase
	 */
	public viewtag: string = 'b507b8efc20db47d7b01d67561638cd6';
