 ...
 */
export class TestTaskEditView_EditBase extends EditViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof TestTaskEditView_EditBase
     */ 
    protected viewName: string = 'TestTaskEditView_Edit';
