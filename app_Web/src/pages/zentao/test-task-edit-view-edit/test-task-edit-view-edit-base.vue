<template>
<div class="view-container test-task-edit-view-edit">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskeditview_edit"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.testtask.editview_edittoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.testtask.editview_edittoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class TestTaskEditView_EditBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.testtask.views.editview_edit.caption',
        srfTitle: 'entities.testtask.views.editview_edit.title',
        srfSubTitle: 'entities.testtask.views.editview_edit.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof TestTaskEditView_Edit
     */
...
<style lang='less'>
@import './test-task-edit-view-edit.less';
</style>