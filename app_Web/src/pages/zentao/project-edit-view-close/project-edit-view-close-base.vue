<template>
<div class="view-container project-edit-view-close">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projecteditview_close"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.project.editview_closetoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.project.editview_closetoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProjectEditView_CloseBase extends Vue {
...
<style lang='less'>
@import './project-edit-view-close.less';
</style>