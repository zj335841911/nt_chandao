<template>
<div class="view-container story-mpickup-view2">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storympickupview2"></app-studioaction>
...
export default class StoryMPickupView2Base extends Vue {
...
<style lang='less'>
@import './story-mpickup-view2.less';
</style>