<template>
<div class="view-container branch-pmedit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="branchpmeditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.branch.pmeditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class BranchPMEditViewBase extends Vue {
...
<style lang='less'>
@import './branch-pmedit-view.less';
</style>