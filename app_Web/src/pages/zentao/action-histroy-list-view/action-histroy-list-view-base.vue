...
<template>
<studio-view viewName="actionhistroylistview" viewTitle="历史记录" class='delistview action-histroy-list-view'>
    <view_list 
        :viewState="viewState"  
...
export default class ActionHistroyListViewBase extends Vue {
	 ...
	 * @memberof ActionHistroyListViewBase
	 */
	public viewtag: string = '770a170098d148e438a7666b248e6519';
...
<style lang='less'>
@import './action-histroy-list-view.less';
</style>