 ...
 *
 * @export
 * @class ActionHistroyListViewBase
 * @extends {ListViewBase}
 */
export class ActionHistroyListViewBase extends ListViewBase {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.action.views.histroylistview.caption',
        srfTitle: 'entities.action.views.histroylistview.title',
        srfSubTitle: 'entities.action.views.histroylistview.subtitle',
        dataInfo: ''
    }
