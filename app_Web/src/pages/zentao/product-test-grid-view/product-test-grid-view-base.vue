<template>
    <div class='view-container product-test-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="producttestgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.product.testgridviewtoolbar_toolbar.tbitem4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <dropdown v-show="toolBarModels.tbitem16.visabled" trigger='click'>
                            <tooltip :transfer="true" :max-width="600">
                                ...
                                <div slot='content'>{{$t('entities.product.testgridviewtoolbar_toolbar.tbitem16.tip')}}</div>
                            </tooltip>
                            ...
                            <div slot='content'>{{$t('entities.product.testgridviewtoolbar_toolbar.tbitem21.tip')}}</div>
                        </tooltip>
...
export default class ProductTestGridViewBase extends Vue {
 ...
 tbitem21: { name: 'tbitem21', caption: '导出数据模型', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportModel', target: '' } },
     ...
     * @memberof 
     */
    protected toolbar_tbitem6_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected toolbar_tbitem25_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof 
     */
    protected toolbar_tbitem21_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
     ...
     * @memberof ProductTestGridViewBase
     */
    protected Copy(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        if (args.length === 0) {
            return;
        }
        const _this: any = this;
     ...
     * @memberof ProductTestGridViewBase
     */
    protected ExportModel(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
