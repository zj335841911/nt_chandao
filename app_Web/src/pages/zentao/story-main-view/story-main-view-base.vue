...
<template>
<div class="view-container story-main-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storymainview"></app-studioaction>
...
export default class StoryMainViewBase extends Vue {
