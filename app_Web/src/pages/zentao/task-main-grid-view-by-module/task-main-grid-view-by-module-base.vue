<template>
<studio-view viewName="taskmaingridview_bymodule" viewTitle="task表格视图" class='degridview task-main-grid-view-by-module'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='fa fa-plus'></i>
                    <span class='caption'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
...
export default class TaskMainGridView_ByModuleBase extends Vue {
	 ...
	 * @memberof TaskMainGridView_ByModuleBase
	 */
	public viewtag: string = '8d033e1df3a5b0e948f7b6fba22dd0ac';
