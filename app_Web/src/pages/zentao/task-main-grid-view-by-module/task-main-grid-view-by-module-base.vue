<template>
    <div class='view-container task-main-grid-view-by-module'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskmaingridview_bymodule"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction4.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction5" :caption="$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction5.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction5' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.task.maingridview_bymoduletoolbar_toolbar.deuiaction5.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class TaskMainGridView_ByModuleBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.task.views.maingridview_bymodule.caption',
        srfTitle: 'entities.task.views.maingridview_bymodule.title',
        srfSubTitle: 'entities.task.views.maingridview_bymodule.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './task-main-grid-view-by-module.less';
</style>