 ...
 *
 * @export
 * @class BugGridView9_StoryaffectBase
 * @extends {GridView9Base}
 */
export class BugGridView9_StoryaffectBase extends GridView9Base {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof BugGridView9_StoryaffectBase
     */
	protected viewtag: string = '5eeecfcd239a98f93fb8f322d3470d76';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof BugGridView9_Storyaffect
     */
