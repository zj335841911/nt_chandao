...
<studio-view viewName="taskeditview" viewTitle="task编辑视图" class='deeditview task-edit-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.task.editviewtoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='sx-tb-saveandclose'></i>
                    <span class='caption'>{{$t('entities.task.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_form 
