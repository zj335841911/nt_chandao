<template>
<div class="view-container product-test-list-exp-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="producttestlistexpview"></app-studioaction>
...
export default class ProductTestListExpViewBase extends Vue {
     ...
     * @memberof ProductTestListExpView
     */
    public viewUID: string = 'zentao-product-test-list-exp-view';

}
</script>

<style lang='less'>
@import './product-test-list-exp-view.less';
</style>