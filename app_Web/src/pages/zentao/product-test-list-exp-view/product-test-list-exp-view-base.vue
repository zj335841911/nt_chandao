<template>
<studio-view viewName="producttestlistexpview" viewTitle="测试统计" class='delistexpview product-test-list-exp-view'>
    <view_listexpbar 
        :viewState="viewState"  
...
export default class ProductTestListExpViewBase extends ListExpViewBase {
