<template>
<div class="view-container case-test-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casetestoptionview"></app-studioaction>
...
export default class CaseTestOptionViewBase extends Vue {
...
<style lang='less'>
@import './case-test-option-view.less';
</style>