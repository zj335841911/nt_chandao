...
export class ProductListExpViewBase extends ListExpViewBase {
    ...
    public listexpviewlistexpbar_list_quicktoolbarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.product.listexpviewlistexpbar_list_quicktoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.product.listexpviewlistexpbar_list_quicktoolbar_toolbar.deuiaction1.tip', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'New', target: '', class: '' } },
     ...
     * @memberof ProductListExpViewBase
     */
	protected viewtag: string = 'a84a543c155b01389bc12eb1c27624b5';
