<template>
    <div class='view-container task-main-grid-view9-child'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskmaingridview9_child"></app-studioaction>
...
export default class TaskMainGridView9_ChildBase extends Vue {
