<template>
<div class="view-container task-cancel-task-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskcanceltaskview"></app-studioaction>
...
export default class TaskCancelTaskViewBase extends Vue {
