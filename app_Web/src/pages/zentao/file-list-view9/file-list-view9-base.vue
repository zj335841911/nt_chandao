...
<template>
<div class='view-container file-list-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="filelistview9"></app-studioaction>
...
export default class FileListView9Base extends Vue {
