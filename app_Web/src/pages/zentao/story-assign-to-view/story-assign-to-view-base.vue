<template>
<div class="view-container story-assign-to-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyassigntoview"></app-studioaction>
...
export default class StoryAssignToViewBase extends Vue {
...
<style lang='less'>
@import './story-assign-to-view.less';
</style>