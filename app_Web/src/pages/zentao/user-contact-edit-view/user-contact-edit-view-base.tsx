...
export class UserContactEditViewBase extends EditViewBase {
    ...
    public toolBarModels: any = {
        ...
        deuiaction4: { name: 'deuiaction4', caption: '新建', 'isShowCaption': true, 'isShowIcon': true, tooltip: '新建', iconcls: 'fa fa-file-text-o', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'New', target: '', class: '' } },
