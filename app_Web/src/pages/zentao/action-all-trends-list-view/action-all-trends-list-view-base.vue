...
<template>
<studio-view viewName="actionalltrendslistview" viewTitle="系统日志列表视图" class='delistview action-all-trends-list-view'>
    <view_list 
        :viewState="viewState"  
...
export default class ActionAllTrendsListViewBase extends Vue {
	 ...
	 * @memberof ActionAllTrendsListViewBase
	 */
	public viewtag: string = 'df57be69540a2e80fee7f3575162b93a';
...
<style lang='less'>
@import './action-all-trends-list-view.less';
</style>