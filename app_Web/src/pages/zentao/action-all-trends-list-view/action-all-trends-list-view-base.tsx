 ...
 *
 * @export
 * @class ActionAllTrendsListViewBase
 * @extends {ListViewBase}
 */
export class ActionAllTrendsListViewBase extends ListViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof ActionAllTrendsListViewBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.action.views.alltrendslistview.caption',
        srfTitle: 'entities.action.views.alltrendslistview.title',
        srfSubTitle: 'entities.action.views.alltrendslistview.subtitle',
        dataInfo: ''
    }
     ...
     * @memberof ViewBase
     */
	protected viewtag: string = 'df57be69540a2e80fee7f3575162b93a';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof ActionAllTrendsListView
     */
