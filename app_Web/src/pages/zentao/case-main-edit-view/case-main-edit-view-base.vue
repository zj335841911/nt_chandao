...
<studio-view viewName="casemaineditview" viewTitle="测试用例" class='deeditview case-main-edit-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.case.maineditviewtoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
...
export default class CaseMainEditViewBase extends Vue {
	 ...
	 * @memberof CaseMainEditViewBase
	 */
	public viewtag: string = '8e070a3e9ad67b127db723463198f9ac';
