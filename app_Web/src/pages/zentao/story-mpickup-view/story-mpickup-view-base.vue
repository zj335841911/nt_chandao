<template>
<div class="view-container dempickupview story-mpickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storympickupview"></app-studioaction>
...
<style lang='less'>
@import './story-mpickup-view.less';
</style>