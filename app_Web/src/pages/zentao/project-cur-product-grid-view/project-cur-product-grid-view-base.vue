...
<studio-view viewName="projectcurproductgridview" viewTitle="project表格视图" class='degridview project-cur-product-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.project.curproductgridviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-refresh'></i>
                    <span class='caption'>{{$t('entities.project.curproductgridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
