<template>
    <div class='view-container project-cur-product-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectcurproductgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.project.curproductgridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
