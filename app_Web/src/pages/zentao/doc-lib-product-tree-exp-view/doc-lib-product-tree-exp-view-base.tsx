 ...
 *
 * @export
 * @class DocLibProductTreeExpViewBase
 * @extends {TreeExpViewBase}
 */
export class DocLibProductTreeExpViewBase extends TreeExpViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof DocLibProductTreeExpView
     */
     ...
     * @memberof DocLibProductTreeExpView
     */
    public viewUID: string = 'zentao-doc-lib-product-tree-exp-view';
