...
<template>
<studio-view viewName="producttestleftsidebarlistview" viewTitle="所有产品" class='delistview product-test-left-sidebar-list-view'>
    <template slot='title'>
...
export default class ProductTestLeftSidebarListViewBase extends Vue {
	 ...
	 * @memberof ProductTestLeftSidebarListViewBase
	 */
	public viewtag: string = '7af111f4c127f7032c3e12e8c5fc0045';
