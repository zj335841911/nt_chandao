<template>
    <div class='view-container case-main-my-new-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casemainmynewgridview"></app-studioaction>
...
export default class CaseMainMyNewGridViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.case.views.mainmynewgridview.caption',
        srfTitle: 'entities.case.views.mainmynewgridview.title',
        srfSubTitle: 'entities.case.views.mainmynewgridview.subtitle',
        dataInfo: ''
    }
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof CaseMainMyNewGridView
     */
...
<style lang='less'>
@import './case-main-my-new-grid-view.less';
</style>