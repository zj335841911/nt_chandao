 ...
 *
 * @export
 * @class CaseMainMyNewGridViewBase
 * @extends {GridViewBase}
 */
export class CaseMainMyNewGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
