<template>
<div class='view-container product-plan-main-tab-exp tab-exp-view-header-flot'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productplanmaintabexp"></app-studioaction>
