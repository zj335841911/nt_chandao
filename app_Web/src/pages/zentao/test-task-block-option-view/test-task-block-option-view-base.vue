<template>
<div class="view-container test-task-block-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskblockoptionview"></app-studioaction>
...
export default class TestTaskBlockOptionViewBase extends Vue {
...
<style lang='less'>
@import './test-task-block-option-view.less';
</style>