...
<template>
<div class='view-container action-project-trends-list-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="actionprojecttrendslistview9"></app-studioaction>
...
export default class ActionProjectTrendsListView9Base extends Vue {
