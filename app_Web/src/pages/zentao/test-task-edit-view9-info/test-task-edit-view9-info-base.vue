<template>
<div class="view-container test-task-edit-view9-info">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskeditview9_info"></app-studioaction>
...
export default class TestTaskEditView9_InfoBase extends Vue {
