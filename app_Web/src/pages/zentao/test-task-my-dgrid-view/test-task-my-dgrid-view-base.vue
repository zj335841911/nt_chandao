<template>
    <div class='view-container test-task-my-dgrid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskmydgridview"></app-studioaction>
...
export default class TestTaskMyDGridViewBase extends Vue {
...
<style lang='less'>
@import './test-task-my-dgrid-view.less';
</style>