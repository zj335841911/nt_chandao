...
<template>
<div class='view-container action-project-trends-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="actionprojecttrendslistview"></app-studioaction>
