<template>
    <div class='view-container test-task-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.testtask.gridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.testtask.gridviewtoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.testtask.gridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction5" :caption="$t('entities.testtask.gridviewtoolbar_toolbar.deuiaction5.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction5' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.testtask.gridviewtoolbar_toolbar.deuiaction5.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
