 ...
 *
 * @export
 * @class TestTaskGridViewBase
 * @extends {GridViewBase}
 */
export class TestTaskGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof TestTaskGridViewBase
     */
	protected viewtag: string = 'aae1ade339fe6a2ebe367489f6393db1';
