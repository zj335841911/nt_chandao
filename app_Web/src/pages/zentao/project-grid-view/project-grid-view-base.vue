<template>
    <div class='view-container project-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectgridview"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.project.gridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.project.gridviewtoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.project.gridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.project.gridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction1" :caption="$t('entities.project.gridviewtoolbar_toolbar.deuiaction1.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction1' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.project.gridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ProjectGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        ...
        deuiaction1: { name: 'deuiaction1', caption: '导出', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000  },
