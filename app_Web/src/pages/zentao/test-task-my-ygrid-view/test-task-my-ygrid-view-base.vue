<template>
    <div class='view-container test-task-my-ygrid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskmyygridview"></app-studioaction>
...
export default class TestTaskMyYGridViewBase extends Vue {
...
<style lang='less'>
@import './test-task-my-ygrid-view.less';
</style>