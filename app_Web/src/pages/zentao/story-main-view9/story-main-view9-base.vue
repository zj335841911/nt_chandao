<template>
<studio-embed-view viewName="storymainview9" viewTitle="需求编辑视图" class='deeditview9 story-main-view9'>
    <view_form 
                :viewState="viewState"  
...
export default class StoryMainView9Base extends Vue {
	 ...
	 * @memberof StoryMainView9Base
	 */
	public viewtag: string = '94e0ee1a97736ff4d28b88a46cd395b7';
