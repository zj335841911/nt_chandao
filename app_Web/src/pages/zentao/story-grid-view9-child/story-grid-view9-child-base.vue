<template>
    <div class='view-container story-grid-view9-child'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storygridview9_child"></app-studioaction>
...
export default class StoryGridView9_ChildBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {StoryService}
     * @memberof StoryGridView9_ChildBase
     */
	 ...
	 * @memberof StoryGridView9_ChildBase
	 */
	protected viewtag: string = 'd6ef7de701a935bd9023cd0eb1338f58';
     ...
     */
    protected model: any = {
        srfCaption: 'entities.story.views.gridview9_child.caption',
        srfTitle: 'entities.story.views.gridview9_child.title',
        srfSubTitle: 'entities.story.views.gridview9_child.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './story-grid-view9-child.less';
</style>