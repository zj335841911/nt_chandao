<template>
<div class="view-container story-activite-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyactiviteview"></app-studioaction>
...
export default class StoryActiviteViewBase extends Vue {
...
<style lang='less'>
@import './story-activite-view.less';
</style>