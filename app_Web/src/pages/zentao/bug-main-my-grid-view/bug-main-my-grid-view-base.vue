<template>
    <div class='view-container bug-main-my-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugmainmygridview"></app-studioaction>
...
export default class BugMainMyGridViewBase extends Vue {
...
<style lang='less'>
@import './bug-main-my-grid-view.less';
</style>