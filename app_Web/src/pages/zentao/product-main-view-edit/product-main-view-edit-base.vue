<template>
<div class="view-container product-main-view-edit">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productmainview_edit"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.product.mainview_edittoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.product.mainview_edittoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProductMainView_EditBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.product.views.mainview_edit.caption',
        srfTitle: 'entities.product.views.mainview_edit.title',
        srfSubTitle: 'entities.product.views.mainview_edit.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './product-main-view-edit.less';
</style>