<template>
<div class="view-container test-task-activite-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskactiviteoptionview"></app-studioaction>
...
export default class TestTaskActiviteOptionViewBase extends Vue {
...
<style lang='less'>
@import './test-task-activite-option-view.less';
</style>