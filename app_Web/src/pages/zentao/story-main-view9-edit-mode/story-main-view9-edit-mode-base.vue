<template>
<studio-embed-view viewName="storymainview9_editmode" viewTitle="需求编辑视图" class='deeditview9 story-main-view9-edit-mode'>
    <view_form 
                :viewState="viewState"  
...
export default class StoryMainView9_EditModeBase extends Vue {
	 ...
	 * @memberof StoryMainView9_EditModeBase
	 */
	public viewtag: string = '538555af88ea31549a5bc7dbf1e6286a';
...
<style lang='less'>
@import './story-main-view9-edit-mode.less';
</style>