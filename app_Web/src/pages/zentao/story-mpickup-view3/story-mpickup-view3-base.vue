<template>
<div class="view-container story-mpickup-view3">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storympickupview3"></app-studioaction>
...
export default class StoryMPickupView3Base extends Vue {
...
<style lang='less'>
@import './story-mpickup-view3.less';
</style>