 ...
 *
 * @export
 * @class SysEmployeeUsr3GridViewUserConcatBase
 * @extends {GridViewBase}
 */
export class SysEmployeeUsr3GridViewUserConcatBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof SysEmployeeUsr3GridViewUserConcatBase
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.sysemployee.views.usr3gridviewuserconcat.caption',
        srfTitle: 'entities.sysemployee.views.usr3gridviewuserconcat.title',
        srfSubTitle: 'entities.sysemployee.views.usr3gridviewuserconcat.subtitle',
        dataInfo: '',
    };
     ...
     *
     * @type {*}
     * @memberof SysEmployeeUsr3GridViewUserConcat
     */
     ...
     * @memberof SysEmployeeUsr3GridViewUserConcatBase
     */
	protected viewtag: string = '8b1be3cc2e5253c0ea5bcb16b1d02f6e';
     ...
     * @memberof SysEmployeeUsr3GridViewUserConcatBase
     */ 
    protected viewName: string = 'SysEmployeeUsr3GridViewUserConcat';
