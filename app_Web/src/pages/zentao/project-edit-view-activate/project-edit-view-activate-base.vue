<template>
<div class="view-container project-edit-view-activate">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projecteditview_activate"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.project.editview_activatetoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.project.editview_activatetoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProjectEditView_ActivateBase extends Vue {
...
<style lang='less'>
@import './project-edit-view-activate.less';
</style>