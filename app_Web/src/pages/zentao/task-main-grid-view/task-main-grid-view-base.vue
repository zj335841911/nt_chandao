...
<studio-view viewName="taskmaingridview" viewTitle="task表格视图" class='degridview task-main-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.task.maingridviewtoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.task.maingridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.task.maingridviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
