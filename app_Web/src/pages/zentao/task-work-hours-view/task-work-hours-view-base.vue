<template>
<div class="view-container task-work-hours-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskworkhoursview"></app-studioaction>
...
export default class TaskWorkHoursViewBase extends Vue {
...
<style lang='less'>
@import './task-work-hours-view.less';
</style>