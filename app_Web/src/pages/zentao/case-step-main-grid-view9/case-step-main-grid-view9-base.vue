<template>
    <div class='view-container case-step-main-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casestepmaingridview9"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.casestep.maingridview9toolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
