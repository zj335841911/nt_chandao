<template>
    <div class='view-container module-line-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="modulelinegridview"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3.visabled" :disabled="toolBarModels.deuiaction3.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction3.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction3.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.module.linegridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ModuleLineGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        ...
        deuiaction1: { name: 'deuiaction1', caption: '删除', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Remove', target: 'MULTIKEY' } },
...
<style lang='less'>
@import './module-line-grid-view.less';
</style>