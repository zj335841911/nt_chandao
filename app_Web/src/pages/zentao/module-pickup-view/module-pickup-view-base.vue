<template>
<div class="view-container depickupview module-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="modulepickupview"></app-studioaction>
...
export default class ModulePickupViewBase extends Vue {
     ...
     */
    public appEntityService: ModuleService = new ModuleService;
	 ...
	 * @memberof ModulePickupViewBase
	 */
	public viewtag: string = 'cb6c278fd7205b3de3fc041816d15dd8';
