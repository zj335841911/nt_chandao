...
<template>
<div class='view-container action-history-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="actionhistorylistview"></app-studioaction>
...
export default class ActionHistoryListViewBase extends Vue {
...
<style lang='less'>
@import './action-history-list-view.less';
</style>