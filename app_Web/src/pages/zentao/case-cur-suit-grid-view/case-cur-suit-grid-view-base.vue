<template>
    <div class='view-container case-cur-suit-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casecursuitgridview"></app-studioaction>
...
export default class CaseCurSuitGridViewBase extends Vue {
