<template>
<studio-view viewName="casecursuitgridview" viewTitle="功能测试" class='degridview case-cur-suit-grid-view'>
...
export default class CaseCurSuitGridViewBase extends GridViewBase {
...
<style lang='less'>
@import './case-cur-suit-grid-view.less';
</style>