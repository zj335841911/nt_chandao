<template>
    <div class='view-container case-main-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casemaingridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction3_batchnew.visabled" :disabled="toolBarModels.deuiaction3_batchnew.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3_batchnew' }, $event)">
                                    <i class='fa fa-plus'></i>
                                    <span class='caption'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction3_batchnew.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction3_batchnew.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    <i class='fa fa-plus'></i>
                                    <span class='caption'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction5" :caption="$t('entities.case.maingridviewtoolbar_toolbar.deuiaction5.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction5' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.case.maingridviewtoolbar_toolbar.deuiaction5.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class CaseMainGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction3_batchnew: { name: 'deuiaction3_batchnew', caption: '批量新建用例', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'BatchNew', target: 'NONE' } },
    ...
    protected toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction3_batchnew')) {
            this.toolbar_deuiaction3_batchnew_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_deuiaction3_batchnew_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
...
<style lang='less'>
@import './case-main-grid-view.less';
</style>