<template>
    <div class='view-container story-build-sub-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storybuildsubgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.buildsubgridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class StoryBuildSubGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: '关联需求', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'buildLinkStories', target: 'NONE' } },
