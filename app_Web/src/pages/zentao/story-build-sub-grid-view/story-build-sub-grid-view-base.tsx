...
export class StoryBuildSubGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.story.buildsubgridviewtoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.story.buildsubgridviewtoolbar_toolbar.deuiaction1.tip', iconcls: 'fa fa-link', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__STORY_UNLP_BUT', uiaction: { tag: 'buildLinkStories', target: 'NONE', class: '' } },

        deuiaction2: { name: 'deuiaction2', caption: 'entities.story.buildsubgridviewtoolbar_toolbar.deuiaction2.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.story.buildsubgridviewtoolbar_toolbar.deuiaction2.tip', iconcls: 'fa fa-filter', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '', class: '' } },
