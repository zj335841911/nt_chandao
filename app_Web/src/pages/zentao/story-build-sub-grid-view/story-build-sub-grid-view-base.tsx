...
export class StoryBuildSubGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        ...
        deuiaction2: { name: 'deuiaction2', caption: '批量移除', 'isShowCaption': true, 'isShowIcon': true, tooltip: '批量移除', iconcls: 'fa fa-unlink', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'buildUnlinkMultiStories', target: 'MULTIKEY', class: '' } },
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:StoryUIService  = new StoryUIService();
        curUIService.Story_buildUnlinkMultiStories(datas,contextJO, paramJO,  $event, xData,this,"Story");
    }
