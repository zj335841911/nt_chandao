<template>
<div class="view-container bug-resolve-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugresolveview"></app-studioaction>
...
export default class BugResolveViewBase extends Vue {
