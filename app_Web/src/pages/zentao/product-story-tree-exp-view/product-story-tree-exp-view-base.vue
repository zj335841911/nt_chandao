<template>
<studio-view viewName="productstorytreeexpview" viewTitle="产品需求导航视图" class='detreeexpview product-story-tree-exp-view'>
    <view_treeexpbar 
                    :viewState="viewState"  
...
export default class ProductStoryTreeExpViewBase extends Vue {
	 ...
	 * @memberof ProductStoryTreeExpViewBase
	 */
	public viewtag: string = '58a943454a652d4f4ce2702d6447c079';
...
<style lang='less'>
@import './product-story-tree-exp-view.less';
</style>