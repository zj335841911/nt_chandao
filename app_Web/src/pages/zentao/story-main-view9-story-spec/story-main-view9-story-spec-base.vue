<template>
<studio-embed-view viewName="storymainview9_storyspec" viewTitle="需求编辑视图" class='deeditview9 story-main-view9-story-spec'>
    <view_form 
                :viewState="viewState"  
...
export default class StoryMainView9_StorySpecBase extends Vue {
	 ...
	 * @memberof StoryMainView9_StorySpecBase
	 */
	public viewtag: string = '61f32b2b422e8f1a9825e1f704464a8c';
...
<style lang='less'>
@import './story-main-view9-story-spec.less';
</style>