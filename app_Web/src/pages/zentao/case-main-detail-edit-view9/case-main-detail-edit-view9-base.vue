<template>
<div class="view-container case-main-detail-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casemaindetaileditview9"></app-studioaction>
...
export default class CaseMainDetailEditView9Base extends Vue {
