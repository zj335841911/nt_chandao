 ...
 *
 * @export
 * @class TaskMainEditViewBase
 * @extends {EditViewBase}
 */
export class TaskMainEditViewBase extends EditViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     * @memberof TaskMainEditViewBase
     */
	protected viewtag: string = 'f7cc804a46bac35842ad9cb21963ee26';
