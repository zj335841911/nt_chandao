<template>
<div class="view-container task-main-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskmaineditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.task.maineditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
