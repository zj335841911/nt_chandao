<template>
<div class="view-container case-main-new-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casemainnewview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.case.mainnewviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
