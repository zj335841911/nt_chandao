<template>
<div class='view-container project-task-tree-exp-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projecttasktreeexpview"></app-studioaction>
...
export default class ProjectTaskTreeExpViewBase extends Vue {
