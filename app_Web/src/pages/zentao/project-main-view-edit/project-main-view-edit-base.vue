<template>
<div class="view-container project-main-view-edit">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectmainview_edit"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.project.mainview_edittoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.project.mainview_edittoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProjectMainView_EditBase extends Vue {
...
<style lang='less'>
@import './project-main-view-edit.less';
</style>