<template>
<div class="view-container bug-steps-info-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugstepsinfoeditview"></app-studioaction>
...
export default class BugStepsInfoEditViewBase extends Vue {
