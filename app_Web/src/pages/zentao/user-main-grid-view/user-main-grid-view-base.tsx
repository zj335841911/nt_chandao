 ...
 *
 * @export
 * @class UserMainGridViewBase
 * @extends {GridViewBase}
 */
export class UserMainGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolBarModels: any = {
        ...
        deuiaction3_syncaccount: { name: 'deuiaction3_syncaccount', caption: '同步账号', 'isShowCaption': true, 'isShowIcon': true, tooltip: '同步账号', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__ADMIN', uiaction: { tag: 'SyncAccount', target: 'NONE', class: '' } },
    ...
    public toolbar_click($event: any, $event2?: any): void {
        ...
        if (Object.is($event.tag, 'deuiaction3_syncaccount')) {
            this.toolbar_deuiaction3_syncaccount_click(null, '', $event2);
        }
    ...
    public toolbar_deuiaction3_create_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.User_Create(datas,contextJO, paramJO,  $event, xData,this,"User");
    }
     ...
     * @memberof 
     */
    public toolbar_deuiaction3_syncaccount_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        const curUIService:UserUIService  = new UserUIService();
        curUIService.User_SyncAccount(datas,contextJO, paramJO,  $event, xData,this,"User");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"User");
    }
