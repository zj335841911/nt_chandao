<template>
<div class="view-container story-plan-sub-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyplansubeditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.story.plansubeditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
