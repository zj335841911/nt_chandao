 ...
 *
 * @export
 * @class DocKEditView9Base
 * @extends {EditView9Base}
 */
export class DocKEditView9Base extends EditView9Base {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.doc.views.keditview9.caption',
        srfTitle: 'entities.doc.views.keditview9.title',
        srfSubTitle: 'entities.doc.views.keditview9.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof DocKEditView9Base
     */
	protected viewtag: string = '82c6ad02ac6082c71d742df0460a93e2';
