<template>
    <div class='view-container product-plan-sub-plan-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productplansubplangridview"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction4.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            <app-export-excel :item="toolBarModels.deuiaction5" :caption="$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction5.caption')" @exportexcel="toolbar_click({ tag: 'deuiaction5' }, $event)"></app-export-excel>
                            <div slot='content'>{{$t('entities.subproductplan.subplangridviewtoolbar_toolbar.deuiaction5.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
...
export default class ProductPlanSubPlanGridViewBase extends Vue {
    ...
    protected toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"SubProductPlan");
    }
    ...
    protected toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SubProductPlan");
    }
...
<style lang='less'>
@import './product-plan-sub-plan-grid-view.less';
</style>