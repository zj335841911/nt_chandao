 ...
 */
export class StorySubGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
    ...
    public toolBarModels: any = {
        deuiaction2: { name: 'deuiaction2', caption: 'entities.substory.subgridviewtoolbar_toolbar.deuiaction2.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.substory.subgridviewtoolbar_toolbar.deuiaction2.tip', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'NewRow', target: '', class: '' } },

        deuiaction3: { name: 'deuiaction3', caption: 'entities.substory.subgridviewtoolbar_toolbar.deuiaction3.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.substory.subgridviewtoolbar_toolbar.deuiaction3.tip', iconcls: 'fa fa-save', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveRow', target: '', class: '' } },
     ...
     * @memberof StorySubGridViewBase
     */
	protected viewtag: string = '85897eeca4e1fb9fd7e7fe5c4fa28fa0';
