...
export class CaseStepCarryOutEditModeBase extends GridView9Base {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.casestep.views.carryouteditmode.caption',
        srfTitle: 'entities.casestep.views.carryouteditmode.title',
        srfSubTitle: 'entities.casestep.views.carryouteditmode.subtitle',
        dataInfo: ''
    }
