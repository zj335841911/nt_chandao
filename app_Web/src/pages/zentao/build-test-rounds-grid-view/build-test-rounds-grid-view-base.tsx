...
export class BuildTestRoundsGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', caption: 'entities.build.testroundsgridviewtoolbar_toolbar.deuiaction1.caption', 'isShowCaption': true, 'isShowIcon': true, tooltip: 'entities.build.testroundsgridviewtoolbar_toolbar.deuiaction1.tip', iconcls: 'fa fa-filter', icon: '', disabled: false, type: 'DEUIACTION', visible: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '', class: '' } },
