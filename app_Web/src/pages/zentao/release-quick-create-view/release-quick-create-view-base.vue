<template>
<div class="view-container release-quick-create-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="releasequickcreateview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.release.quickcreateviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
