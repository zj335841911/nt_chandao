<template>
    <div class='view-container product-grid-view-un-closed'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productgridview_unclosed"></app-studioaction>
...
export default class ProductGridView_UnClosedBase extends Vue {
