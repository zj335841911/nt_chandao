...
export class TodoGridViewBase extends GridViewBase {
    ...
    public toolBarModels: any = {
        deuiaction3_todocreate: { name: 'deuiaction3_todocreate', caption: '新建', 'isShowCaption': true, 'isShowIcon': true, tooltip: '新建', iconcls: 'fa fa-plus', icon: '', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALCREATE', uiaction: { tag: 'TodoCreate', target: 'NONE', class: '' } },
