    ...
    routes: [
        {
            ...
            children: [
                ...
                {
                    path: 'products/:product?/testreports/:testreport?/editview_report/:editview_report?',
                    meta: {
                        ...
                        parameters: [
                            ...
                            { pathName: 'products', parameterName: 'product' },
                            { pathName: 'testreports', parameterName: 'testreport' },
                            { pathName: 'editview_report', parameterName: 'editview_report' },
                        ],
                        requireAuth: true,
                    },
                    component: () => import('@pages/zentao/test-report-edit-view-report/test-report-edit-view-report.vue'),
                },
                {
                    path: 'testreports/:testreport?/editview_report/:editview_report?',
                    meta: {
                        caption: 'entities.testreport.views.editview_report.caption',
                        info:'',
                        imgPath: '',
                ...
                {
                    path: 'products/:product?/stories/:story?/cases/:case?/runresultchartview9/:runresultchartview9?',
                    meta: {
                        caption: 'entities.case.views.runresultchartview9.caption',
                        info:'',
                        imgPath: '',
                        iconCls: 'fa fa-star-o',
                        parameters: [
                            ...
                            { pathName: 'stories', parameterName: 'story' },
                            { pathName: 'cases', parameterName: 'case' },
                            { pathName: 'runresultchartview9', parameterName: 'runresultchartview9' },
                        ],
                        requireAuth: true,
                    },
                    component: () => import('@pages/zentao/case-run-result-chart-view9/case-run-result-chart-view9.vue'),
                },
                {
                    path: 'stories/:story?/cases/:case?/runresultchartview9/:runresultchartview9?',
                    meta: {
                        caption: 'entities.case.views.runresultchartview9.caption',
                        info:'',
                        imgPath: '',
                ...
                {
                    path: 'products/:product?/cases/:case?/runresultchartview9/:runresultchartview9?',
                    meta: {
                        caption: 'entities.case.views.runresultchartview9.caption',
                        info:'',
                        imgPath: '',
                ...
                {
                    path: 'cases/:case?/runresultchartview9/:runresultchartview9?',
                    meta: {
                        caption: 'entities.case.views.runresultchartview9.caption',
                        info:'',
                        imgPath: '',
