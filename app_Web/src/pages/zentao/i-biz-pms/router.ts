...
const router = new Router({
    routes: [
            ...
            children: [
                ...
                {
                    path: 'products/:product?/stories/:story?/tasks/:task?/usr2gridview/:usr2gridview?',
                    meta: {
                        caption: 'entities.task.views.usr2gridview.caption',
                        info:'',
                        imgPath: '',
                        iconCls: 'fa fa-tasks',
                        parameters: [
                    ...
                    component: () => import('@pages/zentao/task-usr2-grid-view/task-usr2-grid-view.vue'),
                },
                {
                    path: 'projects/:project?/tasks/:task?/usr2gridview/:usr2gridview?',
                    meta: {
                        caption: 'entities.task.views.usr2gridview.caption',
                        info:'',
                        imgPath: '',
                ...
                {
                    path: 'stories/:story?/tasks/:task?/usr2gridview/:usr2gridview?',
                    meta: {
                        caption: 'entities.task.views.usr2gridview.caption',
                        info:'',
                        imgPath: '',
                ...
                {
                    path: 'tasks/:task?/usr2gridview/:usr2gridview?',
                    meta: {
                        caption: 'entities.task.views.usr2gridview.caption',
                        info:'',
                        imgPath: '',
