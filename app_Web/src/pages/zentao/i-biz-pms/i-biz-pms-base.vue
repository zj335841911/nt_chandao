<template>
<div class="index_view i-biz-pms">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibizpms"></app-studioaction>
...
export default class IBizPMSBase extends Vue {
    ...
    protected afterMounted(){
        ...
        this.$viewTool.setIndexParameters([{ pathName: 'ibizpms', parameterName: 'ibizpms' }]);
