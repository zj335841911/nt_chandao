<template>
<div class="view-container test-task-start-option-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testtaskstartoptionview"></app-studioaction>
...
export default class TestTaskStartOptionViewBase extends Vue {
...
<style lang='less'>
@import './test-task-start-option-view.less';
</style>