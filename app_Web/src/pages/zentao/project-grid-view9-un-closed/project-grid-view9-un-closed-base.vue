<template>
<studio-embed-view viewName="projectgridview9_unclosed" viewTitle="项目表格视图" class='degridview9 project-grid-view9-un-closed'>
    <view_grid 
        :viewState="viewState"  
...
export default class ProjectGridView9_UnClosedBase extends Vue {
	 ...
	 * @memberof ProjectGridView9_UnClosedBase
	 */
	public viewtag: string = 'a7a97014cad1917b94284db21ec968f1';
...
<style lang='less'>
@import './project-grid-view9-un-closed.less';
</style>