<template>
<studio-view viewName="storyreleasesubgridview" viewTitle="story表格视图" class='degridview story-release-sub-grid-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.story.releasesubgridviewtoolbar_toolbar.deuiaction4.tip')" v-show="toolBarModels.deuiaction4.visabled" :disabled="toolBarModels.deuiaction4.disabled" class='' @click="toolbar_click({ tag: 'deuiaction4' }, $event)">
                    <i class='fa fa-remove'></i>
                    <span class='caption'>{{$t('entities.story.releasesubgridviewtoolbar_toolbar.deuiaction4.caption')}}</span>
                </i-button>
            <span class='seperator'>|</span>    <i-button :title="$t('entities.story.releasesubgridviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-refresh'></i>
                    <span class='caption'>{{$t('entities.story.releasesubgridviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_grid 
...
export default class StoryReleaseSubGridViewBase extends Vue {
	 ...
	 * @memberof StoryReleaseSubGridViewBase
	 */
	public viewtag: string = '87b3a9ce09500f304291ed2d69799d5e';
...
<style lang='less'>
@import './story-release-sub-grid-view.less';
</style>