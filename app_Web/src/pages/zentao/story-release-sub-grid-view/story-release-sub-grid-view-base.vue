<template>
    <div class='view-container story-release-sub-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyreleasesubgridview"></app-studioaction>
                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.story.releasesubgridviewtoolbar_toolbar.deuiaction2.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </row>
