<template>
<div class="view-container task-work-info-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskworkinfoeditview9"></app-studioaction>
...
export default class TaskWorkInfoEditView9Base extends Vue {
...
<style lang='less'>
@import './task-work-info-edit-view9.less';
</style>