<template>
<div class="view-container story-project-plan-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyprojectplanview"></app-studioaction>
...
export default class StoryProjectPlanViewBase extends Vue {
...
<style lang='less'>
@import './story-project-plan-view.less';
</style>