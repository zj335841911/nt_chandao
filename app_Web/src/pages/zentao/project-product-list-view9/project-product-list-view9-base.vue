...
<template>
<studio-embed-view viewName="projectproductlistview9" viewTitle="项目产品列表视图" class='delistview9 project-product-list-view9'>
    <view_list 
        :viewState="viewState"  
...
export default class ProjectProductListView9Base extends Vue {
	 ...
	 * @memberof ProjectProductListView9Base
	 */
	public viewtag: string = 'd0454a2ae9eb44aca3613b27169f3b18';
...
<style lang='less'>
@import './project-product-list-view9.less';
</style>