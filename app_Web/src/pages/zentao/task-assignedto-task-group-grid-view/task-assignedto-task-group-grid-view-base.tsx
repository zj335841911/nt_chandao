 ...
 *
 * @export
 * @class TaskAssignedtoTaskGroupGridViewBase
 * @extends {GridViewBase}
 */
export class TaskAssignedtoTaskGroupGridViewBase extends GridViewBase {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     ...
     */
    protected model: any = {
        srfCaption: 'entities.task.views.assignedtotaskgroupgridview.caption',
        srfTitle: 'entities.task.views.assignedtotaskgroupgridview.title',
        srfSubTitle: 'entities.task.views.assignedtotaskgroupgridview.subtitle',
        dataInfo: '',
    };
     ...
     * @memberof TaskAssignedtoTaskGroupGridViewBase
     */ 
    protected viewName: string = 'TaskAssignedtoTaskGroupGridView';
