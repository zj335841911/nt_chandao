<template>
<div class="view-container project-edit-view-putoff">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projecteditview_putoff"></app-studioaction>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.project.editview_putofftoolbar_toolbar.deuiaction1.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.project.editview_putofftoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProjectEditView_PutoffBase extends Vue {
...
<style lang='less'>
@import './project-edit-view-putoff.less';
</style>