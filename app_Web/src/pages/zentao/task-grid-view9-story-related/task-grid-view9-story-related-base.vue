<template>
    <div class='view-container task-grid-view9-story-related'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="taskgridview9_storyrelated"></app-studioaction>
...
export default class TaskGridView9_StoryRelatedBase extends Vue {
...
<style lang='less'>
@import './task-grid-view9-story-related.less';
</style>