...
<template>
<div class="view-container todo-dashboard-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="tododashboardview"></app-studioaction>
...
export default class TodoDashboardViewBase extends Vue {
...
<style lang='less'>
@import './todo-dashboard-view.less';
</style>