<template>
<div class="view-container project-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projecteditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.project.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
...
export default class ProjectEditViewBase extends Vue {
	 ...
	 * @memberof ProjectEditViewBase
	 */
	protected viewtag: string = 'f83dac873b9215483c4bb91673284b41';
