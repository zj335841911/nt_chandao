<template>
<div class="view-container story-release-sub-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyreleasesubeditview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.story.releasesubeditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
