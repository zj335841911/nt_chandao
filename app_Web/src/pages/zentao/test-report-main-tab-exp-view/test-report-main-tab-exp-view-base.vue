<template>
<div class='view-container test-report-main-tab-exp-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="testreportmaintabexpview"></app-studioaction>
...
export default class TestReportMainTabExpViewBase extends Vue {
