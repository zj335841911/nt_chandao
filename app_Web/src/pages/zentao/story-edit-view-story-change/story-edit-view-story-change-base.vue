<template>
<studio-view viewName="storyeditview_storychange" viewTitle="需求编辑视图" class='deeditview story-edit-view-story-change'>
    <template slot='title'>
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
    </template>
    <template slot="toolbar">
                <div class='toolbar-container'>
            <i-button :title="$t('entities.story.editview_storychangetoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='sx-tb-saveandclose'></i>
                    <span class='caption'>{{$t('entities.story.editview_storychangetoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_form 
...
export default class StoryEditView_StoryChangeBase extends Vue {
	 ...
	 * @memberof StoryEditView_StoryChangeBase
	 */
	public viewtag: string = 'e54598b1e6d38d7c6ce8231b531b46bd';
...
<style lang='less'>
@import './story-edit-view-story-change.less';
</style>