<template>
<div class="view-container story-edit-view-story-change">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storyeditview_storychange"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.story.editview_storychangetoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
