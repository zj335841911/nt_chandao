<template>
<div class="view-container case-test-main-detail-edit-view9">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="casetestmaindetaileditview9"></app-studioaction>
...
export default class CaseTestMainDetailEditView9Base extends Vue {
...
<style lang='less'>
@import './case-test-main-detail-edit-view9.less';
</style>