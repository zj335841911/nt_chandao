 ...
 *
 * @export
 * @class ProjectMoreUndoneProjectGridView9Base
 * @extends {GridView9Base}
 */
export class ProjectMoreUndoneProjectGridView9Base extends GridView9Base {
    /**
     * 视图对应应用实体名称
     *
     * @protected
     * @type {string}
     * @memberof ProjectMoreUndoneProjectGridView9Base
     */
     ...
     */
    protected model: any = {
        srfCaption: 'entities.project.views.moreundoneprojectgridview9.caption',
        srfTitle: 'entities.project.views.moreundoneprojectgridview9.title',
        srfSubTitle: 'entities.project.views.moreundoneprojectgridview9.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof ProjectMoreUndoneProjectGridView9
     */
     ...
     * @memberof ProjectMoreUndoneProjectGridView9Base
     */ 
    protected viewName:string = "ProjectMoreUndoneProjectGridView9";
