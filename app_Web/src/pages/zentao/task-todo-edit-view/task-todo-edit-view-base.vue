<template>
<div class="view-container task-todo-edit-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="tasktodoeditview"></app-studioaction>
...
export default class TaskTodoEditViewBase extends Vue {
...
<style lang='less'>
@import './task-todo-edit-view.less';
</style>