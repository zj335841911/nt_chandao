...
<studio-view viewName="projectleftsidebarlistview" viewTitle="所有项目" class='delistview project-left-sidebar-list-view'>
    ...
    <template slot="toolbar">
            ...
            <span class='seperator'>|</span>    <i-button :title="$t('entities.project.leftsidebarlistviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-refresh'></i>
                    <span class='caption'>{{$t('entities.project.leftsidebarlistviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_list 
...
export default class ProjectLeftSidebarListViewBase extends Vue {
	 ...
	 * @memberof ProjectLeftSidebarListViewBase
	 */
	public viewtag: string = '7c79a923d0cdd1a5bc41a34367809077';
