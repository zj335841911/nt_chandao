...
<template>
<div class='view-container project-left-sidebar-list-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="projectleftsidebarlistview"></app-studioaction>
    ...
    <div class='pull-right'>
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.deuiaction3_manager.visabled" :disabled="toolBarModels.deuiaction3_manager.disabled" class='' @click="toolbar_click({ tag: 'deuiaction3_manager' }, $event)">
                        <i class='fa fa-list'></i>
                        
                    </i-button>
                <div slot='content'>{{$t('entities.project.leftsidebarlistviewtoolbar_toolbar.deuiaction3_manager.tip')}}</div>
            </tooltip>
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.project.leftsidebarlistviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.project.leftsidebarlistviewtoolbar_toolbar.deuiaction2.tip')}}</div>
            </tooltip>
        </div>
    </div>
</row>
...
export default class ProjectLeftSidebarListViewBase extends Vue {
    ...
    public toolBarModels: any = {
        deuiaction3_manager: { name: 'deuiaction3_manager', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Manager', target: 'NONE' } },

        seperator2: {  name: 'seperator2', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { } },
        deuiaction1: { name: 'deuiaction1', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'New', target: '' } },
    ...
    protected toolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction3_manager')) {
            this.toolbar_deuiaction3_manager_click($event, '', $event2);
        }
     ...
     * @memberof 
     */
    protected toolbar_deuiaction3_manager_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
