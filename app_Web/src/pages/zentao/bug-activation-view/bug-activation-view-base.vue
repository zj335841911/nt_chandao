<template>
<div class="view-container bug-activation-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugactivationview"></app-studioaction>
...
export default class BugActivationViewBase extends Vue {
...
<style lang='less'>
@import './bug-activation-view.less';
</style>