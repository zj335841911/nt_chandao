<template>
    <div class='view-container product-plan-project-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productplanprojectgridview9"></app-studioaction>
...
export default class ProductPlanProjectGridView9Base extends Vue {
	 ...
	 * @memberof ProductPlanProjectGridView9Base
	 */
	protected viewtag: string = '908a34af4784424622d2f7905335d023';
...
<style lang='less'>
@import './product-plan-project-grid-view9.less';
</style>