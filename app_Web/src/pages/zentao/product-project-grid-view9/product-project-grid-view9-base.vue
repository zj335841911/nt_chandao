<template>
    <div class='view-container product-project-grid-view9'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productprojectgridview9"></app-studioaction>
...
export default class ProductProjectGridView9Base extends Vue {
	 ...
	 * @memberof ProductProjectGridView9Base
	 */
	protected viewtag: string = '0b1b51910ca13751bfd6d356dcadbbce';
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof ProductProjectGridView9
     */
...
<style lang='less'>
@import './product-project-grid-view9.less';
</style>