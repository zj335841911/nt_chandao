...
<studio-view viewName="productplansubplancreateview" viewTitle="计划" class='deeditview product-plan-sub-plan-create-view'>
    ...
    <template slot="toolbar">
            ...
            <i-button :title="$t('entities.subproductplan.subplancreateviewtoolbar_toolbar.deuiaction2.tip')" v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    <i class='fa fa-save'></i>
                    <span class='caption'>{{$t('entities.subproductplan.subplancreateviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <i-button :title="$t('entities.subproductplan.subplancreateviewtoolbar_toolbar.deuiaction1.tip')" v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    <i class='sx-tb-saveandclose'></i>
                    <span class='caption'>{{$t('entities.subproductplan.subplancreateviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
        </div>
    </template>
    <view_form 
...
export default class ProductPlanSubPlanCreateViewBase extends Vue {
	 ...
	 * @memberof ProductPlanSubPlanCreateViewBase
	 */
	public viewtag: string = '170c1d558f26cf37236390b28f8aca82';
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SubProductPlan");
    }
