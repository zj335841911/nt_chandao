<template>
<div class="view-container product-plan-sub-plan-create-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="productplansubplancreateview"></app-studioaction>
    ...
    <span class='caption-info'>{{$t(model.srfTitle)}}</span>
        ...
        <div class='toolbar-container'>
            <tooltip :transfer="true" :max-width="600">
                ...
                <div slot='content'>{{$t('entities.subproductplan.subplancreateviewtoolbar_toolbar.deuiaction1.tip')}}</div>
            </tooltip>
        </div>
