<template>
<studio-view viewName="productbugtreeexpview" viewTitle="产品需求导航视图" class='detreeexpview product-bug-tree-exp-view'>
    <view_treeexpbar 
                    :viewState="viewState"  
...
export default class ProductBugTreeExpViewBase extends Vue {
	 ...
	 * @memberof ProductBugTreeExpViewBase
	 */
	public viewtag: string = 'f78c94cb0a20d7f459753a4070f8f3e7';
...
<style lang='less'>
@import './product-bug-tree-exp-view.less';
</style>