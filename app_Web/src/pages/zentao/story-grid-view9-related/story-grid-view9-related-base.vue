<template>
    <div class='view-container story-grid-view9-related'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="storygridview9_related"></app-studioaction>
...
export default class StoryGridView9_RelatedBase extends Vue {
     ...
     */
    protected model: any = {
        srfCaption: 'entities.story.views.gridview9_related.caption',
        srfTitle: 'entities.story.views.gridview9_related.title',
        srfSubTitle: 'entities.story.views.gridview9_related.subtitle',
        dataInfo: ''
    }
     ...
     * @param {*} [$event]
     * @param {*} [xData]
     * @memberof StoryGridView9_Related
     */
...
<style lang='less'>
@import './story-grid-view9-related.less';
</style>