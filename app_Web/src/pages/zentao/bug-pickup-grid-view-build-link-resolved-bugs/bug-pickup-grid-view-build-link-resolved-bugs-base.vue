<template>
<div class='view-container bug-pickup-grid-view-build-link-resolved-bugs'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="bugpickupgridview_buildlinkresolvedbugs"></app-studioaction>
...
export default class BugPickupGridView_buildLinkResolvedBugsBase extends Vue {
     ...
     *
     * @type {string}
     * @memberof BugPickupGridView_buildLinkResolvedBugs
     */
...
<style lang='less'>
@import './bug-pickup-grid-view-build-link-resolved-bugs.less';
</style>