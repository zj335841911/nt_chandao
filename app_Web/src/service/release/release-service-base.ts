...
// 实体接口
    ...
    public async Create(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && true){
            ...
            return Http.getInstance().post(`/products/${context.product}/releases`,data,isloading);
        }
        let masterData:any = {};
    ...
    public async Update(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().put(`/products/${context.product}/releases/${context.release}`,data,isloading);
        }
        let masterData:any = {};
        Object.assign(data,masterData);
    ...
    public async Get(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().get(`/products/${context.product}/releases/${context.release}`,isloading);
        }
    ...
    public async GetDraft(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && true){
            return Http.getInstance().get(`/products/${context.product}/releases/getdraft`,isloading);
        }
    ...
    public async BatchUnlinkBug(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/batchunlinkbug`,data,isloading);
        }
    ...
    public async CheckKey(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/checkkey`,data,isloading);
        }
    ...
    public async LinkBug(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/linkbug`,data,isloading);
        }
    ...
    public async LinkBugbyBug(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/linkbugbybug`,data,isloading);
        }
    ...
    public async LinkBugbyLeftBug(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/linkbugbyleftbug`,data,isloading);
        }
    ...
    public async Save(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/save`,data,isloading);
        }
        let masterData:any = {};
        Object.assign(data,masterData);
    ...
    public async UnlinkBug(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.product && context.release){
            return Http.getInstance().post(`/products/${context.product}/releases/${context.release}/unlinkbug`,data,isloading);
        }
