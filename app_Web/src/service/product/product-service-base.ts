...
// 实体接口
    ...
    public async Create(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        this.tempStorage.setItem(tempContext.srfsessionkey+'_testreports',JSON.stringify(res.data.testreports));
        ...
        this.tempStorage.setItem(tempContext.srfsessionkey+'_testmodules',JSON.stringify(res.data.testmodules));
    ...
    public async Update(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Object.assign(data,masterData);
            ...
            this.tempStorage.setItem(context.srfsessionkey+'_testreports',JSON.stringify(res.data.testreports));
            ...
            this.tempStorage.setItem(context.srfsessionkey+'_testmodules',JSON.stringify(res.data.testmodules));
