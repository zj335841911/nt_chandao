...
// 实体接口
    ...
    public async Create(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        let ibz_projectteamsData:any = [];
        if(!Object.is(this.tempStorage.getItem(context.srfsessionkey+'_ibz_projectteams'),'undefined')){
            ibz_projectteamsData = JSON.parse(this.tempStorage.getItem(context.srfsessionkey+'_ibz_projectteams') as any);
            if(ibz_projectteamsData && ibz_projectteamsData.length && ibz_projectteamsData.length > 0){
                ibz_projectteamsData.forEach((item:any) => {
                    if(item.srffrontuf){
                        if(Object.is(item.srffrontuf,"0")){
                            item.id = null;
                        }
        ...
        masterData.ibz_projectteams = ibz_projectteamsData;
        let bugsData:any = [];
        ...
        this.tempStorage.setItem(tempContext.srfsessionkey+'_ibz_projectteams',JSON.stringify(res.data.ibz_projectteams));
    ...
    public async Update(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Object.assign(data,masterData);
            ...
            this.tempStorage.setItem(context.srfsessionkey+'_ibz_projectteams',JSON.stringify(res.data.ibz_projectteams));
