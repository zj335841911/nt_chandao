<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'story-link-story-mob-pickup-mdview': true }">
    ...
    <div id="searchformstorylinkstorymobpickupmdview"></div>
    <ion-content >
                <view_mdctrl
            :viewState="viewState"
            viewName="StoryLinkStoryMobPickupMDView"  
