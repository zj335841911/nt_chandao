<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'user-mob-pickup-mdview': true }">
...
export default class UserMobPickupMDViewBase extends Vue {
	 ...
	 * @memberof UserMobPickupMDViewBase
	 */
	protected viewtag: string = '8ca2ced94768f27ac028aaea323e33b5';
...
<style lang='less'>
@import './user-mob-pickup-mdview.less';
</style>