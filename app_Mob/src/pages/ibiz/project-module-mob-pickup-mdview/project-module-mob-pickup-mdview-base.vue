<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'project-module-mob-pickup-mdview': true }">
...
export default class ProjectModuleMobPickupMDViewBase extends Vue {
	 ...
	 * @memberof ProjectModuleMobPickupMDViewBase
	 */
	protected viewtag: string = '73daedb821777aaf1a46923f595ea272';
