...
export default class StoryMobMDViewCurProjectBase extends Vue {
    ...
    */
    public righttoolbarModels: any = {
            ...
            deuiaction2: { name: 'deuiaction2', caption: '按照计划关联', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__STORY_UNLP_BUT', uiaction: { tag: 'MobAccordingToPlanLinkStory', target: 'SINGLEKEY' } },
