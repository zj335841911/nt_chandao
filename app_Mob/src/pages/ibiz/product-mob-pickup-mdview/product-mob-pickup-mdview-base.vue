<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'product-mob-pickup-mdview': true }">
...
export default class ProductMobPickupMDViewBase extends Vue {
	 ...
	 * @memberof ProductMobPickupMDViewBase
	 */
	protected viewtag: string = '2a07bb13f1ffd6dabae943ff44cd0b2c';
     ...
     */
    protected model: any = {
        srfTitle: '产品移动端选择多数据视图',
        srfCaption: 'product.views.mobpickupmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'product.mobpickupmdview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './product-mob-pickup-mdview.less';
</style>