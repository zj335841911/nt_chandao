...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'task-estimate-mob-edit-view': true }">
...
export default class TaskEstimateMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskEstimateMobEditViewBase
     */
	 ...
	 * @memberof TaskEstimateMobEditViewBase
	 */
	protected viewtag: string = '62a5d87af94fd31f6703b9e2c1c05ad6';
    ...
    protected model: any = {
        ...
        srfCaption: 'taskestimate.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        iconcls: '',
        icon: ''
   ...
   /**
    * 工具栏 TaskEstimateMobEditView 模型
    *
    * @type {*}
    * @memberof TaskEstimateMobEditView
    */
...
<style lang='less'>
@import './task-estimate-mob-edit-view.less';
</style>