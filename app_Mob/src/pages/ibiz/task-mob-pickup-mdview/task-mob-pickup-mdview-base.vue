<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'task-mob-pickup-mdview': true }">
    ...
    <div id="searchformtaskmobpickupmdview"></div>
    <ion-content >
                <view_mdctrl
            :viewState="viewState"
            viewName="TaskMobPickupMDView"  
