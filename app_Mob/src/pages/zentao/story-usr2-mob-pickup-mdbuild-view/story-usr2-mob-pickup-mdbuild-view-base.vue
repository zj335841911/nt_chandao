<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'story-usr2-mob-pickup-mdbuild-view': true }">
    ...
    <div id="searchformstoryusr2mobpickupmdbuildview"></div>
...
export default class StoryUsr2MobPickupMDBuildViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof StoryUsr2MobPickupMDBuildViewBase
     */
	 ...
	 * @memberof StoryUsr2MobPickupMDBuildViewBase
	 */
	protected viewtag: string = 'efe6c0907f23f66eb908b5d39b80e495';
     ...
     * @memberof StoryUsr2MobPickupMDBuildViewBase
     */
    protected navParam: any = { 'srfparentkey': '%srfparentkey%', 'project': '%project%', 'n_parent_gtandeq': '0', 'build': '%build%' };
    ...
    protected model: any = {
        ...
        srfCaption: 'story.views.usr2mobpickupmdbuildview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.usr2mobpickupmdbuildview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof StoryUsr2MobPickupMDBuildView
     */
...
<style lang='less'>
@import './story-usr2-mob-pickup-mdbuild-view.less';
</style>