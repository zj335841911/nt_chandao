<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'bug-usr2-mob-pickup-mdview': true }">
    ...
    <ion-header>
        <ion-toolbar v-show="titleStatus" class="ionoc-view-header">
            ...
            <ion-title class="view-title"><label class="title-label"><ion-icon v-if="model.icon" :name="model.icon"></ion-icon> <img v-else-if="model.iconcls" :src="model.iconcls" alt=""> {{$t(model.srfCaption)}}</label></ion-title>
                ...
                <div class="bug-usr2-mob-pickup-mdview-toolbar default-sort">
                    <div class="view-tool">
    ...
    <ion-content :scroll-events="true" @ionScroll="onScroll" ref="ionScroll" @ionScrollEnd="onScrollEnd">
        <ion-refresher 
            ...
            loadAction="Get"
            createAction="Create"
            fetchAction="FetchNotCurPlanLinkBug" 
...
export default class BugUsr2MobPickupMDViewBase extends Vue {
	 ...
	 * @memberof BugUsr2MobPickupMDViewBase
	 */
	protected viewtag: string = 'cef05d2d324d0c60a52a11885691bb74';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr2mobpickupmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr2mobpickupmdview',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof BugUsr2MobPickupMDView
     */
...
<style lang='less'>
@import './bug-usr2-mob-pickup-mdview.less';
</style>