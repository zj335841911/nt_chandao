<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'todo-usr2-mob-edit-view': true }">
        ...
        <ion-toolbar v-show="titleStatus" class="ionoc-view-header">
            ...
            <ion-buttons slot="end">
                    ...
                    <div class="app-quick-toolbar toolbar-right-bottons">
                                <app-mob-button 
                            iconName="sx-tb-saveandclose"
                            :text="$t('todo.usr2mobeditviewrighttoolbar_toolbar.deuiaction1.caption')"
...
export default class TodoUsr2MobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TodoUsr2MobEditViewBase
     */
	 ...
	 * @memberof TodoUsr2MobEditViewBase
	 */
	protected viewtag: string = '43c69df69c0835044f0ea14e91d6ab6b';
    ...
    protected model: any = {
        srfTitle: '待办移动端编辑视图',
        srfCaption: 'todo.views.usr2mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'todo.usr2mobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 TodoUsr2MobEditView 模型
    *
    * @type {*}
    * @memberof TodoUsr2MobEditView
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', caption: '保存并关闭', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__UNIVERSALSAVE', uiaction: { tag: 'SaveAndExit', target: '' } },
...
<style lang='less'>
@import './todo-usr2-mob-edit-view.less';
</style>