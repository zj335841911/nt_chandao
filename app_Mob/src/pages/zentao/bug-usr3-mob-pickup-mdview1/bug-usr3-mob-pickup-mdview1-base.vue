<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'bug-usr3-mob-pickup-mdview1': true }">
    ...
    <ion-header>
        <ion-toolbar v-show="titleStatus" class="ionoc-view-header">
            ...
            <ion-title class="view-title"><label class="title-label"><ion-icon v-if="model.icon" :name="model.icon"></ion-icon> <img v-else-if="model.iconcls" :src="model.iconcls" alt=""> {{$t(model.srfCaption)}}</label></ion-title>
                ...
                <div class="bug-usr3-mob-pickup-mdview1-toolbar default-sort">
                    <div class="view-tool">
    ...
    <div id="searchformbugusr3mobpickupmdview1"></div>
...
export default class BugUsr3MobPickupMDView1Base extends Vue {
	 ...
	 * @memberof BugUsr3MobPickupMDView1Base
	 */
	protected viewtag: string = 'c5fb7ab4959d7dacf105f0a51695180b';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr3mobpickupmdview1.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr3mobpickupmdview1',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof BugUsr3MobPickupMDView1
     */
...
<style lang='less'>
@import './bug-usr3-mob-pickup-mdview1.less';
</style>