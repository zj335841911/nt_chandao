...
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'bug-ass-mob-mdview9': true }">
    ...
    <template slot="toolbar">
            <ion-buttons slot="end" class="ibiz-top-right-buttons ibiz-buttonGroup">
                    ...
                    {{$t('bug.assmobmdview9righttoolbar_toolbar.deuiaction1.caption')}}
                    </ion-button>
...
export default class BugAssMobMDView9Base extends Vue {
   ...
   /**
    * 工具栏 BugAssMobMDView9 模型
    *
    * @type {*}
    * @memberof BugAssMobMDView9
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', caption: '更多', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'AssToMyBugMore', target: 'NONE' } },
