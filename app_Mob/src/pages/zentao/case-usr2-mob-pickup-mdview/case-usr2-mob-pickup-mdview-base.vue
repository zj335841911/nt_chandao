<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupmdview': true, 'case-usr2-mob-pickup-mdview': true }">
    ...
    <div id="searchformcaseusr2mobpickupmdview"></div>
    <ion-content >
                <view_mdctrl
            :viewState="viewState"
            viewName="CaseUsr2MobPickupMDView"  
...
export default class CaseUsr2MobPickupMDViewBase extends Vue {
	 ...
	 * @memberof CaseUsr2MobPickupMDViewBase
	 */
	protected viewtag: string = '68c58498bdd6d8ed8be598ff9886ca3a';
     ...
     */
    protected model: any = {
        srfTitle: '测试用例移动端选择多数据视图',
        srfCaption: 'case.views.usr2mobpickupmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'case.usr2mobpickupmdview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof CaseUsr2MobPickupMDView
     */
...
<style lang='less'>
@import './case-usr2-mob-pickup-mdview.less';
</style>