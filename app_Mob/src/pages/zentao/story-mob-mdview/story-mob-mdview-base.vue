...
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'story-mob-mdview': true }">
    ...
    <ion-footer class="view-footer" style="z-index:9;">
            ...
            {{$t('story.mobmdviewrighttoolbar_toolbar.deuiaction1.caption')}}    
            </ion-fab-button>
...
export default class StoryMobMDViewBase extends Vue {
    ...
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', caption: '新建需求', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__STORY_CREATE_BUT', uiaction: { tag: 'MobCreate', target: 'NONE' } },
