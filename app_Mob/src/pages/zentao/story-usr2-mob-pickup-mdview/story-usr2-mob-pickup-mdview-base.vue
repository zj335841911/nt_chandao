...
export default class StoryUsr2MobPickupMDViewBase extends Vue {
	 ...
	 * @memberof StoryUsr2MobPickupMDViewBase
	 */
	protected viewtag: string = 'a7f7ac4849d3c395bc27d5c368a56b50';
    ...
    protected model: any = {
        ...
        srfCaption: 'story.views.usr2mobpickupmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.usr2mobpickupmdview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof StoryUsr2MobPickupMDView
     */
...
<style lang='less'>
@import './story-usr2-mob-pickup-mdview.less';
</style>