<template>
<ion-page class="view-container app-mob-pickup-mdview bug-usr3-mob-pickup-build-resolved-mdview">
    <ion-content class="view-content" :scroll-events="true" @ionScroll="onScroll" ref="ionScroll" @ionScrollEnd="onScrollEnd">
        <view_mdctrl
    :viewState="viewState"
    viewName="Usr3MobPickupBuildResolvedMDView"
    ...
    loadAction="Get"
    createAction="Create"
    fetchAction="FetchBuildLinkResolvedBugs" 
...
export default class BugUsr3MobPickupBuildResolvedMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof BugUsr3MobPickupBuildResolvedMDViewBase
     */
	 ...
	 * @memberof BugUsr3MobPickupBuildResolvedMDViewBase
	 */
	protected viewtag: string = '318823b2dad1bfe2062d1bcf1aa83cf3';
     ...
     * @memberof BugUsr3MobPickupBuildResolvedMDViewBase
     */
    protected navParam: any = { 'product': '%product%', 'project': '%project%', 'build': '%build%' };
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr3mobpickupbuildresolvedmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr3mobpickupbuildresolvedmdview',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
     ...
     *
     * @type {boolean}
     * @memberof BugUsr3MobPickupBuildResolvedMDView
     */
...
<style lang='less'>
@import './bug-usr3-mob-pickup-build-resolved-mdview.less';
</style>