...
export default class IbzWeeklyUsr2MobTabExpViewBase extends Vue {
	 ...
	 * @memberof IbzWeeklyUsr2MobTabExpViewBase
	 */
	protected viewtag: string = '0b4e10da9ed1583e36501c27a58a5a9c';
    ...
    public setCacheTabkey(value:any) {
        const cacheTab:any = {name:'ibzweekly',id:this.context.ibzweekly,value:value,viewtag: this.viewtag};
    ...
    public getCacheTabkey() {
        ...
        if (cacheTabKey.name && cacheTabKey.name == 'ibzweekly' && cacheTabKey.id && cacheTabKey.id == this.context.ibzweekly && cacheTabKey.viewtag === this.viewtag) {
