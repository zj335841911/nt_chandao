...
export default class IbzDailyDailyMobTabExpViewBase extends Vue {
	 ...
	 * @memberof IbzDailyDailyMobTabExpViewBase
	 */
	protected viewtag: string = '61c39e479b48562ea5dd171967cf9975';
    ...
    */
    ...
    public setCacheTabkey(value:any) {
        const cacheTab:any = {name:'ibzdaily',id:this.context.ibzdaily,value:value,viewtag: this.viewtag};
    ...
    public getCacheTabkey() {
        ...
        if (cacheTabKey.name && cacheTabKey.name == 'ibzdaily' && cacheTabKey.id && cacheTabKey.id == this.context.ibzdaily && cacheTabKey.viewtag === this.viewtag) {
