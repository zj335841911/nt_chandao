...
import { ProjectStatusBarMobModel } from '@/app-core/ctrl-model/project/project-status-bar-mob-portlet-model';
 ...
 */
export class ProjectStatusBarMobService extends PortletServiceBase {
