...
import { ProjectTeamMobModel } from '@/app-core/ctrl-model/ibzprojectteamnest/project-team-mob-multieditviewpanel-model';
...
export class ProjectTeamMobService extends MultiEditViewPanelServiceBase {
     ...
     * @memberof ProjectTeamMobService
     */
    protected appDEName: string = 'ibzprojectteamnest';
