...
import { MobPickupViewpickupviewpanelModel } from '@/app-core/ctrl-model/product-line/mob-pickup-viewpickupviewpanel-pickupviewpanel-model';
...
export class MobPickupViewpickupviewpanelService extends PickupViewPanelServiceBase {
     ...
     * @memberof MobPickupViewpickupviewpanelService
     */
    protected appDeKey: string = 'productlineid';
}
// 默认导出
