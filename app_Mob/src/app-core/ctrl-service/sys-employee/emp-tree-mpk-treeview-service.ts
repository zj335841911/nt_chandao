 ...
 *
 * @export
 * @class EmpTreeMpkService
 * @extends {TreeViewServiceBase}
 */
export class EmpTreeMpkService extends TreeViewServiceBase {

    /**
     * 部件模型
     *
     * @protected
     * @type {EmpTreeMpkModel}
     * @memberof ControlServiceBase
     */
    protected model: EmpTreeMpkModel = new EmpTreeMpkModel();
...
// 默认导出
export default EmpTreeMpkService;