<template>
<div class="app-mob-meditviewpanel ibzprojectteam-meditviewpanel ">
...
export default class ProjectTeamMobBase extends Vue implements ControlInterface {
     ...
     * @memberof ProjectTeamMobBase
     */  
    public deUIService:IBZPROJECTTEAMUIService = new IBZPROJECTTEAMUIService(this.$store);
    ...
    private doItems(datas: any[]): void {
        ...
        datas.forEach((arg: any) => {
            ...
            let title :string = arg.ibzprojectteamname ?  arg.ibzprojectteamname :'';
