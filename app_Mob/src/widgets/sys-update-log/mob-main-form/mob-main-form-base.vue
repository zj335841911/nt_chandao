<template>
    <div ref='form' class="app-form sysupdatelog-form ">
...
<app-form-item 
    ...
    :isEmptyCaption="true">
        <app-mob-rich-text-editor-pms :formState="formState" :isInfoFormMode="true"  :value="data.updesc" @change="(val) =>{this.data.updesc =val}" :disabled="detailsModel.updesc.disabled" :data="JSON.stringify(this.data)"  name="updesc" :uploadparams='{}' :exportparams='{}'  style=""  @noticeusers_change="(val)=>{this.data.noticeusers =val}"/>
...
<app-form-druipart
    class='' 
    parameterName='sysupdatelog' 
    refviewtype='DEMOBMDVIEW9'  
    refreshitems='' 
    viewname='sys-update-features-mob-mdview9' 
    v-show="detailsModel.druipart1.visible" 
    :caption="$t('sysupdatelog.mobmain_form.details.druipart1')"  
    paramItem='sysupdatelog' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdefname":"SYS_UPDATE_LOGID","srfparentdename":"SYS_UPDATE_LOG","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_SYS_UPDATE_FEATURES_SYS_UPDATE_LOG_SYS_UPDATE_LOGID","SRFDER1NID":"DER1N_SYS_UPDATE_FEATURES_SYS_UPDATE_LOG_SYS_UPDATE_LOGID"}' 
    :parameters="[
...
<app-form-druipart
    ...
    refviewtype='DEMOBMDVIEW9'  
    refreshitems='' 
    viewname='sys-update-features-ymob-mdview9' 
    v-show="detailsModel.druipart2.visible" 
    :caption="$t('sysupdatelog.mobmain_form.details.druipart2')"  
    paramItem='sysupdatelog' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdefname":"SYS_UPDATE_LOGID","srfparentdename":"SYS_UPDATE_LOG","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_SYS_UPDATE_FEATURES_SYS_UPDATE_LOG_SYS_UPDATE_LOGID","SRFDER1NID":"DER1N_SYS_UPDATE_FEATURES_SYS_UPDATE_LOG_SYS_UPDATE_LOGID"}' 
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '功能增强', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'sysupdatelog.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '优化', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'sysupdatelog.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '系统更新日志基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'sysupdatelog.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '系统更新日志标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '更新名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    /**
     * 监控表单属性 sys_update_logname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobMain
     */
    @Watch('data.sys_update_logname')
    onSys_update_lognameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'sys_update_logname', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.update')
    onUpdateChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'update', newVal: newVal, oldVal: oldVal });
    }
     ...
     */
    @Watch('data.updesc')
    onUpdescChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'updesc', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 sys_update_logid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobMain
     */
    @Watch('data.sys_update_logid')
    onSys_update_logidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'sys_update_logid', newVal: newVal, oldVal: oldVal });
    }
    ...
    protected async loadDraft(opt: any = {}): Promise<any> {
        ...
        if (response && response.status === 200) {
            const data = response.data;
            if(data.sysupdatelog){
                Object.assign(this.context, { sysupdatelog: data.sysupdatelog });
            }
    ...
    protected async save(opt: any = {}, showResultInfo?: boolean, isStateNext: boolean = true): Promise<any> {
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"SysUpdateLog",action:'appRefresh',data:Object.assign(data,{appRefreshAction:action===this.createAction?false:true})});
            this.$store.dispatch('viewaction/datasaved', { viewtag: this.viewtag });
            this.$nextTick(() => {
                this.formState.next({ type: 'save', data: data });
            });
