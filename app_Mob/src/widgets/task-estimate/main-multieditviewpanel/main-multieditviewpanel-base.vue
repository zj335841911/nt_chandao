<template>
<div class="app-mob-meditviewpanel taskestimate-meditviewpanel ">
...
import MainService from '@/app-core/ctrl-service/task-estimate/main-multieditviewpanel-service';
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    private doItems(datas: any[]): void {
        ...
        datas.forEach((arg: any) => {
            ...
            let title :string = arg.taskestimatename ?  arg.taskestimatename :'';
