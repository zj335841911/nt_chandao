...
<app-form-item 
    ...
    :caption="$t('taskestimate.newform_form.details.date')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('taskestimate.newform_form.details.consumed')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('taskestimate.newform_form.details.left')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('taskestimate.newform_form.details.work')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import NewFormService from '@/app-core/ctrl-service/task-estimate/new-form-form-service';
