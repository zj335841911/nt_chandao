        ...
        <app-mob-context-menu :value="contextMenuShowStatus" @change="(val)=>{this.contextMenuShowStatus=val}">
         <div slot="content" >
            ...
            <div v-if="activeNode == 'Doc'">
                        ...
                        <div class="context-menu-item" name='deuiaction1'  @click="doc_cm_click({tag: $event})">
                                    <ion-icon name="star-outline"></ion-icon>
                            
                        </div>
                        
                        <div class="context-menu-item" name='deuiaction2'  @click="doc_cm_click({tag: $event})">
                                    <ion-icon name="star"></ion-icon>
            ...
            <div v-if="activeNode == 'Module'">
                        ...
                        <div class="context-menu-item" name='deuiaction1'  @click="module_cm_click({tag: $event})">
                                    <ion-icon name="star"></ion-icon>
                            
                        </div>
                        
                        <div class="context-menu-item" name='deuiaction2'  @click="module_cm_click({tag: $event})">
                                    <ion-icon name="star-outline"></ion-icon>
...
export default class DocLibTreeProductMobBase extends Vue implements ControlInterface {
    ...
    protected file_cm_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1')) {
            this.file_cm_deuiaction1_click($event, 'file_cm', $event2);
        }
        if (Object.is($event.tag, 'deuiaction2')) {
     ...
     * @memberof TreeBase
     */
    protected async file_cm_deuiaction1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        // 参数
        ...
        if (curUIService) {
            curUIService.File_Look(datas, contextJO, paramJO, $event, xData, this);
        }
    }
