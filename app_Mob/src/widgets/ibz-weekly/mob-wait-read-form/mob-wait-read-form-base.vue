<template>
    <div ref='form' class="app-form ibzweekly-form ">
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobwaitread_form.details.account')"  
    :labelWidth="0"  
    :isShowCaption="false"
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="TOP" 
    ref="plannextweek_item"  
    :itemValue="this.data.plannextweek" 
...
<app-form-druipart
    ...
    :caption="$t('ibzweekly.mobwaitread_form.details.druipart3')"  
    paramItem='ibzweekly' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"IBZ_WEEKLY","SRFPARENTTYPE":"CUSTOM"}' 
...
<app-form-druipart
    ...
    :caption="$t('ibzweekly.mobwaitread_form.details.druipart4')"  
    paramItem='ibzweekly' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"IBZ_WEEKLY","SRFPARENTTYPE":"CUSTOM"}' 
...
export default class MobWaitReadBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobWaitReadService}
     * @memberof MobWaitRead
     */
    protected service: MobWaitReadService = new MobWaitReadService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '完成的任务', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzweekly.mobwaitread_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '下周计划参与', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzweekly.mobwaitread_form', extractMode: 'ITEM', details: [] } })
, 
        druipart3: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart3', visible: true, isShowCaption: true, form: this })
, 
        grouppanel3: new FormGroupPanelModel({ caption: '附件', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzweekly.mobwaitread_form', extractMode: 'ITEM', details: [] } })
, 
        druipart4: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart4', visible: true, isShowCaption: true, form: this })
, 
        grouppanel4: new FormGroupPanelModel({ caption: '操作历史', detailType: 'GROUPPANEL', name: 'grouppanel4', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzweekly.mobwaitread_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '周报基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'ibzweekly.mobwaitread_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '周报标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '周报名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ibz_weeklyname: new FormItemModel({ caption: '周报名称', detailType: 'FORMITEM', name: 'ibz_weeklyname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        workthisweek: new FormItemModel({ caption: '本周工作', detailType: 'FORMITEM', name: 'workthisweek', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        plannextweek: new FormItemModel({ caption: '下周计划', detailType: 'FORMITEM', name: 'plannextweek', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    /**
     * 监控表单属性 ibz_weeklyname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobWaitRead
     */
    @Watch('data.ibz_weeklyname')
    onIbz_weeklynameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ibz_weeklyname', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 workthisweek 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobWaitRead
     */
    @Watch('data.workthisweek')
    onWorkthisweekChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'workthisweek', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 plannextweek 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobWaitRead
     */
    @Watch('data.plannextweek')
    onPlannextweekChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'plannextweek', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 thisweektask 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MobWaitRead
     */
    @Watch('data.thisweektask')
    onThisweektaskChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'thisweektask', newVal: newVal, oldVal: oldVal });
    }
     ...
     * @memberof MobWaitRead
     */
    @Watch('data.ibz_weeklyid')
    onIbz_weeklyidChange(newVal: any, oldVal: any) {
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`ibzweekly.mobwaitread_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
    ...
    protected async loadDraft(opt: any = {}): Promise<any> {
        ...
        if (response && response.status === 200) {
            const data = response.data;
            if(data.ibzweekly){
                Object.assign(this.context, { ibzweekly: data.ibzweekly });
            }
    ...
    protected async save(opt: any = {}, showResultInfo?: boolean, isStateNext: boolean = true): Promise<any> {
        ...
        Object.assign(this.viewparams,{ ibzweeklyname: arg.ibzweeklyname});
        Object.assign(arg, this.viewparams);
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"IbzWeekly",action:'appRefresh',data:Object.assign(data,{appRefreshAction:action===this.createAction?false:true})});
            this.$store.dispatch('viewaction/datasaved', { viewtag: this.viewtag });
            this.$nextTick(() => {
                this.formState.next({ type: 'save', data: data });
            });
    ...
    private async remove(opt: Array<any> = [], showResultInfo?: boolean): Promise<any> {
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"IbzWeekly",action:'appRefresh',data:data});
...
<style lang='less'>
@import './mob-wait-read-form.less';
</style>