...
import Usr2MobTabExpViewtabviewpanel3Service from '@/app-core/ctrl-service/ibz-weekly/usr2-mob-tab-exp-viewtabviewpanel3-tabviewpanel-service';
...
export default class Usr2MobTabExpViewtabviewpanel3Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Usr2MobTabExpViewtabviewpanel3
     */
     ...
     *
     * @param {any} args
     * @memberof  Usr2MobTabExpViewtabviewpanel3Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {Usr2MobTabExpViewtabviewpanel3Service}
     * @memberof Usr2MobTabExpViewtabviewpanel3
     */
    protected service: Usr2MobTabExpViewtabviewpanel3Service = new Usr2MobTabExpViewtabviewpanel3Service({$store:this.$store});
...
<style lang='less'>
@import './usr2-mob-tab-exp-viewtabviewpanel3-tabviewpanel.less';
</style>