...
import WeeklyMyReceviedService from '@/app-core/ctrl-service/ibz-weekly/weekly-my-recevied-mobmdctrl-service';
...
export default class WeeklyMyReceviedBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {WeeklyMyReceviedService}
     * @memberof WeeklyMyRecevied
     */
    protected service: WeeklyMyReceviedService = new WeeklyMyReceviedService({$store:this.$store});
...
<style lang='less'>
@import './weekly-my-recevied-mobmdctrl.less';
</style>