...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="thisweektask_item"  
    :itemValue="this.data.thisweektask" 
    v-show="detailsModel.thisweektask.visible" 
    :itemRules="this.rules.thisweektask" 
    :caption="$t('ibzweekly.mobweekedit_form.details.thisweektask')"  
    :labelWidth="130"  
    :isShowCaption="true"
    :disabled="detailsModel.thisweektask.disabled"
    :error="detailsModel.thisweektask.error" 
    ...
    :value="data.thisweektask"   
    :navigateContext ='{ "date": "%date%" } '
    :navigateParam ='{ "date": "%date%" } '
    @change="($event)=>this.data.thisweektask = $event"/>
</app-form-item>
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobweekedit_form.details.workthisweek')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="nextweektask_item"  
    :itemValue="this.data.nextweektask" 
    v-show="detailsModel.nextweektask.visible" 
    :itemRules="this.rules.nextweektask" 
    :caption="$t('ibzweekly.mobweekedit_form.details.nextweektask')"  
    :labelWidth="130"  
    :isShowCaption="true"
    :disabled="detailsModel.nextweektask.disabled"
    :error="detailsModel.nextweektask.error" 
    :isEmptyCaption="false">
        <app-mob-check-list 
    type="dynamic"  
    tag="MyPlanTask"
    ...
    :context="context"
    :viewparams="viewparams"
    :value="data.nextweektask"   
    :navigateContext ='{ } '
    :navigateParam ='{ } '
    @change="($event)=>this.data.nextweektask = $event"/>
</app-form-item>
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobweekedit_form.details.plannextweek')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobweekedit_form.details.comment')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobweekedit_form.details.files')"  
    :labelWidth="130"  
    :isShowCaption="true"
    ...
    :context="context" 
    :viewparams="viewparams" 
    :uploadParam='{objecttype:"weekly",objectid:"0",version:"1"}' 
    :exportParam='{objecttype:"weekly",objectid:"0",version:"1"}' 
...
export default class MobWeekEditBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobWeekEditService}
     * @memberof MobWeekEdit
     */
    protected service: MobWeekEditService = new MobWeekEditService({$store:this.$store});
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`ibzweekly.mobweekedit_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
...
<style lang='less'>
@import './mob-week-edit-form.less';
</style>