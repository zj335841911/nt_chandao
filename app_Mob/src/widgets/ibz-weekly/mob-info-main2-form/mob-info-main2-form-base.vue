...
<app-form-group 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.account')"  
    :labelWidth="0"  
    :isShowCaption="false"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.date')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.workthisweek')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.plannextweek')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.comment')"  
    :labelWidth="130"  
    :isShowCaption="true"
    :disabled="detailsModel.comment.disabled"
    :error="detailsModel.comment.error" 
    :isEmptyCaption="false">
        <app-mob-rich-text-editor-pms :formState="formState" :isInfoFormMode="true"  :value="data.comment" @change="(val) =>{this.data.comment =val}" :disabled="detailsModel.comment.disabled" :data="JSON.stringify(this.data)"  name="comment" :uploadparams='{}' :exportparams='{}'  style=""  @noticeusers_change="(val)=>{this.data.noticeusers =val}"/>
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.reportto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.mailto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('ibzweekly.mobinfomain2_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
export default class MobInfoMain2Base extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobInfoMain2Service}
     * @memberof MobInfoMain2
     */
    protected service: MobInfoMain2Service = new MobInfoMain2Service({$store:this.$store});
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`ibzweekly.mobinfomain2_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof MobInfoMain2
     */
...
<style lang='less'>
@import './mob-info-main2-form.less';
</style>