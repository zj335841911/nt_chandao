...
import Usr2MobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/ibz-weekly/usr2-mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
...
export default class Usr2MobTabExpViewtabviewpanel2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Usr2MobTabExpViewtabviewpanel2
     */
     ...
     *
     * @param {any} args
     * @memberof  Usr2MobTabExpViewtabviewpanel2Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {Usr2MobTabExpViewtabviewpanel2Service}
     * @memberof Usr2MobTabExpViewtabviewpanel2
     */
    protected service: Usr2MobTabExpViewtabviewpanel2Service = new Usr2MobTabExpViewtabviewpanel2Service({$store:this.$store});
...
<style lang='less'>
@import './usr2-mob-tab-exp-viewtabviewpanel2-tabviewpanel.less';
</style>