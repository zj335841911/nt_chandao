...
import Usr2MobTabExpViewMyReceivedtabviewpanel2Service from '@/app-core/ctrl-service/ibz-weekly/usr2-mob-tab-exp-view-my-receivedtabviewpanel2-tabviewpanel-service';
...
export default class Usr2MobTabExpViewMyReceivedtabviewpanel2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Usr2MobTabExpViewMyReceivedtabviewpanel2
     */
     ...
     *
     * @param {any} args
     * @memberof  Usr2MobTabExpViewMyReceivedtabviewpanel2Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {Usr2MobTabExpViewMyReceivedtabviewpanel2Service}
     * @memberof Usr2MobTabExpViewMyReceivedtabviewpanel2
     */
    protected service: Usr2MobTabExpViewMyReceivedtabviewpanel2Service = new Usr2MobTabExpViewMyReceivedtabviewpanel2Service({$store:this.$store});
...
<style lang='less'>
@import './usr2-mob-tab-exp-view-my-receivedtabviewpanel2-tabviewpanel.less';
</style>