<template>
    <div class='app-tab-view-panel productplan-tabviewpanel3 ' v-if='isActivied' >
        <story-usr2-mob-mdview-5219 
...
import MobTabExpViewtabviewpanel3Service from '@/app-core/ctrl-service/product-plan/mob-tab-exp-viewtabviewpanel3-tabviewpanel-service';
