<template>
    <div class='app-tab-view-panel productplan-tabviewpanel4 ' v-if='isActivied' >
        <product-plan-mob-edit-view 
...
import MobTabExpViewtabviewpanel4Service from '@/app-core/ctrl-service/product-plan/mob-tab-exp-viewtabviewpanel4-tabviewpanel-service';
