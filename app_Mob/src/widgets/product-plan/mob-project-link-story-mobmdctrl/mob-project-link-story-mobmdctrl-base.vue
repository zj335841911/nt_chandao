<template>
    <div  class="app-mob-mdctrl productplan-mdctrl ">
...
import MOB_ProjectLinkStoryService from '@/app-core/ctrl-service/product-plan/mob-project-link-story-mobmdctrl-service';
...
export default class MOB_ProjectLinkStoryBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MOB_ProjectLinkStoryBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MOB_ProjectLinkStoryService}
     * @memberof MOB_ProjectLinkStory
     */
    protected service: MOB_ProjectLinkStoryService = new MOB_ProjectLinkStoryService({$store:this.$store});
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { productplan: keys.join(';') }
...
<style lang='less'>
@import './mob-project-link-story-mobmdctrl.less';
</style>