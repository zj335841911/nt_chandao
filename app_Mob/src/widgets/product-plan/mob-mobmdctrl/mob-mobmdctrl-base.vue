...
import MobService from '@/app-core/ctrl-service/product-plan/mob-mobmdctrl-service';
...
export default class MobBase extends Vue implements ControlInterface {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u4cc60c1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_ub4c88f1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u4cc60c1')) {
            this.mdctrl_u4cc60c1_click();
        }
        if (Object.is(tag, 'ub4c88f1')) {
            this.mdctrl_ub4c88f1_click();
        }
   ...
   /**
    ...
    public ActionModel:any ={
        MobMainEdit: { name: 'MobMainEdit',disabled: false, visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__PROP_EDIT_BUT', target: 'SINGLEKEY',icon:'edit',isShowCaption:false,isShowIcon:true},
        MobDelete: { name: 'MobDelete',disabled: false, visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__PROP_DELETE_BUT', target: 'SINGLEKEY',icon:'remove',isShowCaption:false,isShowIcon:true}
    };
