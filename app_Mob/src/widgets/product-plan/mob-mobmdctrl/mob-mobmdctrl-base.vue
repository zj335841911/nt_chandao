...
export default class MobBase extends Vue implements ControlInterface {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u4512a67_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_uc88df6f_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.productplanid, value)) {
                if (detail.checked) {
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u4512a67')) {
            this.mdctrl_u4512a67_click();
        }
        if (Object.is(tag, 'uc88df6f')) {
            this.mdctrl_uc88df6f_click();
        }
        this.closeSlidings();
    }
