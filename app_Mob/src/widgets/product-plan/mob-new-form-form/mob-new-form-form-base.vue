...
<app-form-group 
    ...
    :caption="$t('productplan.mobnewform_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('productplan.mobnewform_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('productplan.mobnewform_form.details.branch')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('productplan.mobnewform_form.details.title')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('productplan.mobnewform_form.details.grouppanel2')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('productplan.mobnewform_form.details.begin')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('productplan.mobnewform_form.details.end')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :isEmptyCaption="false">
        <app-mob-rich-text-editor :formState="formState" :value="data.desc" @change="(val) =>{this.data.desc =val}" :disabled="detailsModel.desc.disabled" :data="JSON.stringify(this.data)"  name="desc" :uploadparams='{objecttype:"productplan",version:"editor"}' :exportparams='{objecttype:"productplan",version:"editor"}'  style=""/>
...
export default class MobNewFormBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        grouppanel2: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'productplan.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'productplan.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'productplan基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'productplan.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        future: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'future', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    protected async save(opt: any = {}, showResultInfo?: boolean, isStateNext: boolean = true): Promise<any> {
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"ProductPlan",action:'appRefresh',data:Object.assign(data,{appRefreshAction:action===this.createAction?false:true})});
            this.$store.dispatch('viewaction/datasaved', { viewtag: this.viewtag });
            this.$nextTick(() => {
                this.formState.next({ type: 'save', data: data });
            });
