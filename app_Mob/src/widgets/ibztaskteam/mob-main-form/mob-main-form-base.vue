...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        srfmajortext: [
            { type: 'string', message: '用户 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户 值必须为字符串类型', trigger: 'blur' },
        ...
        type: [
            { type: 'string', message: '团队类型 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '团队类型 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '团队类型 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '团队类型 值不能为空', trigger: 'blur' },
        ],
        account: [
            { type: 'string', message: '用户 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户 值必须为字符串类型', trigger: 'blur' },
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['account_item', 'estimate_item', ];
        let falg = true;
