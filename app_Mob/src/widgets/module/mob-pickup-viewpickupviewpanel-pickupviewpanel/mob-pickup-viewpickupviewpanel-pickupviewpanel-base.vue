<template>
    <div class='pickupviewpanel module-pickupviewpanel'>
        <component 
...
import ModuleEntityService from '@/app-core/service/module/module-service';
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/module/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     * @memberof MobPickupViewpickupviewpanel
     */
    protected appEntityService: ModuleEntityService = new ModuleEntityService();
     ...
     * @memberof MobPickupViewpickupviewpanelBase
     */  
    public deUIService:ModuleUIService = new ModuleUIService(this.$store);
     ...
     */
    protected view: any = {
        viewname: 'module-mob-pickup-mdview',
        data: {},
    }
