<template>
    <div  class="app-mob-mdctrl module-mdctrl ">
...
import MobService from '@/app-core/ctrl-service/module/mob-mobmdctrl-service';
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { module: keys.join(';') }
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.moduleid, value)) {
                if (detail.checked) {
