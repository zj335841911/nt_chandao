<template>
    <div class='pickupviewpanel projectmodule-pickupviewpanel'>
        <component 
...
import ProjectModuleEntityService from '@/app-core/service/project-module/project-module-service';
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/project-module/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     * @memberof MobPickupViewpickupviewpanel
     */
    protected appEntityService: ProjectModuleEntityService = new ProjectModuleEntityService();
     ...
     * @memberof MobPickupViewpickupviewpanelBase
     */  
    public deUIService:ProjectModuleUIService = new ProjectModuleUIService(this.$store);
     ...
     */
    protected view: any = {
        viewname: 'project-module-mob-pickup-mdview',
        data: {},
    }
