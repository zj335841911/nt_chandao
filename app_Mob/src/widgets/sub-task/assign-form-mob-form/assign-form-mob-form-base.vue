...
<app-form-group 
    ...
    :caption="$t('subtask.assignformmob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('subtask.assignformmob_form.details.assignedto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.assignformmob_form.details.left')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.assignformmob_form.details.comment')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('subtask.assignformmob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import AssignFormMobService from '@/app-core/ctrl-service/sub-task/assign-form-mob-form-service';
...
export default class AssignFormMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {AssignFormMobService}
     * @memberof AssignFormMob
     */
    protected service: AssignFormMobService = new AssignFormMobService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.assignformmob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '任务基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.assignformmob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['assignedto_item', 'left_item', 'comment_item', ];
        let falg = true;
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof AssignFormMob
     */
...
<style lang='less'>
@import './assign-form-mob-form.less';
</style>