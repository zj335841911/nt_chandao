...
<app-form-group 
    ...
    :caption="$t('subtask.mobmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.projectname')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.modulename')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.name')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.type')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.assignedto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.assigneddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('subtask.mobmain_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.status')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.pri')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.estimate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.consumed')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.left')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.eststarted')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.realstarted')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.deadline')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.finishedby')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.closedby')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.closeddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.closedreason')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobmain_form.details.desc')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('subtask.mobmain_form.details.grouppanel2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import MobMainService from '@/app-core/ctrl-service/sub-task/mob-main-form-service';
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'subtask.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '任务基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        desc: new FormItemModel({ caption: '任务描述', detailType: 'FORMITEM', name: 'desc', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 0 })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['projectname_item', 'modulename_item', 'name_item', 'type_item', 'assignedto_item', 'assigneddate_item', 'status_item', 'pri_item', 'estimate_item', 'consumed_item', 'left_item', 'eststarted_item', 'realstarted_item', 'deadline_item', 'finishedby_item', 'closedby_item', 'closeddate_item', 'closedreason_item', 'desc_item', ];
        let falg = true;
