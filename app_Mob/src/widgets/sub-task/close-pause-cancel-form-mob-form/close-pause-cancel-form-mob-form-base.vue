...
<app-form-group 
    ...
    :caption="$t('subtask.closepausecancelformmob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('subtask.closepausecancelformmob_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('subtask.closepausecancelformmob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import ClosePauseCancelFormMobService from '@/app-core/ctrl-service/sub-task/close-pause-cancel-form-mob-form-service';
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.closepausecancelformmob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '任务基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.closepausecancelformmob_form', extractMode: 'ITEM', details: [] } })
, 
