<template>
    <div  class="app-mob-mdctrl subtask-mdctrl ">
...
import Mob_3335Service from '@/app-core/ctrl-service/sub-task/mob-3335-mobmdctrl-service';
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { subtask: keys.join(';') }
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.subtaskid, value)) {
                if (detail.checked) {
