<template>
    <div ref='searchform' class="app-form subtask-searchform ">
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_name_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_type_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_status_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_projectname_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_closeddate_ltandeq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('subtask.mobdef_searchform.details.n_finisheddate_ltandeq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobDefService from '@/app-core/ctrl-service/sub-task/mob-def-searchform-service';
