...
<app-form-group 
    ...
    :caption="$t('subtask.estimatemob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
import EstimateMobService from '@/app-core/ctrl-service/sub-task/estimate-mob-form-service';
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '工时', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.estimatemob_form', extractMode: 'ITEM', details: [] } })
, 
