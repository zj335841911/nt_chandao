<template>
    <div class='pickupviewpanel subtask-pickupviewpanel'>
        <component 
...
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/sub-task/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'task-mob-pickup-mdview',
        data: {},
    }
