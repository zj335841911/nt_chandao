<template>
    <div ref='form' class="app-form subtask-form ">
...
<app-form-group 
    ...
    :caption="$t('subtask.mobstartform_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('subtask.mobstartform_form.details.realstarted')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobstartform_form.details.consumed')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobstartform_form.details.left')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('subtask.mobstartform_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('subtask.mobstartform_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import MobStartFormService from '@/app-core/ctrl-service/sub-task/mob-start-form-form-service';
...
export default class MobStartFormBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobStartFormService}
     * @memberof MobStartForm
     */
    protected service: MobStartFormService = new MobStartFormService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.mobstartform_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '任务基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'subtask.mobstartform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['realstarted_item', 'consumed_item', 'left_item', 'comment_item', ];
        let falg = true;
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof MobStartForm
     */
    ...
    protected async loadDraft(opt: any = {}): Promise<any> {
        ...
        if (response && response.status === 200) {
            const data = response.data;
            if(data.subtask){
                Object.assign(this.context, { subtask: data.subtask });
            }
    ...
    protected async save(opt: any = {}, showResultInfo?: boolean, isStateNext: boolean = true): Promise<any> {
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"SubTask",action:'appRefresh',data:data});
            this.$store.dispatch('viewaction/datasaved', { viewtag: this.viewtag });
            this.$nextTick(() => {
                this.formState.next({ type: 'save', data: data });
            });
...
<style lang='less'>
@import './mob-start-form-form.less';
</style>