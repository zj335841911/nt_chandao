...
<app-form-group 
    ...
    :caption="$t('case.createmob_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('case.createmob_form.details.title')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('case.createmob_form.details.type')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('case.createmob_form.details.stage')"  
    :labelWidth="130"  
    :isShowCaption="true"
    ...
    :navigateContext ='{ } '
    :navigateParam ='{ } '
    @change="($event)=>this.data.stage = $event"/>
</app-form-item>
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="precondition_item"  
    :itemValue="this.data.precondition" 
    v-show="detailsModel.precondition.visible" 
    :itemRules="this.rules.precondition" 
    :caption="$t('case.createmob_form.details.precondition')"  
    :labelWidth="130"  
    :isShowCaption="true"
    ...
    :disabled="detailsModel.precondition.disabled" 
    @change="($event)=>this.data.precondition = $event" />
</app-form-item>
...
<app-form-item 
    ...
    :caption="$t('case.createmob_form.details.keywords')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import CreatemobService from '@/app-core/ctrl-service/case/createmob-form-service';
...
export default class CreatemobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {CreatemobService}
     * @memberof Createmob
     */
    protected service: CreatemobService = new CreatemobService({$store:this.$store});
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`case.createmob_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
