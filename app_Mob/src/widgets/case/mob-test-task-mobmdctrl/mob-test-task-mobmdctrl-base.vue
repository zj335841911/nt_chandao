...
import Mob_TestTaskService from '@/app-core/ctrl-service/case/mob-test-task-mobmdctrl-service';
...
export default class Mob_TestTaskBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof Mob_TestTask
     */
     ...
     * 建构部件服务对象
     *
     * @type {Mob_TestTaskService}
     * @memberof Mob_TestTask
     */
    protected service: Mob_TestTaskService = new Mob_TestTaskService({$store:this.$store});
...
<style lang='less'>
@import './mob-test-task-mobmdctrl.less';
</style>