...
<app-form-item 
    ...
    :caption="$t('case.mobdef_searchform.details.n_modulename_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
, 
    ...
    protected formValidateStatus(): boolean {
        const refArr: Array<string> = ['n_title_like_item', 'n_type_eq_item', 'n_status_eq_item', 'n_modulename_like_item', ];
        let falg = true;
