...
import MOB_ReleaseLink_reBugService from '@/app-core/ctrl-service/bug/mob-release-link-re-bug-mobmdctrl-service';
...
export default class MOB_ReleaseLink_reBugBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MOB_ReleaseLink_reBugBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MOB_ReleaseLink_reBugService}
     * @memberof MOB_ReleaseLink_reBug
     */
    protected service: MOB_ReleaseLink_reBugService = new MOB_ReleaseLink_reBugService({$store:this.$store});
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u876f801_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u876f801')) {
            this.mdctrl_u876f801_click();
        }
...
<style lang='less'>
@import './mob-release-link-re-bug-mobmdctrl.less';
</style>