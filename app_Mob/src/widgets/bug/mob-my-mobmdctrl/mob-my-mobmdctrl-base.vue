...
​           Object.assign(data,this.sort);
   ...
   /**
    ...
    public ActionModel:any ={
        ...
        ConfirmBugMob: { name: 'ConfirmBugMob',disabled: false, visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__BUG_CONFIRM_BUT', target: 'SINGLEKEY',icon:'fa fa-check-square-o',isShowCaption:false,isShowIcon:true},
        ActivationMob: { name: 'ActivationMob',disabled: false, visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__BUG_ACTIVATE_BUT', target: 'SINGLEKEY',icon:'pin',isShowCaption:false,isShowIcon:true},
