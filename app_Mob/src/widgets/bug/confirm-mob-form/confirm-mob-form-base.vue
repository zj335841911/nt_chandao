...
<app-form-group 
    ...
    :caption="$t('bug.confirmmob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('bug.confirmmob_form.details.assignedto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('bug.confirmmob_form.details.type')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('bug.confirmmob_form.details.pri')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('bug.confirmmob_form.details.mailto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('bug.confirmmob_form.details.grouppanel6')" 
    :isShowCaption="true" 
    :titleBarCloseMode="1" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
import ConfirmMobService from '@/app-core/ctrl-service/bug/confirm-mob-form-service';
...
export default class ConfirmMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {ConfirmMobService}
     * @memberof ConfirmMob
     */
    protected service: ConfirmMobService = new ConfirmMobService({$store:this.$store});
...
, 
        grouppanel6: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel6', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'bug.confirmmob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'Bug基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.confirmmob_form', extractMode: 'ITEM', details: [] } })
, 
