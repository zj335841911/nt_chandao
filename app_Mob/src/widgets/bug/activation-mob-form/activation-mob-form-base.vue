...
<app-form-group 
    ...
    :caption="$t('bug.activationmob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('bug.activationmob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('bug.activationmob_form.details.files')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('bug.activationmob_form.details.grouppanel6')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
import ActivationMobService from '@/app-core/ctrl-service/bug/activation-mob-form-service';
...
export default class ActivationMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {ActivationMobService}
     * @memberof ActivationMob
     */
    protected service: ActivationMobService = new ActivationMobService({$store:this.$store});
    ...
    protected detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.activationmob_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel6: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel6', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'bug.activationmob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'Bug基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.activationmob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof ActivationMob
     */
...
<style lang='less'>
@import './activation-mob-form.less';
</style>