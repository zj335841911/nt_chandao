...
import Usr3MobMPickupBuildCreateBugViewpickupviewpanelService from '@/app-core/ctrl-service/bug/usr3-mob-mpickup-build-create-bug-viewpickupviewpanel-pickupviewpanel-service';
...
export default class Usr3MobMPickupBuildCreateBugViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     *
     * @type {string}
     * @memberof Usr3MobMPickupBuildCreateBugViewpickupviewpanel
     */
     ...
     *
     * @param {any} args
     * @memberof  Usr3MobMPickupBuildCreateBugViewpickupviewpanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {Usr3MobMPickupBuildCreateBugViewpickupviewpanelService}
     * @memberof Usr3MobMPickupBuildCreateBugViewpickupviewpanel
     */
    protected service: Usr3MobMPickupBuildCreateBugViewpickupviewpanelService = new Usr3MobMPickupBuildCreateBugViewpickupviewpanelService({$store:this.$store});
     ...
     */
    protected view: any = {
        viewname: 'bug-usr3-mob-pickup-build-resolved-mdview',
        data: {},
    }
...
<style lang='less'>
@import './usr3-mob-mpickup-build-create-bug-viewpickupviewpanel-pickupviewpanel.less';
</style>