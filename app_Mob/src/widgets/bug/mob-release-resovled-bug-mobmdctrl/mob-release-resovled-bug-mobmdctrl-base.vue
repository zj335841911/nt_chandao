...
import MOB_Release_ResovledBugService from '@/app-core/ctrl-service/bug/mob-release-resovled-bug-mobmdctrl-service';
...
export default class MOB_Release_ResovledBugBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MOB_Release_ResovledBug
     */
     ...
     *
     * @param {any} args
     * @memberof  MOB_Release_ResovledBugBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MOB_Release_ResovledBugService}
     * @memberof MOB_Release_ResovledBug
     */
    protected service: MOB_Release_ResovledBugService = new MOB_Release_ResovledBugService({$store:this.$store});
...
<style lang='less'>
@import './mob-release-resovled-bug-mobmdctrl.less';
</style>