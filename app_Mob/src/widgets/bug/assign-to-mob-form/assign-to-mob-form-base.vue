...
<app-form-group 
    ...
    :caption="$t('bug.assigntomob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('bug.assigntomob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-group 
    ...
    :caption="$t('bug.assigntomob_form.details.grouppanel6')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('bug.assigntomob_form.details.druipart1')"  
    paramItem='bug' 
    style="" 
    :formState="formState" 
...
import AssignToMobService from '@/app-core/ctrl-service/bug/assign-to-mob-form-service';
...
export default class AssignToMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {AssignToMobService}
     * @memberof AssignToMob
     */
    protected service: AssignToMobService = new AssignToMobService({$store:this.$store});
    ...
    protected detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.assigntomob_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel6: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel6', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.assigntomob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'Bug基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'bug.assigntomob_form', extractMode: 'ITEM', details: [] } })
, 
...
<style lang='less'>
@import './assign-to-mob-form.less';
</style>