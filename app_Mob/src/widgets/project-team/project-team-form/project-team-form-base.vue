...
<app-form-group 
    ...
    :caption="$t('projectteam.projectteam_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.account')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.role')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.join')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.days')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.hours')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.total')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('projectteam.projectteam_form.details.limited')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
import ProjectTeamService from '@/app-core/ctrl-service/project-team/project-team-form-service';
...
export default class ProjectTeamBase extends Vue implements ControlInterface {
     ...
     * @memberof ProjectTeam
     */
    protected service: ProjectTeamService = new ProjectTeamService({$store:this.$store});
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '项目团队基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'projectteam.projectteam_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`projectteam.projectteam_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
