...
<app-form-druipart
    class='' 
    parameterName='projectteam' 
    refviewtype='DEMOBMEDITVIEW9'  
    refreshitems='' 
    viewname='project-team-project-team-mob-medit-view' 
    v-show="detailsModel.druipart1.visible" 
    :caption="$t('projectteam.projectteamrelation_form.details.druipart1')"  
    paramItem='projectteam' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"IBZ_PROJECTTEAM","SRFPARENTTYPE":"CUSTOM"}' 
    :parameters="[
...
import ProjectTeamRelationService from '@/app-core/ctrl-service/project-team/project-team-relation-form-service';
...
export default class ProjectTeamRelationBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof ProjectTeamRelation
     */
     ...
     *
     * @param {any} args
     * @memberof  ProjectTeamRelationBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {ProjectTeamRelationService}
     * @memberof ProjectTeamRelation
     */
    protected service: ProjectTeamRelationService = new ProjectTeamRelationService({$store:this.$store});
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`projectteam.projectteamrelation_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof ProjectTeamRelation
     */
...
<style lang='less'>
@import './project-team-relation-form.less';
</style>