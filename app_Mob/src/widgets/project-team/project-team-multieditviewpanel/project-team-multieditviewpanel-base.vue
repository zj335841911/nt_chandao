<template>
<div class="app-mob-meditviewpanel projectteam-meditviewpanel ">
...
import ProjectTeamService from '@/app-core/ctrl-service/project-team/project-team-multieditviewpanel-service';
...
export default class ProjectTeamBase extends Vue implements ControlInterface {
    ...
    private doItems(datas: any[]): void {
        ...
        datas.forEach((arg: any) => {
            ...
            let title :string = arg.projectteamname ?  arg.projectteamname :'';
...
<style lang='less'>
@import './project-team-multieditviewpanel.less';
</style>
