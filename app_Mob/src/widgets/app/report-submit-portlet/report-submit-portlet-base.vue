    ...
    <ion-row>
        <ion-list class='app-mob-portlet  '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>我提交的</span></span>
...
import ReportSubmitService from '@/app-core/ctrl-service/app/report-submit-portlet-service';
...
<style lang='less'>
@import './report-submit-portlet.less';
</style>