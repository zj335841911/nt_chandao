    ...
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container6 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`${this.localeDeName}.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container6_portlet`)}}</span></span>
...
import MobDashboardViewdashboard_container6Service from '@/app-core/ctrl-service/ibz-my-territory/mob-dashboard-viewdashboard-container6-portlet-service';
...
export default class MobDashboardViewdashboard_container6Base extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MobDashboardViewdashboard_container6Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobDashboardViewdashboard_container6Service}
     * @memberof MobDashboardViewdashboard_container6
     */
    protected service: MobDashboardViewdashboard_container6Service = new MobDashboardViewdashboard_container6Service({$store:this.$store});
    ...
    get editTitle(){
        ...
        return (this.$t(`app.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container6_portlet`) as string)
    }
...
<style lang='less'>
@import './mob-dashboard-viewdashboard-container6-portlet.less';
</style>