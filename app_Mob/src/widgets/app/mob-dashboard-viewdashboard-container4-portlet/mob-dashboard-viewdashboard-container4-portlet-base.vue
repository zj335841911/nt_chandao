<template>
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container4 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`${this.localeDeName}.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container4_portlet`)}}</span></span>
            ...
            <div class="edit_title_btn" :style="edit_title_btn">
                ...
                <div>dashboard_container4类型CONTAINER不提供内容输出</div>
        </ion-list>
...
export default class MobDashboardViewdashboard_container4Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MobDashboardViewdashboard_container4
     */
     ...
     *
     * @param {any} args
     * @memberof  MobDashboardViewdashboard_container4Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobDashboardViewdashboard_container4Service}
     * @memberof MobDashboardViewdashboard_container4
     */
    protected service: MobDashboardViewdashboard_container4Service = new MobDashboardViewdashboard_container4Service({$store:this.$store});
    ...
    get editTitle(){
        ...
        return (this.$t(`app.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container4_portlet`) as string)
    }
...
<style lang='less'>
@import './mob-dashboard-viewdashboard-container4-portlet.less';
</style>