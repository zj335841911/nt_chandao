...
import MyTaskFavMobService from '@/app-core/ctrl-service/ibz-my-territory/my-task-fav-mob-portlet-service';
...
export default class MyTaskFavMobBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MyTaskFavMob
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyTaskFavMobService}
     * @memberof MyTaskFavMob
     */
    protected service: MyTaskFavMobService = new MyTaskFavMobService({$store:this.$store});
...
<style lang='less'>
@import './my-task-fav-mob-portlet.less';
</style>