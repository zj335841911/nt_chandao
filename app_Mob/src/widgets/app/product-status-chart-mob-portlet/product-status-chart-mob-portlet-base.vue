    ...
    <ion-row>
        <ion-list class='app-mob-portlet product-dashboard_sysportlet8 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`product${this.viewName.toLowerCase()}.productstatuschartmob_portlet`)}}</span></span>
