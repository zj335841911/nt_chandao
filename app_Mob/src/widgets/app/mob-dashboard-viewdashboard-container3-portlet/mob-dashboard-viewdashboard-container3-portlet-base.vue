<template>
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container3 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`ibzmyterritory${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container3_portlet`)}}</span></span>
            ...
            <div class="edit_title_btn" :style="edit_title_btn">
                ...
                <div>dashboard_container3类型CONTAINER不提供内容输出</div>
        </ion-list>
...
import MobDashboardViewdashboard_container3Service from '@/app-core/ctrl-service/ibz-my-territory/mob-dashboard-viewdashboard-container3-portlet-service';
...
export default class MobDashboardViewdashboard_container3Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MobDashboardViewdashboard_container3
     */
     ...
     *
     * @param {any} args
     * @memberof  MobDashboardViewdashboard_container3Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobDashboardViewdashboard_container3Service}
     * @memberof MobDashboardViewdashboard_container3
     */
    protected service: MobDashboardViewdashboard_container3Service = new MobDashboardViewdashboard_container3Service({$store:this.$store});
    ...
    get editTitle(){
        ...
        return (this.$t(`app.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container3_portlet`) as string)
    }
...
<style lang='less'>
@import './mob-dashboard-viewdashboard-container3-portlet.less';
</style>