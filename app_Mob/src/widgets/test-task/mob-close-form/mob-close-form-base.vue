...
<app-form-group 
    ...
    :caption="$t('testtask.mobclose_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('testtask.mobclose_form.details.name')"  
    :labelWidth="1"  
    :isShowCaption="true"
...
<app-form-druipart
    ...
    :caption="$t('testtask.mobclose_form.details.druipart1')"  
    paramItem='testtask' 
    style="" 
    :formState="formState" 
...
import MobCloseService from '@/app-core/ctrl-service/test-task/mob-close-form-service';
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '变更历史', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobclose_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '测试版本基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobclose_form', extractMode: 'ITEM', details: [] } })
, 
