...
<app-form-group 
    ...
    :caption="$t('testtask.mobstart_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('testtask.mobstart_form.details.name')"  
    :labelWidth="1"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('testtask.mobstart_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="1" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('testtask.mobstart_form.details.druipart1')"  
    paramItem='testtask' 
    style="" 
    :formState="formState" 
...
import MobStartService from '@/app-core/ctrl-service/test-task/mob-start-form-service';
...
export default class MobStartBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobStartService}
     * @memberof MobStart
     */
    protected service: MobStartService = new MobStartService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '变更历史', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobstart_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '测试版本基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobstart_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`testtask.mobstart_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
