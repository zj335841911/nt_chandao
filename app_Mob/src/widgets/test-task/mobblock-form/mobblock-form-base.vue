...
<app-form-group 
    ...
    :caption="$t('testtask.mobblock_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('testtask.mobblock_form.details.name')"  
    :labelWidth="1"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('testtask.mobblock_form.details.comment')"  
    :labelWidth="60"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('testtask.mobblock_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="1" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('testtask.mobblock_form.details.druipart1')"  
    paramItem='testtask' 
    style="" 
    :formState="formState" 
...
import MobblockService from '@/app-core/ctrl-service/test-task/mobblock-form-service';
...
export default class MobblockBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobblockService}
     * @memberof Mobblock
     */
    protected service: MobblockService = new MobblockService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '变更历史', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobblock_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '测试版本基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'testtask.mobblock_form', extractMode: 'ITEM', details: [] } })
, 
