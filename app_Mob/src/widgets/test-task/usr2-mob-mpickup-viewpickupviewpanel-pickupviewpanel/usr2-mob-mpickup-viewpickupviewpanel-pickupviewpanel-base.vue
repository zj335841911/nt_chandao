<template>
    <div class='pickupviewpanel testtask-pickupviewpanel'>
        <component 
...
import Usr2MobMPickupViewpickupviewpanelService from '@/app-core/ctrl-service/test-task/usr2-mob-mpickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class Usr2MobMPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'test-task-usr2-mob-pickup-mdview',
        data: {},
    }
