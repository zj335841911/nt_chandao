...
<app-form-item 
    ...
    :caption="$t('testtask.mobeditform_form.details.mailtopk')"  
    :labelWidth="100"  
    :isShowCaption="true"
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`testtask.mobeditform_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
