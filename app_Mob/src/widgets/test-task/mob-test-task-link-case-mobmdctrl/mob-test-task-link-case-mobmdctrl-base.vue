<template>
    <div  class="app-mob-mdctrl testtask-mdctrl ">
...
import MobTestTaskLinkCaseService from '@/app-core/ctrl-service/test-task/mob-test-task-link-case-mobmdctrl-service';
...
export default class MobTestTaskLinkCaseBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MobTestTaskLinkCase
     */
     ...
     *
     * @param {any} args
     * @memberof  MobTestTaskLinkCaseBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobTestTaskLinkCaseService}
     * @memberof MobTestTaskLinkCase
     */
    protected service: MobTestTaskLinkCaseService = new MobTestTaskLinkCaseService({$store:this.$store});
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { testtask: keys.join(';') }
...
​           Object.assign(data,this.sort);
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.testtaskid, value)) {
                if (detail.checked) {
...
<style lang='less'>
@import './mob-test-task-link-case-mobmdctrl.less';
</style>