<template>
    <div class='app-tab-view-panel release-tabviewpanel4 ' v-if='isActivied' >
        <bug-usr2-mob-mdview 
...
import MobTabExpViewtabviewpanel4Service from '@/app-core/ctrl-service/release/mob-tab-exp-viewtabviewpanel4-tabviewpanel-service';
