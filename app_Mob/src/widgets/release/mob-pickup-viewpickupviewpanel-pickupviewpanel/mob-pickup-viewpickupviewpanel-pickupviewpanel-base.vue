<template>
    <div class='pickupviewpanel release-pickupviewpanel'>
        <component 
...
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/release/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'release-mob-pickup-mdview',
        data: {},
    }
