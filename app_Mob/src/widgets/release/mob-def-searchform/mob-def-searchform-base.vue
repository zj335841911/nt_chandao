<template>
    <div ref='searchform' class="app-form release-searchform ">
...
<app-form-item 
    ...
    :caption="$t('release.mobdef_searchform.details.n_name_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('release.mobdef_searchform.details.n_status_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('release.mobdef_searchform.details.n_releasetype_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobDefService from '@/app-core/ctrl-service/release/mob-def-searchform-service';
...
export default class MobDefBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        n_status_eq: [
            { type: 'string', message: '状态(等于 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '状态(等于 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '状态(等于 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '状态(等于 值不能为空', trigger: 'blur' },
        ],
        n_releasetype_eq: [
...
, 
        n_name_like: new FormItemModel({ caption: '发布名称', detailType: 'FORMITEM', name: 'n_name_like', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    protected formValidateStatus(): boolean {
        const refArr: Array<string> = ['n_name_like_item', 'n_status_eq_item', 'n_releasetype_eq_item', ];
        let falg = true;
