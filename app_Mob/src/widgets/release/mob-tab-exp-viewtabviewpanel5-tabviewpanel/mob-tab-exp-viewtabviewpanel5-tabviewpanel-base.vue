<template>
    <div class='app-tab-view-panel release-tabviewpanel5 ' v-if='isActivied' >
        <bug-mob-mdview9-8177 
...
import MobTabExpViewtabviewpanel5Service from '@/app-core/ctrl-service/release/mob-tab-exp-viewtabviewpanel5-tabviewpanel-service';
