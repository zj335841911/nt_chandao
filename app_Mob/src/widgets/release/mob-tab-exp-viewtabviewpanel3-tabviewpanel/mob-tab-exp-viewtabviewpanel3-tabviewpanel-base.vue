<template>
    <div class='app-tab-view-panel release-tabviewpanel3 ' v-if='isActivied' >
        <release-mob-edit-view 
...
import MobTabExpViewtabviewpanel3Service from '@/app-core/ctrl-service/release/mob-tab-exp-viewtabviewpanel3-tabviewpanel-service';
