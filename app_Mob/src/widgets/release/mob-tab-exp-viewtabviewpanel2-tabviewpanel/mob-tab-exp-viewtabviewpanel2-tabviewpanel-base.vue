<template>
    <div class='app-tab-view-panel release-tabviewpanel2 ' v-if='isActivied' >
        <story-usr3-mob-mdview 
...
import MobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/release/mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
