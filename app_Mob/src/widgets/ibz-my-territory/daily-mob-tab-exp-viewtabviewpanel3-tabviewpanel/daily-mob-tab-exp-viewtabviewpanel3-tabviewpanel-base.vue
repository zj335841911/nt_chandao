<template>
    <div class='app-tab-view-panel ibzmyterritory-tabviewpanel3 ' v-if='isActivied' >
        <task-my-plans-tomorrow-task-mob-mdview 
...
import DailyMobTabExpViewtabviewpanel3Service from '@/app-core/ctrl-service/ibz-my-territory/daily-mob-tab-exp-viewtabviewpanel3-tabviewpanel-service';
...
export default class DailyMobTabExpViewtabviewpanel3Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof DailyMobTabExpViewtabviewpanel3
     */
     ...
     *
     * @param {any} args
     * @memberof  DailyMobTabExpViewtabviewpanel3Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {DailyMobTabExpViewtabviewpanel3Service}
     * @memberof DailyMobTabExpViewtabviewpanel3
     */
    protected service: DailyMobTabExpViewtabviewpanel3Service = new DailyMobTabExpViewtabviewpanel3Service({$store:this.$store});
...
<style lang='less'>
@import './daily-mob-tab-exp-viewtabviewpanel3-tabviewpanel.less';
</style>