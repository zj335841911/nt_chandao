    ...
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container6 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t('app.portlets.mobdashboardviewdashboard_container6.caption')}}</span></span>
...
export default class MobDashboardViewdashboard_container6Base extends Vue implements ControlInterface {
    ...
    get editTitle(){
        ...
        return (this.$t('app.portlets.mobdashboardviewdashboard_container6.caption') as string)
    }
