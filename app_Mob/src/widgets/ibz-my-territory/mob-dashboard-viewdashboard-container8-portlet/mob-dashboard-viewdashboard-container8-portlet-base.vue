    ...
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container8 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`ibzmyterritory${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container8_portlet`)}}</span></span>
