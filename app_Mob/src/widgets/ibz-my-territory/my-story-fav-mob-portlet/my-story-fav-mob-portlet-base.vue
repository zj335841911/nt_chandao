...
import MyStoryFavMobService from '@/app-core/ctrl-service/ibz-my-territory/my-story-fav-mob-portlet-service';
...
export default class MyStoryFavMobBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MyStoryFavMob
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyStoryFavMobService}
     * @memberof MyStoryFavMob
     */
    protected service: MyStoryFavMobService = new MyStoryFavMobService({$store:this.$store});
...
<style lang='less'>
@import './my-story-fav-mob-portlet.less';
</style>