<template>
    <div  class="app-mob-mdctrl ibzmyterritory-mdctrl ">
...
import MobService from '@/app-core/ctrl-service/ibz-my-territory/mob-mobmdctrl-service';
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { ibzmyterritory: keys.join(';') }
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.ibzmyterritoryid, value)) {
                if (detail.checked) {
