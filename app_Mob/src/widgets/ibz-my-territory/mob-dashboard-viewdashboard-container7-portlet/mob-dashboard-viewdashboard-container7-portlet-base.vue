    ...
    <ion-row>
        <ion-list class='app-mob-portlet ibzmyterritory-dashboard_container7 '>
            <ion-list-header v-if="editTitle"  class='app-mob-portlet__header'>
                ...
                <span v-if="!isEditTitle"><span v-if="customizeTitle">{{customizeTitle}}</span><span v-else>{{$t(`${this.localeDeName}.views.${this.viewName.toLowerCase()}.mobdashboardviewdashboard_container7_portlet`)}}</span></span>
            ...
            <div class="edit_title_btn" :style="edit_title_btn">
                ...
                <div>dashboard_container7类型CONTAINER不提供内容输出</div>
        </ion-list>
...
import MobDashboardViewdashboard_container7Service from '@/app-core/ctrl-service/ibz-my-territory/mob-dashboard-viewdashboard-container7-portlet-service';
...
export default class MobDashboardViewdashboard_container7Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MobDashboardViewdashboard_container7
     */
     ...
     *
     * @param {any} args
     * @memberof  MobDashboardViewdashboard_container7Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobDashboardViewdashboard_container7Service}
     * @memberof MobDashboardViewdashboard_container7
     */
    protected service: MobDashboardViewdashboard_container7Service = new MobDashboardViewdashboard_container7Service({$store:this.$store});
...
<style lang='less'>
@import './mob-dashboard-viewdashboard-container7-portlet.less';
</style>