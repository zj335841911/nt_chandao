...
import MobService from '@/app-core/ctrl-service/ibzcase-step/mob-mobmdctrl-service';
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { ibzcasestep: keys.join(';') }
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.ibzcasestepid, value)) {
                if (detail.checked) {
