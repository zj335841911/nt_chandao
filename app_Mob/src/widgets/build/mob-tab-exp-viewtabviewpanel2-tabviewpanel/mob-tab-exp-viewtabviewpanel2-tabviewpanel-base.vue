<template>
    <div class='app-tab-view-panel build-tabviewpanel2 ' v-if='isActivied' >
        <story-usr2-mob-mdview9 
...
import MobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/build/mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
