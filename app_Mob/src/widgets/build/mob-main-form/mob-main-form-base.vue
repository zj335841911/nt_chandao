...
<app-form-group 
    ...
    :caption="$t('build.mobmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('build.mobmain_form.details.grouppanel2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="1" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('build.mobmain_form.details.druipart2')"  
    paramItem='build' 
    style="" 
    :formState="formState" 
    ...
    :viewparams="viewparams" 
    :navigateContext ='{ } ' 
    :navigateParam ='{ "objecttype": "build" } ' 
...
, 
        grouppanel2: new FormGroupPanelModel({ caption: '附件', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'build.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`build.mobmain_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
