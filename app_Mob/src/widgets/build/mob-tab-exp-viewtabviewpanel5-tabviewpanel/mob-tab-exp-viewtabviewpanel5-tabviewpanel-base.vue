<template>
    <div class='app-tab-view-panel build-tabviewpanel5 ' v-if='isActivied' >
        <build-mob-edit-view 
...
import MobTabExpViewtabviewpanel5Service from '@/app-core/ctrl-service/build/mob-tab-exp-viewtabviewpanel5-tabviewpanel-service';
