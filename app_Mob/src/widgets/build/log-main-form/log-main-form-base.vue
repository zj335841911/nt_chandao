...
<app-form-group 
    ...
    :caption="$t('build.logmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('build.logmain_form.details.name')"  
    :labelWidth="0"  
    :isShowCaption="false"
...
<app-form-group 
    ...
    :caption="$t('build.logmain_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    refreshitems='' 
    viewname='story-log-mob-mdview9' 
    v-show="detailsModel.druipart1.visible" 
    :caption="$t('build.logmain_form.details.druipart1')"  
    paramItem='build' 
    style="" 
    :formState="formState" 
...
<app-form-group 
    ...
    :caption="$t('build.logmain_form.details.grouppanel2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    refviewtype='DEMOBMDVIEW9'  
    refreshitems='' 
    viewname='bug-log-mob-mdview9' 
    v-show="detailsModel.druipart2.visible" 
    :caption="$t('build.logmain_form.details.druipart2')"  
    paramItem='build' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"ZT_BUILD","SRFPARENTTYPE":"CUSTOM"}' 
...
import LogMainService from '@/app-core/ctrl-service/build/log-main-form-service';
...
export default class LogMainBase extends Vue implements ControlInterface {
     ...
     * @memberof LogMain
     */
    protected service: LogMainService = new LogMainService({$store:this.$store});
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '版本基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'build.logmain_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '完成需求', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'build.logmain_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '解决Bug', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'build.logmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        name: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'name', visible: true, isShowCaption: false, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`build.logmain_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
    ...
    protected async save(opt: any = {}, showResultInfo?: boolean, isStateNext: boolean = true): Promise<any> {
        ...
        if (response && response.status === 200) {
            ...
            AppCenterService.notifyMessage({name:"Build",action:'appRefresh',data:Object.assign(data,{appRefreshAction:action===this.createAction?false:true})});
            this.$store.dispatch('viewaction/datasaved', { viewtag: this.viewtag });
            this.$nextTick(() => {
                this.formState.next({ type: 'save', data: data });
            });
