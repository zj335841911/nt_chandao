...
<app-form-item2
    ...
    :caption="$t('project.mobdef_searchform.details.n_name_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('project.mobdef_searchform.details.n_status_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item2
    ...
    :caption="$t('project.mobdef_searchform.details.n_type_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobDefService from '@/app-core/ctrl-service/project/mob-def-searchform-service';
