<template>
    <div class='app-tab-view-panel project-tabviewpanel4 ' v-if='isActivied' >
        <build-mob-mdview 
...
import MobTabExpViewtabviewpanel4Service from '@/app-core/ctrl-service/project/mob-tab-exp-viewtabviewpanel4-tabviewpanel-service';
