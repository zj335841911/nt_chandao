...
<app-form-group 
    ...
    :caption="$t('project.mobnewform_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('project.mobnewform_form.details.grouppanel2')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.name')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.code')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.begin')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    labelPos="LEFT" 
    ref="period_item"  
    :itemValue="this.data.period" 
    v-show="detailsModel.period.visible" 
    :itemRules="this.rules.period" 
    :caption="$t('project.mobnewform_form.details.period')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.end')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('project.mobnewform_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.days')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.team')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.type')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :isEmptyCaption="false">
        <app-mob-rich-text-editor :formState="formState" :value="data.desc" @change="(val) =>{this.data.desc =val}" :disabled="detailsModel.desc.disabled" :data="JSON.stringify(this.data)"  name="desc" :uploadparams='{objecttype:"project",version:"editor"}' :exportparams='{objecttype:"project",version:"editor"}'  style=""></app-mob-rich-text-editor>
...
<app-form-item 
    ...
    :caption="$t('project.mobnewform_form.details.acl')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
export default class MobNewFormBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        period: [
            { type: 'string', message: '时间段 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '时间段 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '时间段 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '时间段 值不能为空', trigger: 'blur' },
        ],
        end: [
    ...
    protected detailsModel: any = {
        grouppanel2: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'project.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'project.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'project基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'project.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        period: new FormItemModel({ caption: '时间段', detailType: 'FORMITEM', name: 'period', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    private async formLogic({ name, newVal, oldVal }: { name: string, newVal: any, oldVal: any }){
        ...
        if (Object.is(name, 'end')) {
            ...
            if(await this.validItem('end', this.data['end'])){
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['name_item', 'code_item', 'begin_item', 'period_item', 'end_item', 'days_item', 'team_item', 'type_item', 'desc_item', 'acl_item', ];
        let falg = true;
