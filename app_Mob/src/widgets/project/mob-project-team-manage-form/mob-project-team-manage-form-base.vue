...
<app-form-druipart
    ...
    refreshitems='' 
    viewname='project-team-project-team-mob-medit-view' 
    v-show="detailsModel.druipart1.visible" 
    :caption="$t('project.mobprojectteammanage_form.details.druipart1')"  
    paramItem='project' 
    style="" 
    :formState="formState" 
...
import MobProjectTeamManageService from '@/app-core/ctrl-service/project/mob-project-team-manage-form-service';
...
export default class MobProjectTeamManageBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MobProjectTeamManage
     */
     ...
     *
     * @param {any} args
     * @memberof  MobProjectTeamManageBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobProjectTeamManageService}
     * @memberof MobProjectTeamManage
     */
    protected service: MobProjectTeamManageService = new MobProjectTeamManageService({$store:this.$store});
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`project.mobprojectteammanage_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof MobProjectTeamManage
     */
...
<style lang='less'>
@import './mob-project-team-manage-form.less';
</style>