...
<app-form-group 
    ...
    :caption="$t('project.suspendnclosemob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('project.suspendnclosemob_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('project.suspendnclosemob_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
export default class SuspendNCloseMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {SuspendNCloseMobService}
     * @memberof SuspendNCloseMob
     */
    protected service: SuspendNCloseMobService = new SuspendNCloseMobService({$store:this.$store});
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'project.suspendnclosemob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: 'project基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'project.suspendnclosemob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof SuspendNCloseMob
     */
...
<style lang='less'>
@import './suspend-nclose-mob-form.less';
</style>