<template>
    <div class='app-tab-view-panel project-tabviewpanel5 ' v-if='isActivied' >
        <bug-mob-mdview 
...
import MobTabExpViewtabviewpanel5Service from '@/app-core/ctrl-service/project/mob-tab-exp-viewtabviewpanel5-tabviewpanel-service';
