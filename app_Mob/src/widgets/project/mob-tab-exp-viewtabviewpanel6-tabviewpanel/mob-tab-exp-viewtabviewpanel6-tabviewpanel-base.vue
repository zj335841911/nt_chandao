<template>
    <div class='app-tab-view-panel project-tabviewpanel6 ' v-if='isActivied' >
        <story-mob-mdview-cur-project 
...
import MobTabExpViewtabviewpanel6Service from '@/app-core/ctrl-service/project/mob-tab-exp-viewtabviewpanel6-tabviewpanel-service';
