...
import MOBPorjectService from '@/app-core/ctrl-service/story/mobporject-mobmdctrl-service';
...
export default class MOBPorjectBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MOBPorjectService}
     * @memberof MOBPorject
     */
    protected service: MOBPorjectService = new MOBPorjectService({$store:this.$store});
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u282a8fb_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.Story_ProjectUnlinkStoryMob(datas, contextJO, paramJO, $event, xData, this);
        }
    }
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u282a8fb')) {
            this.mdctrl_u282a8fb_click();
        }
...
<style lang='less'>
@import './mobporject-mobmdctrl.less';
</style>