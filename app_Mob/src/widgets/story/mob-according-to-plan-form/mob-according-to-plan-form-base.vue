...
<app-form-group 
    ...
    :caption="$t('story.mobaccordingtoplan_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
export default class MobAccordingToPlanBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MobAccordingToPlanBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MobAccordingToPlanService}
     * @memberof MobAccordingToPlan
     */
    protected service: MobAccordingToPlanService = new MobAccordingToPlanService({$store:this.$store});
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '(此操作会将所选计划下面的需求全部关联到此项目中)', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'story.mobaccordingtoplan_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        plan: new FormItemModel({ caption: '', detailType: 'FORMITEM', name: 'plan', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`story.mobaccordingtoplan_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof MobAccordingToPlan
     */
...
<style lang='less'>
@import './mob-according-to-plan-form.less';
</style>