...
<app-form-group 
    ...
    :caption="$t('story.mobmainedit_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.prodoctname')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.branch')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.modulename')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.plan')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.source')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.sourcenote')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.assignedtopk')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.neednotreview')"  
    :labelWidth="10"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.pri')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.storypoints')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.estimate')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.spec')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.verify')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.mailtopk')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobmainedit_form.details.keywords')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
export default class MobMainEditBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '需求基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'story.mobmainedit_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`story.mobmainedit_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
