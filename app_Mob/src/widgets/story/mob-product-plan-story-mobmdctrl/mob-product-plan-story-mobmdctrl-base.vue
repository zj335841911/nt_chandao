...
export default class Mob_ProductPlan_StoryBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {Mob_ProductPlan_StoryService}
     * @memberof Mob_ProductPlan_Story
     */
    protected service: Mob_ProductPlan_StoryService = new Mob_ProductPlan_StoryService({$store:this.$store});
...
<style lang='less'>
@import './mob-product-plan-story-mobmdctrl.less';
</style>