...
export default class Mob_PlanBase extends Vue implements ControlInterface {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u867f6ca_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u867f6ca')) {
            this.mdctrl_u867f6ca_click();
        }
