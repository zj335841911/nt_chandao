<template>
    <div  class="app-mob-mdctrl story-dashboard_sysportlet5_list ">
        ...
        <div v-else class="app-mob-mdctrl-dashboard_sysportlet5_list">
            <ion-list class="items">
                <template v-if="controlStyle != 'SWIPERVIEW' ">
                    <ion-item-sliding v-for="(item, index) in items" :key="index" class="app-mob-mdctrl-item">
                        <div style="width:100%;">
                        <layout_dashboard_sysportlet5_list_itempanel :context="{}" :viewparams="{}" :item="item"></layout_dashboard_sysportlet5_list_itempanel>
                        </div>
                    </ion-item-sliding>
                </template>
...
import FavoriteMOBService from '@/app-core/ctrl-service/story/favorite-mob-list-service';
