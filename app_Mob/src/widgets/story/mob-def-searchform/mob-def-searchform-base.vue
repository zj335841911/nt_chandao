...
export default class MobDefBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        n_title_like: [
            { type: 'string', message: '需求名 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '需求名 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '需求名 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '需求名 值不能为空', trigger: 'blur' },
        ],
        n_status_eq: [
...
, 
        n_title_like: new FormItemModel({ caption: '需求名', detailType: 'FORMITEM', name: 'n_title_like', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        n_type_eq: new FormItemModel({ caption: '需求类型', detailType: 'FORMITEM', name: 'n_type_eq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
