<template>
    <div ref='searchform' class="app-form story-searchform ">
...
<app-form-item 
    ...
    :caption="$t('story.mobdef_searchform.details.n_title_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobdef_searchform.details.n_status_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobdef_searchform.details.n_type_eq')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('story.mobdef_searchform.details.n_modulename_like')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobDefService from '@/app-core/ctrl-service/story/mob-def-searchform-service';
...
export default class MobDefBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        n_title_like: [
            { type: 'string', message: '需求名称(文本包含(%)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '需求名称(文本包含(%)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '需求名称(文本包含(%)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '需求名称(文本包含(%)) 值不能为空', trigger: 'blur' },
        ],
        n_status_eq: [
        ...
        n_type_eq: [
            { type: 'string', message: '需求类型(等于(=)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '需求类型(等于(=)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '需求类型(等于(=)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '需求类型(等于(=)) 值不能为空', trigger: 'blur' },
        ],
        n_modulename_like: [
            { type: 'string', message: '所属模块名称(文本包含(%)) 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '所属模块名称(文本包含(%)) 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '所属模块名称(文本包含(%)) 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '所属模块名称(文本包含(%)) 值不能为空', trigger: 'blur' },
        ],
    }
...
, 
        n_title_like: new FormItemModel({ caption: '需求名称(文本包含(%))', detailType: 'FORMITEM', name: 'n_title_like', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        n_type_eq: new FormItemModel({ caption: '需求类型(等于(=))', detailType: 'FORMITEM', name: 'n_type_eq', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        n_modulename_like: new FormItemModel({ caption: '所属模块名称(文本包含(%))', detailType: 'FORMITEM', name: 'n_modulename_like', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
    ...
    protected formValidateStatus(): boolean {
        const refArr: Array<string> = ['n_title_like_item', 'n_status_eq_item', 'n_type_eq_item', 'n_modulename_like_item', ];
        let falg = true;
