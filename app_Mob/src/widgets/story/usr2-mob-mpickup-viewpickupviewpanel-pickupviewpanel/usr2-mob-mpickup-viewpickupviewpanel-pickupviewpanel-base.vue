...
import Usr2MobMPickupViewpickupviewpanelService from '@/app-core/ctrl-service/story/usr2-mob-mpickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class Usr2MobMPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'story-usr2-mob-pickup-mdview',
        data: {},
    }
