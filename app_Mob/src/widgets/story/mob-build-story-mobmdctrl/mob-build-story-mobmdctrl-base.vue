...
import MOB_Build_StoryService from '@/app-core/ctrl-service/story/mob-build-story-mobmdctrl-service';
...
export default class MOB_Build_StoryBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MOB_Build_StoryService}
     * @memberof MOB_Build_Story
     */
    protected service: MOB_Build_StoryService = new MOB_Build_StoryService({$store:this.$store});
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u418afe3_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.Story_buildUnlinkStory(datas, contextJO, paramJO, $event, xData, this);
        }
    }
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u418afe3')) {
            this.mdctrl_u418afe3_click();
        }
   ...
   /**
    ...
    public ActionModel:any ={
        buildUnlinkStory: { name: 'buildUnlinkStory',disabled: false, visabled: true,noprivdisplaymode:1,dataaccaction: 'SRFUR__STORY_UNLP_BUT', target: 'SINGLEKEY',icon:'unlink',isShowCaption:false,isShowIcon:true}
    };
...
<style lang='less'>
@import './mob-build-story-mobmdctrl.less';
</style>