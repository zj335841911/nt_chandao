...
import MOB_BuildLink_StoryService from '@/app-core/ctrl-service/story/mob-build-link-story-mobmdctrl-service';
...
export default class MOB_BuildLink_StoryBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MOB_BuildLink_StoryBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MOB_BuildLink_StoryService}
     * @memberof MOB_BuildLink_Story
     */
    protected service: MOB_BuildLink_StoryService = new MOB_BuildLink_StoryService({$store:this.$store});
...
<style lang='less'>
@import './mob-build-link-story-mobmdctrl.less';
</style>