...
<app-form-group 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.ibz_dailyname')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.group2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.createman')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.createdate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.updateman')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.mobmain_form.details.updatedate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobMainService from '@/app-core/ctrl-service/ibz-daily/mob-main-form-service';
...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '日报基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
