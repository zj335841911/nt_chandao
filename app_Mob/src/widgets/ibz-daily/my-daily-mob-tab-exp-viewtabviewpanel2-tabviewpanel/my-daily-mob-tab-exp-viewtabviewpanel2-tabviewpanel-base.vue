<template>
    <div class='app-tab-view-panel ibzdaily-tabviewpanel2 ' v-if='isActivied' >
        <ibz-daily-daily-complete-task-mob-mdview 
...
import MyDailyMobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/ibz-daily/my-daily-mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
...
export default class MyDailyMobTabExpViewtabviewpanel2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MyDailyMobTabExpViewtabviewpanel2
     */
     ...
     *
     * @param {any} args
     * @memberof  MyDailyMobTabExpViewtabviewpanel2Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyDailyMobTabExpViewtabviewpanel2Service}
     * @memberof MyDailyMobTabExpViewtabviewpanel2
     */
    protected service: MyDailyMobTabExpViewtabviewpanel2Service = new MyDailyMobTabExpViewtabviewpanel2Service({$store:this.$store});
...
<style lang='less'>
@import './my-daily-mob-tab-exp-viewtabviewpanel2-tabviewpanel.less';
</style>