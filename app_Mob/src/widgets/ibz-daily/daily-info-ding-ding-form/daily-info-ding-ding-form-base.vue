...
<app-form-group 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.account')"  
    :labelWidth="0"  
    :isShowCaption="false"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.date')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.grouppanel3')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.worktoday')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.grouppanel4')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.planstomorrow')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.comment')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.reportto')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.mailto')"  
    :labelWidth="90"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.druipart1')"  
    paramItem='ibzdaily' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"IBZ_DAILY","SRFPARENTTYPE":"CUSTOM"}' 
...
<app-form-group 
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.grouppanel2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    :data="transformData(data)"
...
<app-form-druipart
    ...
    :caption="$t('ibzdaily.dailyinfodingding_form.details.druipart2')"  
    paramItem='ibzdaily' 
    style="" 
    :formState="formState" 
    :parentdata='{"srfparentdename":"IBZ_DAILY","SRFPARENTTYPE":"CUSTOM"}' 
...
export default class DailyInfoDingDingBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  DailyInfoDingDingBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {DailyInfoDingDingService}
     * @memberof DailyInfoDingDing
     */
    protected service: DailyInfoDingDingService = new DailyInfoDingDingService({$store:this.$store});
...
, 
        grouppanel3: new FormGroupPanelModel({ caption: '完成任务', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfodingding_form', extractMode: 'ITEM', details: [] } })
, 
        druipart4: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart4', visible: true, isShowCaption: true, form: this })
, 
        grouppanel4: new FormGroupPanelModel({ caption: '计划参与', detailType: 'GROUPPANEL', name: 'grouppanel4', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfodingding_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '日报基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfodingding_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '附件', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfodingding_form', extractMode: 'ITEM', details: [] } })
, 
        druipart2: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart2', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '操作记录', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfodingding_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof DailyInfoDingDing
     */
...
<style lang='less'>
@import './daily-info-ding-ding-form.less';
</style>