...
export default class MyDailyMobTabExpViewtabviewpanelBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MyDailyMobTabExpViewtabviewpanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyDailyMobTabExpViewtabviewpanelService}
     * @memberof MyDailyMobTabExpViewtabviewpanel
     */
    protected service: MyDailyMobTabExpViewtabviewpanelService = new MyDailyMobTabExpViewtabviewpanelService({$store:this.$store});
...
<style lang='less'>
@import './my-daily-mob-tab-exp-viewtabviewpanel-tabviewpanel.less';
</style>