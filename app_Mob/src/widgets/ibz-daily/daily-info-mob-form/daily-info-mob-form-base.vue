...
<app-form-druipart
    ...
    :caption="$t('ibzdaily.dailyinfomob_form.details.druipart1')"  
    paramItem='ibzdaily' 
    style="" 
    :formState="formState" 
...
import DailyInfoMobService from '@/app-core/ctrl-service/ibz-daily/daily-info-mob-form-service';
...
export default class DailyInfoMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {DailyInfoMobService}
     * @memberof DailyInfoMob
     */
    protected service: DailyInfoMobService = new DailyInfoMobService({$store:this.$store});
...
, 
        grouppanel2: new FormGroupPanelModel({ caption: '操作记录', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ibzdaily.dailyinfomob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`ibzdaily.dailyinfomob_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof DailyInfoMob
     */
...
<style lang='less'>
@import './daily-info-mob-form.less';
</style>