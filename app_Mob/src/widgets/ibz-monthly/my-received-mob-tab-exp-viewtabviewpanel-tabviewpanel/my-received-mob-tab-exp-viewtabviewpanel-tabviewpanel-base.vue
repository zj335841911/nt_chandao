...
import MyReceivedMobTabExpViewtabviewpanelService from '@/app-core/ctrl-service/ibz-monthly/my-received-mob-tab-exp-viewtabviewpanel-tabviewpanel-service';
...
export default class MyReceivedMobTabExpViewtabviewpanelBase extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MyReceivedMobTabExpViewtabviewpanel
     */
     ...
     *
     * @param {any} args
     * @memberof  MyReceivedMobTabExpViewtabviewpanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyReceivedMobTabExpViewtabviewpanelService}
     * @memberof MyReceivedMobTabExpViewtabviewpanel
     */
    protected service: MyReceivedMobTabExpViewtabviewpanelService = new MyReceivedMobTabExpViewtabviewpanelService({$store:this.$store});
...
<style lang='less'>
@import './my-received-mob-tab-exp-viewtabviewpanel-tabviewpanel.less';
</style>