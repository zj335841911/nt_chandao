...
<app-form-group 
    ...
    :caption="$t('ibzmonthly.mobnew_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="thismonthtask_item"  
    :itemValue="this.data.thismonthtask" 
    v-show="detailsModel.thismonthtask.visible" 
    :itemRules="this.rules.thismonthtask" 
    :caption="$t('ibzmonthly.mobnew_form.details.thismonthtask')"  
    :labelWidth="100"  
    :isShowCaption="true"
    :disabled="detailsModel.thismonthtask.disabled"
    :error="detailsModel.thismonthtask.error" 
...
<app-form-item 
    ...
    :caption="$t('ibzmonthly.mobnew_form.details.workthismonth')"  
    :labelWidth="100"  
    :isShowCaption="true"
    :disabled="detailsModel.workthismonth.disabled"
    :error="detailsModel.workthismonth.error" 
    :isEmptyCaption="false">
        <app-mob-rich-text-editor-pms :formState="formState"  :value="data.workthismonth" @change="(val) =>{this.data.workthismonth =val}" :disabled="detailsModel.workthismonth.disabled" :data="JSON.stringify(this.data)"  name="workthismonth" :uploadparams='{objecttype:"monthly",version:"editor"}' :exportparams='{objecttype:"monthly",version:"editor"}'  style=""  @noticeusers_change="(val)=>{this.data.noticeusers =val}"/>
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="nextmonthplanstask_item"  
    :itemValue="this.data.nextmonthplanstask" 
    v-show="detailsModel.nextmonthplanstask.visible" 
    :itemRules="this.rules.nextmonthplanstask" 
    :caption="$t('ibzmonthly.mobnew_form.details.nextmonthplanstask')"  
    :labelWidth="100"  
    :isShowCaption="true"
    :disabled="detailsModel.nextmonthplanstask.disabled"
    :error="detailsModel.nextmonthplanstask.error" 
    :isEmptyCaption="false">
        <app-mob-check-list 
    type="dynamic"  
    tag="MyPlanTask"
    ...
    :context="context"
    :viewparams="viewparams"
    :value="data.nextmonthplanstask"   
    :navigateContext ='{ } '
    :navigateParam ='{ } '
    @change="($event)=>this.data.nextmonthplanstask = $event"/>
</app-form-item>
...
<app-form-item 
    ...
    :caption="$t('ibzmonthly.mobnew_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('ibzmonthly.mobnew_form.details.files')"  
    :labelWidth="100"  
    :isShowCaption="true"
    ...
    :context="context" 
    :viewparams="viewparams" 
    :uploadParam='{objecttype:"monthly",objectid:"0",version:"1"}' 
    :exportParam='{objecttype:"monthly",objectid:"0",version:"1"}' 
...
export default class MobNewBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'ibzmonthly.mobnew_form', extractMode: 'ITEM', details: [] } })
, 
