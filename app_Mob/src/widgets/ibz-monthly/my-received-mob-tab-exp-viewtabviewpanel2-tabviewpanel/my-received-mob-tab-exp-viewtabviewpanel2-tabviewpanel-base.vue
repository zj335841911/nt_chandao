<template>
    <div class='app-tab-view-panel ibzmonthly-tabviewpanel2 ' v-if='isActivied' >
        <ibz-monthly-my-received-mob-edit-view 
...
import MyReceivedMobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/ibz-monthly/my-received-mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
...
export default class MyReceivedMobTabExpViewtabviewpanel2Base extends Vue implements ControlInterface {

    /**
     * 名称
     *
     * @type {string}
     * @memberof MyReceivedMobTabExpViewtabviewpanel2
     */
     ...
     *
     * @param {any} args
     * @memberof  MyReceivedMobTabExpViewtabviewpanel2Base
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyReceivedMobTabExpViewtabviewpanel2Service}
     * @memberof MyReceivedMobTabExpViewtabviewpanel2
     */
    protected service: MyReceivedMobTabExpViewtabviewpanel2Service = new MyReceivedMobTabExpViewtabviewpanel2Service({$store:this.$store});
...
<style lang='less'>
@import './my-received-mob-tab-exp-viewtabviewpanel2-tabviewpanel.less';
</style>