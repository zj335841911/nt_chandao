<template>
    <div ref='form' class="app-form taskteam-form ">
...
<app-form-group 
    ...
    :caption="$t('taskteam.mobmain_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('taskteam.mobmain_form.details.account')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('taskteam.mobmain_form.details.estimate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import MobMainService from '@/app-core/ctrl-service/task-team/mob-main-form-service';
...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '任务团队基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'taskteam.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async loadDraft(opt: any = {}): Promise<any> {
        ...
        if (response && response.status === 200) {
            const data = response.data;
            if(data.taskteam){
                Object.assign(this.context, { taskteam: data.taskteam });
            }
