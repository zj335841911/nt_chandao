<template>
<div class="app-mob-meditviewpanel taskteam-meditviewpanel ">
...
import MainService from '@/app-core/ctrl-service/task-team/main-multieditviewpanel-service';
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    private doItems(datas: any[]): void {
        ...
        datas.forEach((arg: any) => {
            ...
            let title :string = arg.taskteamname ?  arg.taskteamname :'新建';
