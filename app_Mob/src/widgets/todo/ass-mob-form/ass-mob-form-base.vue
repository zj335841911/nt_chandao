...
<app-form-group 
    ...
    :caption="$t('todo.assmob_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('todo.assmob_form.details.date')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.assmob_form.details.begin')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.assmob_form.details.end')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
export default class AssMobBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '指派给', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'todo.assmob_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`todo.assmob_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
