...
export default class MobNewBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        begin: [
            { type: 'number', message: '开始 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '开始 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '开始 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '开始 值不能为空', trigger: 'blur' },
        ],
        end: [
            { type: 'number', message: '结束 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '结束 值必须为数值类型', trigger: 'blur' },
            { required: false, type: 'number', message: '结束 值不能为空', trigger: 'change' },
            { required: false, type: 'number', message: '结束 值不能为空', trigger: 'blur' },
        ],
        type: [
        ...
        private: [
            { type: 'number', message: '私人事务 值必须为数值类型', trigger: 'change' },
