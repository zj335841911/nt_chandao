...
<app-form-group 
    ...
    :caption="$t('todo.todo_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('todo.todo_form.details.name')"  
    :labelWidth="130"  
    :isShowCaption="true"
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`todo.todo_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
