...
<app-form-group 
    ...
    :caption="$t('todo.mobmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.name')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.pri')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.begin')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.end')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.type')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.status')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.assignedby')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.assigneddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('todo.mobmain_form.details.assignedto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('todo.mobmain_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    @groupuiactionclick="groupUIActionClick($event)">
...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        begin: [
            ...
            { type: 'string', message: '开始 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '开始 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '开始 值不能为空', trigger: 'blur' },
        ],
        end: [
            { type: 'string', message: '结束 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '结束 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '结束 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '结束 值不能为空', trigger: 'blur' },
        ],
        type: [
        ...
        assignedby: [
            { type: 'string', message: '由谁指派 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '由谁指派 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '由谁指派 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '由谁指派 值不能为空', trigger: 'blur' },
        ],
        assigneddate: [
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'todo.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '待办事宜表基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'todo.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        assignedby: new FormItemModel({ caption: '由谁指派', detailType: 'FORMITEM', name: 'assignedby', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
