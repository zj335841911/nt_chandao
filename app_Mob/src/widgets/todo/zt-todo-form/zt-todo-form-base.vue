...
<app-form-group 
    ...
    :caption="$t('todo.zt_todo_form.details.group1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('todo.zt_todo_form.details.name')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import ZT_TODOService from '@/app-core/ctrl-service/todo/zt-todo-form-service';
...
export default class ZT_TODOBase extends Vue implements ControlInterface {
     ...
     * @memberof ZT_TODO
     */
    protected service: ZT_TODOService = new ZT_TODOService({$store:this.$store});
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '待办基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'todo.zt_todo_form', extractMode: 'ITEM', details: [] } })
, 
    ...
    public validItem(property:string, data:any):Promise<any>{
        return new Promise((resolve, reject) => {
            ...
            Util.validateItem(property,data,this.rules[property]).then(()=>{
                ...
                let _message :any = (this.$t(`todo.zt_todo_form.details.${field}`) as string) +' '+ this.$t(`app.form.rules.${message}`);
