                ...
                <template v-if="(viewType == 'DEMOBMDVIEW9') && controlStyle != 'SWIPERVIEW' ">
                    <ion-item-sliding ref="sliding" v-for="(item,index) in items" @click="item_click(item)" :key="item.srfkey" class="app-mob-mdctrl-item" :disabled="item.sliding_disabled" @ionDrag="ionDrag">
                        <ion-item-options v-if="controlStyle != 'LISTVIEW3'" side="end">
                            <ion-item-option v-show="item.LookDaily.visabled" :disabled="item.LookDaily.disabled" color="primary" @click="mdctrl_click($event, 'ub24bd6e', item)"><ion-icon v-if="item.LookDaily.icon && item.LookDaily.isShowIcon" :name="item.LookDaily.icon"></ion-icon><ion-label v-if="item.LookDaily.isShowCaption">详情</ion-label></ion-item-option>
                            <ion-item-option v-show="item.LookWeekly.visabled" :disabled="item.LookWeekly.disabled" color="primary" @click="mdctrl_click($event, 'u11525d3', item)"><ion-icon v-if="item.LookWeekly.icon && item.LookWeekly.isShowIcon" :name="item.LookWeekly.icon"></ion-icon><ion-label v-if="item.LookWeekly.isShowCaption">详情</ion-label></ion-item-option>
                            <ion-item-option v-show="item.LookMonthy.visabled" :disabled="item.LookMonthy.disabled" color="primary" @click="mdctrl_click($event, 'u151f646', item)"><ion-icon v-if="item.LookMonthy.icon && item.LookMonthy.isShowIcon" :name="item.LookMonthy.icon"></ion-icon><ion-label v-if="item.LookMonthy.isShowCaption">详情</ion-label></ion-item-option>
                        </ion-item-options>
                        <div style="width:100%;">
...
<style lang='less'>
@import './my-submit-mobmdctrl.less';
</style>