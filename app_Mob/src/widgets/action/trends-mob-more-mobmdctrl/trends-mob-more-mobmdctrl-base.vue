...
export default class TrendsMobMoreBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {TrendsMobMoreService}
     * @memberof TrendsMobMore
     */
    protected service: TrendsMobMoreService = new TrendsMobMoreService({$store:this.$store});
...
<style lang='less'>
@import './trends-mob-more-mobmdctrl.less';
</style>