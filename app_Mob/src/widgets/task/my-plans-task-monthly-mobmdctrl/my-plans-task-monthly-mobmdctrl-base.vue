...
import MyPlansTaskMonthlyService from '@/app-core/ctrl-service/task/my-plans-task-monthly-mobmdctrl-service';
...
export default class MyPlansTaskMonthlyBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MyPlansTaskMonthlyBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyPlansTaskMonthlyService}
     * @memberof MyPlansTaskMonthly
     */
    protected service: MyPlansTaskMonthlyService = new MyPlansTaskMonthlyService({$store:this.$store});
...
<style lang='less'>
@import './my-plans-task-monthly-mobmdctrl.less';
</style>