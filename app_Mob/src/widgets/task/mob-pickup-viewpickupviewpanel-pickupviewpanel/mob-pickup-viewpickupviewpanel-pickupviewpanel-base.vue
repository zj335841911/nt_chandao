<template>
    <div class='pickupviewpanel task-pickupviewpanel'>
        <component 
...
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/task/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
