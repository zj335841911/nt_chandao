...
import MyCompleteTaskMonthlyService from '@/app-core/ctrl-service/task/my-complete-task-monthly-mobmdctrl-service';
...
export default class MyCompleteTaskMonthlyBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MyCompleteTaskMonthlyBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyCompleteTaskMonthlyService}
     * @memberof MyCompleteTaskMonthly
     */
    protected service: MyCompleteTaskMonthlyService = new MyCompleteTaskMonthlyService({$store:this.$store});
...
<style lang='less'>
@import './my-complete-task-monthly-mobmdctrl.less';
</style>