...
import FavoriteMOBDasService from '@/app-core/ctrl-service/task/favorite-mobdas-mobmdctrl-service';
...
export default class FavoriteMOBDasBase extends Vue implements ControlInterface {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u2543f0b_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
     ...
     * @memberof MdctrlBase
     */
    protected async mdctrl_u1de6edf_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
...
​           Object.assign(data,this.sort);
    ...
    */
    ...
    public mdctrl_click($event: any, tag: any, item: any): void {
        ...
        this.selectedArray = [];
        this.selectedArray.push(item);
        if (Object.is(tag, 'u2543f0b')) {
            this.mdctrl_u2543f0b_click();
        }
        if (Object.is(tag, 'u1de6edf')) {
            this.mdctrl_u1de6edf_click();
        }
