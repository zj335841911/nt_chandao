...
import MyCompleteTaskMobService from '@/app-core/ctrl-service/task/my-complete-task-mob-mobmdctrl-service';
...
export default class MyCompleteTaskMobBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MyCompleteTaskMobBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyCompleteTaskMobService}
     * @memberof MyCompleteTaskMob
     */
    protected service: MyCompleteTaskMobService = new MyCompleteTaskMobService({$store:this.$store});
...
<style lang='less'>
@import './my-complete-task-mob-mobmdctrl.less';
</style>