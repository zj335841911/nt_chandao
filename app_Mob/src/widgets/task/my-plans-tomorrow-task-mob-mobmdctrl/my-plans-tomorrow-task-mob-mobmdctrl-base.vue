...
import MyPlansTomorrowTaskMobService from '@/app-core/ctrl-service/task/my-plans-tomorrow-task-mob-mobmdctrl-service';
...
export default class MyPlansTomorrowTaskMobBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MyPlansTomorrowTaskMobBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MyPlansTomorrowTaskMobService}
     * @memberof MyPlansTomorrowTaskMob
     */
    protected service: MyPlansTomorrowTaskMobService = new MyPlansTomorrowTaskMobService({$store:this.$store});
...
<style lang='less'>
@import './my-plans-tomorrow-task-mob-mobmdctrl.less';
</style>