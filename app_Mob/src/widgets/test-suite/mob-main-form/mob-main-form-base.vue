...
<app-form-group 
    ...
    :caption="$t('testsuite.mobmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        lasteditedby: [
            { type: 'string', message: '最后编辑人 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '最后编辑人 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '最后编辑人 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '最后编辑人 值不能为空', trigger: 'blur' },
        ],
        lastediteddate: [
            { type: 'string', message: '最后编辑时间 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '最后编辑时间 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '最后编辑时间 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '最后编辑时间 值不能为空', trigger: 'blur' },
        ],
        id: [
            { type: 'number', message: '编号 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '编号 值必须为数值类型', trigger: 'blur' },
