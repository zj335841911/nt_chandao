<template>
    <div class='app-tab-view-panel testsuite-tabviewpanel2 ' v-if='isActivied' >
        <test-suite-mob-edit-view 
...
import MobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/test-suite/mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
