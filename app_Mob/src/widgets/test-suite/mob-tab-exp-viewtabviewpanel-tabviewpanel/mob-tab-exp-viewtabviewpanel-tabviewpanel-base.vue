<template>
    <div class='app-tab-view-panel testsuite-tabviewpanel ' v-if='isActivied' >
        <case-mob-mdview-test-suite 
...
import MobTabExpViewtabviewpanelService from '@/app-core/ctrl-service/test-suite/mob-tab-exp-viewtabviewpanel-tabviewpanel-service';
