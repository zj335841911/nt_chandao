<template>
    <div class='pickupviewpanel user-pickupviewpanel'>
        <component 
...
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/user/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'user-mob-pickup-mdview',
        data: {},
    }
    ...
    protected onViewDatasChange($event: any): void {
        if ($event.length > 0) {
          $event.forEach((item:any,index:any) => {
              let srfmajortext = item['realname'];
              if(srfmajortext){
