<template>
    <div  class="app-mob-mdctrl substory-mdctrl ">
...
import FavoriteMOBService from '@/app-core/ctrl-service/sub-story/favorite-mob-mobmdctrl-service';
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { substory: keys.join(';') }
    ...
    */
    ...
    public checkboxChange(data: any) {
        ...
        this.items.forEach((item: any, index: number) => {
            ...
            if (Object.is(item.substoryid, value)) {
                if (detail.checked) {
