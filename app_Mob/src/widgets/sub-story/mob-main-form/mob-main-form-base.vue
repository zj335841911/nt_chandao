...
<app-form-group 
    ...
    :caption="$t('substory.mobmain_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.prodoctname')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.branchname')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.modulename1')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.title')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.type')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.pri')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.status')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.assignedto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.assigneddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.source')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.sourcenote')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.stage')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.closedby')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.closeddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.closedreason')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.spec')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.verify')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.mailto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobmain_form.details.keywords')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.mobmain_form.details.grouppanel1')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="true" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import MobMainService from '@/app-core/ctrl-service/sub-story/mob-main-form-service';
...
export default class MobMainBase extends Vue implements ControlInterface {
    ...
    protected rules: any = {
        ...
        modulename1: [
            { type: 'string', message: '所属模块名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '所属模块名称 值必须为字符串类型', trigger: 'blur' },
            { required: false, type: 'string', message: '所属模块名称 值不能为空', trigger: 'change' },
            { required: false, type: 'string', message: '所属模块名称 值不能为空', trigger: 'blur' },
        ],
        title: [
            { type: 'string', message: '需求名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '需求名称 值必须为字符串类型', trigger: 'blur' },
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '需求基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobmain_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['prodoctname_item', 'branchname_item', 'modulename1_item', 'title_item', 'type_item', 'pri_item', 'status_item', 'assignedto_item', 'assigneddate_item', 'source_item', 'sourcenote_item', 'stage_item', 'closedby_item', 'closeddate_item', 'closedreason_item', 'spec_item', 'verify_item', 'mailto_item', 'keywords_item', ];
        let falg = true;
