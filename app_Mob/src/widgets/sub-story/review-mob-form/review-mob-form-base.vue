<template>
    <div ref='form' class="app-form substory-form ">
...
<app-form-group 
    ...
    :caption="$t('substory.reviewmob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.title')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.reviewmob_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    uiStyle="DEFAULT"  
    labelPos="LEFT" 
    ref="revieweddate_item"  
    :itemValue="this.data.revieweddate" 
    v-show="detailsModel.revieweddate.visible" 
    :itemRules="this.rules.revieweddate" 
    :caption="$t('substory.reviewmob_form.details.revieweddate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    labelPos="LEFT" 
    ref="result_item"  
    :itemValue="this.data.result" 
    v-show="detailsModel.result.visible" 
    :itemRules="this.rules.result" 
    :caption="$t('substory.reviewmob_form.details.result')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.reviewmob_form.details.grouppanel2')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.pri')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.estimate')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    labelPos="LEFT" 
    ref="preversion_item"  
    :itemValue="this.data.preversion" 
    v-show="detailsModel.preversion.visible" 
    :itemRules="this.rules.preversion" 
    :caption="$t('substory.reviewmob_form.details.preversion')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.reviewmob_form.details.grouppanel3')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.closedreason')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.assignedto')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    labelPos="LEFT" 
    ref="reviewedby_item"  
    :itemValue="this.data.reviewedby" 
    v-show="detailsModel.reviewedby.visible" 
    :itemRules="this.rules.reviewedby" 
    :caption="$t('substory.reviewmob_form.details.reviewedby')"  
    :labelWidth="130"  
    :isShowCaption="true"
    ...
    :navigateContext ='{ } '
    :navigateParam ='{ } '
    @change="($event)=>this.data.reviewedby = $event"/>
</app-form-item>
...
<app-form-item 
    ...
    :caption="$t('substory.reviewmob_form.details.comment')"  
    :labelWidth="130"  
    :isShowCaption="true"
...
import ReviewMobService from '@/app-core/ctrl-service/sub-story/review-mob-form-service';
...
export default class ReviewMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {ReviewMobService}
     * @memberof ReviewMob
     */
    protected service: ReviewMobService = new ReviewMobService({$store:this.$store});
     ...
     * @memberof ReviewMobBase
     */  
    public deUIService:SubStoryUIService = new SubStoryUIService(this.$store);
    ...
    protected detailsModel: any = {
        grouppanel2: new FormGroupPanelModel({ caption: '评审通过', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.reviewmob_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel3: new FormGroupPanelModel({ caption: '拒绝', detailType: 'GROUPPANEL', name: 'grouppanel3', visible: false, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.reviewmob_form', extractMode: 'ITEM', details: [] } })
, 
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.reviewmob_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        group1: new FormGroupPanelModel({ caption: '需求基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.reviewmob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        result: new FormItemModel({ caption: '评审结果', detailType: 'FORMITEM', name: 'result', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        preversion: new FormItemModel({ caption: '之前版本', detailType: 'FORMITEM', name: 'preversion', visible: false, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     * @memberof ReviewMob
     */
    @Watch('data.preversion')
    onPreversionChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'preversion', newVal: newVal, oldVal: oldVal });
    }
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['title_item', 'revieweddate_item', 'result_item', 'pri_item', 'estimate_item', 'preversion_item', 'closedreason_item', 'assignedto_item', 'reviewedby_item', 'comment_item', ];
        let falg = true;
    ...
    protected async loadDraft(opt: any = {}): Promise<any> {
        ...
        if (response && response.status === 200) {
            const data = response.data;
            if(data.substory){
                Object.assign(this.context, { substory: data.substory });
            }
