...
<app-form-group 
    ...
    :caption="$t('substory.activitemob_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('substory.activitemob_form.details.assignedto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.activitemob_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.activitemob_form.details.grouppanel2')" 
    :isShowCaption="true" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import ActiviteMobService from '@/app-core/ctrl-service/sub-story/activite-mob-form-service';
...
export default class ActiviteMobBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {ActiviteMobService}
     * @memberof ActiviteMob
     */
    protected service: ActiviteMobService = new ActiviteMobService({$store:this.$store});
...
, 
        grouppanel2: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'substory.activitemob_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '需求描述信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.activitemob_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['assignedto_item', 'comment_item', ];
        let falg = true;
