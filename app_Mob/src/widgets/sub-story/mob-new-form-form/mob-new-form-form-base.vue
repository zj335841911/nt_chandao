...
<app-form-group 
    ...
    :caption="$t('substory.mobnewform_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.prodoctname')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.branch')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.modulename')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.plan')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.source')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.sourcenote')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.assignedto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.neednotreview')"  
    :labelWidth="10"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.title')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.pri')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.estimate')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.spec')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.verify')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.mailto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobnewform_form.details.keywords')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
import MobNewFormService from '@/app-core/ctrl-service/sub-story/mob-new-form-form-service';
...
export default class MobNewFormBase extends Vue implements ControlInterface {
    ...
    protected detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '需求基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobnewform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['prodoctname_item', 'branch_item', 'modulename_item', 'plan_item', 'source_item', 'sourcenote_item', 'assignedto_item', 'neednotreview_item', 'title_item', 'pri_item', 'estimate_item', 'spec_item', 'verify_item', 'mailto_item', 'keywords_item', ];
        let falg = true;
