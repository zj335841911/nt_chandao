...
<app-form-group 
    ...
    :caption="$t('substory.mobchageform_form.details.group1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
...
<app-form-group 
    ...
    :caption="$t('substory.mobchageform_form.details.grouppanel1')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.assignedto')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.neednotreview')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.title')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.spec')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.verify')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.comment')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-item 
    ...
    :caption="$t('substory.mobchageform_form.details.files')"  
    :labelWidth="100"  
    :isShowCaption="true"
...
<app-form-group 
    ...
    :caption="$t('substory.mobchageform_form.details.grouppanel2')" 
    :isShowCaption="false" 
    :titleBarCloseMode="0" 
    :isInfoGroupMode="false" 
    @groupuiactionclick="groupUIActionClick($event)">
...
import MobChageFormService from '@/app-core/ctrl-service/sub-story/mob-chage-form-form-service';
...
export default class MobChageFormBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {MobChageFormService}
     * @memberof MobChageForm
     */
    protected service: MobChageFormService = new MobChageFormService({$store:this.$store});
    ...
    protected detailsModel: any = {
        grouppanel1: new FormGroupPanelModel({ caption: '分组面板', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobchageform_form', extractMode: 'ITEM', details: [] } })
, 
        druipart1: new FormDRUIPartModel({ caption: '', detailType: 'DRUIPART', name: 'druipart1', visible: true, isShowCaption: true, form: this })
, 
        grouppanel2: new FormGroupPanelModel({ caption: '历史记录', detailType: 'GROUPPANEL', name: 'grouppanel2', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobchageform_form', extractMode: 'ITEM', details: [] } })
, 
        group1: new FormGroupPanelModel({ caption: '需求描述信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'substory.mobchageform_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        neednotreview: new FormItemModel({ caption: '需要评审', detailType: 'FORMITEM', name: 'neednotreview', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    protected async formValidateStatus(): Promise<boolean> {
        const refArr: Array<string> = ['assignedto_item', 'neednotreview_item', 'title_item', 'spec_item', 'verify_item', 'comment_item', 'files_item', ];
        let falg = true;
     ...
     *
     * @param {*} [arg={}]
     * @memberof @memberof MobChageForm
     */
...
<style lang='less'>
@import './mob-chage-form-form.less';
</style>