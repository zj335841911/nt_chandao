...
import Mob_3817Service from '@/app-core/ctrl-service/sub-story/mob-3817-mobmdctrl-service';
...
export default class Mob_3817Base extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {Mob_3817Service}
     * @memberof Mob_3817
     */
    protected service: Mob_3817Service = new Mob_3817Service({$store:this.$store});
...
<style lang='less'>
@import './mob-3817-mobmdctrl.less';
</style>