<template>
    <div class='pickupviewpanel substory-pickupviewpanel'>
        <component 
...
import MobPickupViewpickupviewpanelService from '@/app-core/ctrl-service/sub-story/mob-pickup-viewpickupviewpanel-pickupviewpanel-service';
...
export default class MobPickupViewpickupviewpanelBase extends Vue implements ControlInterface {
     ...
     */
    protected view: any = {
        viewname: 'story-mob-pickup-mdview',
        data: {},
    }
