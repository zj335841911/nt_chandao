...
FTL stack trace ("~" means nesting-related):
	- Failed at: #if editor.getEditorParam("isEnableDe...  [in template "TEMPLCODE_zh_CN" at line 3, column 5]
----
...
export default class MobListBase extends Vue implements ControlInterface {
     ...
     * @memberof MobList
     */
    protected service: MobListService = new MobListService({$store:this.$store});
     ...
     * @memberof MobListBase
     */  
    public deUIService:FileUIService = new FileUIService(this.$store);
    ...
    */
    ...
    public async remove(datas: any[]): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            const _remove = async () => {
                let _context: any = { file: keys.join(';') }
...
<style lang='less'>
@import './mob-list-mobmdctrl.less';
</style>