<template>
    <div class='app-tab-view-panel productstats-tabviewpanel2 ' v-if='isActivied' >
        <story-mob-mdview 
...
import MobTabExpViewtabviewpanel2Service from '@/app-core/ctrl-service/product-stats/mob-tab-exp-viewtabviewpanel2-tabviewpanel-service';
