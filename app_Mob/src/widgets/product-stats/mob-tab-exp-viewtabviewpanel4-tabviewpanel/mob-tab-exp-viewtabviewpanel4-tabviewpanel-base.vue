<template>
    <div class='app-tab-view-panel productstats-tabviewpanel4 ' v-if='isActivied' >
...
import MobTabExpViewtabviewpanel4Service from '@/app-core/ctrl-service/product-stats/mob-tab-exp-viewtabviewpanel4-tabviewpanel-service';
