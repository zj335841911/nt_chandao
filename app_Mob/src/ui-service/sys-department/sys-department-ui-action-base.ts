...
import SysDepartmentAuthService from '@/app-core/auth-service/sys-department/sys-department-auth-service';
 ...
 *
 * @export
 * @class SysDepartmentUIActionBase
 * @extends {UIActionBase}
 */
export default class SysDepartmentUIActionBase extends EntityUIActionBase {
