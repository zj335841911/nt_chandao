...
import ProjectModuleAuthService from '@/app-core/auth-service/project-module/project-module-auth-service';
 ...
 *
 * @export
 * @class ProjectModuleUIActionBase
 * @extends {UIActionBase}
 */
export default class ProjectModuleUIActionBase extends EntityUIActionBase {
