...
import IbzDailyAuthService from '@/app-core/auth-service/ibz-daily/ibz-daily-auth-service';
 ...
 *
 * @export
 * @class IbzDailyUIActionBase
 * @extends {UIActionBase}
 */
export default class IbzDailyUIActionBase extends EntityUIActionBase {
     ...
     */
    public async IbzDaily_submitMob(args: any[], contextJO: any = {}, paramJO: any = {}, $event?: any, xData?: any, container?: any, srfParentDeName?: string): Promise<any> {
        ...
        const backend = async () => {
            const curUIService: any = await this.globaluiservice.getAppEntityService('ibzdaily');
            const response: any = await curUIService.Submit(_context, _params);
            if (response && response.status === 200) {
                this.notice.success('提交成功！');
                if (xData && xData.refresh && xData.refresh instanceof Function) {
                    xData.refresh(args);
                    AppCenterService.notifyMessage({name:"IbzDaily",action:'appRefresh',data:args});
                }
            } else {
     ...
     * @memberof IbzDailyUIService
     */
    public async IbzDaily_MobCreate(args: any[], contextJO: any = {}, paramJO: any = {}, $event?: any, xData?: any, container?: any, srfParentDeName?: string): Promise<any> {
        const _args: any[] = Util.deepCopy(args);
