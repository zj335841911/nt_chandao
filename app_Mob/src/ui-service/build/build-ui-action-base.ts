 ...
 *
 * @export
 * @class BuildUIActionBase
 * @extends {UIActionBase}
 */
export default class BuildUIActionBase extends EntityUIActionBase {
    ...
    public initViewMap(){
        ...
        this.allViewMap.set(':',{viewname:'editmobeditview',srfappde:'builds'});
        this.allViewMap.set(':',{viewname:'newmobeditview',srfappde:'builds'});
        this.allViewMap.set(':',{viewname:'logmobeditview',srfappde:'builds'});
        this.allViewMap.set('MOBMPICKUPVIEW:',{viewname:'mobmpickupview',srfappde:'builds'});
    }
    ...
    public async Build_MobDelete(args: any[], contextJO: any = {}, paramJO: any = {}, $event?: any, xData?: any, container?: any, srfParentDeName?: string): Promise<any> {
        ...
        const backend = async () => {
            const curUIService: any = await this.globaluiservice.getAppEntityService('build');
            const response: any = await curUIService.Remove(_context, _params);
            if (response && response.status === 200) {
                this.notice.success('删除成功！');
                if (xData && xData.refresh && xData.refresh instanceof Function) {
                    xData.refresh(args);
                    AppCenterService.notifyMessage({name:"Build",action:'appRefresh',data:args});
                }
            } else {
     ...
     * @memberof BuildUIService
     */
    public async Build_mob(args: any[], contextJO: any = {}, paramJO: any = {}, $event?: any, xData?: any, container?: any, srfParentDeName?: string): Promise<any> {
     ...
     * @memberof BuildUIService
     */
    public async Build_MobEditBuild(args: any[], contextJO: any = {}, paramJO: any = {}, $event?: any, xData?: any, container?: any, srfParentDeName?: string): Promise<any> {
        const _args: any[] = Util.deepCopy(args);
        const actionTarget: string | null = 'SINGLEKEY';
        Object.assign(contextJO, { build: '%build%' });
        Object.assign(paramJO, { id: '%build%' });
