...
import ProductModuleAuthService from '@/app-core/auth-service/product-module/product-module-auth-service';
 ...
 *
 * @export
 * @class ProductModuleUIActionBase
 * @extends {UIActionBase}
 */
export default class ProductModuleUIActionBase extends EntityUIActionBase {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MOBPICKUPVIEW:',{viewname:'mobpickupview',srfappde:'productmodules'});
        this.allViewMap.set(':',{viewname:'mobpickupmdview',srfappde:'productmodules'});
    }
