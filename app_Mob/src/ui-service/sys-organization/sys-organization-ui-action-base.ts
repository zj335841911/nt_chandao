...
import SysOrganizationAuthService from '@/app-core/auth-service/sys-organization/sys-organization-auth-service';
 ...
 *
 * @export
 * @class SysOrganizationUIActionBase
 * @extends {UIActionBase}
 */
export default class SysOrganizationUIActionBase extends EntityUIActionBase {
