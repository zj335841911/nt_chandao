...
import CaseStepAuthService from '@/app-core/auth-service/case-step/case-step-auth-service';
 ...
 *
 * @export
 * @class CaseStepUIActionBase
 * @extends {UIActionBase}
 */
export default class CaseStepUIActionBase extends EntityUIActionBase {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set(':',{viewname:'mobmdview9',srfappde:'casesteps'});
    }
