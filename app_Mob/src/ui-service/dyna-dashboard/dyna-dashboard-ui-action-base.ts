...
import DynaDashboardAuthService from '@/app-core/auth-service/dyna-dashboard/dyna-dashboard-auth-service';
 ...
 */
export default class DynaDashboardUIActionBase extends EntityUIActionBase {
