...
export default class CaseUIActionBase extends EntityUIActionBase {
    ...
    public initDeMainStateOPPrivsMap(){
        ...
        this.allDeMainStateOPPrivsMap.set('investigate__no',Object.assign({'CASECOF':0,'CASERESULT':0,'CASERUN':0,'CASETOBUG':0,'CONFIRM':0,'CREATE':0,'DELETE':0,'EDIT':0,'READ':0,'RESULT':0,'RUN':0,'TOBUG':0,'UNLINK':0,'UPDATE':0},{'SRFUR__CASE_CONFIRM_BUT':1,'SRFUR__CASE_TOBUG_BUT':1,'SRFUR__CASE_CASECOF_BUT':1,}));
