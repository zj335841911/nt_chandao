...
import ModuleAuthService from '@/app-core/auth-service/module/module-auth-service';
 ...
 *
 * @export
 * @class ModuleUIActionBase
 * @extends {UIActionBase}
 */
export default class ModuleUIActionBase extends EntityUIActionBase {
