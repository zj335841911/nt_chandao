...
import ProjectProjectStatusBarMobb from '@/widgets/project/project-status-bar-mobb-portlet/project-status-bar-mobb-portlet.vue';
...
export const  PortletComponent = {
    install(v: any, opt: any) {
        ...
        v.component('app-project-project-status-bar-mobb-portlet', ProjectProjectStatusBarMobb);
        ...
        v.component('project-project-status-bar-mobb-portlet', ProjectProjectStatusBarMobb);
