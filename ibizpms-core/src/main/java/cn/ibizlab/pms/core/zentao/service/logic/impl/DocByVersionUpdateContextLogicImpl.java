...
import cn.ibizlab.pms.core.zentao.service.logic.IDocByVersionUpdateContextLogic;
import cn.ibizlab.pms.core.zentao.domain.Doc;

/**
 * 关系型数据实体[ByVersionUpdateContext] 对象
 */
@Slf4j
@Service
public class DocByVersionUpdateContextLogicImpl implements IDocByVersionUpdateContextLogic{
    ...
    @Autowired
    private cn.ibizlab.pms.core.zentao.service.IDocService iBzSysDefaultService;

    public cn.ibizlab.pms.core.zentao.service.IDocService getIBzSysDefaultService() {
