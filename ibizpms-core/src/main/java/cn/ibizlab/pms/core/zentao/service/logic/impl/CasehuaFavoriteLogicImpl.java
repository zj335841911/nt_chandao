...
import cn.ibizlab.pms.core.zentao.service.logic.ICasehuaFavoriteLogic;
import cn.ibizlab.pms.core.zentao.domain.Case;

/**
 * 关系型数据实体[huaFavorite] 对象
 */
@Slf4j
@Service
public class CasehuaFavoriteLogicImpl implements ICasehuaFavoriteLogic{
    ...
    public void execute(Case et){
        ...
        try{
           ...
           kieSession.startProcess("cn.ibizlab.pms.core.zentao.service.logic.casehuafavorite");

        }catch(Exception e){
            throw new RuntimeException("执行[huaFavorite]处理逻辑发生异常"+e);
        }finally {
            if(kieSession!=null)
            kieSession.destroy();
        }
