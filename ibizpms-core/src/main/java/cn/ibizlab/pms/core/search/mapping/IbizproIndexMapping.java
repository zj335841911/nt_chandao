...
public class IbizproIndexMapping {
     ...
     */
    public static IbizproIndex bug2Bug(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
     ...
     */
    public static IbizproIndex case2Case(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
        IbizproIndex indexET = new IbizproIndex();
     ...
     */
    public static IbizproIndex product2Product(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
        IbizproIndex indexET = new IbizproIndex();
     ...
     */
    public static IbizproIndex project2Project(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
        IbizproIndex indexET = new IbizproIndex();
     ...
     */
    public static IbizproIndex story2Story(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
        IbizproIndex indexET = new IbizproIndex();
     ...
     */
    public static IbizproIndex task2Task(cn.ibizlab.pms.core.zentao.domain.IbizproIndex srcET) {
        IbizproIndex indexET = new IbizproIndex();
