...
import cn.ibizlab.pms.core.ibiz.service.logic.IIbzMyTerritoryMobMenuCountLogic;
import cn.ibizlab.pms.core.ibiz.domain.IbzMyTerritory;

/**
 * 关系型数据实体[MobMenuCount] 对象
 */
@Slf4j
@Service
public class IbzMyTerritoryMobMenuCountLogicImpl implements IIbzMyTerritoryMobMenuCountLogic{
    ...
    @Autowired
    private cn.ibizlab.pms.core.ibiz.service.IIbzMyTerritoryService ibzmyterritoryservice;

    public cn.ibizlab.pms.core.ibiz.service.IIbzMyTerritoryService getIbzmyterritoryService() {
