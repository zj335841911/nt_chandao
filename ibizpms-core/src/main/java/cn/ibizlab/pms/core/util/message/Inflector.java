...
public class Inflector {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Inflector.getInstance().pluralize("story"));
        System.out.println(Inflector.getInstance().pluralize("task"));
        //复数转单数
        System.out.println(Inflector.getInstance().singularize("women"));
        System.out.println(Inflector.getInstance().singularize("story"));
        System.out.println(Inflector.getInstance().singularize("bug"));
        System.out.println(Inflector.getInstance().singularize("todo"));
        System.out.println(Inflector.getInstance().singularize("task"));
    }
}
