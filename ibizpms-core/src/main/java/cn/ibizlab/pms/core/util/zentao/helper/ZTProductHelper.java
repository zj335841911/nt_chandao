...
final public class ZTProductHelper {
    ...
    private final static List<ZTCheckItem> ACTION_CHECKLIST_PROJECT = new ArrayList<>();
    ...
    private final static List<ZTCheckItem> ACTION_CHECKLIST_ROADMAP = new ArrayList<>();
    private final static List<ZTCheckItem> ACTION_CHECKLIST_DYNAMIC = new ArrayList<>();
    private final static List<ZTCheckItem> ACTION_CHECKLIST_AJAXGETPROJECTS = new ArrayList<>();
    private final static List<ZTCheckItem> ACTION_CHECKLIST_AJAXGETPLANS = new ArrayList<>();
    ...
    private final static List<ZTCheckItem> ACTION_CHECKLIST_SHOWERRORNONE = new ArrayList<>();
    ...
    private final static String ACTION_RETURNURL_PROJECT = null;
    private final static String ACTION_RETURNURL_BROWSE = null;
    private final static String ACTION_RETURNURL_CREATE = "/zentao/product-browse-";
    private final static String ACTION_RETURNURL_EDIT = "/zentao/product-view-";
    ...
    private final static String ACTION_RETURNURL_ROADMAP = null;
    private final static String ACTION_RETURNURL_DYNAMIC = null;
    private final static String ACTION_RETURNURL_AJAXGETPROJECTS = null;
    private final static String ACTION_RETURNURL_AJAXGETPLANS = null;
    ...
    private final static String ACTION_RETURNURL_SHOWERRORNONE = null;
